...
# 1000 inserts operation per sec
...
#workload = Workload(context, insert_thread + search_thread + checkpoint_thread)
workload.options.report_interval=5
# Number of sec
workload.options.run_time=20
# Uncomment to raise an exception instead of a warning
# workload.options.max_latency_fatal = True
