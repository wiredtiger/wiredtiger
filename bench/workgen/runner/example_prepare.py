...
read_txn = op_group_transaction(opread, 5, "read_timestamp")
...
write_txn = op_group_transaction(opwrite, 5, "isolation=snapshot")
...
update_txn = op_group_transaction(opupdate, 5, "isolation=snapshot")
