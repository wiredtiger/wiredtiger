...
class PerfStatCollection:
    ...
    def compact_stats():
        ...
        return [
            ...
            PerfStat(short_label="block_alloc_first_fit_count",
                     stat_file='compact_summary.txt',
                     pattern=r'Block alloc first fit count\s+:\s+\d+',
                     input_offset=6,
                     output_label='Block alloc first fit count'),
            PerfStat(short_label="block_alloc_restricted_best_fit_count",
                     stat_file='compact_summary.txt',
                     pattern=r'Block alloc restricted best fit count\s+:\s+\d+',
                     input_offset=7,
                     output_label='Block alloc restricted best fit count'),
            PerfStat(short_label="block_first_srch_walk_time_max_us",
                     stat_file='compact_summary.txt',
                     pattern=r'Block first srch walk time max usecs\s+:\s+\d+',
                     input_offset=8,
                     output_label='Block first srch walk time max usecs'),
