    ...
    def all_stats():
        return [
            ...
            PerfStat(short_label="reconfigure_pickup",
                     ...
                     output_precision=4,
                     conversion_function=float),
            PerfStat(short_label="reconfigure_setup_pickup",
                     stat_files=['../stdout_file.txt'],
                     pattern=r'PERF reconfigure_setup_pickup_secs:\s+[\d.]+',
                     input_offset=2,
                     output_label='reconfigure setup pickup seconds',
                     output_precision=4,
                     conversion_function=float),
            PerfStat(short_label="reconfigure_update_pickup",
                     stat_files=['../stdout_file.txt'],
                     pattern=r'PERF reconfigure_update_pickup_secs:\s+[\d.]+',
                     input_offset=2,
                     output_label='reconfigure update pickup seconds',
                     output_precision=4,
                     conversion_function=float),
            ...
            PerfStat(short_label="disagg_pick_up_file_meta_updated",
                     stat_files=['../stdout_file.txt'],
                     pattern=r'PERF disagg_pick_up_file_meta_updated:\s+\d+',
                     input_offset=2,
                     output_label='disagg pick up file meta updated',
                     conversion_function=int),
