...
DEF_OPT_AS_BOOL(scramble, 0,
  "if true, apply FNV-1a hash to distribution output to scatter hot keys across the key space, "
  "matching the behavior of YCSB's ScrambledZipfianGenerator. Intended for use with pareto.")
