...
/*
 * Handle errors that generated by the op_ functions that we can safely ignore.
 */
int
...
/*
 * Handle the messages generated by the op_ functions that we can safely ignore.
 */
int
