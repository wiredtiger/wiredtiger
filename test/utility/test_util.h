...
typedef struct {
    ...
    /*
     * TODO: this buffer isn't thread safe, but it's convenient. The solution is to change the
     * progress function to take variable args, like the __wt_err implementation.
     */
