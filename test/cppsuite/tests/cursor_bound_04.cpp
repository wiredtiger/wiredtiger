...
class operation_tracker_cursor_bound_04 : public operation_tracker {

    public:
    operation_tracker_cursor_bound_04(
...
class cursor_bound_04 : public test {
    ...
    cursor_bound_04(const test_args &args) : test(args)
    {
        init_operation_tracker(
          new operation_tracker_cursor_bound_04(_config->get_subconfig(OPERATION_TRACKER),
