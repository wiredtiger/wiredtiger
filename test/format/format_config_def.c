...
CONFIG configuration_list[] = {{"assert.read_timestamp", "assert read_timestamp", C_BOOL, 2, 0, 0,
  ...
  {"stress.failpoint_non_txn_truncate_restart",
    "stress failpoint non-transactional truncate restart", C_BOOL, 2, 0, 0,
    V_GLOBAL_STRESS_FAILPOINT_NON_TXN_TRUNCATE_RESTART},
