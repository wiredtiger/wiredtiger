...
CONFIG configuration_list[] = {{"assert.read_timestamp", "assert read_timestamp", C_BOOL, 2, 0, 0,
  ...
  {"file_manager.close_handle_minimum",
    "number of handles open before the file manager will look for handles to close", 0x0, 0, 20, 32,
  ...
  {"file_manager.close_scan_interval",
    "interval in seconds at which to check for files that are inactive and close them", 0x0, 0,
    1000, 100000, V_GLOBAL_FILE_MANAGER_CLOSE_SCAN_INTERVAL},
