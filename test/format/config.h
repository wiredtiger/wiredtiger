...
static CONFIG c[] = {
  ...
  /* 2% */
  {"stress.checkpoint_prepare_after_get_ts", "stress checkpoint prepare after getting timestamps", C_BOOL, 2, 0, 0,
    &g.c_timing_stress_checkpoint_prepare_after_get_ts, NULL},

  /* 2% */
  {"stress.checkpoint_prepare_before_get_ts", "stress checkpoint prepare before getting timestamps", C_BOOL, 2, 0, 0,
    &g.c_timing_stress_checkpoint_prepare_before_get_ts, NULL},
