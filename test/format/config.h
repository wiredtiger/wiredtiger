...
#define V_GLOBAL_FILE_MANAGER_CLOSE_HANDLE_MINIMUM 48
#define V_GLOBAL_FILE_MANAGER_CLOSE_IDLE_TIME 49
#define V_GLOBAL_FILE_MANAGER_CLOSE_SCAN_INTERVAL 50
