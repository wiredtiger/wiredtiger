...
#define BACKUP_INFO_FILE "BKUP_INFO"         /* Format's backup information for restart */
#define BACKUP_INFO_FILE_TMP "BKUP_INFO.TMP" /* Format's backup information for restart */
