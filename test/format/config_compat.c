...
static const char *list[] = {
  ...
  "huffman_value=", "btree.huffman_value", "independent_thread_rng=", "runs.independent_thread_rng",
  "insert_pct=", "ops.pct.insert", "internal_key_truncation=", "btree.internal_key_truncation",
  "internal_page_max=", "btree.internal_page_max", "isolation=", "transaction.isolation",
  "key_gap=", "btree.key_gap", "key_max=", "btree.key_max", "key_min=", "btree.key_min",
  "leaf_page_max=", "btree.leaf_page_max", "leak_memory=", "wiredtiger.leak_memory",
  "logging_archive=", "logging.archive", "logging_compression=", "logging.compression",
  "logging_file_max=", "logging.file_max", "logging_prealloc=", "logging.prealloc",
  "lsm_worker_threads=", "lsm.worker_threads", "memory_page_max=", "btree.memory_page_max",
  "merge_max=", "lsm.merge_max", "mmap=", "disk.mmap", "mmap_all=", "runs.mmap_all", "modify_pct=",
