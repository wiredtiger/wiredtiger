...
static const char *list[] = {
  "abort=", "runs.abort", "alter=", "ops.alter", "assert_commit_timestamp=",
  ...
  "btree.compression", "data_extend=", "disk.data_extend", "delete_pct=", "ops.pct.delete",
  "dictionary=", "btree.dictionary", "direct_io=", "disk.direct_io", "encryption=",
  "disk.encryption", "firstfit=", "disk.firstfit", "huffman_key=", "btree.huffman_key",
  "huffman_value=", "btree.huffman_value", "in_memory=", "wiredtiger.in_memory",
  "independent_thread_rng=", "runs.independent_thread_rng", "insert_pct=", "ops.pct.insert",
  "internal_key_truncation=", "btree.internal_key_truncation", "internal_page_max=",
  "btree.internal_page_max", "isolation=", "transaction.isolation", "key_gap=", "btree.key_gap",
  "key_max=", "btree.key_max", "key_min=", "btree.key_min", "leaf_page_max=", "btree.leaf_page_max",
  "leak_memory=", "wiredtiger.leak_memory", "logging_archive=", "logging.archive",
  "logging_compression=", "logging.compression", "logging_file_max=", "logging.file_max",
  "logging_prealloc=", "logging.prealloc", "lsm_worker_threads=", "lsm.worker_threads",
  "memory_page_max=", "btree.memory_page_max", "merge_max=", "lsm.merge_max", "mmap=", "disk.mmap",
  "mmap_all=", "runs.mmap_all", "modify_pct=", "ops.pct.modify", "ops=", "runs.ops",
  "prefix_compression=", "btree.prefix_compression", "prefix_compression_min=",
  "btree.prefix_compression_min", "prepare=", "ops.prepare", "random_cursor=", "ops.random_cursor",
  "read_pct=", "ops.pct.read", "rebalance=", "ops.rebalance", "repeat_data_pct=",
  "btree.repeat_data_pct", "reverse=", "btree.reverse", "rows=", "runs.rows", "salvage=",
  "ops.salvage", "split_pct=", "btree.split_pct", "statistics=", "statistics", "statistics_server=",
  "statistics.server", "threads=", "runs.threads", "timer=", "runs.timer",
