...
class test_rollback_to_stable26(test_rollback_to_stable_base):
    ...
    def conn_config(self):
        config = 'cache_size=5MB,statistics=(all),timing_stress_for_test=[history_store_checkpoint_delay]'
        return config
