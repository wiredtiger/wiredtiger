...
# test_history_store08.py
# Verify modify insert into lookaside logic.
class test_history_store08(wttest.WiredTigerTestCase):
    ...
    def test_modify_insert_to_las(self):
        uri = "table:test_history_store08"
        ...
        # will get written to the data store the second will fetch the full value
        # of our previous modify to be written as a reverse delta into the history
        # store.
        self.session.begin_transaction()
        cursor.set_key(1)
