...
class test_layered_schema11(wttest.WiredTigerTestCase, DisaggSchemaEpochMixin):
    ...
    def test_no_recreate_dropped_table_with_epochs(self):
        ...
        self.assertTrue(self.uri_has_stable_constituent(conn_follow, self.uri))
        ...
        self.assertFalse(self.uri_has_stable_constituent(conn_follow, self.uri))
    ...
    def test_no_recreate_dropped_table_isolation(self):
        ...
        conn_follow, session_follow = self.open_follower()
        self.assertTrue(self.uri_has_stable_constituent(conn_follow, self.uri))
        self.assertTrue(self.uri_has_stable_constituent(conn_follow, self.uri2))
