...
from test_layered_follower04 import Oplog
from wtscenario import make_scenarios

# test_layered_ingest04.py
# Test garbage collecting redundant content in the ingest table
@disagg_test_class
class test_layered_ingest04(wttest.WiredTigerTestCase):
    ...
    disagg_storages = gen_disagg_storages('test_layered_ingest04', disagg_only = True)

    scenarios = make_scenarios(disagg_storages)

    uri = 'layered:test_layered_ingest04'
    ingest_uri = 'file:test_layered_ingest04.wt_ingest'
    ...
    def evict_ingest(self, session, ts):
        ...
        evict_cursor = session.open_cursor("file:test_layered_ingest04.wt_ingest", None, "debug=(release_evict)")
