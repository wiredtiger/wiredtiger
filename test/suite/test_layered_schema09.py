...
#   Test WT_SESSION::publish for disaggregated storage.
@disagg_test_class
class test_layered_schema09(wttest.WiredTigerTestCase, suite_subprocess):
    ...
    disagg_storages = gen_disagg_storages('test_layered_schema09', disagg_only=True)
    ...
    def test_publish_error_invalid_uri(self):
        ...
        self.assertRaisesWithMessage(wiredtiger.WiredTigerError,
            lambda: self.session.publish(
                'file:test_layered_schema09_err_uri',
    ...
    def test_checkpoint_fails_without_publish(self):
        ...
        [returncode, _] = self.run_subprocess_function(subdir,
            'test_layered_schema09.test_layered_schema09.subprocess_checkpoint_fails_without_publish',
            silent=True)
    ...
    def test_checkpoint_fails_with_publish_at_later_epoch(self):
        ...
        [returncode, _] = self.run_subprocess_function(subdir,
            'test_layered_schema09.test_layered_schema09.'
