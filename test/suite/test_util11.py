...
class test_util11(wttest.WiredTigerTestCase, suite_subprocess):
    ...
    def test_list_drop(self):
        ...
        self.populate(pfx + '2')
        self.populate(pfx + '3')
        self.dropUntilSuccess(self.session, 'table:' + pfx + '2', None)
        self.dropUntilSuccess(self.session, 'table:' + pfx + '4', None)
    ...
    def test_list_drop_all(self):
        ...
        self.populate(pfx + '2')
        self.populate(pfx + '3')
        self.dropUntilSuccess(self.session, 'table:' + pfx + '5', None)
        self.dropUntilSuccess(self.session, 'table:' + pfx + '4', None)
        self.dropUntilSuccess(self.session, 'table:' + pfx + '3', None)
        self.dropUntilSuccess(self.session, 'table:' + pfx + '2', None)
        self.dropUntilSuccess(self.session, 'table:' + pfx + '1', None)
