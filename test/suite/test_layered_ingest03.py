...
# test_layered_ingest03.py
# Test pinning the content in the ingest table
@disagg_test_class
class test_layered_ingest03(wttest.WiredTigerTestCase):
    ...
    disagg_storages = gen_disagg_storages('test_layered_ingest03', disagg_only = True)

    scenarios = make_scenarios(disagg_storages)

    uri = 'layered:test_layered_ingest03'
    ...
    def test_ping_ingest_table(self):
        ...
        evict_cursor = session_follow.open_cursor("file:test_layered_ingest03.wt_ingest", None, "debug=(release_evict)")
