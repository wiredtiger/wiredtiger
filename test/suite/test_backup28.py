...
# including colgroups or lsm formats should raise a message. The only supported types are
...
class test_backup28(backup_base):
    ...
    types = [
        ...
        ('table-cg', dict(pfx='table:', target_uri_list=["colgroup:table0:g0", "table:table0"])),
    ]
    ...
    def test_backup28(self):
        ...
        if len(self.target_uri_list) and self.target_uri_list[0] == "table:table0":
            ...
            # colgroups or lsm. This should fail and return with a message, as we only allow
            # table formats.
