...
@disagg_test_class
class test_layered_ingest07(wttest.WiredTigerTestCase):
    ...
    uri = 'layered:test_layered_ingest07'
    ingest_uri = 'file:test_layered_ingest07.wt_ingest'
    create_config = 'key_format=i,value_format=S'

    disagg_storages = gen_disagg_storages('test_layered_ingest07', disagg_only=True)
