...
@disagg_test_class
class test_layered74(wttest.WiredTigerTestCase, DisaggConfigMixin):
    encrypt = [
    ...
    uris = [
        ('layered', dict(uri='layered:test_layered74')),
        ('btree', dict(uri='file:test_layered74')),
    ]
    ...
    delta = [
        ('write_leaf_only', dict(delta_config='page_delta=(internal_page_delta=false,leaf_page_delta=true,delta_pct=80)', delta_type='leaf_only')),
        ('write_none', dict(delta_config='page_delta=(internal_page_delta=false,leaf_page_delta=false)', delta_type='none')),
        ('write_both', dict(delta_config='page_delta=(internal_page_delta=true,leaf_page_delta=true,delta_pct=80)', delta_type='both')),
    ]
