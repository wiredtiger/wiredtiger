...
# test_disagg_config03.py
# Test that creating a tiered table fails when in disaggregated storage mode
@disagg_test_class
class test_disagg_config03(wttest.WiredTigerTestCase, DisaggConfigMixin):
    ...
    disagg_storages = gen_disagg_storages('test_disagg_config03', disagg_only = True)
    ...
    def test_disagg_tiered_create_disabled(self):
        ...
        lambda: self.session.create(self.prefix + 'test_disagg_config03',
