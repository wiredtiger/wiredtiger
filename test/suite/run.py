...
if __name__ == '__main__':
    ...
    wttest.WiredTigerTestCase.globalSetup(command_line_vars, preserve, removeAtStart, timestamp, gdbSub,
                                          lldbSub, verbose, wt_builddir, dirarg, longtest,
                                          extralongtest, zstdtest, ignoreStdout, seedw, seedz,
