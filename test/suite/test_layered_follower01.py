...
class test_layered_follower01(wttest.WiredTigerTestCase):
    ...
    layered_uris = ["table:test_layered_follower01a", "layered:test_layered_follower01b"]
    file_uris = ["file:test_layered_follower01c"]
    table_uris = ["table:test_layered_follower01d"]
    all_uris = layered_uris + file_uris + table_uris
    with_ingest_uris = all_uris + ["file:test_layered_follower01a.wt_ingest", "file:test_layered_follower01b.wt_ingest"]
    ...
    def test_layered_follower01(self):
