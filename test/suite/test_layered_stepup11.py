...
@disagg_test_class
class test_layered_stepup11(wttest.WiredTigerTestCase, suite_subprocess):
    tablename = 'test_layered_stepup11'
    ...
    def test_race(self):
        rc, _ = self.run_subprocess_function(
            'SUBPROCESS',
            'test_layered_stepup11.test_layered_stepup11.subprocess_race',
            silent=True)
