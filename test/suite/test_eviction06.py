...
# test_eviction06.py
#
# Functional correctness tests for the two_phase_eviction mode introduced in
# WT-17041. The same suite of operations (clean eviction, dirty eviction,
# update visibility after eviction, runtime toggle) is run under both the
# new two-phase model (two_phase_eviction=true, the default) and the legacy
# single-phase model (two_phase_eviction=false) to confirm identical
