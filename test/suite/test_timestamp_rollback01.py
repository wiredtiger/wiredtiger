...
class test_timestamp_rollback01(wttest.WiredTigerTestCase, suite_subprocess):
    ...
    def test_basic(self):
       ...
       #  somewhat complex tree
        ...
        self.conn.rollback_nondurable_commits('timestamp=' + timestamp_str(key_range / 2))
        ...
        self.conn.rollback_nondurable_commits('timestamp=' + timestamp_str(1 + key_range + key_range / 4))
