...
@disagg_test_class
class test_layered_ingest05(wttest.WiredTigerTestCase):
    disagg_storages = gen_disagg_storages('test_layered_ingest05', disagg_only = True)
    ...
    def test_remove(self):
        uri = "layered:test_layered_ingest05"
        # Setup
