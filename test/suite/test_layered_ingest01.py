...
# test_layered_ingest01.py
# Test draining the ingest table
@disagg_test_class
class test_layered_ingest01(wttest.WiredTigerTestCase):
    ...
    disagg_storages = gen_disagg_storages('test_layered_ingest01', disagg_only = True)

    scenarios = make_scenarios(disagg_storages, sizes)

    uri = 'layered:test_layered_ingest01'
