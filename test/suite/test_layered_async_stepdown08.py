...
@disagg_test_class
class test_layered_async_stepdown08(LayeredStepdownMixin, wttest.WiredTigerTestCase,
                                    suite_subprocess):
    ...
    def test_step_down_checkpoint_boundary(self):
        rc, _ = self.run_subprocess_function(
            'SUBPROCESS',
            'test_layered_async_stepdown08.test_layered_async_stepdown08.subprocess_step_down',
            silent=True,
