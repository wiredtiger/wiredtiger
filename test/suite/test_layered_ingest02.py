...
# test_layered_ingest02.py
#    Test delete on the ingest table.
@disagg_test_class
class test_layered_ingest02(wttest.WiredTigerTestCase):
    ...
    disagg_storages = gen_disagg_storages('test_layered_ingest02', disagg_only = True)
    ...
    def test_delete(self):
        uri = "layered:test_layered_ingest02"
