...
class test_backup14(backup_base):
    ...
    def add_data_validate_backups(self):
        ...
        self.add_data(self.uri, self.bigkey, self.bigval, do_checkpoint=True)
    ...
    def drop_old_add_new_table(self):
        ...
        self.new_table = True
        self.add_data(self.uri2, self.bigkey, self.bigval, do_checkpoint=True)
        self.take_incr_backup(self.home_incr)
    ...
    def insert_bulk_data(self):
        ...
        self.add_data(self.uri_logged, self.bigkey, self.bigval, do_checkpoint=True)
        ...
        self.add_data(self.uri_not_logged, self.bigkey, self.bigval, do_checkpoint=True)
