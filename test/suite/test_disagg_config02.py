...
class test_disagg_config02(wttest.WiredTigerTestCase, DisaggConfigMixin):

    disagg_storages = gen_disagg_storages('test_disagg_config02', disagg_only = True)
    ...
    def test_disagg_compact(self):
        ...
        self.assertRaisesWithMessage(wiredtiger.WiredTigerError,
            lambda: self.session.compact('table:test_disagg_config02'),
