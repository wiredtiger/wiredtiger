...
class test_load01(wttest.WiredTigerTestCase):
    ...
    def test_load_reconfig(self):
        ...
        configs = [
            ...
            "load_control=[enable=false,control_threshold=80]",
            "load_control=[enable=false,control_threshold=85]",
            "load_control=[enable=false,control_threshold=100]",
            "load_control=[enable=true,control_threshold=10]",
            "load_control=[enable=true,control_threshold=25]",
            "load_control=[enable=true,control_threshold=50]",
            "load_control=[enable=true,control_threshold=80]",
            "load_control=[enable=true,control_threshold=85]",
        ...
        failure_configs = [
            ...
            "load_control=[enable=true,control_threshold=110]",
        ]
