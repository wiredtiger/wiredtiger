...
class test_layered_ingest06(wttest.WiredTigerTestCase):
    ...
    uri = "layered:test_layered_ingest06"

    disagg_storages = gen_disagg_storages('test_layered_ingest06', disagg_only = True)
    scenarios = make_scenarios(disagg_storages)

    def test_layered_ingest06(self):
