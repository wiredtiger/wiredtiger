...
class test_disagg_config04(wttest.WiredTigerTestCase, DisaggConfigMixin):

    disagg_storages = gen_disagg_storages('test_disagg_config04', disagg_only = True)

    uri = "layered:test_disagg_config04_%02d"
