...
@disagg_test_class
class test_layered_schema07(wttest.WiredTigerTestCase):
    ...
    def test_populate_table_on_leader(self):
        self.session.create(f"{self.prefix}test_layered_schema07", self.make_create_config())
        # Check the leader
        expected_files = {"file:test_layered_schema07.wt_stable": TEST_NAMESPACE_SHARED,
                          "file:test_layered_schema07.wt_ingest": TEST_NAMESPACE_LOCAL}
    ...
    def test_populate_10_tables_on_leader_pick_up_on_follower(self):
        ...
        for i in range(10):
            table_name = f"test_layered_schema07_{i}"
