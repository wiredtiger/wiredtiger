...
# unzips the test artefacts, aliases the mongodbtoolchain binaries, installs cmake into the machine,
# and exports the LD_LIBRARY_PATH.
# 
...
if [[ -n $COMPILE_ARCHIVE ]]; then
   tar --wildcards -xzf $COMPILE_ARCHIVE
fi

if [[ -z $COMPILE_ARCHIVE && -z WT_ARCHIVE ]]; then
