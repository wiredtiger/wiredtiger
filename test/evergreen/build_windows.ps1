...
if ($configure -eq $true) {
    ...
    C:\cmake\bin\cmake --no-warn-unused-cli -DSWIG_DIR='C:\swigwin-4.2.1' -DSWIG_EXECUTABLE='C:\swigwin-4.2.1\swig.exe' -DCMAKE_TOOLCHAIN_FILE='..\cmake\toolchains\cl.cmake' ${args} -G "Ninja" ..\.
