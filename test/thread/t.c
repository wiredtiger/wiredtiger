...
{
    static WT_EVENT_HANDLER event_handler = {handle_error, handle_message,
      NULL /* Progress handler */, NULL /* Session close handler. */,
      NULL /* Connection ready handler */, NULL /* Connection close handler */};
    char config[512];
