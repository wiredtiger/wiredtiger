...
typedef struct {
    ...
    bool disagg_stable_dhandle_delay_timing_stress; /* Disagg stable dhandle delay timing stress */
    ...
    bool prepare_checkpoint_delay_timing_stress;    /* Checkpoint prepare delay timing stress */
