...
static uint32_t (*fsoftware)(const void *, size_t);
...
main(int argc, char *argv[])
{
	...
	/* Get the underlying software function. */
	fsoftware = __wt_checksum_sw();
