...
static TEST_DRIVER driver[] = {
  {{"parse_opts", "-b", "builddir", "-T", "21", NULL},
   {NULL, NULL, {0}, NULL, (char *)"builddir", NULL, 0, NULL, NULL, false, false, false, false, false, 0,
      0, 21, UNUSED_OPTS},
    {NULL, 0, 0, 0}},
  ...
  {{"parse_opts", "-v", "-PT", NULL},
    {NULL, NULL, {0}, NULL, NULL, (char *)"dir_store", 0, NULL, NULL, false, false, true, true, false, 0,
      0, 0, UNUSED_OPTS},
    {NULL, 0, 0, 0}},

  {{"parse_opts", "-v", "-Po", "my_store", "-PT", NULL},
    {NULL, NULL, {0}, NULL, NULL, (char *)"my_store", 0, NULL, NULL, false, false, true, true, false, 0, 0,
      0, UNUSED_OPTS},
    {NULL, 0, 0, 0}},
