...
static TEST_DRIVER driver[] = {
  ...
  {{"parse_opts", "-v", "-PT", NULL},
    {NULL, NULL, {0}, NULL, NULL, (char *)"dir_store", TABLE_NOT_SET, NULL, NULL, false, false, true, true,
      false, 0, 0, 0, UNUSED_OPTS},
    {NULL, 0, 0, 0}},

  {{"parse_opts", "-v", "-Po", "my_store", "-PT", NULL},
    {NULL, NULL, {0}, NULL, NULL, (char *)"my_store", TABLE_NOT_SET, NULL, NULL, false, false, true, true,
      false, 0, 0, 0, UNUSED_OPTS},
    {NULL, 0, 0, 0}},
