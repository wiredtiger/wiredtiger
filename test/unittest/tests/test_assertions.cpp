...
uint16_t DIAGNOSTIC_FLAGS[] = {WT_DIAGNOSTIC_ALL, WT_DIAGNOSTIC_CHECKPOINT_VALIDATE,
  WT_DIAGNOSTIC_CURSOR_CHECK, WT_DIAGNOSTIC_EVICTION_CHECK, WT_DIAGNOSTIC_DISK_VALIDATE,
  WT_DIAGNOSTIC_HS_VALIDATE, WT_DIAGNOSTIC_KEY_OUT_OF_ORDER, WT_DIAGNOSTIC_LOG_VALIDATE,
  WT_DIAGNOSTIC_GENERATION_CHECK, WT_DIAGNOSTIC_PREPARED, WT_DIAGNOSTIC_SLOW_OPERATION,
