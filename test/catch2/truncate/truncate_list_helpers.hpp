...
class scoped_slow_truncate_disable {
public:
    scoped_slow_truncate_disable() : _previous(__wt_process.disagg_slow_truncate_2026)
    {
        __wt_process.disagg_slow_truncate_2026 = false;
    }

    ~scoped_slow_truncate_disable()
    {
        __wt_process.disagg_slow_truncate_2026 = _previous;
    }
...
private:
    scoped_slow_truncate_disable _enable;
