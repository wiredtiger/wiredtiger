...
TEST_CASE("Test disaggregated configuration logic", "[disagg_config]")
{
    ...
    REQUIRE(__wt_spin_init(session, &conn_impl->disaggregated_storage.shared_metadata_lock,
    ...
    __wt_spin_destroy(session, &conn_impl->disaggregated_storage.shared_metadata_lock);
