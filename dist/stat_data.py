...
connection_stats = [
    ...
    CacheStat('cache_eviction_target_page_ge128', 'Histogram - Per tree page target greater than 128'),
    CacheStat('cache_eviction_target_page_lt10', 'Histogram - Per tree page target 0-10'),
    CacheStat('cache_eviction_target_page_lt32', 'Histogram - Per tree page target 10-32'),
    CacheStat('cache_eviction_target_page_lt64', 'Histogram - Per tree page target 32-64'),
    CacheStat('cache_eviction_target_page_lt128', 'Histogram - Per tree page target 64-128'),
    ...
    CacheStat('cache_eviction_walks_gave_up_no_target', 'eviction walks gave up because they saw too many pages and found no candidates'),
