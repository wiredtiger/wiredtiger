...
conn_stats = [
    ...
    EvictStat('eviction_force_no_retry', 'forced eviction - do not retry count to evict pages selected to evict during reconciliation'),s    EvictStat('eviction_get_ref_empty', 'eviction calls to get a page could not find a page'),
    ...
    EvictStat('eviction_skip_page_retry', 'eviction skips pages that previously failed eviction and likely will again'),
