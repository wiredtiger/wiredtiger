...
conn_stats = [
    ...
    ChunkCacheStat('chunkcache_create_and_link_chunks', 'total number of chunks created, and linked to their corresponding on-disk offsets using information extracted from metadata.'),
