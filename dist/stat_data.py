...
connection_stats = [
    ...
    CacheStat('cache_eviction_force', 'pages selected for forced eviction count'),
    CacheStat('cache_eviction_force_clean', 'clean pages forcibly evicted count'),
    CacheStat('cache_eviction_force_clean_time', 'clean pages forcibly evicted time (usecs)'),
    CacheStat('cache_eviction_force_delete', 'pages selected for forced eviction because of too many deleted items count'),
    CacheStat('cache_eviction_force_dirty', 'dirty pages forcibly evicted count'),
    CacheStat('cache_eviction_force_dirty_time', 'dirty pages forcibly evicted time (usecs)'),
    CacheStat('cache_eviction_force_fail', 'pages selected for forced eviction unable to be evicted count'),
