...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_dirty_index_drain_hazard', 'dirty index slots skipped by drain due to hazard-pointer failure'),
    ...
    CacheStat('cache_eviction_dirty_index_drain_skipped_stable_unchanged', 'dirty index drain skipped because the pinned stable timestamp has not advanced past the last unproductive pass'),
