...
connection_stats = [
    ...
    ConnStat('capacity_evict_calls', 'throttled eviction write calls'),
    ConnStat('capacity_evict_throttles', 'throttled eviction writes for capacity'),
    ConnStat('capacity_evict_time', 'throttled capacity time in eviction (usecs)'),
    ConnStat('capacity_log_calls', 'throttled log write calls'),
    ConnStat('capacity_log_throttles', 'throttled log writes for capacity'),
    ConnStat('capacity_log_time', 'throttled capacity time in logging (usecs)'),
    ...
    ConnStat('capacity_signal_calls', 'throttled capacity signal function called'),
    ConnStat('capacity_signals', 'throttled capacity thread signalled'),
    ...
    ConnStat('capacity_time_fsync', 'throttled capacity thread time spent in background fsync (msecs)', 'no_clear,no_scale'),
    ConnStat('capacity_time_wait', 'throttled capacity thread time spent in cond_wait (msecs)', 'no_clear,no_scale'),
    ...
    ConnStat('fsync_all', 'background fsync calls'),
