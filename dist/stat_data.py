...
connection_stats = [
    ...
    BlockStat('block_cache_blocks', 'total blocks'),
    BlockStat('block_cache_bytes', 'total bytes used'),
    BlockStat('block_cache_data_refs', 'references asking for data'),
    BlockStat('block_cache_hits', 'number of cache hits, including existence checks'),
    BlockStat('block_cache_misses', 'number of cache misses, including existence checks'),
...
dsrc_stats = [
    ...
    ##########################################
    CompressStat('compress_hist_ratio_2', 'number of blocks with compress ratio smaller than two'),
    CompressStat('compress_hist_ratio_4', 'number of blocks with compress ratio smaller than four'),
    CompressStat('compress_hist_ratio_8', 'number of blocks with compress ratio smaller than eight'),
