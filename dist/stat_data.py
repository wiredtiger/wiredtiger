...
conn_stats = [
    ...
    CacheStat('cache_eviction_skip_pages_retry', 'skip pages that previously failed eviction and likely will again'),
    CacheStat('cache_eviction_skip_pages_last_running', 'skip pages that are written with transactions greater than the last running'),
    CacheStat('cache_eviction_skip_dirty_pages_during_checkpoint', 'skip dirty pages during a running checkpoint'),
