...
conn_stats = [
    ...
    TxnStat('txn_prepare_rollback_left_hs_update_with_ckpt_next_txnid', 'prepared transactions rolled back and left the history store entry with checkpoint next transaction id'),
