...
conn_dsrc_stats = [
    ...
    RecStat('rec_time_aggr_newest_start_durable_ts', 'pages written including an aggregated newest start durable/prepare timestamp '),
    RecStat('rec_time_aggr_newest_stop_durable_ts', 'pages written including an aggregated newest stop durable/prepare timestamp '),
    RecStat('rec_time_aggr_newest_stop_ts', 'pages written including an aggregated newest stop commit/prepare timestamp '),
    ...
    RecStat('rec_time_aggr_oldest_start_ts', 'pages written including an aggregated oldest start commit/prepare timestamp '),
    ...
    RecStat('rec_time_window_pages_start_commit_ts', 'pages written including at least one start commit timestamp'),
    RecStat('rec_time_window_pages_start_durable_ts', 'pages written including at least one start durable timestamp'),
    RecStat('rec_time_window_pages_start_prepare_ts', 'pages written including at least one start prepare timestamp'),
    RecStat('rec_time_window_pages_start_prepared_id', 'pages written including at least one start prepared id'),
    RecStat('rec_time_window_pages_start_txn', 'pages written including at least one start transaction ID'),
    RecStat('rec_time_window_pages_stop_commit_ts', 'pages written including at least one stop commit timestamp'),
    RecStat('rec_time_window_pages_stop_durable_ts', 'pages written including at least one stop durable timestamp'),
    RecStat('rec_time_window_pages_stop_prepare_ts', 'pages written including at least one stop prepare timestamp'),
    RecStat('rec_time_window_pages_stop_prepared_id', 'pages written including at least one stop prepared id'),
    ...
    RecStat('rec_time_window_start_commit_ts', 'records written including a start commit timestamp'),
    RecStat('rec_time_window_start_durable_ts', 'records written including a start durable timestamp'),
    RecStat('rec_time_window_start_prepare_ts', 'records written including a start prepare timestamp'),
    RecStat('rec_time_window_start_prepared_id', 'records written including a start prepared id'),
    RecStat('rec_time_window_start_txn', 'records written including a start transaction ID'),
    RecStat('rec_time_window_stop_commit_ts', 'records written including a stop commit timestamp'),
    RecStat('rec_time_window_stop_durable_ts', 'records written including a stop durable timestamp'),
    RecStat('rec_time_window_stop_prepare_ts', 'records written including a stop prepare timestamp'),
    RecStat('rec_time_window_stop_prepared_id', 'records written including a stop prepared id'),
