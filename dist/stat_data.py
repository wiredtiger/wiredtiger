...
##########################################
    ...
    RecStat('rec_pages_with_txn', 'pages reconciled with transaction ids'),
    RecStat('rec_pages_with_ts', 'pages reconciled with timestamps'),
    RecStat('rec_pages_with_prepare', 'pages reconciled with prepared transaction metadata'),
