...
conn_stats = [
    ...
    YieldStat('hazard_acquire_busy_blocked_locked', 'hazard acquire busy blocked due to locked state'),
    YieldStat('hazard_acquire_busy_blocked_other', 'hazard acquire busy blocked due to other non-memory state'),
    YieldStat('page_acquire_blocked_time_us', 'page acquire total blocked wall time (usecs)'),
    YieldStat('page_acquire_retries', 'page acquire total retry iterations'),
    YieldStat('page_acquire_yield_count', 'page acquire yield calls before sleeping'),
