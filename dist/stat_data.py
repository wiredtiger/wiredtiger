...
conn_dsrc_stats = [
    ...
    CacheStat('hs_early_exit_squash', 'size of updates when hs store inserting'),
    CacheStat('hs_early_exit_skip_updates_already_hs', 'size of updates when hs store inserting'),
