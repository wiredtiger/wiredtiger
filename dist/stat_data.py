...
connection_stats = [
    ...
    CacheStat('cache_hs_key_truncate_onpage_removal', 'history store table truncation calls due to the key being removed from the data page during reconciliation'),
