...
conn_stats = [
    ...
    BlockStat('block_byte_read_intl_precomp', 'bytes read for internal pages before decompression and decryption', 'size'),
    BlockStat('block_byte_read_leaf', 'bytes read for leaf pages', 'size'),
    BlockStat('block_byte_read_leaf_precomp', 'bytes read for leaf pages before decompression and decryption', 'size'),
    ...
    BlockStat('block_byte_write_intl', 'bytes written for internal pages after compression and encryption', 'size'),
    BlockStat('block_byte_write_intl_precomp', 'bytes written for internal pages before compression and encryption', 'size'),
    BlockStat('block_byte_write_leaf', 'bytes written for leaf pages after compression and encryption', 'size'),
    BlockStat('block_byte_write_leaf_precomp', 'bytes written for leaf pages before compression and encryption', 'size'),
