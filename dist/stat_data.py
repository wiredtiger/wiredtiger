...
conn_stats = [
    ...
    SessionOpStat('session_table_compact_pages_skipped', 'table compact pages skipped', 'no_clear,no_scale'),
    SessionOpStat('session_table_compact_pages_written', 'table compact pages written', 'no_clear,no_scale'),
