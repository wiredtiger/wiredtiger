...
conn_dsrc_stats = [
    ...
    CursorStat('cursor_release_page_to_reposition', 'cursor releases the page and marks to reposition it'),
    CursorStat('cursor_reposition', 'cursor reposition'),
    CursorStat('cursor_reposition_failed', 'Total number of times cursor fails to reposition'),
