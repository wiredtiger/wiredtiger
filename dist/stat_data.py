...
conn_stats = [
    ...
    CursorStat('cursor_touch_skipped_no_addr', 'touch cursor warmup skipped because the leaf had no address cookie'),
    CursorStat('cursor_touch_skipped_non_disagg', 'touch cursor warmup skipped because the tree is not disaggregated'),
...
dsrc_stats = [
    ...
    CursorStat('cursor_touch_skipped_no_addr', 'touch warmup skipped because the leaf had no address cookie'),
    CursorStat('cursor_touch_skipped_non_disagg', 'touch warmup skipped because the tree is not disaggregated'),
