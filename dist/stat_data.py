...
connection_stats = [
    ...
    CacheStat('cache_hs_key_truncate_call', 'history store table truncation calls '),
    CacheStat('cache_hs_key_truncate_mix_ts', 'history store table truncation calls due to mixed timestamps'),
    CacheStat('cache_hs_key_truncate_mix_ts_restart', 'history store table truncation calls due to mixed timestamps that returned restart'),
    CacheStat('cache_hs_key_truncate_onpage_removal', 'history store table truncation due to the key being removed from the data page during reconciliation'),
    CacheStat('cache_hs_key_truncate_rts', 'history store table truncation by rollback to stable'),
    CacheStat('cache_hs_key_truncate_rts_unstable', 'history store table truncation by rollback to stable to remove unstable updates'),
