...
dsrc_stats = [
    ...
    CompressStat('compress_read', 'compressed pages read from disk'),
    ...
    CompressStat('compress_read_ratio_hist_2', 'compressed pages read from disk with compression ratio smaller than  2'),
    CompressStat('compress_read_ratio_hist_4', 'compressed pages read from disk with compression ratio smaller than  4'),
    CompressStat('compress_read_ratio_hist_8', 'compressed pages read from disk with compression ratio smaller than  8'),
    CompressStat('compress_read_ratio_hist_16', 'compressed pages read from disk with compression ratio smaller than 16'),
    CompressStat('compress_read_ratio_hist_32', 'compressed pages read from disk with compression ratio smaller than 32'),
    CompressStat('compress_read_ratio_hist_64', 'compressed pages read from disk with compression ratio smaller than 64'),
    CompressStat('compress_read_ratio_hist_max', 'compressed pages read from disk with compression ratio greater than 64'),
    CompressStat('compress_write', 'compressed pages written to disk'),
    CompressStat('compress_write_ratio_hist_2', 'compressed pages written to disk with compression ratio smaller than  2'),
    CompressStat('compress_write_ratio_hist_4', 'compressed pages written to disk with compression ratio smaller than  4'),
    CompressStat('compress_write_ratio_hist_8', 'compressed pages written to disk with compression ratio smaller than  8'),
    CompressStat('compress_write_ratio_hist_16', 'compressed pages written to disk with compression ratio smaller than 16'),
    CompressStat('compress_write_ratio_hist_32', 'compressed pages written to disk with compression ratio smaller than 32'),
    CompressStat('compress_write_ratio_hist_64', 'compressed pages written to disk with compression ratio smaller than 64'),
    CompressStat('compress_write_ratio_hist_max', 'compressed pages written to disk with compression ratio greater than 64'),
