...
conn_stats = [
    ...
    EvictStat('eviction_needed', 'application wants to evict', 'no_clear,no_scale'),
    EvictStat('eviction_needed_clean', 'application wants to evict clean', 'no_clear,no_scale'),
    EvictStat('eviction_needed_dirty', 'application wants to evict dirty', 'no_clear,no_scale'),
    EvictStat('eviction_needed_updates', 'application wants to evict updates', 'no_clear,no_scale'),
