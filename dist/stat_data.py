...
conn_stats = [
    ...
    EvictStat('eviction_bucket_clean_internal_items', 'eviction bucket items clean internal'),
    EvictStat('eviction_bucket_clean_leaf_items', 'eviction bucket items clean leaf'),
    EvictStat('eviction_bucket_dirty_internal_items', 'eviction bucket items dirty internal'),
    EvictStat('eviction_bucket_dirty_leaf_items', 'eviction bucket items dirty leaf'),
    EvictStat('eviction_bucket_updates_internal_items', 'eviction bucket items updates internal'),
    EvictStat('eviction_bucket_updates_leaf_items', 'eviction bucket items updates leaf'),
    EvictStat('eviction_bucket_wont_need_clean_leaf_items', 'eviction bucket items won\'t need clean leaf'),
    EvictStat('eviction_bucket_wont_need_dirty_leaf_items', 'eviction bucket items won\'t need dirty leaf'),
    EvictStat('eviction_bucket_wont_need_internal_items', 'eviction bucket items won\'t need internal'),
    ...
    EvictStat('eviction_min_bucket_clean_internal', 'eviction starting bucket clean internal bucket'),
    EvictStat('eviction_min_bucket_clean_leaf', 'eviction starting bucket clean leaf bucket'),
    EvictStat('eviction_min_bucket_dirty_internal', 'eviction starting bucket dirty internal bucket'),
    EvictStat('eviction_min_bucket_dirty_leaf', 'eviction starting bucket dirty leaf bucket'),
    EvictStat('eviction_min_bucket_updates_internal', 'eviction starting bucket updates internal bucket'),
    EvictStat('eviction_min_bucket_updates_leaf', 'eviction starting bucket updates leaf bucket'),
    EvictStat('eviction_min_bucket_wont_need_internal', 'eviction starting bucket won\'t need internal bucket'),
    EvictStat('eviction_min_bucket_wont_need_clean_leaf', 'eviction starting bucket won\'t need clean leaf bucket'),
    EvictStat('eviction_min_bucket_wont_need_dirty_leaf', 'eviction starting bucket won\'t need dirty leaf bucket'),
