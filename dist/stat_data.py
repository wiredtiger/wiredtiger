...
conn_stats = [
    ...
    # Eviction statistics
    ##########################################
    EvictStat('app_evict_accepted', 'application eviction accepted: proceeding to evict', 'no_clear'),
    EvictStat('app_evict_refused_busy_below_target', 'application eviction skipped: busy and cache below target', 'no_clear'),
    EvictStat('app_evict_refused_cache_tolerant', 'application eviction skipped: session is cache-trigger tolerant', 'no_clear'),
    EvictStat('app_evict_refused_checkpoint_txn', 'application eviction skipped: checkpoint cursor transaction', 'no_clear'),
    EvictStat('app_evict_refused_contention', 'application eviction skipped to avoid lock contention', 'no_clear'),
    EvictStat('app_evict_refused_in_memory', 'application eviction skipped: in-memory configuration', 'no_clear'),
    EvictStat('app_evict_refused_incremental_score', 'application eviction skipped: incremental score too low', 'no_clear'),
    EvictStat('app_evict_refused_locks_or_ignore_cache', 'application eviction skipped: holding locks or ignoring cache size', 'no_clear'),
    EvictStat('app_evict_refused_max_wait_disabled', 'application eviction skipped: eviction disabled via cache_max_wait_us', 'no_clear'),
    EvictStat('app_evict_refused_no_evict_or_metadata', 'application eviction skipped: cache-resident tree or metadata', 'no_clear'),
    EvictStat('app_evict_refused_no_reconcile', 'application eviction skipped: session cannot reconcile', 'no_clear'),
    EvictStat('app_evict_refused_not_needed', 'application eviction skipped: eviction not needed', 'no_clear'),
    EvictStat('app_evict_refused_prefetch', 'application eviction skipped: prefetch thread', 'no_clear'),
    EvictStat('app_evict_refused_prepare', 'application eviction skipped: transaction is prepared', 'no_clear'),
    ...
    EvictStat('app_evict_worker_evict_hard_error', 'application eviction worker: page eviction returned hard error', 'no_clear'),
    ...
    EvictStat('app_evict_worker_exit_rollback_cache_overflow', 'application eviction worker: rollback due to cache overflow timeout', 'no_clear'),
    EvictStat('app_evict_worker_exit_user_not_ok', 'application eviction worker: exited due to user or interruptible check', 'no_clear'),
    #
    EvictStat('application_check_evict', 'application checked if eviction is needed', 'no_clear'),
    ...
    EvictStat('eviction_bucket_dirty_internal_items', 'eviction bucket items dirty internal', 'no_clear,no_scale'),
    EvictStat('eviction_bucket_dirty_leaf_items', 'eviction bucket items dirty leaf', 'no_clear,no_scale'),
    EvictStat('eviction_bucket_updates_internal_items', 'eviction bucket items updates internal', 'no_clear,no_scale'),
    EvictStat('eviction_bucket_updates_leaf_items', 'eviction bucket items updates leaf', 'no_clear,no_scale'),
    EvictStat('eviction_bucket_wont_need_clean_leaf_items', 'eviction bucket items won\'t need clean leaf', 'no_clear,no_scale'),
    EvictStat('eviction_bucket_wont_need_dirty_leaf_items', 'eviction bucket items won\'t need dirty leaf', 'no_clear,no_scale'),
    ...
    EvictStat('eviction_force_app_refuse_dirty', 'forced eviction: app refused because dirty'),
    EvictStat('eviction_force_app_refuse_modify', 'forced eviction: app refused because modify is not null'),
    EvictStat('eviction_force_app_try_dirty', 'forced eviction: app will try to evict dirty'),
    EvictStat('eviction_force_clean', 'forced eviction - pages evicted that were clean count'),
    EvictStat('eviction_force_cursor', 'forced eviction: cursor inline'),
...
#    EvictStat('eviction_force_noforce', 'forced eviction - page does not have the right read generation'),
    EvictStat('eviction_force_nokeep_in_read', 'forced eviction - NOKEEP set in read'),
    EvictStat('eviction_get_ref_empty_app', 'eviction calls by application to get a page could not find a page'),
    EvictStat('eviction_get_ref_empty_worker', 'eviction calls by worker to get a page could not find a page'),
    EvictStat('eviction_get_ref_iterations', 'eviction calls total iterations when looking for a page to evict'),
    ...
    EvictStat('eviction_min_bucket_clean_internal', 'eviction starting bucket clean internal bucket', 'no_clear,no_scale'),
    EvictStat('eviction_min_bucket_clean_leaf', 'eviction starting bucket clean leaf bucket', 'no_clear,no_scale'),
    EvictStat('eviction_min_bucket_dirty_internal', 'eviction starting bucket dirty internal bucket', 'no_clear,no_scale'),
    EvictStat('eviction_min_bucket_dirty_leaf', 'eviction starting bucket dirty leaf bucket', 'no_clear,no_scale'),
    EvictStat('eviction_min_bucket_updates_internal', 'eviction starting bucket updates internal bucket', 'no_clear,no_scale'),
    EvictStat('eviction_min_bucket_updates_leaf', 'eviction starting bucket updates leaf bucket', 'no_clear,no_scale'),
    ...
    EvictStat('eviction_server_passes', 'eviction server loop passes'),
    ...
    EvictStat('eviction_server_skip_update_work', 'eviction server passes that read the published eviction state instead of recomputing it'),
    EvictStat('eviction_server_sleep_time', 'eviction server total time slept (usecs)'),
    EvictStat('eviction_server_slept', 'eviction server slept'),
    EvictStat('eviction_server_slept_progress', 'eviction server slept after making eviction progress'),
    ...
    EvictStat('eviction_skip_empty_subqueue', 'eviction skipped an empty per-handle subqueue in a bucket'),
    ...
    EvictStat('eviction_skip_ingest_trees', 'eviction skips ingest btrees in disagg'),
    EvictStat('eviction_skip_intl_page_non_aggressive', 'eviction skipped the internal pages if eviction is not in aggressive mode'),
    EvictStat('eviction_skip_intl_page_with_active_child', 'eviction  skips internal pages as it has an active child'),
    EvictStat('eviction_skip_locked_hashchain', 'eviction skips locked dhandle hash chains in dirty buckets'),
    EvictStat('eviction_skip_locked_subqueue', 'eviction skips locked per-dhandle sub-queues in dirty buckets'),
    ...
    EvictStat('eviction_target_bucket_wont_need_clean_leaf', 'eviction selected pages from won\'t need clean leaf bucket'), 
    EvictStat('eviction_target_bucket_wont_need_dirty_leaf', 'eviction selected pages from won\'t need dirty leaf bucket'), 
