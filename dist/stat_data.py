...
conn_dsrc_stats = [
    ...
    CacheStat('cache_obsolete_updates_freed_during_hs_insert', 'obsolete updates freed during history store insert'),
    CacheStat('cache_obsolete_updates_freed_during_reconcile', 'obsolete updates freed during reconciliation'),
    CacheStat('cache_obsolete_updates_freed_during_update_obsolete_check', 'obsolete updates freed during update obsolete check'),
