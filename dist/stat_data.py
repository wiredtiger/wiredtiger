...
connection_stats = [
    ...
    LogStat('log_slot_active_closed', 'consolidated slot join found active slot closed'),
    LogStat('log_slot_close_race', 'consolidated slot close lost race'),
    LogStat('log_slot_close_unbuf', 'consolidated slot close unbuffered waits'),
    ...
    LogStat('log_slot_duration', 'consolidated slot joins yield time (usecs)', 'no_clear,no_scale'),
    LogStat('log_slot_immediate', 'consolidated slot join calls did not yield'),
    ...
    LogStat('log_slot_yield_race', 'consolidated slot join calls raced'),
    LogStat('log_slot_yield_sleep', 'consolidated slot join calls slept'),
