...
connection_stats = [
    ...
    LockStat('lock_evict_queue_wait_application', 'cache eviction queue lock application thread wait time (usecs)'),
    LockStat('lock_evict_queue_wait_internal', 'cache eviction queue lock internal thread wait time (usecs)'),
    LockStat('lock_evict_queues_count', 'cache individual queue lock acquisitions'),
    LockStat('lock_evict_queues_wait_application', 'cache individual queue lock application thread wait time (usecs)'),
    LockStat('lock_evict_queues_wait_internal', 'cache individual queue lock internal thread wait time (usecs)'),
    LockStat('lock_evict_walk_count', 'cache eviction walk lock acquisitions'),
    LockStat('lock_evict_walk_wait_application', 'cache eviction walk lock application thread wait time (usecs)'),
    LockStat('lock_evict_walk_wait_internal', 'cache eviction walk lock internal thread wait time (usecs)'),
