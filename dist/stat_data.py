...
conn_stats = [
    ...
    CacheStat('cache_top5_dirty_pct', 'percentage of dirty leaf bytes held by the 5 largest tables', 'no_clear,no_scale'),
    CacheStat('cache_top5_inuse_pct', 'percentage of cache held by the 5 largest tables', 'no_clear,no_scale'),
    CacheStat('cache_top5_updates_pct', 'percentage of update bytes held by the 5 largest tables', 'no_clear,no_scale'),
    CacheStat('cache_top_dirty_pct', 'percentage of dirty leaf bytes held by the 32 largest tables', 'no_clear,no_scale'),
    CacheStat('cache_top_inuse_pct', 'percentage of cache held by the 32 largest tables', 'no_clear,no_scale'),
    CacheStat('cache_top_updates_pct', 'percentage of update bytes held by the 32 largest tables', 'no_clear,no_scale'),
