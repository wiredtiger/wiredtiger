...
conn_stats = [
    ...
    DisaggStat('disagg_step_down_mirrored_writes', 'writes mirrored during step-down'),
    ...
    DisaggStat('disagg_step_down_window_duration', 'step-down window most recent duration (msecs)'),
