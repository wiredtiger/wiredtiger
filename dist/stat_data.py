...
conn_dsrc_stats = [
    ...
    RecStat('rec_ingest_gc_verify_attempts', 'number of garbage collected keys considered for verification against the stable table for disaggregated storage'),
    RecStat('rec_ingest_gc_verify_passed', 'number of garbage collected keys verified against the stable table for disaggregated storage'),
    RecStat('rec_ingest_gc_verify_skipped_gate', 'number of garbage collected keys not verified against the stable table because the prune timestamp does not match the stable checkpoint for disaggregated storage'),
    RecStat('rec_ingest_gc_verify_skipped_other', 'number of garbage collected keys not verified against the stable table for other reasons for disaggregated storage'),
