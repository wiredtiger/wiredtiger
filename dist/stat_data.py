...
conn_stats = [
    ...
    CursorStat('cursor_touch_leaf_cached', 'touch cursor search calls that skipped warmup because the leaf was already in cache'),
    CursorStat('cursor_touch_search', 'touch cursor search calls'),
    CursorStat('cursor_touch_skipped_no_addr', 'touch cursor warmups skipped because the leaf had no address cookie'),
    CursorStat('cursor_touch_skipped_non_disagg', 'touch cursor warmups skipped because the tree is not disaggregated'),
    CursorStat('cursor_touch_warmup', 'touch cursor warmup hints issued to the page log layer'),
    CursorStat('cursor_touch_warmup_error', 'touch cursor warmup hints that returned an error'),
...
dsrc_stats = [
    ...
    CursorStat('cursor_touch_leaf_cached', 'touch search calls that skipped warmup because the leaf was already in cache'),
    CursorStat('cursor_touch_search', 'touch search calls'),
    CursorStat('cursor_touch_skipped_no_addr', 'touch warmups skipped because the leaf had no address cookie'),
    CursorStat('cursor_touch_skipped_non_disagg', 'touch warmups skipped because the tree is not disaggregated'),
    CursorStat('cursor_touch_warmup', 'touch warmup hints issued to the page log layer'),
    CursorStat('cursor_touch_warmup_error', 'touch warmup hints that returned an error'),
