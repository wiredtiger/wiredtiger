...
conn_stats = [
    ...
    EvictStat('eviction_force_btinline1', 'forced eviction: __wt_bt_inline1'),
    EvictStat('eviction_force_btinline2', 'forced eviction: __wt_bt_inline2'),
    EvictStat('eviction_force_btread', 'forced eviction: __wt_bt_read'),
    EvictStat('eviction_force_btsync', 'forced eviction: __wt_bt_sync'),
