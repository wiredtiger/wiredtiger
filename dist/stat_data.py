...
session_stats = [
    ...
    SessionStat('read_internal', 'page read from disk was internal'),
    SessionStat('read_leaf', 'page read from disk was leaf'),
    SessionStat('read_time', 'page read from disk to cache time (usecs)'),
    SessionStat('session_read', 'page read from disk to cache count'),
