...
conn_stats = [
    ...
    EvictStat('eviction_maximum_clean_page_size', 'maximum clean page size seen at eviction', 'no_clear,no_scale,size'),
    EvictStat('eviction_maximum_dirty_page_size', 'maximum dirty page size seen at eviction', 'no_clear,no_scale,size'),
    ...
    EvictStat('eviction_maximum_updates_page_size', 'maximum updates page size seen at eviction', 'no_clear,no_scale,size'),
