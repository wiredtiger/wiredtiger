...
conn_stats = [
    ...
    EvictStat('eviction_interrupted_by_app', 'application requested eviction interrupt'),
    ...
    EvictStat('eviction_server_skip_metadata_with_history', 'eviction server skips metadata pages with history'),
