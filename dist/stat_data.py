...
conn_stats = [
    ...
    CacheStat('cache_bytes_hs_leaf', 'leaf page bytes belonging to the history store table in the cache', 'no_clear,no_scale,size'),
    CacheStat('cache_bytes_hs_intl', 'intl page bytes belonging to the history store table in the cache', 'no_clear,no_scale,size'),
    ...
    CacheStat('cache_eviction_hs_pages_in_parallel_with_checkpoint', 'history store pages evicted in parallel with checkpoint'),
...
conn_dsrc_stats = [
    ...
    CacheStat('cache_checkpoint_state', 'checkpoint state'),
    ...
    CacheStat('cache_eviction_pct_full_application', 'eviction application thread pct full'),
    CacheStat('cache_eviction_app_thread_exit', 'eviction application thread exited from eviction'),
    CacheStat('cache_eviction_busy_exit', 'eviction busy page error exited from eviction'),
    ...
    CacheStat('cache_hs_update_size', 'size of updates when hs store inserting'),
    CacheStat('cache_nothing_to_insert', 'nothing to insert into history store.'),
    CacheStat('hs_early_exit_squash', 'early exit squash when hs store inserting'),
    CacheStat('list_onpage_selected_early_continue', 'list on page is null'),
    CacheStat('no_update_to_insert_hs', 'no update to insert hs'),
    CacheStat('updates_already_inserted', 'updates already inserted'),
    CacheStat('hs_early_exit_skip_updates_already_hs', 'update already in hs store inserting'),
