...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_early_busy_exit', 'eviction early exit because of busy check'),
    CacheStat('cache_eviction_busy_exit', 'eviction busy exit'),
    ...
    CacheStat('cache_rec_upd_select_app', 'has newer updates with application thread'),
    ...
    CacheStat('cache_eviction_check_busy_app', 'Performing eviction check with busy, application thread true'),
