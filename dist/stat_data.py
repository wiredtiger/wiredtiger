...
connection_stats = [
    ...
    LockStat('lock_dhandle_wait_application', 'dhandle lock application thread time waiting for the table lock (usecs)'),
    LockStat('lock_dhandle_wait_internal', 'dhandle lock internal thread time waiting for the table lock (usecs)'),
