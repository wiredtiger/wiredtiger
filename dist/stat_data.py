...
##########################################
checkpoint_stats = [
    CheckpointStat('byte_count', 'byte count of a file'),
    CheckpointStat('row_count', 'row count of a file'),
]

checkpoint_stats = sorted(checkpoint_stats, key=attrgetter('desc'))
