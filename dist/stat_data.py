...
conn_stats = [
    ...
    CacheStat('cache_eviction_server_skip_checkpointing_trees', 'skip trees that are being checkpointed'),
    ...
    CacheStat('cache_eviction_server_skip_metatdata_with_history', 'skip metadata pages with history'),
    CacheStat('cache_eviction_server_skip_trees_not_useful_before', 'skip trees that are not useful before'),
    CacheStat('cache_eviction_server_skip_trees_stick_in_cache', 'skip trees that are configured to stick in cache'),
    CacheStat('cache_eviction_server_skip_trees_too_many_active_walks', 'skip trees because there are too many active walks'),
    CacheStat('cache_eviction_server_skip_unwanted_pages', 'skip pages that we do not want to evict'),
