...
##########################################
    ...
    TxnStat('txn_rollback_keys_removed', 'rollback to stable keys removed'),
    TxnStat('txn_rollback_keys_restored', 'rollback to stable keys restored'),
    TxnStat('txn_rollback_pages_visited', 'rollback to stable pages visited'),
