...
conn_stats = [
    ...
    DisaggStat('disagg_read_age_ckpt0', 'block reads from most recent checkpoint'),
    DisaggStat('disagg_read_age_ckpt1', 'block reads from 1 checkpoint ago'),
    DisaggStat('disagg_read_age_ckpt16_31', 'block reads from 16-31 checkpoints ago'),
    DisaggStat('disagg_read_age_ckpt2_3', 'block reads from 2-3 checkpoints ago'),
    DisaggStat('disagg_read_age_ckpt4_7', 'block reads from 4-7 checkpoints ago'),
    DisaggStat('disagg_read_age_ckpt8_15', 'block reads from 8-15 checkpoints ago'),
    DisaggStat('disagg_read_age_older', 'block reads from pages older than tracked checkpoint window'),
    DisaggStat('disagg_read_age_unknown', 'block reads with unclassifiable page LSN (zero or ahead of latest checkpoint)'),
    DisaggStat('disagg_read_pred_ckpt0', 'delta reads whose predecessor is in most recent checkpoint'),
    DisaggStat('disagg_read_pred_ckpt1', 'delta reads whose predecessor is 1 checkpoint ago'),
    DisaggStat('disagg_read_pred_ckpt16_31', 'delta reads whose predecessor is 16-31 checkpoints ago'),
    DisaggStat('disagg_read_pred_ckpt2_3', 'delta reads whose predecessor is 2-3 checkpoints ago'),
    DisaggStat('disagg_read_pred_ckpt4_7', 'delta reads whose predecessor is 4-7 checkpoints ago'),
    DisaggStat('disagg_read_pred_ckpt8_15', 'delta reads whose predecessor is 8-15 checkpoints ago'),
    DisaggStat('disagg_read_pred_older', 'delta reads whose predecessor is older than tracked checkpoint window'),
    DisaggStat('disagg_read_pred_unknown', 'delta reads with unclassifiable predecessor LSN (zero or ahead of latest checkpoint)'),
...
conn_dsrc_stats = [
    ...
    CacheStat('cache_pages_requested_stable', 'pages requested from the cache for stable disaggregated tables'),
    ...
    CacheStat('cache_read_stable', 'stable disaggregated table pages read into cache'),
