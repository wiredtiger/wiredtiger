...
connection_stats = [
    ...
    CacheStat('cache_eviction_random_retune_add', 'eviction random retune will add workers'),
    CacheStat('cache_eviction_random_retune_remove', 'eviction random retune will remove workers'),
