...
conn_stats = [
    ...
    EvictStat('eviction_server_skip_pages_prune_timestamp_lt_newest_timestamp', 'eviction server skips pages that are written with transactions greater than the prune timestamp'),
