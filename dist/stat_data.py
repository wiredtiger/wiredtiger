...
connection_stats = [
    ...
    ConnStat('capacity_time_ckpt', 'throttled capacity time in checkpoints (usecs)'),
    ConnStat('capacity_time_evict', 'throttled capacity time in eviction (usecs)'),
    ConnStat('capacity_time_log', 'throttled capacity time in logging (usecs)'),
    ConnStat('capacity_time_read', 'throttled capacity time in reads (usecs)'),
    ConnStat('capacity_time_fsync', 'throttled capacity thread time spent in background fsync (msecs)', 'no_clear,no_scale'),
    ConnStat('capacity_time_total', 'throttled time in total capacity (usecs)'),
