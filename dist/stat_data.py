...
conn_stats = [
    ...
    EvictStat('eviction_dirty_index_ring_full_capacity_max', 'dirty index largest capacity among rings that hit full', 'no_clear,no_scale'),
    EvictStat('eviction_dirty_index_ring_peak_occupancy', 'dirty index largest ring occupancy seen in slots', 'no_clear,no_scale'),
    ...
    EvictStat('eviction_server_skip_pages_disagg_low_pressure', 'eviction server skips disaggregated pages with too few modifications while cache pressure is low'),
    ...
    EvictStat('eviction_walk_skipped_drain_filled', 'eviction walks skipped because the drain filled the per-tree budget'),
...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_dirty_index_drain_hazard', 'dirty index slots deferred because a hazard pointer could not be acquired'),
    CacheStat('cache_eviction_dirty_index_drain_queued', 'dirty index slots queued to ordinary or urgent eviction by drain'),
    ...
    CacheStat('cache_eviction_pages_seen', 'pages seen by eviction candidate discovery'),
    CacheStat('cache_eviction_pages_seen_clean', 'eviction candidate discovery pages seen that were clean'),
    CacheStat('cache_eviction_pages_seen_dirty', 'eviction candidate discovery pages seen that were dirty'),
    CacheStat('cache_eviction_pages_seen_updates', 'eviction candidate discovery pages seen that had updates'),
