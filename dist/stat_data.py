...
conn_stats = [
    ...
    BlockStat('block_byte_read_intl_precomp', 'bytes read for internal pages before compression and encryption', 'size'),
    BlockStat('block_byte_read_leaf', 'bytes read for leaf pages', 'size'),
    BlockStat('block_byte_read_leaf_precomp', 'bytes read for leaf pages before compression and encryption', 'size'),
