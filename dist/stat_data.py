...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_target_page_ge512', 'eviction walk target pages histogram - 512 and higher'),
    CacheStat('cache_eviction_target_page_lt10', 'eviction walk target pages histogram - 0-9'),
    CacheStat('cache_eviction_target_page_lt128', 'eviction walk target pages histogram - 64-127'),
    CacheStat('cache_eviction_target_page_lt256', 'eviction walk target pages histogram - 128-255'),
    CacheStat('cache_eviction_target_page_lt32', 'eviction walk target pages histogram - 10-31'),
    CacheStat('cache_eviction_target_page_lt512', 'eviction walk target pages histogram - 256-511'),
