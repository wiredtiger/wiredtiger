...
conn_stats = [
    ...
    CacheStat('cache_eviction_try_evict', 'AAA before test evict'),
    CacheStat('cache_eviction_cant_evict', 'AAA cant evict'),
    CacheStat('cache_eviction_try_dirty_during_cp', 'AAA Test queue dirty pages in trees during checkpoints'),
    CacheStat('cache_eviction_dont_evict_dirty_during_cp', 'AAA Dont queue dirty pages in trees during checkpoints'),
    CacheStat('cache_eviction_try_dont_want_page', 'AAA before dont want page'),
    CacheStat('cache_eviction_dont_want_page', 'AAA dont want page'),
    CacheStat('cache_eviction_evict_clean', 'AAA evict clean'),
    CacheStat('cache_eviction_evict_dirty', 'AAA evict dirty'),
    CacheStat('cache_eviction_evict_updates', 'AAA evict updates'),
    CacheStat('cache_eviction_dirty_pages_seen', 'AAA dirty pages seen by eviction walk'),
    CacheStat('cache_eviction_dirty_pages_walked', 'AAA dirty pages walked'),
    CacheStat('cache_eviction_dont_evict_internal_last_parent', 'AAA dont evict internal last parent'),
    CacheStat('cache_eviction_dont_evict_internal', 'AAA dont evict internal'),
    CacheStat('cache_eviction_heuristic_skip', 'AAA heuristic skip'),
