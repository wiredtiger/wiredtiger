...
conn_stats = [
    ...
    DisaggStat('disagg_checkpoint_pending_lsn', 'most recently delivered checkpoint metadata LSN', 'no_clear,no_scale'),
    ...
    DisaggStat('disagg_snapshot_pin_retry', 'snapshots rebuilt after racing a checkpoint pick-up'),
