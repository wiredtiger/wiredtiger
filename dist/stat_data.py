...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_pages_queued_clean_with_mod', 'eviction walk pages queued that were clean with modifications'),
    ...
    CacheStat('cache_eviction_pages_seen_clean_with_mod', 'eviction walk pages seen that were clean with modifications'),
