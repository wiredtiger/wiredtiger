...
conn_stats = [
    ...
    PerfHistStat('perf_hist_disaggblkcachecompress_latency_gt10000', 'disagg block cache compress latency histogram (bucket 8) - 10000us+'),
    PerfHistStat('perf_hist_disaggblkcachecompress_latency_lt100', 'disagg block cache compress latency histogram (bucket 1) - 50-99us'),
    PerfHistStat('perf_hist_disaggblkcachecompress_latency_lt250', 'disagg block cache compress latency histogram (bucket 2) - 100-249us'),
    PerfHistStat('perf_hist_disaggblkcachecompress_latency_lt500', 'disagg block cache compress latency histogram (bucket 3) - 250-499us'),
    PerfHistStat('perf_hist_disaggblkcachecompress_latency_lt1000', 'disagg block cache compress latency histogram (bucket 4) - 500-999us'),
    PerfHistStat('perf_hist_disaggblkcachecompress_latency_lt2500', 'disagg block cache compress latency histogram (bucket 5) - 1000-2499us'),
    PerfHistStat('perf_hist_disaggblkcachecompress_latency_lt5000', 'disagg block cache compress latency histogram (bucket 6) - 2500-4999us'),
    PerfHistStat('perf_hist_disaggblkcachecompress_latency_lt10000', 'disagg block cache compress latency histogram (bucket 7) - 5000-9999us'),
    PerfHistStat('perf_hist_disaggblkcachecompress_latency_total_usecs', 'disagg block cache compress latency histogram total (usecs)'),
