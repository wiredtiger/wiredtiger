...
conn_dsrc_stats = [
    ...
    TxnStat('txn_rts_prep_trunc_rollback', 'rollback to stable rolled back prepared fast truncations'),
    TxnStat('txn_rts_prep_trunc_rollback_dryrun', 'rollback to stable prepared fast truncations that would have been rolled back in non-dryrun mode'),
