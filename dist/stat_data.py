...
##########################################
    ...
    RecStat('rec_time_pages_durable_start_ts', 'pages written including at least one start durable timestamp'),
    RecStat('rec_time_pages_durable_stop_ts', 'pages written including at least one stop durable timestamp'),
    RecStat('rec_time_pages_prepared', 'pages written including at least one prepare state'),
    RecStat('rec_time_pages_start_ts', 'pages written including at least one start timestamp'),
    RecStat('rec_time_pages_start_txn', 'pages written including at least one start transaction ID'),
    RecStat('rec_time_pages_stop_ts', 'pages written including at least one stop timestamp'),
    RecStat('rec_time_pages_stop_txn', 'pages written including at least one stop transaction ID'),
    RecStat('rec_time_durable_start_ts', 'records written including a start durable timestamp'),
    RecStat('rec_time_durable_stop_ts', 'records written including a stop durable timestamp'),
    RecStat('rec_time_prepared', 'records written including a prepare state'),
    RecStat('rec_time_start_ts', 'records written including a start timestamp'),
    RecStat('rec_time_start_txn', 'records written including a start transaction ID'),
    RecStat('rec_time_stop_ts', 'records written including a stop timestamp'),
    RecStat('rec_time_stop_txn', 'records written including a stop transaction ID'),
...
dsrc_stats = [
    ...
    RecStat('rec_time_pages_durable_start_ts', 'pages written including at least one start durable timestamp'),
    RecStat('rec_time_pages_durable_stop_ts', 'pages written including at least one stop durable timestamp'),
    RecStat('rec_time_pages_prepared', 'pages written including at least one prepare'),
    RecStat('rec_time_pages_start_ts', 'pages written including at least one start timestamp'),
    RecStat('rec_time_pages_start_txn', 'pages written including at least one start transaction ID'),
    RecStat('rec_time_pages_stop_ts', 'pages written including at least one stop timestamp'),
    RecStat('rec_time_pages_stop_txn', 'pages written including at least one stop transaction ID'),
    RecStat('rec_time_durable_start_ts', 'records written including a start durable timestamp'),
    RecStat('rec_time_durable_stop_ts', 'records written including a stop durable timestamp'),
    RecStat('rec_time_prepared', 'records written including a prepare'),
    RecStat('rec_time_start_ts', 'records written including a start timestamp'),
    RecStat('rec_time_start_txn', 'records written including a start transaction ID'),
    RecStat('rec_time_stop_ts', 'records written including a stop timestamp'),
    RecStat('rec_time_stop_txn', 'records written including a stop transaction ID'),
