...
conn_stats = [
    ...
    SessionOpStat('session_table_create_with_import_fail', 'table create with import failed calls', 'no_clear,no_scale'),
    SessionOpStat('session_table_create_with_import_success', 'table create with import successful calls', 'no_clear,no_scale'),
