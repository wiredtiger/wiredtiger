...
connection_stats = [
    ...
    CacheStat('cache_write_app_count', 'number of writes by application threads'),
    CacheStat('cache_write_app_time', 'time spent by application threads doing writes (usecs)'),
