...
conn_stats = [
    ...
    CacheStat('cache_top5_dirty_pct', 'dirty leaf bytes held by the top 5 tables', 'no_clear,no_scale'),
    CacheStat('cache_top5_inuse_pct', 'cache held by the top 5 tables', 'no_clear,no_scale'),
    CacheStat('cache_top5_updates_pct', 'update bytes held by the top 5 tables', 'no_clear,no_scale'),
    CacheStat('cache_top_dirty_pct', 'dirty leaf bytes held by the top 32 tables', 'no_clear,no_scale'),
    CacheStat('cache_top_inuse_pct', 'cache held by the top 32 tables', 'no_clear,no_scale'),
    CacheStat('cache_top_updates_pct', 'update bytes held by the top 32 tables', 'no_clear,no_scale'),
