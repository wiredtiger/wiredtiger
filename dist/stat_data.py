...
conn_stats = [
    ...
    EvictStat('eviction_bucket_pending_split_leaf_items', 'eviction bucket items pending split leaf', 'no_clear,no_scale'),
    ...
    EvictStat('eviction_eligible_clean_internal', 'eviction eligible bucketset clean internal'),
    EvictStat('eviction_eligible_clean_leaf', 'eviction eligible bucketset clean leaf'),
    EvictStat('eviction_eligible_dirty_internal', 'eviction eligible bucketset dirty internal'),
    EvictStat('eviction_eligible_dirty_leaf', 'eviction eligible bucketset dirty leaf'),
    EvictStat('eviction_eligible_pending_split_leaf', 'eviction eligible bucketset pending split leaf'),
    EvictStat('eviction_eligible_updates_internal', 'eviction eligible bucketset updates internal'),
    EvictStat('eviction_eligible_updates_leaf', 'eviction eligible bucketset updates leaf'),
...
#    EvictStat('eviction_force_noforce', 'forced eviction - page does not have the right read generation'),
    ...
    EvictStat('eviction_target_bucket_pending_split_leaf', 'eviction selected pages from pending split leaf bucket'),
...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_blocked_checkpoint_pending_split', 'checkpoint blocked eviction of a page with a pending multi-block split'),
