...
connection_stats = [
    ...
    CacheStat('cache_lookaside_prepare_insert', 'prepared updates added to cache overflow'),
    ...
    CacheStat('cache_prepared_updates_active', 'prepared updates active in the cache'),
    CacheStat('cache_prepared_updates_resolved', 'prepared updates resolved in the cache'),
