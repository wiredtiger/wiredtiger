...
conn_stats = [
    ...
    CacheStat('cache_eviction_force_update_list', 'forced eviction when more than 1000 updates found in an update chain.'),
...
conn_dsrc_stats = [
    ...
    CursorStat('cursor_next_skip_pages', 'cursor next call skipped pages without reading'),
    ...
    CursorStat('cursor_prev_skip_pages', 'cursor prev call skipped pages without reading'),
