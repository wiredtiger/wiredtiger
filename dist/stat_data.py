...
conn_stats = [
    ...
    CursorStat('cursor_range_stat', 'cursor range_stat calls'),
    ...
    SessionOpStat('session_table_range_fail', 'table range failed calls', 'no_clear,no_scale'),
    SessionOpStat('session_table_range_success', 'table range successful calls', 'no_clear,no_scale'),
