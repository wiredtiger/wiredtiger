...
dsrc_stats = [
    ...
    ##########################################
    CompressStat('compress_read_hist_ratio_2', 'number of read blocks with compress ratio smaller than 2'),
    CompressStat('compress_read_hist_ratio_4', 'number of read blocks with compress ratio smaller than 4'),
    CompressStat('compress_read_hist_ratio_8', 'number of read blocks with compress ratio smaller than 8'),
    CompressStat('compress_read_hist_ratio_16', 'number of read blocks with compress ratio smaller than 16'),
    CompressStat('compress_read_hist_ratio_32', 'number of read blocks with compress ratio smaller than 32'),
    CompressStat('compress_read_hist_ratio_64', 'number of read blocks with compress ratio smaller than 64'),
    CompressStat('compress_read_hist_ratio_max', 'number of read blocks with compress ratio greater than 64'),
    CompressStat('compress_write_hist_ratio_2', 'number of written blocks with compress ratio smaller than 2'),
    CompressStat('compress_write_hist_ratio_4', 'number of written blocks with compress ratio smaller than 4'),
    CompressStat('compress_write_hist_ratio_8', 'number of written blocks with compress ratio smaller than 8'),
    CompressStat('compress_write_hist_ratio_16', 'number of written blocks with compress ratio smaller than 16'),
    CompressStat('compress_write_hist_ratio_32', 'number of written blocks with compress ratio smaller than 32'),
    CompressStat('compress_write_hist_ratio_64', 'number of written blocks with compress ratio smaller than 64'),
    CompressStat('compress_write_hist_ratio_max', 'number of written blocks with compress ratio greater than 64'),
