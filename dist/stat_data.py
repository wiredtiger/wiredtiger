...
conn_dsrc_stats = [
    ...
    RecStat('rec_page_mismatch01', 'rec_page_mismatch01: page checksum mismatch - WT_REC_EVICT WT_PM_REC_MULTIBLOCK'),
    RecStat('rec_page_mismatch02', 'rec_page_mismatch02: page checksum mismatch - WT_REC_EVICT mod_multi_entries < multi_next'),
    RecStat('rec_page_mismatch03', 'rec_page_mismatch03: page checksum mismatch - WT_REC_EVICT evict_matching_checksum_failed'),
    RecStat('rec_page_mismatch04', 'rec_page_mismatch04: page checksum mismatch - WT_PM_REC_MULTIBLOCK'),
    RecStat('rec_page_mismatch05', 'rec_page_mismatch05: page checksum mismatch - mod_multi_entries < multi_next'),
    RecStat('rec_page_mismatch06', 'rec_page_mismatch06: page checksum mismatch - (1) size'),
    RecStat('rec_page_mismatch07', 'rec_page_mismatch07: page checksum mismatch - (2) checksum'),
    RecStat('rec_page_mismatch08', 'rec_page_mismatch08: page checksum mismatch - (3) memcmp'),
