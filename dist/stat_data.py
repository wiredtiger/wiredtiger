...
conn_stats = [
    ...
    ##########################################
    LiveRestoreStat('live_restore_bytes_copied', 'the number of bytes copied from the source to the destination'),
    LiveRestoreStat('live_restore_hist_source_read_latency_gt1000', 'live restore source read latency histogram (bucket 7) - 1000ms+'),
    LiveRestoreStat('live_restore_hist_source_read_latency_lt10', 'live restore source read latency histogram (bucket 1) - 0-10ms'),
    LiveRestoreStat('live_restore_hist_source_read_latency_lt50', 'live restore source read latency histogram (bucket 2) - 10-49ms'),
    LiveRestoreStat('live_restore_hist_source_read_latency_lt100', 'live restore source read latency histogram (bucket 3) - 50-99ms'),
    LiveRestoreStat('live_restore_hist_source_read_latency_lt250', 'live restore source read latency histogram (bucket 4) - 100-249ms'),
    LiveRestoreStat('live_restore_hist_source_read_latency_lt500', 'live restore source read latency histogram (bucket 5) - 250-499ms'),
    LiveRestoreStat('live_restore_hist_source_read_latency_lt1000', 'live restore source read latency histogram (bucket 6) - 500-999ms'),
    LiveRestoreStat('live_restore_hist_source_read_latency_total_msecs', 'live restore source read latency histogram total (msecs)'),
