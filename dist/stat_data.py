...
##########################################
    ...
    TxnStat('txn_prepared_updates_active', 'prepared active updates'),
    TxnStat('txn_prepared_updates_in_lookaside', 'prepared updates in cache overflow'),
    TxnStat('txn_prepared_updates_resolved', 'prepared resolved updates'),
