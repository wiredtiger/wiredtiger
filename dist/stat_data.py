...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_multiblock_checkpoint_flagged', 'pages with an unresolved multiblock split flagged by checkpoint for urgent eviction'),
    ...
    CacheStat('cache_eviction_multiblock_urgent_queued', 'pages with an unresolved multiblock queued for urgent eviction'),
    CacheStat('cache_eviction_multiblock_urgent_queued_fail', 'pages with an unresolved multiblock queued for urgent eviction, fail'),
