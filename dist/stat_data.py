...
##########################################
    ...
    RecStat('rec_pages_with_txn', 'pages written with transaction ids'),
    RecStat('rec_pages_with_ts', 'pages written with timestamps'),
    RecStat('rec_pages_with_prepare', 'pages written with prepared transaction metadata'),
