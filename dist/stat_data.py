...
connection_stats = [
    ...
    CacheStat('cache_read_app_count', 'application threads cache page read count'),
    CacheStat('cache_read_app_time', 'application threads cache page read time (usecs)'),
    CacheStat('cache_read_lookaside', 'pages read into cache requiring lookaside entries'),
    CacheStat('cache_read_overflow', 'overflow pages read into cache'),
    CacheStat('cache_write', 'pages written from cache'),
    CacheStat('cache_write_app_count', 'application threads cache page write count'),
    CacheStat('cache_write_app_time', 'application threads cache page write time (usecs)'),
