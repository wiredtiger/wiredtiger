...
conn_stats = [
    ...
    BlockStat('block_cache_hits', 'block cache number of hits'),
    BlockStat('block_cache_lookups', 'block cache lookups'),
    BlockStat('block_cache_misses', 'block cache number of misses'),
