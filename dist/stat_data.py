...
conn_stats = [
    ...
    PerfHistStat('perf_hist_fsread_latency_total', 'file system read latency histogram total (msecs)'),
    ...
    PerfHistStat('perf_hist_fswrite_latency_total', 'file system write latency histogram total (msecs)'),
    ...
    PerfHistStat('perf_hist_opread_latency_total', 'operation read latency histogram total (usecs)'),
    ...
    PerfHistStat('perf_hist_opwrite_latency_total', 'operation write latency histogram total (usecs)'),
