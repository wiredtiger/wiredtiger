...
conn_stats = [
    ...
    DisaggStat('disagg_pick_up_cursor_merge_usecs',
        'time merging the local and shared metadata cursors during checkpoint pick-up (usecs)'),
    DisaggStat('disagg_pick_up_file_create_blockmgr_usecs',
        'time creating the underlying file during checkpoint pick-up (usecs)'),
    DisaggStat('disagg_pick_up_file_create_config_usecs',
        'time assembling the file metadata configuration during checkpoint pick-up (usecs)'),
    DisaggStat('disagg_pick_up_file_create_exists_usecs',
        'time checking whether the file already exists during checkpoint pick-up (usecs)'),
    DisaggStat('disagg_pick_up_file_create_meta_insert_usecs',
        'time inserting the new file metadata during checkpoint pick-up (usecs)'),
    ...
    DisaggStat('disagg_pick_up_ingest_create_usecs',
        'time creating missing ingest tables during checkpoint pick-up (usecs)'),
    DisaggStat('disagg_pick_up_ingest_search_usecs',
        'time searching the local metadata for ingest tables during checkpoint pick-up (usecs)'),
    DisaggStat('disagg_pick_up_insert_meta_usecs',
        'time inserting new metadata entries during checkpoint pick-up (usecs)'),
    DisaggStat('disagg_pick_up_prefetch_checks',
        'pre-fetch checks reached during checkpoint pick-up'),
    DisaggStat('disagg_pick_up_prefetch_issued',
        'pre-fetch work issued during checkpoint pick-up'),
    DisaggStat('disagg_pick_up_queue_scan_calls',
        'shared metadata queue scans performed during checkpoint pick-up'),
    DisaggStat('disagg_pick_up_queue_scan_entries',
        'shared metadata queue entries examined during checkpoint pick-up'),
    DisaggStat('disagg_pick_up_update_file_meta_usecs',
        'time updating existing file metadata entries during checkpoint pick-up (usecs)'),
    DisaggStat('disagg_role_leader', 'role leader'),
    DisaggStat('disagg_shared_metadata_queue_length',
        'shared metadata queue length at the most recent checkpoint pick-up', 'no_clear,no_scale'),
