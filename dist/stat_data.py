...
conn_stats = [
    ...
    EvictStat('eviction_server_push_pages_failed_when_flagging', 'eviction server push pages to queue failed because of racing with setting flag'),
...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_blocked_hazard_app_thread',
        'application thread phase-2 hazard pointer bail: immediate EBUSY without spinning'),
    ...
    CacheStat('cache_eviction_dirty_gap_rereconcile',
        'two-phase eviction dirty-gap re-reconciles: phase-1 work discarded, re-reconciled under lock'),
    CacheStat('cache_eviction_dirty_obsolete_tw', 'pages dirtied due to obsolete time window by eviction'),
    CacheStat('cache_eviction_hp_cooldown_skipped',
        'eviction walk skipped pages in hazard pointer cooldown (recently failed phase-2)'),
