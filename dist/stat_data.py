...
connection_stats = [
    ...
    TxnStat('txn_commit_queue_empty', 'transactions commit timestamp queue insert to empty'),
    ...
    TxnStat('txn_commit_queue_rdlock', 'transactions commit timestamp queue read locks'),
    TxnStat('txn_commit_queue_try_fail', 'transactions commit timestamp queue write locks failed'),
    TxnStat('txn_commit_queue_try_success', 'transactions commit timestamp queue write locks succeeded'),
    TxnStat('txn_commit_queue_wrlock', 'transactions commit timestamp queue write locks'),
    TxnStat('txn_fail_cache', 'transaction failures due to cache overflow'),
    TxnStat('txn_global_rdlock', 'transactions global read locks'),
    TxnStat('txn_global_wrlock', 'transactions global write locks'),
    TxnStat('txn_global_try_fail', 'transactions global write locks failed'),
    TxnStat('txn_global_try_success', 'transactions global write locks succeeded'),
    ...
    TxnStat('txn_query_ts', 'transactions query timestamp calls'),
    TxnStat('txn_read_queue_empty', 'transactions read timestamp queue insert to empty'),
    ...
    TxnStat('txn_read_queue_rdlock', 'transactions read timestamp queue read locks'),
    TxnStat('txn_read_queue_try_fail', 'transactions read timestamp queue write locks failed'),
    TxnStat('txn_read_queue_try_success', 'transactions read timestamp queue write locks succeeded'),
    TxnStat('txn_read_queue_wrlock', 'transactions read timestamp queue write locks'),
    TxnStat('txn_rollback', 'transactions rolled back'),
    TxnStat('txn_set_ts', 'transactions set timestamp calls'),
    TxnStat('txn_setts_commit', 'transactions set timestamp commit calls'),
    TxnStat('txn_setts_commit_upd', 'transactions set timestamp commit updates'),
    TxnStat('txn_setts_oldest', 'transactions set timestamp oldest calls'),
    TxnStat('txn_setts_oldest_upd', 'transactions set timestamp oldest updates'),
    TxnStat('txn_setts_stable', 'transactions set timestamp stable calls'),
    TxnStat('txn_setts_stable_upd', 'transactions set timestamp stable updates'),
