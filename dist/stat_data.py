...
conn_stats = [
    ...
    BlockCacheStat('block_prefetch_skipped_no_flag_set', 'pre-fetch not triggered as ref on the queue does not have pre-fetch flag set'),
    BlockCacheStat('block_prefetch_skipped_no_leaf_page', 'pre-fetch not triggered on internal page, pre-fetch should only see leaf pages'),
