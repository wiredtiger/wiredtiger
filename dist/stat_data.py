...
conn_dsrc_stats = [
    ...
    CursorStat('cursor_bounds_next_early_exit', 'cursor bounds next early exit'),
    CursorStat('cursor_bounds_prev_early_exit', 'cursor bounds prev early exit'),
    CursorStat('cursor_bounds_next', 'cursor bounds next called on an unpositioned cursor'),
    CursorStat('cursor_bounds_prev', 'cursor bounds prev called on an unpositioned cursor'),
