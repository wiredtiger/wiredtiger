...
conn_stats = [
    ...
    BackgroundCompactStat('background_compact_skipped_exclude', 'background compact skipped file as it is part of the exclude list', 'no_scale'),
    BackgroundCompactStat('background_compact_skipped_missing_permissions', 'background compact skipped as there is a permissions issue', 'no_scale'),
    BackgroundCompactStat('background_compact_skipped_no_such_file', 'background compact skipped, no such file exists', 'no_scale'),
    BackgroundCompactStat('background_compact_skipped_small_file', 'background compact skipped file as it is smaller than 1MB in size', 'no_scale'),
    BackgroundCompactStat('background_compact_skipped_unsuccessful', 'background compact skipped as last compact was unsuccessful/less successful than average', 'no_scale'),
