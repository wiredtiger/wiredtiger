...
connection_stats = [
    ...
    CacheStat('cache_eviction_random_retune_add', 'eviction random re-tune will add workers'),
    ...
    CacheStat('cache_eviction_stable_state_workers', 'stable number of eviction workers', 'no_clear'),
