...
conn_stats = [
    ...
    CacheStat('cache_timed_out_full', 'operations gave up because the cache was full'),
...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_blocked_avail_lag', 'configured availability lag blocked eviction'),
