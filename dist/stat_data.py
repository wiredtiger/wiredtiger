...
connection_stats = [
    ...
    CacheStat('cache_hs_read', 'history store table update reads'),
    CacheStat('cache_hs_read_miss', 'history store table update reads missed'),
    CacheStat('cache_hs_read_squash', 'history store table update reads requiring squashed modifies'),
    CacheStat('cache_hs_read_wasted', 'history store table update reads wasted'),
    CacheStat('cache_hs_score', 'history store score', 'no_clear,no_scale'),
    CacheStat('cache_hs_write_squash', 'history store table update writes requiring squashed modifies'),
    CacheStat('cache_inmem_split', 'in-memory page splits'),
    CacheStat('cache_inmem_splittable', 'in-memory page passed criteria to be split'),
    CacheStat('cache_overhead', 'percentage overhead', 'no_clear,no_scale'),
    CacheStat('cache_page_instantiate_read_hs', 'pages read into cache requiring history store entries.'),
    CacheStat('cache_page_instantiate_read_hs_checkpoint', 'pages read into cache by checkpoint requiring history store entries.'),
...
dsrc_stats = [
    ...
    CacheStat('cache_read_overflow', 'overflow pages read into cache'),
    CacheStat('cache_write', 'pages written from cache'),
    CacheStat('cache_write_hs', 'page written requiring history records'),
    CacheStat('cache_write_restore', 'pages written requiring in-memory restoration'),
