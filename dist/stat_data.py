...
connection_stats = [
    ...
    CacheStat('cache_eviction_target_page_ge512', 'Histogram - Per tree page target greater than 512'),
    CacheStat('cache_eviction_target_page_lt16', 'Histogram - Per tree page target 1-16'),
    CacheStat('cache_eviction_target_page_lt32', 'Histogram - Per tree page target 16-32'),
    CacheStat('cache_eviction_target_page_lt128', 'Histogram - Per tree page target 32-128'),
    CacheStat('cache_eviction_target_page_lt512', 'Histogram - Per tree page target 128-512'),
