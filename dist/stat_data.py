...
conn_stats = [
    ...
    CheckpointStat('checkpoint_handle_meta_check', 'most recent handles metadata checked'),
    ...
    CheckpointStat('checkpoint_handle_lock', 'most recent handles metadata locked'),
