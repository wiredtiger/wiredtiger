...
connection_stats = [
    ...
    BlockStat('block_cache_bypass_not_useful', 'block cache number of bypasses on put because of high block turnover'),
    BlockStat('block_cache_bypass_overhead_get', 'block cache number of bypasses due to overhead on get'),
