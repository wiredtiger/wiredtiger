...
'WT_CONNECTION.query_timestamp' : Method([
    Config('get', 'all_committed', r'''
        ...
        \c last_checkpoint returns the timestamp of the last stable checkpoint,
        ...
        active readers, \c recovery returns the timestamp of the last stable
        checkpoint taken prior to an unclean shutdown and \c stable returns the
