...
arch_doc_pages = [
    ...
    ArchDocPage('arch-disagg-oligarch',
        ['WT_CURSOR_OLIGARCH', 'WT_OLIGARCH', 'WT_OLIGARCH_MANAGER'],
        ['src/include/cursor.h', 'src/conn/conn_oligarch.c',
         'src/cursor/cur_oligarch.c', 'src/txn/txn_oligarch_log.c']),
