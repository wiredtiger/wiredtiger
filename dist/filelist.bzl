...
FILELIST_ARM64_HOST=[
	"src/checksum/arm64/crc32-arm64.c"]

FILELIST_LOONGARCH64_HOST=[
	"src/checksum/loongarch64/crc32-loongarch64.c"]
...
FILELIST_POWERPC_HOST=[
	"src/checksum/power8/crc32_wrapper.c",
	"src/checksum/power8/vec_crc32.c"]

FILELIST_RISCV64_HOST=[
	"src/checksum/riscv64/crc32-riscv64.c"]

FILELIST_WINDOWS_HOST=[
	"src/os_win/os_dir.c",
...
FILELIST_X86_HOST=[
	"src/checksum/x86/crc32-x86-alt.c",
	"src/checksum/x86/crc32-x86.c"]

FILELIST_ZSERIES_HOST=[
	"src/checksum/zseries/crc32-s390x.c",
	"src/checksum/zseries/crc32le-vx.sx"]
