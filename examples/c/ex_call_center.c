...
main(int argc, char *argv[])
{
    ...
    error_check(session->create(session, "table:customers",
      "key_format=i,value_format=SSS,columns=(id,name,address,phone),colgroups=(main,address)"));
    ...
    error_check(session->create(session, "table:calls",
      "key_format=i,value_format=qrrSS,columns=(id,call_date,cust_id,emp_id,call_type,notes)"));
