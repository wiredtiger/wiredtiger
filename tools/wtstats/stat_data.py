...
no_scale_per_second_list = [
    ...
    'cache_walk: Number of clean pages currently in cache',
    'cache_walk: Number of dirty pages currently in cache',
    'cache_walk: Number of entries in the root page',
    'cache_walk: Number of internal pages currently in cache',
    'cache_walk: Number of leaf pages currently in cache',
    'cache_walk: Number of on-disk page image sizes smaller than a single allocation unit',
    'cache_walk: Number of pages currently queued for eviction',
    'cache_walk: Number of pages that could not be queued for eviction',
    'cache_walk: Number of pages that have never been written from cache',
    'cache_walk: Number of refs skipped during cache traversal',
