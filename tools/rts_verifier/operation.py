...
class Operation:
    ...
    def __init_tree(self, line):
        ...
        start_durable = int(matches.group(1))
        stop_durable = int(matches.group(2))
        self.durable = Timestamp(start_durable, stop_durable)
    ...
    def __init_update_abort(self, line):
        ...
        start_durable = int(matches.group(3))
        stop_durable = int(matches.group(4))
        self.durable = Timestamp(start_durable, stop_durable)
    ...
    def __init_ondisk_abort_tw(self, line):
        ...
        start_durable_start = int(matches.group(3))
        start_durable_end = int(matches.group(4))
        self.start_durable = Timestamp(start_durable_start, start_durable_end)
    ...
    def __init_hs_update_abort(self, line):
        ...
        start_durable_start = int(matches.group(1))
        start_durable_end = int(matches.group(2))
        self.start_durable = Timestamp(start_durable_start, start_durable_end)
        ...
        stop_durable_start = int(matches.group(6))
        stop_durable_end = int(matches.group(7))
        self.stop_durable = Timestamp(start_durable_start, start_durable_end)
    ...
    def __init_hs_abort_stop(self, line):
        ...
        start_durable_start = int(matches.group(1))
        start_stop_durable = int(matches.group(2))
        self.start_durable = Timestamp(start_durable_start, start_stop_durable)
        ...
        stop_durable_start = int(matches.group(1))
        stop_durable_stop = int(matches.group(2))
        self.stop_durable = Timestamp(start_durable_start, stop_durable_start)
