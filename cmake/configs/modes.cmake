...
set(msan_compiler_c_flag "-fsanitize=memory" "-fno-optimize-sibling-calls" "-fsanitize-memory-track-origins=2" "-fsanitize-blacklist=${CMAKE_CURRENT_LIST_DIR}/msan-ignorelist.txt")
set(msan_compiler_cxx_flag "-fsanitize=memory" "-fno-optimize-sibling-calls" "-fsanitize-memory-track-origins=2" "-fsanitize-blacklist=${CMAKE_CURRENT_LIST_DIR}/msan-ignorelist.txt")
