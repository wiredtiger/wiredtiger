...
if(HAVE_RCPC)
    add_compile_options($<$<COMPILE_LANGUAGE:C>:-march=armv8.2-a+rcpc+crc>)
    add_compile_options($<$<COMPILE_LANGUAGE:CXX>:-march=armv8.2-a+rcpc+crc>)
else()
    add_compile_options($<$<COMPILE_LANGUAGE:C>:-march=armv8-a+crc>)
    add_compile_options($<$<COMPILE_LANGUAGE:CXX>:-march=armv8-a+crc>)
endif()
...
if(has_moutline_atomics)
    add_compile_options($<$<COMPILE_LANGUAGE:C>:-moutline-atomics>)
endif()
...
if(has_arm_neon)
    add_compile_options($<$<COMPILE_LANGUAGE:C>:-DHAVE_ARM_NEON_INTRIN_H>)
endif()
