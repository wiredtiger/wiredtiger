...
function(setup_gdb_autoloader)
    if(WT_LINUX AND ENABLE_SHARED)
        ...
        add_custom_target(
            copy-autoload-script ALL
            COMMAND
                ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/tools/gdb/load_gdb_scripts.py
                ${CMAKE_BINARY_DIR}/libwiredtiger.so.${VERSION_MAJOR}.${VERSION_MINOR}.${VERSION_PATCH}-gdb.py
        )

        add_custom_target(
            copy-runtime-files ALL
            COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/tools/gdb/gdb_scripts
