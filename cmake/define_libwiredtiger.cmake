...
macro(define_wiredtiger_library target type)
	...
	if(HAVE_LIBACCEL-CONFIG)
            target_link_libraries(${target} PRIVATE ${HAVE_LIBACCEL-CONFIG})
            if(HAVE_LIBACCEL-CONFIG_INCLUDES)
	        target_include_directories(${target} PRIVATE ${HAVE_LIBACCEL-CONFIG_INCLUDES})
	    endif()
        endif()
    endif()
endmacro()
