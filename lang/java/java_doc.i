...
COPYDOC(__wt_session, WT_SESSION, timestamp_transaction_numeric)
COPYDOC(__wt_session, WT_SESSION, query_timestamp)
COPYDOC(__wt_session, WT_SESSION, query_timestamp_numeric)
...
COPYDOC(__wt_connection, WT_CONNECTION, query_timestamp_numeric)
