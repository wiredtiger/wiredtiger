 ...
 * @param locked True if cp_registry->lock is left locked for additional processing along with incrementing the ref_count.
 */
WT_CONTROL_POINT *
__wt_control_point_get_data(WT_SESSION_IMPL *session, WT_CONTROL_POINT_REGISTRY *cp_registry, bool locked) {
 ...
 * This is called after finishing the additional processing started with __wt_control_point_get_data() with locked=true.
 *
 * @param cp_registry The control point registry.
 */
void
 ...
 * Call when done using WT_CONTROL_POINT_REGISTRY->data that was returned by __wt_control_point_get_data.
 *
 * @param session The session.
 * @param cp_registry The control point registry.
 ...
 */
void
__wt_control_point_release_data(WT_SESSION_IMPL *session, WT_CONTROL_POINT_REGISTRY *cp_registry, WT_CONTROL_POINT *data, bool locked) {
