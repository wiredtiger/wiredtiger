...
__wt_conn_control_points_enable_all(WT_CONNECTION *conn) {
  ...
  /* This part must be edited. Repeat this for every per connection control point that starts enabled. */
#if 0                           /* For example */
...
__wt_session_control_points_enable_all(WT_SESSION_IMPL *session) {
  ...
  /* This part must be edited. Repeat this for every per session control point that starts enabled. */
#if 0                           /* For example */
