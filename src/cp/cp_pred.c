...
/*!
 * Configuration parsing for control point predicate "Skip the first skip-count control point crossings".
 */
int __wt_control_point_config_pred_skip(WT_SESSION_IMPL *session, WT_CONTROL_POINT *data, const char **configuration) {
    /* TODO. */
}

/*!
 * Control point predicate function for "Enable only the first enable-count control point crossings".
 */
...
/*!
 * Configuration parsing for control point predicate "Enable only the first enable-count control point crossings".
 */
 ...
 */
bool __wt_control_point_pred_probability_param1(WT_SESSION_IMPL *session, WT_CONTROL_POINT *data) {
 ...
 */
int __wt_control_point_config_probability_param1(WT_SESSION_IMPL *session, WT_CONTROL_POINT *data, const char **configuration) {
    /* TODO. */
}
 ...
 */
bool control_point_pred_probability_param2(WT_SESSION_IMPL *session, WT_CONTROL_POINT *data) {
 ...
 * Probability is assigned to param2.value16aa.
 */
int __wt_control_point_config_probability_param2(WT_SESSION_IMPL *session, WT_CONTROL_POINT *data, const char **configuration) {
    /* TODO. */
}
