  ...
  WT_SESSION_IMPL **sessionp)
{
    static const WT_SESSION
      stds = {NULL, NULL, NULL, __session_close, __session_reconfigure, __session_flush_tier,
        ...
        __wt_session_breakpoint},
      stds_readonly = {NULL, NULL, NULL, __session_close, __session_reconfigure,
        __session_flush_tier, __wt_session_strerror, __session_open_cursor,
