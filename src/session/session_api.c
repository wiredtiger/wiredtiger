...
/*
 * __session_timestamp_transaction_commit --
...
__session_timestamp_transaction_commit(WT_SESSION *wt_session, unsigned long long ts)
{
    ...
    session = (WT_SESSION_IMPL *)wt_session;
    SESSION_API_CALL_NOCONF(session, timestamp_transaction_commit);

    ret = __wt_txn_set_timestamp_commit(session, (wt_timestamp_t)ts);
err:
    API_END_RET(session, ret);
}
  ...
  WT_SESSION_IMPL **sessionp)
{
    static const WT_SESSION
      stds = {NULL, NULL, __session_close, __session_reconfigure, __session_flush_tier,
        ...
        __session_timestamp_transaction_commit, __session_checkpoint, __session_reset_snapshot,
      ...
      stds_readonly = {NULL, NULL, __session_close, __session_reconfigure, __session_flush_tier,
        ...
        __session_query_timestamp, __session_timestamp_transaction,
        __session_timestamp_transaction_commit, __session_checkpoint_readonly,
