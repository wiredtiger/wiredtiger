...
__bmd_method_set(WT_BM *bm, bool readonly)
{
    ...
    bm->compact_end = __wt_block_disagg_compact_end;
    bm->compact_page_skip = __wt_block_disagg_compact_page_skip;
    bm->compact_skip = __wt_block_disagg_compact_skip;
    bm->compact_start = __wt_block_disagg_compact_start;
    bm->corrupt = __wt_block_disagg_corrupt;
    bm->free = __bmd_free;
    bm->is_mapped = __wt_block_disagg_is_mapped;
    bm->map_discard = __wt_block_disagg_map_discard;
    bm->read = __wt_block_disagg_read;
    bm->read_multiple = __wt_block_disagg_read_multiple;
    bm->salvage_end = __wt_block_disagg_salvage_end;
    bm->salvage_next = __wt_block_disagg_salvage_next;
    bm->salvage_start = __wt_block_disagg_salvage_start;
    bm->salvage_valid = __wt_block_disagg_salvage_valid;
    bm->size = __wt_block_disagg_manager_size;
    bm->stat = __bmd_stat;
    bm->sync = __wt_block_disagg_sync;
    bm->verify_addr = __wt_block_disagg_verify_addr;
    bm->verify_end = __wt_block_disagg_verify_end;
    bm->verify_start = __wt_block_disagg_verify_start;
