...
extern int __wt_live_restore_fh_extent_to_metadata_string(WT_SESSION_IMPL *session,
  WT_FILE_HANDLE *fh, WT_ITEM *extent_string) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_live_restore_import_extents_from_string(WT_SESSION_IMPL *session,
  WT_FILE_HANDLE *fh, WT_CONFIG_ITEM *lr_config) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
