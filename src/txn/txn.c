...
__txn_resolve_prepared_op(WT_SESSION_IMPL *session, WT_TXN_OP *op, bool commit, WT_CURSOR **cursorp)
{
     ...
     * of the key are resolved. The head of the update chain can also be null in the scenario
     * that we rolled back all associated updates in the previous iteration of this function.
     */
