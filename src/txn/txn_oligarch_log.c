...
/*
 * __wt_txn_truncate_oligarch_log --
 *     Begin truncating a range of a file.
 */
int
__wt_txn_truncate_oligarch_log(WT_TRUNCATE_INFO *trunc_info)
{
    WT_BTREE *btree;
    WT_ITEM *item;
    ...
    WT_RET(__wt_txn_oligarch_log_op(session, NULL));
...
/*
 * __wt_txn_truncate_oligarch_end --
 *     Finish truncating a range of a file.
 */
void
__wt_txn_truncate_oligarch_end(WT_SESSION_IMPL *session)
{
