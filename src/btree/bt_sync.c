...
__wt_sync_file(WT_SESSION_IMPL *session, WT_CACHE_OP syncop)
{
    ...
    case WT_SYNC_CHECKPOINT:
        ...
        /*
         * During normal checkpoints, mark the tree dirty if the btree has modifications that are not
         * visible to the checkpoint. There is a drawback in this approach as we compare the btree's
         * maximum transaction id with the checkpoint snap_min and it is possible that this
