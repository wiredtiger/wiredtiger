...
delete_b:
     ...
     */
    newv->col_start = b_trk->col_stop + 1;
    newv->col_stop = a_trk->col_stop;
...
delete_b:
     ...
     */
    WT_RET(__slvg_key_copy(session, &newv->row_stop, A_TRK_STOP));
     ...
     */
    WT_RET(__slvg_key_copy(session, A_TRK_STOP, B_TRK_START));
    F_SET(newv, WT_TRACK_CHECK_START);
