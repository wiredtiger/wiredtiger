...
__wt_btree_stat_init(WT_SESSION_IMPL *session, WT_CURSOR_STAT *cst)
{
	...
	WT_STAT_SET(session, stats, compress_precomp_leaf_maximum_page_size,
	    btree->maxleafpage_precomp);
	WT_STAT_SET(session, stats, compress_precomp_intl_maximum_page_size,
	    btree->maxintlpage_precomp);
