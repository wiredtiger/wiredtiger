...
__split_root(WT_SESSION_IMPL *session, WT_PAGE *root)
{
	...
	/* Encourage a race */
	__page_split_timing_stress(
	    session, WT_TIMING_STRESS_SPLIT_1, STRESS_SLEEP_LONG);
	...
	/* Encourage a race */
	__page_split_timing_stress(
	    session, WT_TIMING_STRESS_SPLIT_2, STRESS_SLEEP_LONG);
    ...
    uint32_t new_entries, size_t parent_incr, bool exclusive, bool discard)
{
	...
	/* Encourage a race */
	__page_split_timing_stress(
	    session, WT_TIMING_STRESS_SPLIT_3, STRESS_SLEEP_LONG);
	...
	/* Encourage a race */
	__page_split_timing_stress(
	    session, WT_TIMING_STRESS_SPLIT_4, STRESS_SLEEP_LONG);
...
__split_internal(WT_SESSION_IMPL *session, WT_PAGE *parent, WT_PAGE *page)
{
	...
	*alloc_refp++ = page_ref;
	...
	/* Encourage a race */
	__page_split_timing_stress(
	    session, WT_TIMING_STRESS_SPLIT_5, STRESS_SLEEP_LONG);
	...
	/* Encourage a race */
	__page_split_timing_stress(
	    session, WT_TIMING_STRESS_SPLIT_6, STRESS_SLEEP_LONG);
