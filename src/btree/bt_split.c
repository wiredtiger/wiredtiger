...
__split_parent_discard_ref(WT_SESSION_IMPL *session, WT_REF *ref, WT_PAGE *parent, size_t *decrp,
  uint64_t split_gen, bool exclusive, bool disagg_free_block)
{
    WT_DECL_RET;
    WT_IKEY *ikey;
    size_t size;
    ...
    WT_TRET(__wt_ref_block_free(session, ref, disagg_free_block));
