  ...
  WT_SESSION_IMPL *session, WT_REF *ref, void *context, bool visible_all, bool *skipp)
{
    ...
    *skipp = false; /* Default to reading */
     ...
     *    To limit the reading of number of internal pages, the aggregated stop durable
     * timestamp is checked except when the table is logged. Logged tables do not use
     * timestamps.
     *
