  ...
  WT_SESSION_IMPL *session, WT_REF *ref, WT_ITEM *deltas, size_t delta_size)
{
    ...
    case WT_PAGE_ROW_LEAF:
         ...
         * not reentrant.
         *
         * FIXME-WT-15619, FIXME-WT-15618: this should go away when we use an algorithm to directly
         * rewrite delta.
         */
...
__wti_page_inmem_updates(WT_SESSION_IMPL *session, WT_REF *ref)
{
    ...
    if (page->type == WT_PAGE_COL_VAR) {
        ...
        WT_ROW_FOREACH (page, rip, i) {
            ...
            first_upd = WT_ROW_UPDATE(page, rip);
            /*
             * FIXME-WT-15619, FIXME-WT-15618: This key must have been overwritten by a delta. Don't
             * instantiate it.
             */
            if (first_upd == NULL) {
