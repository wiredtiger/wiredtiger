...
/*
#define WT_EVICT_LEVEL_WONT_NEED_CLEAN_LEAF 0
#define WT_EVICT_LEVEL_CLEAN_LEAF 1
#define WT_EVICT_LEVEL_WONT_NEED_DIRTY_LEAF 2
#define WT_EVICT_LEVEL_DIRTY_LEAF 3
#define WT_EVICT_LEVEL_WONT_NEED_INTERNAL 4
#define WT_EVICT_LEVEL_DIRTY_INTERNAL 5
#define WT_EVICT_LEVEL_UPDATES_LEAF 6
...
#define WT_EVICT_LEVEL_CLEAN_LEAF 3
#define WT_EVICT_LEVEL_UPDATES_LEAF 4
#define WT_EVICT_LEVEL_DIRTY_INTERNAL 5
...
extern int __wt_evict_check_if_blocking(WT_SESSION_IMPL *session)
