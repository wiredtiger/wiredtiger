...
__wti_connection_init(WT_CONNECTION_IMPL *conn)
{
    ...
    WT_RET(__wt_spin_init(
      session, &conn->disaggregated_storage.shared_metadata_lock, "update shared metadata"));
...
__wti_connection_destroy(WT_CONNECTION_IMPL *conn)
{
    ...
    __wt_spin_destroy(session, &conn->disaggregated_storage.shared_metadata_lock);
