...
/*
 * __wt_rollback_has_stable_update --
 ...
 */
bool
__wt_rollback_has_stable_update(WT_UPDATE *upd)
{
...
/*
 * __wt_rollback_txn_visible_id --
 *     Check if the transaction id is visible or not.
 */
bool
__wt_rollback_txn_visible_id(WT_SESSION_IMPL *session, uint64_t id)
{
...
/*
 * __wt_rollback_page_needs_abort --
