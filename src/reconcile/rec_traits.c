...
const struct __wt_rec_traits REC_PAGE_ROW_INT_TRAITS = {
  NULL, __rec_page_row_int,
};
const struct __wt_rec_traits REC_PAGE_ROW_LEAF_TRAITS = {
  &CACHE_LAS_ROW_TRAITS, __wt_rec_row_leaf,
};
