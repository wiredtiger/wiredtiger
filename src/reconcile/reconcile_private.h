...
extern int __wti_rec_pack_delta_internal(WT_SESSION_IMPL *session, WT_RECONCILE *r, WTI_REC_KV *key,
  WTI_REC_KV *value) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
