...
int util_command_usage(int argc, char *argv[], const char *cmd);
int usage_alter(void);
int usage_backup(void);
int usage_compact(void);
int usage_dump(void);
int usage_list(void);
int usage_load(void);
int usage_printlog(void);
int usage_read(void);
int usage_rename(void);
int usage_salvage(void);
int usage_stat(void);
int usage_truncate(void);
int usage_upgrade(void);
int usage_verify(void);
