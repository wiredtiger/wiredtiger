    ...
    WT_DSRC_STATS *from, WT_DSRC_STATS *to)
{
	...
	to->cache_write_delta += from->cache_write_delta;
    ...
    WT_DSRC_STATS **from, WT_DSRC_STATS *to)
{
	...
	to->cache_read_delta += WT_STAT_READ(from, cache_read_delta);
	to->cache_write_delta += WT_STAT_READ(from, cache_write_delta);
