...
static const char * const __stats_connection_desc[] = {
	...
	"cache: eviction walks abandoned looking for dirty pages",
...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
	...
	stats->cache_eviction_walks_abandoned_dirty = 0;
    ...
    WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
	...
	to->cache_eviction_walks_abandoned_dirty +=
	    WT_STAT_READ(from, cache_eviction_walks_abandoned_dirty);
