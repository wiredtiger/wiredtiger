...
static const char *const __stats_connection_desc[] = {
  ...
  "block-cache: pre-fetch not triggered for disk read count",
  "block-cache: pre-fetch not triggered for internal session",
  "block-cache: pre-fetch not triggered for same ref",
