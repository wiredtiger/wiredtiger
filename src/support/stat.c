...
static const char *const __stats_connection_desc[] = {
  ...
  "cache: maximum clean page size seen at eviction",
  "cache: maximum dirty page size seen at eviction",
  ...
  "cache: maximum updates page size seen at eviction",
...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
    ...
    /* not clearing eviction_maximum_clean_page_size */
    /* not clearing eviction_maximum_dirty_page_size */
    ...
    /* not clearing eviction_maximum_updates_page_size */
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->eviction_maximum_clean_page_size +=
      WT_STAT_CONN_READ(from, eviction_maximum_clean_page_size);
    to->eviction_maximum_dirty_page_size +=
      WT_STAT_CONN_READ(from, eviction_maximum_dirty_page_size);
    ...
    to->eviction_maximum_updates_page_size +=
      WT_STAT_CONN_READ(from, eviction_maximum_updates_page_size);
