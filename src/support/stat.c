...
static const char *const __stats_connection_desc[] = {
  ...
  "live-restore: live restore source read latency histogram (bucket 1) - 0-10ms",
  "live-restore: live restore source read latency histogram (bucket 2) - 10-49ms",
  "live-restore: live restore source read latency histogram (bucket 3) - 50-99ms",
  "live-restore: live restore source read latency histogram (bucket 4) - 100-249ms",
  "live-restore: live restore source read latency histogram (bucket 5) - 250-499ms",
  "live-restore: live restore source read latency histogram (bucket 6) - 500-999ms",
  "live-restore: live restore source read latency histogram (bucket 7) - 1000ms+",
  "live-restore: live restore source read latency histogram total (msecs)",
