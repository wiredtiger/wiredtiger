...
static const char *const __stats_dsrc_desc[] = {
  ...
  "cursor: touch warmup skipped because the leaf had no address cookie",
  "cursor: touch warmup skipped because the tree is not disaggregated",
...
static const char *const __stats_connection_desc[] = {
  ...
  "cursor: touch cursor warmup skipped because the leaf had no address cookie",
  "cursor: touch cursor warmup skipped because the tree is not disaggregated",
