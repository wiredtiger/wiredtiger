...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
    ...
    stats->eviction_server_skip_trees_checkpoint_pending = 0;
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->eviction_server_skip_trees_checkpoint_pending +=
      WT_STAT_CONN_READ(from, eviction_server_skip_trees_checkpoint_pending);
