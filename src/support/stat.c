...
static const char *const __stats_connection_desc[] = {
  ...
  "background-compact: background compact sleeps due to an active backup",
...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
    ...
    stats->background_compact_sleep_backup_active = 0;
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->background_compact_sleep_backup_active +=
      WT_STAT_CONN_READ(from, background_compact_sleep_backup_active);
