...
static const char *const __stats_connection_desc[] = {
  ...
  "reconciliation: page reconciliation calls for eviction", "reconciliation: pages deleted",
  "reconciliation: pages reconciled with prepared transaction metadata",
  "reconciliation: pages reconciled with timestamps",
  "reconciliation: pages reconciled with transaction ids",
