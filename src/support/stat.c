...
static const char *const __stats_connection_desc[] = {
  ...
  "block-manager: bytes read for internal pages before compression and encryption",
  "block-manager: bytes read for leaf pages",
  "block-manager: bytes read for leaf pages before compression and encryption",
...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
    ...
    stats->block_byte_read_intl_precomp = 0;
    stats->block_byte_read_leaf = 0;
    stats->block_byte_read_leaf_precomp = 0;
    ...
    stats->block_byte_write_intl_precomp = 0;
    stats->block_byte_write_leaf = 0;
    stats->block_byte_write_leaf_precomp = 0;
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->block_byte_read_intl_precomp += WT_STAT_CONN_READ(from, block_byte_read_intl_precomp);
    to->block_byte_read_leaf += WT_STAT_CONN_READ(from, block_byte_read_leaf);
    to->block_byte_read_leaf_precomp += WT_STAT_CONN_READ(from, block_byte_read_leaf_precomp);
    ...
    to->block_byte_write_intl_precomp += WT_STAT_CONN_READ(from, block_byte_write_intl_precomp);
    to->block_byte_write_leaf += WT_STAT_CONN_READ(from, block_byte_write_leaf);
    to->block_byte_write_leaf_precomp += WT_STAT_CONN_READ(from, block_byte_write_leaf_precomp);
