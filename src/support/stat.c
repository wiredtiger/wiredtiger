...
static const char *const __stats_dsrc_desc[] = {
  ...
  "cache: eviction gave up due to detecting out of order timestamps on a page while a checkpoint was running",
...
__wt_stat_dsrc_clear_single(WT_DSRC_STATS *stats)
{
    ...
    stats->cache_eviction_blocked_ooo_checkpoint_race = 0;
...
__wt_stat_dsrc_aggregate_single(WT_DSRC_STATS *from, WT_DSRC_STATS *to)
{
    ...
    to->cache_eviction_blocked_ooo_checkpoint_race +=
      from->cache_eviction_blocked_ooo_checkpoint_race;
...
__wt_stat_dsrc_aggregate(WT_DSRC_STATS **from, WT_DSRC_STATS *to)
{
    ...
    to->cache_eviction_blocked_ooo_checkpoint_race +=
      WT_STAT_READ(from, cache_eviction_blocked_ooo_checkpoint_race);
