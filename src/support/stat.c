...
static const char *const __stats_connection_desc[] = {
  ...
  "disagg: existing file metadata entries deferred for selective checkpoint pick-up",
...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
    ...
    stats->disagg_pick_up_file_meta_deferred = 0;
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->disagg_pick_up_file_meta_deferred +=
      WT_STAT_CONN_READ(from, disagg_pick_up_file_meta_deferred);
