...
static const char *const __stats_dsrc_desc[] = {
  ...
  "transaction: race to read overflow value",
...
__wt_stat_dsrc_clear_single(WT_DSRC_STATS *stats)
{
    ...
    stats->txn_read_race_overflow_remove = 0;
...
__wt_stat_dsrc_aggregate_single(WT_DSRC_STATS *from, WT_DSRC_STATS *to)
{
    ...
    to->txn_read_race_overflow_remove += from->txn_read_race_overflow_remove;
...
__wt_stat_dsrc_aggregate(WT_DSRC_STATS **from, WT_DSRC_STATS *to)
{
    ...
    to->txn_read_race_overflow_remove += WT_STAT_READ(from, txn_read_race_overflow_remove);
