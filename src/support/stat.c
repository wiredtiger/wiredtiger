...
static const char *const __stats_dsrc_desc[] = {
  ...
  "block-disagg: Pages discarded by disaggregated block manager",
...
__wt_stat_dsrc_clear_single(WT_DSRC_STATS *stats)
{
    ...
    stats->disagg_block_pages_discarded = 0;
...
__wt_stat_dsrc_aggregate_single(WT_DSRC_STATS *from, WT_DSRC_STATS *to)
{
    ...
    to->disagg_block_pages_discarded += from->disagg_block_pages_discarded;
...
__wt_stat_dsrc_aggregate(WT_DSRC_STATS **from, WT_DSRC_STATS *to)
{
    ...
    to->disagg_block_pages_discarded += WT_STAT_DSRC_READ(from, disagg_block_pages_discarded);
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->disagg_block_pages_discarded += WT_STAT_CONN_READ(from, disagg_block_pages_discarded);
