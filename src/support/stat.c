...
static const char *const __stats_dsrc_desc[] = {
  ...
  "compression: number of written blocks with compress ratio greater than 64",
  "compression: number of written blocks with compress ratio smaller than 16",
  "compression: number of written blocks with compress ratio smaller than 2",
  "compression: number of written blocks with compress ratio smaller than 32",
  "compression: number of written blocks with compress ratio smaller than 4",
  "compression: number of written blocks with compress ratio smaller than 64",
  "compression: number of written blocks with compress ratio smaller than 8",
...
__wt_stat_dsrc_clear_single(WT_DSRC_STATS *stats)
{
    ...
    stats->compress_read_hist_ratio_max = 0;
    stats->compress_read_hist_ratio_16 = 0;
    stats->compress_read_hist_ratio_2 = 0;
    stats->compress_read_hist_ratio_32 = 0;
    stats->compress_read_hist_ratio_4 = 0;
    stats->compress_read_hist_ratio_64 = 0;
    stats->compress_read_hist_ratio_8 = 0;
    stats->compress_write_hist_ratio_max = 0;
    stats->compress_write_hist_ratio_16 = 0;
    stats->compress_write_hist_ratio_2 = 0;
    stats->compress_write_hist_ratio_32 = 0;
    stats->compress_write_hist_ratio_4 = 0;
    stats->compress_write_hist_ratio_64 = 0;
    stats->compress_write_hist_ratio_8 = 0;
...
__wt_stat_dsrc_aggregate_single(WT_DSRC_STATS *from, WT_DSRC_STATS *to)
{
    ...
    to->compress_read_hist_ratio_max += from->compress_read_hist_ratio_max;
    to->compress_read_hist_ratio_16 += from->compress_read_hist_ratio_16;
    to->compress_read_hist_ratio_2 += from->compress_read_hist_ratio_2;
    to->compress_read_hist_ratio_32 += from->compress_read_hist_ratio_32;
    to->compress_read_hist_ratio_4 += from->compress_read_hist_ratio_4;
    to->compress_read_hist_ratio_64 += from->compress_read_hist_ratio_64;
    to->compress_read_hist_ratio_8 += from->compress_read_hist_ratio_8;
    to->compress_write_hist_ratio_max += from->compress_write_hist_ratio_max;
    to->compress_write_hist_ratio_16 += from->compress_write_hist_ratio_16;
    to->compress_write_hist_ratio_2 += from->compress_write_hist_ratio_2;
    to->compress_write_hist_ratio_32 += from->compress_write_hist_ratio_32;
    to->compress_write_hist_ratio_4 += from->compress_write_hist_ratio_4;
    to->compress_write_hist_ratio_64 += from->compress_write_hist_ratio_64;
    to->compress_write_hist_ratio_8 += from->compress_write_hist_ratio_8;
...
__wt_stat_dsrc_aggregate(WT_DSRC_STATS **from, WT_DSRC_STATS *to)
{
    ...
    to->compress_read_hist_ratio_max += WT_STAT_READ(from, compress_read_hist_ratio_max);
    to->compress_read_hist_ratio_16 += WT_STAT_READ(from, compress_read_hist_ratio_16);
    to->compress_read_hist_ratio_2 += WT_STAT_READ(from, compress_read_hist_ratio_2);
    to->compress_read_hist_ratio_32 += WT_STAT_READ(from, compress_read_hist_ratio_32);
    to->compress_read_hist_ratio_4 += WT_STAT_READ(from, compress_read_hist_ratio_4);
    to->compress_read_hist_ratio_64 += WT_STAT_READ(from, compress_read_hist_ratio_64);
    to->compress_read_hist_ratio_8 += WT_STAT_READ(from, compress_read_hist_ratio_8);
    to->compress_write_hist_ratio_max += WT_STAT_READ(from, compress_write_hist_ratio_max);
    to->compress_write_hist_ratio_16 += WT_STAT_READ(from, compress_write_hist_ratio_16);
    to->compress_write_hist_ratio_2 += WT_STAT_READ(from, compress_write_hist_ratio_2);
    to->compress_write_hist_ratio_32 += WT_STAT_READ(from, compress_write_hist_ratio_32);
    to->compress_write_hist_ratio_4 += WT_STAT_READ(from, compress_write_hist_ratio_4);
    to->compress_write_hist_ratio_64 += WT_STAT_READ(from, compress_write_hist_ratio_64);
    to->compress_write_hist_ratio_8 += WT_STAT_READ(from, compress_write_hist_ratio_8);
