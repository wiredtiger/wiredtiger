...
static const char *const __stats_dsrc_desc[] = {
  ...
  "cursor: Total number of pages skipped without reading by cursor next or prev calls",
...
__wt_stat_dsrc_clear_single(WT_DSRC_STATS *stats)
{
    ...
    stats->cursor_skip_page_count = 0;
...
__wt_stat_dsrc_aggregate_single(WT_DSRC_STATS *from, WT_DSRC_STATS *to)
{
    ...
    to->cursor_skip_page_count += from->cursor_skip_page_count;
...
__wt_stat_dsrc_aggregate(WT_DSRC_STATS **from, WT_DSRC_STATS *to)
{
    ...
    to->cursor_skip_page_count += WT_STAT_READ(from, cursor_skip_page_count);
