...
static const char *const __stats_connection_desc[] = {
  ...
  "allocation",
  "cache: application eviction assists stopped because the cache was stuck and they could not be "
  "rolled back",
...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
    ...
    stats->eviction_app_bounded_wait_cache_stuck = 0;
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->eviction_app_bounded_wait_cache_stuck +=
      WT_STAT_CONN_READ(from, eviction_app_bounded_wait_cache_stuck);
