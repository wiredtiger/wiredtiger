...
static const char *const __stats_connection_desc[] = {
  ...
  "cache: eviction server skip parent internal page of last seen page.",
...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
    ...
    stats->cache_eviction_server_skip_parent_intl_page_of_last_seen_page = 0;
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->cache_eviction_server_skip_parent_intl_page_of_last_seen_page +=
      WT_STAT_READ(from, cache_eviction_server_skip_parent_intl_page_of_last_seen_page);
