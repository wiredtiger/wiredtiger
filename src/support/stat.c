...
static const char *const __stats_connection_desc[] = {
  ...
  "background-compact: background compact skipped as last compact was unsuccessful/less successful "
  "than average",
  "background-compact: background compact skipped as there is a permissions issue",
  "background-compact: background compact skipped file as it is part of the exclude list",
  "background-compact: background compact skipped file as it is smaller than 1MB in size",
