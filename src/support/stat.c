...
static const char *const __stats_connection_desc[] = {
  ...
  "cache: skip metadata pages with history",
  ...
  "cache: skip pages that we do not want to evict",
  "cache: skip trees because there are too many active walks",
  "cache: skip trees that are being checkpointed",
  "cache: skip trees that are configured to stick in cache",
  "cache: skip trees that are not useful before",
  "cache: the number of times full update inserted to history store",
  "cache: the number of times reverse modify inserted to history store",
