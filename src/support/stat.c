...
static const char *const __stats_connection_desc[] = {
  ...
  "cache: eviction threshold cache full target",
  "cache: eviction threshold cache full trigger",
  "cache: eviction threshold dirty target",
  "cache: eviction threshold dirty trigger",
  "cache: eviction threshold updates target",
  "cache: eviction threshold updates trigger",
