...
static const char *const __stats_connection_desc[] = {
  ...
  "block-manager: time spent on linear walk of the available chunks in block_first_srch(usecs)",
...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
    ...
    stats->block_first_srch_linear_walk_time = 0;
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->block_first_srch_linear_walk_time +=
      WT_STAT_CONN_READ(from, block_first_srch_linear_walk_time);
