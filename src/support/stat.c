...
__wt_stat_dsrc_clear_single(WT_DSRC_STATS *stats)
{
	...
	stats->cache_eviction_clean = 0;
		...
		/* not clearing cache_state_root_count_entries */
    ...
    WT_DSRC_STATS *from, WT_DSRC_STATS *to)
{
	...
	to->cache_state_root_count_entries +=
	    from->cache_state_root_count_entries;
    ...
    WT_DSRC_STATS **from, WT_DSRC_STATS *to)
{
	...
	to->cache_state_root_count_entries +=
	    WT_STAT_READ(from, cache_state_root_count_entries);
