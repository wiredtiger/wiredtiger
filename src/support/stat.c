...
static const char *const __stats_dsrc_desc[] = {
  ...
  "session: share_storage operation calls",
  "session: shared storage local retention time (secs)",
...
__wt_stat_dsrc_clear_single(WT_DSRC_STATS *stats)
{
    ...
    stats->share_storage = 0;
    /* not clearing storage_retention */
...
__wt_stat_dsrc_aggregate_single(WT_DSRC_STATS *from, WT_DSRC_STATS *to)
{
    ...
    to->share_storage += from->share_storage;
    to->storage_retention += from->storage_retention;
...
__wt_stat_dsrc_aggregate(WT_DSRC_STATS **from, WT_DSRC_STATS *to)
{
    ...
    to->share_storage += WT_STAT_READ(from, share_storage);
    to->storage_retention += WT_STAT_READ(from, storage_retention);
