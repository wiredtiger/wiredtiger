...
static const char *const __stats_connection_desc[] = {
  ...
  "cache: pages selected for eviction unable to be evicted because of overflow keys",
...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
    ...
    stats->cache_eviction_fail_overflow_keys = 0;
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->cache_eviction_fail_overflow_keys += WT_STAT_READ(from, cache_eviction_fail_overflow_keys);
