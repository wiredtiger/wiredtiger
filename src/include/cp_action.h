 ...
 */
#define CONNECTION_CONTROL_POINT_DEFINE_START(CONNECTION, CONTROL_POINT_ID) \
    do {                                                                    \
        WT_CONNECTION *const _wt_conn = (CONNECTION);                       \
        WT_CONNECTION_IMPL *const _conn = (WT_CONNECTION_IMPL *)_wt_conn;   \
