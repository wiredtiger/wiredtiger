...
#define	WT_TXN_SYNC_SET		0x008000u
#define	WT_TXN_TS_COMMIT_ALWAYS	0x010000u
#define	WT_TXN_TS_COMMIT_KEYS	0x020000u
#define	WT_TXN_TS_COMMIT_NEVER	0x040000u
#define	WT_TXN_TS_DURABLE_ALWAYS	0x080000u
#define	WT_TXN_TS_DURABLE_KEYS	0x100000u
#define	WT_TXN_TS_DURABLE_NEVER	0x200000u
