...
#define	WT_TXN_IGNORE_PREPARE	0x0040u
#define	WT_TXN_NAMED_SNAPSHOT	0x0080u
#define	WT_TXN_PUBLIC_TS_COMMIT	0x0100u
#define	WT_TXN_PUBLIC_TS_READ	0x0200u
#define	WT_TXN_READONLY		0x0400u
#define	WT_TXN_RUNNING		0x0800u
#define	WT_TXN_SYNC_SET		0x1000u
#define	WT_TXN_TS_COMMIT_ALWAYS	0x2000u
