...
#define WT_TXN_EVICT_DBG 0x000004u
#define WT_TXN_EVICT_SKIP 0x000008u
#define WT_TXN_HAS_ID 0x000010u
#define WT_TXN_HAS_SNAPSHOT 0x000020u
#define WT_TXN_HAS_TS_COMMIT 0x000040u
#define WT_TXN_HAS_TS_DURABLE 0x000080u
#define WT_TXN_HAS_TS_PREPARE 0x000100u
