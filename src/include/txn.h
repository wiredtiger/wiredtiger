...
#define WT_TXN_IN_COMMIT_PHASE 0x0000100u
#define WT_TXN_PREPARE 0x0000200u
#define WT_TXN_PREPARE_IGNORE_API_CHECK 0x0000400u
#define WT_TXN_READONLY 0x0000800u
#define WT_TXN_RUNNING 0x0001000u
#define WT_TXN_SHARED_TS_DURABLE 0x0002000u
#define WT_TXN_SHARED_TS_READ 0x0004000u
#define WT_TXN_SYNC_SET 0x0008000u
#define WT_TXN_TS_READ_BEFORE_OLDEST 0x0010000u
#define WT_TXN_TS_ROUND_PREPARED 0x0020000u
#define WT_TXN_TS_ROUND_READ 0x0040000u
#define WT_TXN_TS_WRITE_ALWAYS 0x0080000u
#define WT_TXN_TS_WRITE_KEY_CONSISTENT 0x0100000u
#define WT_TXN_TS_WRITE_MIXED_MODE 0x0200000u
#define WT_TXN_TS_WRITE_NEVER 0x0400000u
#define WT_TXN_TS_WRITE_ORDERED 0x0800000u
#define WT_TXN_UPDATE 0x1000000u
#define WT_TXN_VERB_TS_WRITE 0x2000000u
    /* AUTOMATIC FLAG VALUE GENERATION STOP 32 */
    uint32_t flags;
