...
/* AUTOMATIC FLAG VALUE GENERATION START */
#define WT_TXN_AUTOCOMMIT 0x00000001u
#define WT_TXN_ERROR 0x00000002u
#define WT_TXN_HAS_ID 0x00000004u
#define WT_TXN_HAS_SNAPSHOT 0x00000008u
#define WT_TXN_HAS_TS_COMMIT 0x00000010u
#define WT_TXN_HAS_TS_DURABLE 0x00000020u
#define WT_TXN_HAS_TS_PREPARE 0x00000040u
#define WT_TXN_IGNORE_PREPARE 0x00000080u
#define WT_TXN_PREPARE 0x00000100u
#define WT_TXN_READONLY 0x00000200u
#define WT_TXN_RUNNING 0x00000400u
#define WT_TXN_SHARED_TS_DURABLE 0x00000800u
#define WT_TXN_SHARED_TS_READ 0x00001000u
#define WT_TXN_SYNC_SET 0x00002000u
#define WT_TXN_TS_COMMIT_ALWAYS 0x00004000u
#define WT_TXN_TS_COMMIT_KEY_CONSISTENT 0x00008000u
#define WT_TXN_TS_COMMIT_MIXED_MODE 0x00010000u
#define WT_TXN_TS_COMMIT_NEVER 0x00020000u
#define WT_TXN_TS_COMMIT_ORDERED 0x00040000u
#define WT_TXN_TS_DURABLE_ALWAYS 0x00080000u
#define WT_TXN_TS_DURABLE_KEY_CONSISTENT 0x00100000u
#define WT_TXN_TS_DURABLE_MIXED_MODE 0x00200000u
#define WT_TXN_TS_DURABLE_NEVER 0x00400000u
#define WT_TXN_TS_DURABLE_ORDERED 0x00800000u
#define WT_TXN_TS_READ_BEFORE_OLDEST 0x01000000u
#define WT_TXN_TS_ROUND_PREPARED 0x02000000u
#define WT_TXN_TS_ROUND_READ 0x04000000u
#define WT_TXN_UPDATE 0x08000000u
#define WT_TXN_VERB_TS_COMMIT 0x10000000u
    /* AUTOMATIC FLAG VALUE GENERATION STOP */
    uint32_t flags;
