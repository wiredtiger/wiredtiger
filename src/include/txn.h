...
#define WT_TXN_READONLY 0x0000200u
#define WT_TXN_RUNNING 0x0000400u
#define WT_TXN_SHARED_TS_DURABLE 0x0000800u
#define WT_TXN_SHARED_TS_READ 0x0001000u
#define WT_TXN_SYNC_SET 0x0002000u
#define WT_TXN_TS_COMMIT_ALWAYS 0x0004000u
#define WT_TXN_TS_COMMIT_KEYS 0x0008000u
#define WT_TXN_TS_COMMIT_NEVER 0x0010000u
#define WT_TXN_TS_DURABLE_ALWAYS 0x0020000u
#define WT_TXN_TS_DURABLE_KEYS 0x0040000u
#define WT_TXN_TS_DURABLE_MIXED 0x0080000u
#define WT_TXN_TS_DURABLE_NEVER 0x0100000u
#define WT_TXN_TS_READ_BEFORE_OLDEST 0x0200000u
