 ...
 */
#define	WT_CONFIG_ENTRY_async_conn_close		 0
#define	WT_CONFIG_ENTRY_async_conn_open_data_source	 1
#define	WT_CONFIG_ENTRY_colgroup_meta			 2
#define	WT_CONFIG_ENTRY_connection_add_collator		 3
#define	WT_CONFIG_ENTRY_connection_add_compressor	 4
#define	WT_CONFIG_ENTRY_connection_add_data_source	 5
#define	WT_CONFIG_ENTRY_connection_add_extractor	 6
...
#define	WT_CONFIG_ENTRY_wiredtiger_async_open		31
