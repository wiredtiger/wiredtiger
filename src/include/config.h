...
#define WT_CONFIG_ENTRY_WT_SESSION_reset_snapshot 32
...
#define WT_CONFIG_ENTRY_WT_SESSION_timestamp_transaction_uint 37
...
extern const char __WT_CONFIG_CHOICE_block_ext[];
