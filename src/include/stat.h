...
struct __wt_connection_stats {
	...
	int64_t perf_hist_readfs_latency_lt50;
	int64_t perf_hist_readfs_latency_lt250;
	int64_t perf_hist_readfs_latency_gt1000;
	int64_t perf_hist_readfs_latency_lt500;
	int64_t perf_hist_readfs_latency_lt100;
	int64_t perf_hist_readfs_latency_lt1000;
	int64_t perf_hist_writefs_latency_lt50;
	int64_t perf_hist_writefs_latency_lt250;
	int64_t perf_hist_writefs_latency_gt1000;
	int64_t perf_hist_writefs_latency_lt500;
	int64_t perf_hist_writefs_latency_lt100;
	int64_t perf_hist_writefs_latency_lt1000;
	int64_t perf_hist_readop_latency_lt250;
	int64_t perf_hist_readop_latency_lt10000;
	int64_t perf_hist_readop_latency_gt10000;
	int64_t perf_hist_readop_latency_lt500;
	int64_t perf_hist_readop_latency_lt1000;
	int64_t perf_hist_writeop_latency_lt250;
	int64_t perf_hist_writeop_latency_lt10000;
	int64_t perf_hist_writeop_latency_gt10000;
	int64_t perf_hist_writeop_latency_lt500;
	int64_t perf_hist_writeop_latency_lt1000;
