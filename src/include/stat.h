...
struct __wt_connection_stats {
    ...
    int64_t rec_time_pages_prepared;
    int64_t rec_time_pages_durable_start_ts;
    int64_t rec_time_pages_start_ts;
    int64_t rec_time_pages_start_txn;
    int64_t rec_time_pages_durable_stop_ts;
    int64_t rec_time_pages_stop_ts;
    int64_t rec_time_pages_stop_txn;
    int64_t rec_time_prepared;
    int64_t rec_time_durable_start_ts;
    int64_t rec_time_start_ts;
    int64_t rec_time_start_txn;
    int64_t rec_time_durable_stop_ts;
    int64_t rec_time_stop_ts;
    int64_t rec_time_stop_txn;
