...
struct __wt_connection_stats {
    ...
    int64_t cache_eviction_dont_evict_dirty_during_cp;
    int64_t cache_eviction_try_dirty_during_cp;
    int64_t cache_eviction_try_dont_want_page;
    int64_t cache_eviction_try_evict;
    int64_t cache_eviction_cant_evict;
    int64_t cache_eviction_dirty_pages_seen;
    int64_t cache_eviction_dirty_pages_walked;
    int64_t cache_eviction_dont_evict_internal;
    int64_t cache_eviction_dont_evict_internal_last_parent;
    int64_t cache_eviction_dont_want_page;
    int64_t cache_eviction_evict_clean;
    int64_t cache_eviction_evict_dirty;
    int64_t cache_eviction_evict_updates;
    int64_t cache_eviction_heuristic_skip;
