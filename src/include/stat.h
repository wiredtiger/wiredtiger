...
struct __wt_connection_stats {
    ...
    int64_t rec_time_window_pages_start_durable_ts;
    int64_t rec_time_window_pages_start_prepare_ts;
    int64_t rec_time_window_pages_start_prepared_id;
    int64_t rec_time_window_pages_start_txn;
    int64_t rec_time_window_pages_stop_commit_ts;
    int64_t rec_time_window_pages_stop_durable_ts;
    int64_t rec_time_window_pages_stop_prepare_ts;
    int64_t rec_time_window_pages_stop_prepared_id;
    ...
    int64_t rec_time_window_start_commit_ts;
    int64_t rec_time_window_start_durable_ts;
    int64_t rec_time_window_start_prepare_ts;
    int64_t rec_time_window_start_prepared_id;
    int64_t rec_time_window_start_txn;
    int64_t rec_time_window_stop_commit_ts;
    int64_t rec_time_window_stop_durable_ts;
    int64_t rec_time_window_stop_prepare_ts;
    int64_t rec_time_window_stop_prepared_id;
