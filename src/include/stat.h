...
struct __wt_dsrc_stats {
    ...
    int64_t compress_read_hist_ratio_max;
    int64_t compress_read_hist_ratio_16;
    int64_t compress_read_hist_ratio_2;
    int64_t compress_read_hist_ratio_32;
    int64_t compress_read_hist_ratio_4;
    int64_t compress_read_hist_ratio_64;
    int64_t compress_read_hist_ratio_8;
    int64_t compress_write_hist_ratio_max;
    int64_t compress_write_hist_ratio_16;
    int64_t compress_write_hist_ratio_2;
    int64_t compress_write_hist_ratio_32;
    int64_t compress_write_hist_ratio_4;
    int64_t compress_write_hist_ratio_64;
    int64_t compress_write_hist_ratio_8;
