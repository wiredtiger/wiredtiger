...
struct __wt_connection_stats {
    ...
    int64_t hs_write_addr_newest_start_durable_ts;
    int64_t hs_write_addr_newest_stop_durable_ts;
    int64_t hs_write_addr_newest_stop_ts;
    int64_t hs_write_addr_newest_stop_txn;
    int64_t hs_write_addr_oldest_start_ts;
    int64_t hs_write_addr_oldest_start_txn;
    int64_t hs_write_addr_prepared;
    int64_t hs_write_pages_prepared;
    int64_t hs_write_pages_durable_start_ts;
    int64_t hs_write_pages_start_ts;
    int64_t hs_write_pages_start_txn;
    int64_t hs_write_pages_durable_stop_ts;
    int64_t hs_write_pages_stop_ts;
    int64_t hs_write_pages_stop_txn;
    int64_t hs_write_rec_prepared;
    int64_t hs_write_rec_durable_start_ts;
    int64_t hs_write_rec_start_ts;
    int64_t hs_write_rec_start_txn;
    int64_t hs_write_rec_durable_stop_ts;
    int64_t hs_write_rec_stop_ts;
    int64_t hs_write_rec_stop_txn;
