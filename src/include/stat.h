...
struct __wt_connection_stats {
    ...
    int64_t cache_eviction_dirty_index_drain_skipped_filter_heavy;
    int64_t cache_eviction_dirty_index_drain_skipped_disagg_checkpointed;
    int64_t cache_eviction_dirty_index_drain_skipped_stable_unchanged;
    int64_t cache_eviction_dirty_index_drain_skipped_checkpoint;
    int64_t cache_eviction_dirty_index_drain_skipped_clean_pressure;
    ...
    int64_t cache_eviction_dirty_index_trim_reinserted;
    int64_t cache_eviction_dirty_index_drain_reinserted;
    int64_t cache_eviction_dirty_index_drain_filtered;
    int64_t cache_eviction_dirty_index_drain_hazard;
    ...
    int64_t eviction_walk_skipped_drain_filled;
