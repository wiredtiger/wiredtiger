...
struct __wt_connection_stats {
    ...
    int64_t app_evict_refused_in_memory;
    int64_t app_evict_refused_incremental_score;
    int64_t app_evict_refused_prefetch;
    int64_t app_evict_refused_server_not_running;
    int64_t app_evict_refused_no_reconcile;
    ...
    int64_t app_evict_worker_exit_user_not_ok;
    int64_t app_evict_worker_evict_attempt;
    int64_t app_evict_worker_evict_busy;
    int64_t app_evict_worker_evict_hard_error;
    ...
    int64_t eviction_skip_empty_subqueue;
    ...
    int64_t eviction_force_nokeep_in_read;
    ...
    int64_t eviction_pages_unqueued_out_of_memory;
    int64_t cache_read;
