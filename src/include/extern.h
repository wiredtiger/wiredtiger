...
extern int __wt_hs_create(WT_SESSION_IMPL *session, const char **cfg)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_hs_cursor(WT_SESSION_IMPL *session, uint64_t *session_flags, bool *is_owner)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_hs_cursor_close(WT_SESSION_IMPL *session, uint64_t session_flags, bool is_owner)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_open_internal_session(WT_CONNECTION_IMPL *conn, const char *name,
  bool open_metadata, uint64_t session_flags, WT_SESSION_IMPL **sessionp)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
