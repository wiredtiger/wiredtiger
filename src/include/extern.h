...
extern int __wt_schema_create(WT_SESSION_IMPL *session, const char *uri, const char *config)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_schema_create_layered_stable(WT_SESSION_IMPL *session, const char *uri,
  const char *cfg1, const char *cfg2) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
