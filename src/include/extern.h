...
extern int __wt_config_next(WT_CONFIG *conf, WT_CONFIG_ITEM *key, WT_CONFIG_ITEM *value)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_config_overlay(WT_SESSION_IMPL *session, const char *base, const char **overlay,
  char **config_ret) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
