...
extern int __wt_desc_read(WT_SESSION_IMPL *session, WT_FH *fh, uint32_t allocsize, const char *filename, char **metadatap) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
