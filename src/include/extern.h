...
extern int __wt_rec_bulk_init(WT_SESSION_IMPL *session, WT_CURSOR_BULK *cbulk);
extern int __wt_rec_bulk_wrapup(WT_SESSION_IMPL *session, WT_CURSOR_BULK *cbulk);
extern int __wt_rec_bulk_insert_row(WT_SESSION_IMPL *session, WT_CURSOR_BULK *cbulk);
extern int __wt_rec_bulk_insert_fix(WT_SESSION_IMPL *session, WT_CURSOR_BULK *cbulk);
extern int __wt_rec_bulk_insert_var(WT_SESSION_IMPL *session, WT_CURSOR_BULK *cbulk);
extern int __wt_rec_cell_build_int_key(WT_SESSION_IMPL *session, WT_RECONCILE *r, const void *data, size_t size, bool *is_ovflp);
extern int __wt_rec_cell_build_leaf_key(WT_SESSION_IMPL *session, WT_RECONCILE *r, const void *data, size_t size, bool *is_ovflp);
extern void __wt_rec_cell_build_addr(WT_SESSION_IMPL *session, WT_RECONCILE *r, const void *addr, size_t size, u_int cell_type, uint64_t recno);
extern int __wt_rec_cell_build_val(WT_SESSION_IMPL *session, WT_RECONCILE *r, const void *data, size_t size, uint64_t rle);
extern int __wt_rec_col_int(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_PAGE *page);
extern int __wt_rec_col_fix(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_PAGE *page);
extern int __wt_rec_col_fix_slvg(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_PAGE *page, WT_SALVAGE_COOKIE *salvage);
extern int __wt_rec_col_var(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_PAGE *page, WT_SALVAGE_COOKIE *salvage);
extern int __wt_rec_col_split(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_PAGE *page);
extern int __wt_rec_dictionary_replace( WT_SESSION_IMPL *session, WT_RECONCILE *r, uint64_t rle, WT_KV *val);
...
extern uint32_t __wt_rec_split_page_size(WT_BTREE *btree, uint32_t maxpagesize);
extern int __wt_rec_split_init(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_PAGE *page, uint64_t recno, uint32_t max);
extern int __wt_rec_split(WT_SESSION_IMPL *session, WT_RECONCILE *r, size_t next_len);
extern int __wt_rec_split_raw(WT_SESSION_IMPL *session, WT_RECONCILE *r, size_t next_len);
extern int __wt_rec_split_finish(WT_SESSION_IMPL *session, WT_RECONCILE *r);
extern int __wt_rec_split_discard(WT_SESSION_IMPL *session, WT_PAGE *page);
...
extern int __wt_rec_write_status(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_PAGE *page);
extern int __wt_rec_write_init(WT_SESSION_IMPL *session, WT_REF *ref, uint32_t flags, WT_SALVAGE_COOKIE *salvage, void *reconcilep);
extern void __wt_rec_destroy(WT_SESSION_IMPL *session, void *reconcilep);
extern int __wt_rec_block_free( WT_SESSION_IMPL *session, const uint8_t *addr, size_t addr_size);
extern int __wt_rec_update_move( WT_SESSION_IMPL *session, WT_BOUNDARY *bnd, WT_SAVE_UPD *supd);
extern int __wt_rec_txn_read(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_INSERT *ins, WT_ROW *rip, WT_CELL_UNPACK *vpack, WT_UPDATE **updp);
extern int __wt_rec_child_modify(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_REF *ref, bool *hazardp, WT_CHILD_STATE *statep);
extern void __wt_rec_incr( WT_SESSION_IMPL *session, WT_RECONCILE *r, uint32_t v, size_t size);
extern void __wt_rec_copy_incr(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_KV *kv);
extern uint32_t __wt_rec_leaf_page_max(WT_SESSION_IMPL *session, WT_RECONCILE *r);
extern bool __wt_rec_is_checkpoint( WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_BOUNDARY *bnd);
extern int __wt_rec_raw_decompress( WT_SESSION_IMPL *session, const void *image, size_t size, void *retp);
extern int __wt_rec_update_las(WT_SESSION_IMPL *session, WT_RECONCILE *r, uint32_t btree_id, WT_BOUNDARY *bnd);
extern u_int __wt_rec_vtype(WT_ADDR *addr);
extern int __wt_rec_write_wrapup(WT_SESSION_IMPL *session, WT_RECONCILE *r, WT_PAGE *page);
