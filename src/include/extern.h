...
extern int __wt_recovery_compressor_config(WT_SESSION_IMPL *session, WT_CONFIG_ITEM *cval, WT_COMPRESSOR *compressor, WT_COMPRESSOR **recovery_compressorp) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
