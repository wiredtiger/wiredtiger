...
static inline size_t __wt_cell_pack_addr(WT_SESSION_IMPL *session, WT_CELL *cell, u_int cell_type,
  ...
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static inline size_t __wt_cell_pack_copy(WT_SESSION_IMPL *session, WT_REC_CELL_STATS *cell_stats,
  WT_CELL *cell, WT_TIME_WINDOW *tw, uint64_t rle, uint64_t v)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static inline size_t __wt_cell_pack_del(WT_SESSION_IMPL *session, WT_REC_CELL_STATS *cell_stats,
  WT_CELL *cell, WT_TIME_WINDOW *tw, uint64_t rle) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
static inline size_t __wt_cell_pack_leaf_key(WT_CELL *cell, uint8_t prefix, size_t size)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static inline size_t __wt_cell_pack_ovfl(WT_SESSION_IMPL *session, WT_REC_CELL_STATS *cell_stats,
  WT_CELL *cell, uint8_t type, WT_TIME_WINDOW *tw, uint64_t rle, size_t size)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static inline size_t __wt_cell_pack_value(WT_SESSION_IMPL *session, WT_REC_CELL_STATS *cell_stats,
  WT_CELL *cell, WT_TIME_WINDOW *tw, uint64_t rle, size_t size)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
