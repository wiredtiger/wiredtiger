...
extern int __wt_cache_dump(WT_SESSION_IMPL *session, WT_FSTREAM *fs) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result)) WT_GCC_FUNC_DECL_ATTRIBUTE((visibility("hidden")));
