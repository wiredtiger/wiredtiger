...
extern int __wt_lsm_meta_alter(WT_SESSION_IMPL *session, WT_LSM_TREE *lsm_tree, const char *newcfg[]) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result)) WT_GCC_FUNC_DECL_ATTRIBUTE((visibility("hidden")));
