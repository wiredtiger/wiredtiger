...
extern int __wti_txn_log_commit(WT_SESSION_IMPL *session)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wti_txn_prepare_rollback_delete_key(WT_SESSION_IMPL *session, WT_BTREE *btree,
  WT_CURSOR_BTREE *cbt) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wti_txn_prepare_rollback_restore_hs_update(
...
extern void __wti_txn_resolve_prepared_update_chain(
