...
extern int __wt_page_custom_alloc_row_leaf(WT_SESSION_IMPL *session, uint32_t entries,
...
extern int __wt_unexpected_object_type(
  ...
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_upd_custom_alloc_row_leaf(WT_SESSION_IMPL *session, WT_PAGE *page, size_t allocsz,
...
extern void __wt_page_custom_free_row_leaf(WT_SESSION_IMPL *session, WT_PAGE *page);
...
static inline int __wt_txn_search_check(WT_SESSION_IMPL *session)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static inline int __wt_upd_alloc(WT_SESSION_IMPL *session, WT_PAGE *page, const WT_ITEM *value,
  u_int modify_type, WT_UPDATE **updp, size_t *sizep)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static inline int __wt_upd_alloc_tombstone(WT_SESSION_IMPL *session, WT_PAGE *page,
