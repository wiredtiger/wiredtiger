...
extern int __wt_cursor_set_valuev(WT_CURSOR *cursor, va_list ap)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_cursor_valid(WT_CURSOR_BTREE *cbt, WT_ITEM *key, uint64_t recno,
  WT_UPDATE_VIEW *upd_viewp, bool *valid) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_find_hs_upd(WT_SESSION_IMPL *session, WT_ITEM *key, uint64_t recno,
  WT_UPDATE_VIEW *upd_view, bool allow_prepare, WT_ITEM *on_disk_buf)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_modify_reconstruct_from_upd_list(WT_SESSION_IMPL *session, WT_CURSOR_BTREE *cbt,
  WT_UPDATE *upd, WT_UPDATE_VIEW *upd_view) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_upgrade(WT_SESSION_IMPL *session, const char *cfg[])
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_value_return(WT_CURSOR_BTREE *cbt, WT_UPDATE_VIEW *upd_view)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern void __wt_value_return_upd(WT_CURSOR_BTREE *cbt, WT_UPDATE_VIEW *upd_view);
...
static inline bool __wt_txn_upd_view_visible_all(WT_SESSION_IMPL *session, WT_UPDATE_VIEW *upd_view)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
static inline int __wt_txn_read(WT_SESSION_IMPL *session, WT_CURSOR_BTREE *cbt, WT_ITEM *key,
  uint64_t recno, WT_UPDATE *upd, WT_CELL_UNPACK *vpack, WT_UPDATE_VIEW *upd_view)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
static inline void __wt_upd_view_free(WT_SESSION_IMPL *session, WT_UPDATE_VIEW *upd_view);
