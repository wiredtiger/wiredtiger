...
extern int __wt_random_descent(WT_SESSION_IMPL *session, WT_REF **refp, bool eviction, uint32_t additional_flags) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
