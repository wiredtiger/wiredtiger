...
extern int __wt_txn_parse_timestamp(WT_SESSION_IMPL *session, const char *name, void *timestamp, WT_CONFIG_ITEM *cval) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
