...
extern void __wt_timestamp_to_hex_string(char *hex_timestamp, uint64_t ts);
extern void __wt_verbose_timestamp(WT_SESSION_IMPL *session, const uint64_t ts, const char *msg);
extern int __wt_txn_parse_timestamp_raw(WT_SESSION_IMPL *session, const char *name, uint64_t *timestamp, WT_CONFIG_ITEM *cval) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_txn_parse_timestamp(WT_SESSION_IMPL *session, const char *name, uint64_t *timestamp, WT_CONFIG_ITEM *cval) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_timestamp_validate(WT_SESSION_IMPL *session, const char *name, uint64_t ts, WT_CONFIG_ITEM *cval) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_txn_set_timestamp(WT_SESSION_IMPL *session, const char *cfg[]) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_txn_parse_prepare_timestamp(WT_SESSION_IMPL *session, const char *cfg[], uint64_t *timestamp) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
