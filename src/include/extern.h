...
extern int __wt_log_set_version(WT_SESSION_IMPL *session, uint16_t major, uint16_t minor, uint32_t first_rec, bool downgrade, bool live_chg, uint32_t *lognump) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
