...
extern bool __wt_checksum_alt_match(const void *chunk, size_t len, uint32_t v)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern bool __wt_col_fix_get_time_window(WT_SESSION_IMPL *session, WT_REF *ref, uint64_t recno,
...
extern int __wt_blkcache_map_read(WT_BM *bm, WT_SESSION_IMPL *session, WT_ITEM *buf,
  const uint8_t *addr, size_t addr_size, bool *foundp)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_curfile_open(WT_SESSION_IMPL *session, const char *uri, WT_CURSOR *owner,
  const char *cfg[], WT_CURSOR **cursorp) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_curhs_cache(WT_SESSION_IMPL *session, WT_CURSOR *owner)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_cursor_get_value_notsup(WT_CURSOR *cursor, ...)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_cursor_get_valuev(WT_CURSOR *cursor, const char *fmt, va_list ap)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
