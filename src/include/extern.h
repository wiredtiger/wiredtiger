...
static inline int __wt_txn_modify_page_delete(WT_SESSION_IMPL *session, WT_REF *ref)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static inline int __wt_txn_op_delete_apply_prepare_state(WT_SESSION_IMPL *session, WT_REF *ref,
...
static inline int __wt_upd_value_assign(WT_SESSION_IMPL *session, WT_UPDATE_VALUE *upd_value,
  WT_UPDATE *upd) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
