...
extern int __wt_btcur_prev(WT_CURSOR_BTREE *cbt, bool truncating)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_btcur_range_truncate(WT_CURSOR_BTREE *start, WT_CURSOR_BTREE *stop, WT_CURFILE_STATE_TMP *start_orig, WT_CURFILE_STATE_TMP *stop_orig)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_schema_project_slice(WT_SESSION_IMPL *session, WT_CURSOR **cp, const char *proj_arg,
  ...
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_schema_range_truncate(WT_SESSION_IMPL *session, WT_CURSOR *start, WT_CURSOR *stop, WT_CURFILE_STATE_TMP *start_orig, WT_CURFILE_STATE_TMP *stop_orig)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_txn_truncate_log(WT_SESSION_IMPL *session, WT_CURFILE_STATE_TMP *start,
  WT_CURFILE_STATE_TMP *stop) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
