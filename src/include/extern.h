...
extern void __wt_random_init(WT_RAND_STATE volatile *rnd_state)
  WT_GCC_FUNC_DECL_ATTRIBUTE((visibility("default")));
extern void __wt_random_init_custom_seed(WT_RAND_STATE volatile *rnd_state, uint64_t v, uint32_t w,
  uint32_t z) WT_GCC_FUNC_DECL_ATTRIBUTE((visibility("default")));
