...
extern int __wt_modify_vector_push(WT_MODIFY_VECTOR *modifies, WT_UPDATE *upd,
  wt_timestamp_t adjusted_ts) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern void __wt_modify_vector_peek(
  WT_MODIFY_VECTOR *modifies, WT_UPDATE **updp, wt_timestamp_t *adjusted_tsp);
extern void __wt_modify_vector_pop(
  WT_MODIFY_VECTOR *modifies, WT_UPDATE **updp, wt_timestamp_t *adjusted_tsp);
