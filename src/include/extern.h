...
static inline double __wt_eviction_dirty_target(WT_CACHE *cache)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static inline int __wt_bounds_early_exit(WT_SESSION_IMPL *session, WT_CURSOR_BTREE *cbt,
...
static inline int __wt_btcur_bounds_row_position(WT_SESSION_IMPL *session, WT_CURSOR_BTREE *cbt,
  bool direction, bool *need_walk) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
