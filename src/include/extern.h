...
extern int __wt_page_release_evict( WT_SESSION_IMPL *session, WT_REF *ref, bool checkpointing) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_evict( WT_SESSION_IMPL *session, WT_REF *ref, bool checkpointing, bool closing) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
