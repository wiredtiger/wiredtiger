...
extern int __wt_table_colgroups_config(WT_SESSION_IMPL *session, const char *cfg[], int *ncolgrp) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result)) WT_GCC_FUNC_DECL_ATTRIBUTE((visibility("hidden")));
