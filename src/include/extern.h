...
extern void __wt_capacity_signal(WT_SESSION_IMPL *session);
...
extern int __wt_fsync_all_background(WT_SESSION_IMPL *session) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
