...
extern WT_CONTROL_POINT_DATA *__wt_control_point_pair_init_pointer_match_wait_for_trigger(
  WT_SESSION_IMPL *session, const char *cp_config_name, const char **cfg)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern bool __wt_config_get_choice(const char **choices, WT_CONFIG_ITEM *item)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern bool __wt_control_point_pred_pointer_match(
...
extern int __wt_control_point_config_action_wait_for_trigger(
  ...
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_control_point_config_pred_pointer_match(WT_SESSION_IMPL *session,
