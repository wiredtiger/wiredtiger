...
extern int __wt_cond_auto_init(WT_SESSION_IMPL *session, const char *name, uint64_t min, uint64_t max, WT_CONDVAR *cond) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
