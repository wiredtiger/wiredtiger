...
extern int __wt_layered_create_ingest_file(WT_SESSION_IMPL *session, WT_CURSOR *md_cursor,
  const char *uri, const char *layered_cfg) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
