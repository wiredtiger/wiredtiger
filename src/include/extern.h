...
extern int __wt_block_manager_create(WT_SESSION_IMPL *session, const char *filename, WT_CONFIG_ITEM *advise, uint32_t allocsize) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
