...
extern int __wt_timestamp_validate(WT_SESSION_IMPL *session, const char *name, wt_timestamp_t *ts, WT_CONFIG_ITEM *cval, bool cmp_oldest, bool cmp_stable, bool cmp_commit, bool cmp_prepare) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
