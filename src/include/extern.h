...
static inline bool __wt_session_can_wait(WT_SESSION_IMPL *session)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static inline bool __wt_spin_owns(WT_SESSION_IMPL *session, WT_SPINLOCK *t)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
static inline void __wt_spin_unlock_if_owns(WT_SESSION_IMPL *session, WT_SPINLOCK *t);
