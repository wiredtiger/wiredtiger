...
extern int __wt_evict_worker_run(WT_SESSION_IMPL *session, WT_WORKER_THREAD *worker) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_util_thread_group_resize( WT_SESSION_IMPL *session, WT_WORKER_THREAD_GROUP *group, uint32_t new_min, uint32_t new_max, uint32_t flags) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
