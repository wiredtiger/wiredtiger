...
extern int __wt_txn_truncate_log(WT_SESSION_IMPL *session, bool local_start,
  WT_ITEM *orig_start_key, WT_ITEM *orig_stop_key) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
