...
extern int __wt_session_op_tracker_create_entry( WT_SESSION_IMPL *session, uint32_t type, WT_OP_TRACKER_ENTRY **entryp);
...
extern int __wt_session_op_tracker_dump(WT_SESSION_IMPL *session, uint64_t min_time);
