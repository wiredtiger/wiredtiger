...
static WT_INLINE int __wt_txn_stepdown_straddler_check(WT_SESSION_IMPL *session, bool is_writer,
  wt_timestamp_t stepdown_ts) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
static WT_INLINE int __wt_txn_stepdown_straddler_check_state(WT_SESSION_IMPL *session,
  bool is_writer, wt_timestamp_t stepdown_ts, bool unmirrored_stable, bool wrote_ingest)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
