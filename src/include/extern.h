...
extern int __wt_txn_commit_timestamp_validate(WT_SESSION_IMPL *session, const char *name, wt_timestamp_t ts, WT_CONFIG_ITEM *cval, bool durable_ts, bool round_to_prepare) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
