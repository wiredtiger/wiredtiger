...
extern int __wt_txn_query_timestamp(WT_SESSION_IMPL *session, wt_timestamp_t *ts, const char *cfg[], bool global_txn) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_txn_query_timestamp_hex_str(WT_SESSION_IMPL *session, char *hex_timestamp, const char *cfg[], bool global_txn) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_txn_set_timestamp_numeric(WT_SESSION_IMPL *session, wt_timestamp_t timestamp, const char *cfg[]) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
