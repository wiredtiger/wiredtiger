...
extern int __wt_posix_directory_list( WT_FILE_SYSTEM *file_system, WT_SESSION *wt_session, const char *dir, const char *prefix, uint32_t flags, char ***dirlist, u_int *countp);
...
extern int __wt_win_directory_list( WT_FILE_SYSTEM *file_system, WT_SESSION *wt_session, const char *dir, const char *prefix, uint32_t flags, char ***dirlist, u_int *countp);
