...
extern int __wt_inmem_unsupported_op(WT_SESSION_IMPL *session, const char *op) WT_GCC_FUNC_DECL_ATTRIBUTE((cold)) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
