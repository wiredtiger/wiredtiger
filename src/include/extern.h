...
extern int __wti_btree_tree_open(WT_SESSION_IMPL *session, const uint8_t *addr, size_t addr_size)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wti_build_full_disk_image_on_read(WT_SESSION_IMPL *session, WT_REF *ref,
  WT_PAGE_HEADER *base_dsk, WT_ITEM *deltas, size_t delta_size, WT_ITEM *new_image)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
