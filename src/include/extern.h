...
extern int __wt_bloom_hash_get(WT_BLOOM *bloom, WT_BLOOM_HASH *bhash)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_bloom_inmem_get(
  WT_BLOOM *bloom, WT_ITEM *key) /* Not Used */ WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_bloom_intersection(
  WT_BLOOM *bloom, WT_BLOOM *other) /* Not Used */ WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
