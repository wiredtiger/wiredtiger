...
static WT_INLINE void __wt_cell_unpack_delta_int_key(WT_SESSION_IMPL *session,
  const WT_PAGE_HEADER *page_dsk, const WT_PAGE_HEADER *dsk, WT_CELL *cell,
  WT_CELL_UNPACK_DELTA_INT *unpack_delta);
static WT_INLINE void __wt_cell_unpack_delta_int_value(WT_SESSION_IMPL *session,
  const WT_PAGE_HEADER *page_dsk, const WT_PAGE_HEADER *dsk, WT_CELL *cell,
  WT_CELL_UNPACK_DELTA_INT *unpack_delta);
