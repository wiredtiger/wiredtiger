...
extern void __wt_qsort(void *a, size_t n, size_t es, int (*compar)(const void *, const void *));
extern void __wt_qsort_r(
  void *a, size_t n, size_t es, int (*compar)(const void *, const void *, void *), void *context);
