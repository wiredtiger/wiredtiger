...
extern int __wt_config_next_unescape(WT_CONFIG *conf, WT_CONFIG_ITEM *key, WT_CONFIG_ITEM *value, char **punescaped) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_config_subgetraw(WT_SESSION_IMPL *session, WT_CONFIG_ITEM *cfg, WT_CONFIG_ITEM *key, WT_CONFIG_ITEM *value, char **punescaped) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_config_subgets_unescape(WT_SESSION_IMPL *session, WT_CONFIG_ITEM *cfg, const char *key, WT_CONFIG_ITEM *value, char **punescaped) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_config_unescape(WT_SESSION_IMPL *session, WT_CONFIG_ITEM *value, void *retp) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
