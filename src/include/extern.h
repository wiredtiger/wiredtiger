...
extern int __wt_stat_session_op_desc(WT_CURSOR_STAT *cst, int slot, const char **p) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern void __wt_stat_session_op_init_single(WT_SESSION_OP_STATS *stats);
extern void __wt_stat_session_op_clear_single(WT_SESSION_OP_STATS *stats);
