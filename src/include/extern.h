...
extern int __wt_cursor_next_raw_n_notsup(WT_CURSOR *cursor, size_t n, WT_ITEM **keys,
  WT_ITEM **values, size_t *n_ret) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern int __wt_cursor_prev_raw_n_notsup(WT_CURSOR *cursor, size_t n, WT_ITEM **keys,
  WT_ITEM **values, size_t *n_ret) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
