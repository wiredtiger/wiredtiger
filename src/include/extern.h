...
extern int __wt_update_alloc(WT_SESSION_IMPL *session, const WT_ITEM *value, WT_UPDATE **updp, size_t *sizep, u_int modify_type, u_int prepare_state) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
