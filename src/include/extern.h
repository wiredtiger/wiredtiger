...
extern int __wt_posix_directory_list( WT_FILE_SYSTEM *file_system, WT_SESSION *wtsession, const char *dir, const char *prefix, uint32_t flags, char ***dirlist, u_int *countp);
extern int __wt_posix_file_allocate( WT_FILE_HANDLE *fh, WT_SESSION *wtsession, wt_off_t offset, wt_off_t len);
extern int __wt_posix_map(WT_FILE_HANDLE *fh, WT_SESSION *wtsession, void *mapp, size_t *lenp, void **mappingcookie);
extern int __wt_posix_map_discard( WT_FILE_HANDLE *fh, WT_SESSION *wtsession, void *p, size_t size);
extern int __wt_posix_map_preload( WT_FILE_HANDLE *fh, WT_SESSION *wtsession, const void *p, size_t size);
extern int __wt_posix_map_unmap(WT_FILE_HANDLE *fh, WT_SESSION *wtsession, void *map, size_t len, void **mappingcookie);
...
extern int __wt_win_directory_list( WT_FILE_SYSTEM *file_system, WT_SESSION *wtsession, const char *dir, const char *prefix, uint32_t flags, char ***dirlist, u_int *countp);
extern int __wt_win_map(WT_FILE_HANDLE *file_handle, WT_SESSION *wtsession, void *mapp, size_t *lenp, void **mappingcookie);
extern int __wt_win_map_discard( WT_FILE_HANDLE *file_handle, WT_SESSION *wtsession, void *p, size_t size);
extern int __wt_win_map_preload(WT_FILE_HANDLE *file_handle, WT_SESSION *wtsession, const void *p, size_t size);
extern int __wt_win_map_unmap(WT_FILE_HANDLE *file_handle, WT_SESSION *wtsession, void *map, size_t len, void **mappingcookie);
