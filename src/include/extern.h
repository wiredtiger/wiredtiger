...
extern int __wt_layered_truncate(WT_TRUNCATE_INFO *trunc_info)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_layered_verify_gc_update(WT_SESSION_IMPL *session, WT_CURSOR_BTREE *cbt,
  WT_UPDATE *upd_to_prune) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
