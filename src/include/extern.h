...
extern int __wt_row_random_descent(WT_SESSION_IMPL *session, WT_REF **refp, bool mem_only) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result)) WT_GCC_FUNC_DECL_ATTRIBUTE((visibility("hidden")));
