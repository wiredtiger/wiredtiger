...
extern inline void __wt_stat_read_op_histogram(WT_SESSION_IMPL *session, uint64_t usecs);
extern inline void __wt_stat_write_op_histogram(WT_SESSION_IMPL *session, uint64_t usecs);
...
extern inline void __wt_stat_read_io_histogram(WT_SESSION_IMPL *session, uint64_t msecs);
extern inline void __wt_stat_write_io_histogram(WT_SESSION_IMPL *session, uint64_t msecs);
