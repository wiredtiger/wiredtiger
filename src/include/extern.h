...
extern int __wt_stat_operation_desc(WT_CURSOR_STAT *cst, int slot, const char **p) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern void __wt_stat_operation_init_single(WT_OPERATION_STATS *stats);
extern void __wt_stat_operation_clear_single(WT_OPERATION_STATS *stats);
