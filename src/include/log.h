...
/*
 * WiredTiger release version where log format version changed. FIXME WT-8681 - According to
 * WT_MIN_STARTUP_VERSION any WT version less then 3.2.0 will not start. Can we drop V2, V3 here?
 */
