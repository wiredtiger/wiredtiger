...
typedef enum {
    ...
    WT_THROTTLE_LAYERED_TABLE_LOG, /* Layered table logging throttle */
...
struct __wt_capacity {
    ...
    uint64_t layered_table_log; /* Bytes/sec layered table logging capacity */
    ...
    wt_shared uint64_t reservation_layered_table_log; /* Atomic: next layered table logging write */
