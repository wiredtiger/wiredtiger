  ...
  size_t *sizep)
{
    ...
    *updp = NULL;
    ...
    /*
     * If there is no value ensure that the memory allocation size is matches that
     * returned by sizeof(). Otherwise bit-exact tools like MSan may infer the structure is not
