...
WT_CONF_API_DECLARE(WT_SESSION, create, 8, 90);
...
WT_CONF_API_DECLARE(file, config, 5, 59);
WT_CONF_API_DECLARE(file, meta, 5, 66);
WT_CONF_API_DECLARE(index, meta, 2, 17);
WT_CONF_API_DECLARE(lsm, meta, 7, 78);
WT_CONF_API_DECLARE(object, meta, 5, 68);
WT_CONF_API_DECLARE(oligarch, meta, 2, 15);
WT_CONF_API_DECLARE(table, meta, 2, 13);
WT_CONF_API_DECLARE(tier, meta, 5, 69);
WT_CONF_API_DECLARE(tiered, meta, 5, 71);
