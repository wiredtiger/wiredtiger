...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 18, 108);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 22, 172);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 22, 173);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 22, 167);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 22, 166);
