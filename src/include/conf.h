...
WT_CONF_API_DECLARE(WT_SESSION, create, 10, 95);
...
WT_CONF_API_DECLARE(file, config, 7, 65);
WT_CONF_API_DECLARE(file, meta, 7, 72);
WT_CONF_API_DECLARE(index, meta, 2, 17);
WT_CONF_API_DECLARE(layered, meta, 3, 21);
WT_CONF_API_DECLARE(lsm, meta, 9, 84);
WT_CONF_API_DECLARE(object, meta, 7, 74);
WT_CONF_API_DECLARE(table, meta, 2, 13);
WT_CONF_API_DECLARE(tier, meta, 7, 75);
WT_CONF_API_DECLARE(tiered, meta, 7, 77);
