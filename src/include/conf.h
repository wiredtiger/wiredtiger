...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 20, 123);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 25, 194);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 25, 195);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 25, 189);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 25, 188);
