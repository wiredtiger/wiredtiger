...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 20, 133);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 26, 207);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 26, 208);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 26, 202);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 26, 201);
