...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 18, 101);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 22, 164);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 22, 165);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 22, 159);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 22, 158);
