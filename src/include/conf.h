...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 18, 106);
...
WT_CONF_API_DECLARE(WT_SESSION, create, 9, 92);
...
WT_CONF_API_DECLARE(file, config, 6, 62);
WT_CONF_API_DECLARE(file, meta, 6, 69);
WT_CONF_API_DECLARE(index, meta, 2, 17);
WT_CONF_API_DECLARE(layered, meta, 3, 21);
WT_CONF_API_DECLARE(lsm, meta, 8, 81);
WT_CONF_API_DECLARE(object, meta, 6, 71);
WT_CONF_API_DECLARE(table, meta, 2, 13);
WT_CONF_API_DECLARE(tier, meta, 6, 72);
WT_CONF_API_DECLARE(tiered, meta, 6, 74);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 22, 171);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 22, 172);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 22, 166);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 22, 165);
