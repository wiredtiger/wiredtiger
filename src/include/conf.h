...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 17, 100);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 21, 163);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 21, 164);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 21, 158);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 21, 157);
