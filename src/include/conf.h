...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 19, 102);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 23, 165);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 23, 166);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 23, 160);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 23, 159);
