...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 17, 96);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 21, 159);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 21, 160);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 21, 154);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 21, 153);
