...
WT_CONF_API_DECLARE(WT_SESSION, alter, 3, 18);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 23, 167);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 23, 168);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 23, 162);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 23, 161);
