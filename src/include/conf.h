...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 22, 168);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 22, 169);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 22, 163);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 22, 162);
