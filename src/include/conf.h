...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 20, 130);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 25, 201);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 25, 202);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 25, 196);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 25, 195);
