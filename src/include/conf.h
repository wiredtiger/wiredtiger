...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 21, 124);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 26, 195);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 26, 196);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 26, 190);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 26, 189);
