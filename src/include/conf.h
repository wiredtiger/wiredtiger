...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 19, 111);
...
WT_CONF_API_DECLARE(WT_CURSOR, reconfigure, 1, 4);
WT_CONF_API_DECLARE(WT_SESSION, alter, 4, 19);
WT_CONF_API_DECLARE(WT_SESSION, begin_transaction, 2, 12);
WT_CONF_API_DECLARE(WT_SESSION, checkpoint, 3, 12);
WT_CONF_API_DECLARE(WT_SESSION, commit_transaction, 1, 5);
WT_CONF_API_DECLARE(WT_SESSION, compact, 1, 6);
WT_CONF_API_DECLARE(WT_SESSION, create, 10, 94);
WT_CONF_API_DECLARE(WT_SESSION, drop, 1, 5);
WT_CONF_API_DECLARE(WT_SESSION, join, 1, 7);
WT_CONF_API_DECLARE(WT_SESSION, log_flush, 1, 2);
WT_CONF_API_DECLARE(WT_SESSION, open_cursor, 4, 34);
...
WT_CONF_API_DECLARE(file, config, 7, 64);
WT_CONF_API_DECLARE(file, meta, 7, 71);
WT_CONF_API_DECLARE(index, meta, 2, 17);
WT_CONF_API_DECLARE(layered, meta, 3, 21);
WT_CONF_API_DECLARE(lsm, meta, 9, 83);
WT_CONF_API_DECLARE(object, meta, 7, 73);
WT_CONF_API_DECLARE(table, meta, 2, 13);
WT_CONF_API_DECLARE(tier, meta, 7, 74);
WT_CONF_API_DECLARE(tiered, meta, 7, 76);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 24, 185);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 24, 186);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 24, 180);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 24, 179);
