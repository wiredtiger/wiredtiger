...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 17, 102);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 21, 165);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 21, 166);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 21, 160);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 21, 159);
