...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 18, 103);
...
WT_CONF_API_DECLARE(WT_SESSION, create, 8, 82);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 22, 166);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 22, 167);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 22, 161);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 22, 160);
