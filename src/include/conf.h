...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 26, 204);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 26, 205);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 26, 199);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 26, 198);
