...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 18, 99);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 22, 162);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 22, 163);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 22, 157);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 22, 156);
