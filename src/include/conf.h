...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 18, 104);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 22, 169);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 22, 170);
