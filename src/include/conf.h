...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 20, 121);
...
WT_CONF_API_DECLARE(layered, meta, 5, 30);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 25, 191);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 25, 192);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 25, 186);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 25, 185);
