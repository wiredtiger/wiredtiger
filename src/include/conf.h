...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 20, 132);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 26, 206);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 26, 207);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 26, 201);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 26, 200);
