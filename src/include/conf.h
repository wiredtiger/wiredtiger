...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 19, 120);
...
WT_CONF_API_DECLARE(layered, meta, 4, 29);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 24, 190);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 24, 191);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 24, 185);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 24, 184);
