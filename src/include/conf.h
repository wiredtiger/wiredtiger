...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 25, 181);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 25, 182);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 25, 176);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 25, 175);
