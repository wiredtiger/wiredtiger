...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 29, 182);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 29, 183);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 29, 177);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 29, 176);
