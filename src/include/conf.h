...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 19, 103);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 23, 166);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 23, 167);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 23, 161);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 23, 160);
