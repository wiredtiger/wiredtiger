...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 32, 187);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 32, 188);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 32, 182);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 32, 181);
