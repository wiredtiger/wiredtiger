...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 18, 98);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 22, 161);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 22, 162);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 22, 156);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 22, 155);
