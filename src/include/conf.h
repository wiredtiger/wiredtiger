...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 19, 112);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 24, 181);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 24, 182);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 24, 176);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 24, 175);
