...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 17, 95);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 21, 158);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 21, 159);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 21, 153);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 21, 152);
