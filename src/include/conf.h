...
WT_CONF_API_DECLARE(WT_SESSION, create, 9, 93);
...
WT_CONF_API_DECLARE(file, config, 6, 63);
WT_CONF_API_DECLARE(file, meta, 6, 70);
WT_CONF_API_DECLARE(index, meta, 2, 17);
WT_CONF_API_DECLARE(layered, meta, 3, 21);
WT_CONF_API_DECLARE(lsm, meta, 8, 82);
WT_CONF_API_DECLARE(object, meta, 6, 72);
WT_CONF_API_DECLARE(table, meta, 2, 13);
WT_CONF_API_DECLARE(tier, meta, 6, 73);
WT_CONF_API_DECLARE(tiered, meta, 6, 75);
