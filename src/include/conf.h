...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 21, 133);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 27, 207);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 27, 208);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 27, 202);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 27, 201);
