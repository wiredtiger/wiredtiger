...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 32, 185);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 32, 186);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 32, 180);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 32, 179);
