...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 23, 174);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 23, 175);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 23, 169);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 23, 168);
