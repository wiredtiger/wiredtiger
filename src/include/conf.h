...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 21, 121);
...
WT_CONF_API_DECLARE(layered, meta, 4, 23);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 26, 192);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 26, 193);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 26, 187);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 26, 186);
