...
typedef struct __wti_base_leaf_unpack_state WTI_BASE_LEAF_UNPACK_STATE;
...
typedef struct __wti_delta_leaf_unpack_state WTI_DELTA_LEAF_UNPACK_STATE;
struct __wti_disk_leaf_pack_state;
typedef struct __wti_disk_leaf_pack_state WTI_DISK_LEAF_PACK_STATE;
