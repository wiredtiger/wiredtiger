...
typedef struct __wt_block_pantry WT_BLOCK_PANTRY;
struct __wt_block_pantry_header;
typedef struct __wt_block_pantry_header WT_BLOCK_PANTRY_HEADER;
struct __wt_bloom;
...
typedef struct __wt_cell_unpack_delta WT_CELL_UNPACK_DELTA;
...
typedef struct __wt_delta_cell WT_DELTA_CELL;
