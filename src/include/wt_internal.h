...
typedef struct __wt_control_point_action_thread_barrier WT_CONTROL_POINT_ACTION_THREAD_BARRIER;
struct __wt_control_point_action_trigger;
typedef struct __wt_control_point_action_trigger WT_CONTROL_POINT_ACTION_TRIGGER;
...
typedef struct __wt_control_point_pair_data_thread_barrier
  WT_CONTROL_POINT_PAIR_DATA_THREAD_BARRIER;
struct __wt_control_point_pair_data_trigger;
typedef struct __wt_control_point_pair_data_trigger WT_CONTROL_POINT_PAIR_DATA_TRIGGER;
