...
typedef struct __wt_btree_randlru_data WT_BTREE_RANDLRU_DATA;
...
typedef struct __wt_evict_randlru_data WT_EVICT_RANDLRU_DATA;
...
typedef struct __wt_page_randlru_data WT_PAGE_RANDLRU_DATA;
...
typedef struct __wt_page_modify_randlru_data WT_PAGE_MODIFY_RANDLRU_DATA;
