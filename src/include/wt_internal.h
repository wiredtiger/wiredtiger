...
typedef struct __wt_conn_control_point_action_data_err WT_CONN_CONTROL_POINT_ACTION_DATA_ERR;
struct __wt_conn_control_point_action_data_ret;
typedef struct __wt_conn_control_point_action_data_ret WT_CONN_CONTROL_POINT_ACTION_DATA_RET;
struct __wt_conn_control_point_action_data_sleep;
typedef struct __wt_conn_control_point_action_data_sleep WT_CONN_CONTROL_POINT_ACTION_DATA_SLEEP;
struct __wt_conn_control_point_action_data_wait_for_trigger;
typedef struct __wt_conn_control_point_action_data_wait_for_trigger
  WT_CONN_CONTROL_POINT_ACTION_DATA_WAIT_FOR_TRIGGER;
