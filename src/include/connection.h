...
#define WT_CONN_DEBUG_CRASH_POINT_KEY_PROVIDER 0x0010u
#define WT_CONN_DEBUG_CURSOR_COPY 0x0020u
#define WT_CONN_DEBUG_CURSOR_REPOSITION 0x0040u
#define WT_CONN_DEBUG_EVICTION_CKPT_TS_ORDERING 0x0080u
#define WT_CONN_DEBUG_EVICT_AGGRESSIVE_MODE 0x0100u
#define WT_CONN_DEBUG_REALLOC_EXACT 0x0200u
#define WT_CONN_DEBUG_REALLOC_MALLOC 0x0400u
#define WT_CONN_DEBUG_SLOW_CKPT 0x0800u
#define WT_CONN_DEBUG_STRESS_SKIPLIST 0x1000u
#define WT_CONN_DEBUG_TABLE_LOGGING 0x2000u
#define WT_CONN_DEBUG_TIERED_FLUSH_ERROR_CONTINUE 0x4000u
#define WT_CONN_DEBUG_UPDATE_RESTORE_EVICT 0x8000u
