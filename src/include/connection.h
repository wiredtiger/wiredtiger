...
#define	WT_CONN_EVICTION_NO_LOOKASIDE	0x0000080u
#define	WT_CONN_EVICTION_RUN		0x0000100u
#define	WT_CONN_IN_MEMORY		0x0000200u
#define	WT_CONN_LEAK_MEMORY		0x0000400u
#define	WT_CONN_LOOKASIDE_OPEN		0x0000800u
#define	WT_CONN_LSM_MERGE		0x0001000u
#define	WT_CONN_OPTRACK			0x0002000u
#define	WT_CONN_PANIC			0x0004000u
#define	WT_CONN_READONLY		0x0008000u
#define	WT_CONN_RECOVERING		0x0010000u
#define	WT_CONN_SALVAGE			0x0020000u
#define	WT_CONN_SERVER_ASYNC		0x0040000u
#define	WT_CONN_SERVER_CHECKPOINT	0x0080000u
#define	WT_CONN_SERVER_LOG		0x0100000u
#define	WT_CONN_SERVER_LSM		0x0200000u
#define	WT_CONN_SERVER_STATISTICS	0x0400000u
#define	WT_CONN_SERVER_SWEEP		0x0800000u
