 ...
 */
/* AUTOMATIC FLAG VALUE GENERATION START 0 */
#define WT_TIMING_STRESS_AGGRESSIVE_SWEEP 0x00001ull
#define WT_TIMING_STRESS_BACKUP_RENAME 0x00002ull
#define WT_TIMING_STRESS_CHECKPOINT_RESERVED_TXNID_DELAY 0x00004ull
#define WT_TIMING_STRESS_CHECKPOINT_SLOW 0x00008ull
#define WT_TIMING_STRESS_CHECKPOINT_STOP 0x00010ull
#define WT_TIMING_STRESS_COMPACT_SLOW 0x00020ull
#define WT_TIMING_STRESS_EVICT_REPOSITION 0x00040ull
#define WT_TIMING_STRESS_FAILPOINT_HISTORY_STORE_DELETE_KEY_FROM_TS 0x00080ull
#define WT_TIMING_STRESS_HS_CHECKPOINT_DELAY 0x00100ull
#define WT_TIMING_STRESS_HS_SEARCH 0x00200ull
#define WT_TIMING_STRESS_HS_SWEEP 0x00400ull
#define WT_TIMING_STRESS_PREPARE_CHECKPOINT_DELAY 0x00800ull
#define WT_TIMING_STRESS_SPLIT_1 0x01000ull
#define WT_TIMING_STRESS_SPLIT_2 0x02000ull
#define WT_TIMING_STRESS_SPLIT_3 0x04000ull
#define WT_TIMING_STRESS_SPLIT_4 0x08000ull
#define WT_TIMING_STRESS_SPLIT_5 0x10000ull
#define WT_TIMING_STRESS_SPLIT_6 0x20000ull
#define WT_TIMING_STRESS_SPLIT_7 0x40000ull
#define WT_TIMING_STRESS_TIERED_FLUSH_FINISH 0x80000ull
