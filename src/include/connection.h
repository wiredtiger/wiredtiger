...
#define WT_CONN_DEBUG_CURSOR_COPY 0x0000100u
#define WT_CONN_DEBUG_REALLOC_EXACT 0x0000200u
#define WT_CONN_DEBUG_SLOW_CKPT 0x0000400u
#define WT_CONN_EVICTION_NO_LOOKASIDE 0x0000800u
#define WT_CONN_EVICTION_RUN 0x0001000u
#define WT_CONN_INCR_BACKUP 0x0002000u
#define WT_CONN_IN_MEMORY 0x0004000u
#define WT_CONN_LEAK_MEMORY 0x0008000u
#define WT_CONN_LOOKASIDE_OPEN 0x0010000u
...
#define WT_CONN_SERVER_ASYNC 0x1000000u
