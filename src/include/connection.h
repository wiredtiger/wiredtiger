...
#define WT_CONN_CALL_LOG_ENABLED 0x00000004u
#define WT_CONN_CKPT_CLEANUP_RECLAIM_SPACE 0x00000008u
#define WT_CONN_CKPT_SYNC 0x000000010u
#define WT_CONN_IN_MEMORY 0x00000020u
#define WT_CONN_LIVE_RESTORE_FS 0x00000040u
#define WT_CONN_PRESERVE_PREPARED 0x00000080u
#define WT_CONN_READONLY 0x00000100u
#define WT_CONN_RECOVERING 0x00000200u
#define WT_CONN_RECOVERING_METADATA 0x00000400u
#define WT_CONN_RECOVERY_COMPLETE 0x00000800u
#define WT_CONN_SALVAGE 0x00001000u
#define WT_CONN_WAS_BACKUP 0x00002000u
    /* AUTOMATIC FLAG VALUE GENERATION STOP 32 */
