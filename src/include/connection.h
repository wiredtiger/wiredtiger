...
#define WT_CONN_DEBUG_CLEAN_SCRUB 0x000002u
#define WT_CONN_DEBUG_CONFIGURATION 0x000004u
#define WT_CONN_DEBUG_CORRUPTION_ABORT 0x000008u
#define WT_CONN_DEBUG_CRASH_POINT_AFTER_DROP_COLGROUP 0x000010u
#define WT_CONN_DEBUG_CRASH_POINT_AFTER_DROP_FILE 0x000020u
#define WT_CONN_DEBUG_CRASH_POINT_BEFORE_INSERT_COLGROUP 0x000040u
#define WT_CONN_DEBUG_CRASH_POINT_BEFORE_INSERT_FILE 0x000080u
#define WT_CONN_DEBUG_CURSOR_COPY 0x000100u
#define WT_CONN_DEBUG_CURSOR_REPOSITION 0x000200u
...
#define WT_CONN_DEBUG_EVICT_WALK_FULL 0x002000u
...
#define WT_CONN_DEBUG_TIERED_FLUSH_ERROR_CONTINUE 0x100000u
