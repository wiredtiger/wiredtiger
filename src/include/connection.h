...
#define WT_CONN_LIVE_RESTORE 0x000020000ull
#define WT_CONN_LSM_MERGE 0x000040000ull
#define WT_CONN_MINIMAL 0x000080000ull
#define WT_CONN_OPTRACK 0x000100000ull
#define WT_CONN_PANIC 0x000200000ull
#define WT_CONN_PRECISE_CHECKPOINT 0x000400000ull
#define WT_CONN_PREFETCH_RUN 0x000800000ull
#define WT_CONN_READONLY 0x001000000ull
#define WT_CONN_READY 0x002000000ull
#define WT_CONN_RECONFIGURING 0x004000000ull
#define WT_CONN_RECOVERING 0x008000000ull
