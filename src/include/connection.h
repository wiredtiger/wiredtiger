...
#define WT_TIMING_STRESS_SLEEP_BEFORE_READ_OVERFLOW_ONPAGE 0x0020000u
#define WT_TIMING_STRESS_SPLIT_1 0x0040000u
#define WT_TIMING_STRESS_SPLIT_2 0x0080000u
#define WT_TIMING_STRESS_SPLIT_3 0x0100000u
#define WT_TIMING_STRESS_SPLIT_4 0x0200000u
#define WT_TIMING_STRESS_SPLIT_5 0x0400000u
#define WT_TIMING_STRESS_SPLIT_6 0x0800000u
#define WT_TIMING_STRESS_SPLIT_7 0x1000000u
#define WT_TIMING_STRESS_SPLIT_8 0x2000000u
#define WT_TIMING_STRESS_TIERED_FLUSH_FINISH 0x4000000u
    /* AUTOMATIC FLAG VALUE GENERATION STOP 32 */
