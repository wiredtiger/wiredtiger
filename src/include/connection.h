...
#define WT_TIMING_STRESS_CHECKPOINT_RACE 0x000008u
#define WT_TIMING_STRESS_CHECKPOINT_RESERVED_TXNID_DELAY 0x000010u
#define WT_TIMING_STRESS_CHECKPOINT_SLOW 0x000020u
#define WT_TIMING_STRESS_CHECKPOINT_STOP 0x000040u
#define WT_TIMING_STRESS_COMPACT_SLOW 0x000080u
#define WT_TIMING_STRESS_EVICT_REPOSITION 0x000100u
#define WT_TIMING_STRESS_FAILPOINT_EVICTION_FAIL_AFTER_RECONCILIATION 0x000200u
#define WT_TIMING_STRESS_FAILPOINT_HISTORY_STORE_DELETE_KEY_FROM_TS 0x000400u
#define WT_TIMING_STRESS_HS_CHECKPOINT_DELAY 0x000800u
#define WT_TIMING_STRESS_HS_SEARCH 0x001000u
#define WT_TIMING_STRESS_HS_SWEEP 0x002000u
#define WT_TIMING_STRESS_PREPARE_CHECKPOINT_DELAY 0x004000u
