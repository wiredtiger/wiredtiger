...
#define WT_TSC_DEFAULT_RATIO 1.0
    ...
    bool write_rowbyte; /* include row/byte count information in addresses */
...
#define WT_TIMING_STRESS_CHECKPOINT_SLOW 0x00004u
#define WT_TIMING_STRESS_FAILPOINT_HISTORY_STORE_DELETE_KEY_FROM_TS 0x00008u
#define WT_TIMING_STRESS_FAILPOINT_HISTORY_STORE_INSERT_1 0x00010u
#define WT_TIMING_STRESS_FAILPOINT_HISTORY_STORE_INSERT_2 0x00020u
...
#define WT_TIMING_STRESS_SPLIT_8 0x20000u
    /* AUTOMATIC FLAG VALUE GENERATION STOP 64 */
