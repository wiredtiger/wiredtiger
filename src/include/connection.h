...
#define WT_TIMING_STRESS_DROP_DEFERRED_HOLD 0x00000002000ull
#define WT_TIMING_STRESS_EVICT_REPOSITION 0x00000004000ull
#define WT_TIMING_STRESS_FAILPOINT_DISAGG_CHECKPOINT_APPLY 0x00000008000ull
#define WT_TIMING_STRESS_FAILPOINT_DISAGG_CHECKPOINT_QUEUE_DRAIN 0x00000010000ull
#define WT_TIMING_STRESS_FAILPOINT_EVICTION_SPLIT 0x00000020000ull
#define WT_TIMING_STRESS_FAILPOINT_HISTORY_STORE_DELETE_KEY_FROM_TS 0x00000040000ull
#define WT_TIMING_STRESS_FAILPOINT_PAGE_LOG_HANDLE_PUT 0x00000080000ull
#define WT_TIMING_STRESS_FAILPOINT_REC_BEFORE_WRAPUP 0x00000100000ull
#define WT_TIMING_STRESS_FAILPOINT_REC_SPLIT_WRITE 0x00000200000ull
#define WT_TIMING_STRESS_HS_CHECKPOINT_DELAY 0x00000400000ull
#define WT_TIMING_STRESS_HS_SEARCH 0x00000800000ull
#define WT_TIMING_STRESS_HS_SWEEP 0x00001000000ull
#define WT_TIMING_STRESS_LIVE_RESTORE_CLEAN_UP 0x00002000000ull
#define WT_TIMING_STRESS_OPEN_INDEX_SLOW 0x00004000000ull
#define WT_TIMING_STRESS_PREFETCH_1 0x00008000000ull
#define WT_TIMING_STRESS_PREFETCH_2 0x00010000000ull
#define WT_TIMING_STRESS_PREFETCH_3 0x00020000000ull
#define WT_TIMING_STRESS_PREFIX_COMPARE 0x00040000000ull
#define WT_TIMING_STRESS_PREPARE_CHECKPOINT_DELAY 0x00080000000ull
#define WT_TIMING_STRESS_PREPARE_RESOLUTION_1 0x00100000000ull
#define WT_TIMING_STRESS_PREPARE_RESOLUTION_2 0x00200000000ull
#define WT_TIMING_STRESS_SESSION_ALTER_SLOW 0x00400000000ull
#define WT_TIMING_STRESS_SLEEP_BEFORE_READ_OVERFLOW_ONPAGE 0x00800000000ull
#define WT_TIMING_STRESS_SPLIT_1 0x01000000000ull
#define WT_TIMING_STRESS_SPLIT_2 0x02000000000ull
#define WT_TIMING_STRESS_SPLIT_3 0x04000000000ull
#define WT_TIMING_STRESS_SPLIT_4 0x08000000000ull
#define WT_TIMING_STRESS_SPLIT_5 0x10000000000ull
#define WT_TIMING_STRESS_SPLIT_6 0x20000000000ull
#define WT_TIMING_STRESS_SPLIT_7 0x40000000000ull
#define WT_TIMING_STRESS_SPLIT_8 0x80000000000ull
    /* AUTOMATIC FLAG VALUE GENERATION STOP 64 */
