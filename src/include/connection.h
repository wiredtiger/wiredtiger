...
/* AUTOMATIC FLAG VALUE GENERATION START */
#define WT_CONN_CACHE_CURSORS 0x00001u
#define WT_CONN_CACHE_POOL 0x00002u
#define WT_CONN_CKPT_SYNC 0x00004u
#define WT_CONN_CLOSING 0x00008u
#define WT_CONN_CLOSING_NO_MORE_OPENS 0x00010u
#define WT_CONN_CLOSING_TIMESTAMP 0x00020u
#define WT_CONN_COMPATIBILITY 0x00040u
#define WT_CONN_DATA_CORRUPTION 0x00080u
#define WT_CONN_EVICTION_NO_LOOKASIDE 0x00100u
#define WT_CONN_EVICTION_RUN 0x00200u
#define WT_CONN_IN_MEMORY 0x00400u
#define WT_CONN_LEAK_MEMORY 0x00800u
#define WT_CONN_LOOKASIDE_OPEN 0x01000u
#define WT_CONN_LSM_MERGE 0x02000u
#define WT_CONN_OPTRACK 0x04000u
#define WT_CONN_PANIC 0x08000u
#define WT_CONN_READONLY 0x10000u
#define WT_CONN_RECOVERING 0x20000u
#define WT_CONN_SALVAGE 0x40000u
