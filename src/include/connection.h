...
#define WT_CONN_LOG_ZERO_FILL 0x400u       /* Manually zero files */
    ...
    char *conf_compiled_dummy; /* Dummy strings used by caller */
    WT_CONF_COMPILED **conf_compiled_array;
    uint32_t conf_compiled_size; /* In use size of compiled array */
    uint32_t conf_compiled_max;  /* Allocated size of compiled array */
...
#define WT_TIMING_STRESS_PREPARE_CHECKPOINT_DELAY 0x0004000u
#define WT_TIMING_STRESS_PREPARE_RESOLUTION 0x0008000u
#define WT_TIMING_STRESS_SLEEP_BEFORE_READ_OVERFLOW_ONPAGE 0x0010000u
#define WT_TIMING_STRESS_SPLIT_1 0x0020000u
#define WT_TIMING_STRESS_SPLIT_2 0x0040000u
#define WT_TIMING_STRESS_SPLIT_3 0x0080000u
#define WT_TIMING_STRESS_SPLIT_4 0x0100000u
#define WT_TIMING_STRESS_SPLIT_5 0x0200000u
#define WT_TIMING_STRESS_SPLIT_6 0x0400000u
#define WT_TIMING_STRESS_SPLIT_7 0x0800000u
#define WT_TIMING_STRESS_SPLIT_8 0x1000000u
#define WT_TIMING_STRESS_TIERED_FLUSH_FINISH 0x2000000u
    /* AUTOMATIC FLAG VALUE GENERATION STOP 32 */
