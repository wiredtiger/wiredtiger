...
#define WT_TIMING_STRESS_DRAIN_INGEST_TABLE_SLOW 0x0000000400ull
#define WT_TIMING_STRESS_EVICT_REPOSITION 0x0000000800ull
#define WT_TIMING_STRESS_FAILPOINT_DISAGG_CHECKPOINT_QUEUE_DRAIN 0x0000001000ull
#define WT_TIMING_STRESS_FAILPOINT_EVICTION_SPLIT 0x0000002000ull
#define WT_TIMING_STRESS_FAILPOINT_HISTORY_STORE_DELETE_KEY_FROM_TS 0x0000004000ull
