...
/* AUTOMATIC FLAG VALUE GENERATION START 0 */
#define WT_CONN_DEBUG_CKPT_EVICT 0x001u
#define WT_CONN_DEBUG_CKPT_RETAIN 0x002u
#define WT_CONN_DEBUG_CORRUPTION_ABORT 0x004u
#define WT_CONN_DEBUG_CURSOR_COPY 0x008u
#define WT_CONN_DEBUG_CURSOR_REPOSITION 0x010u
#define WT_CONN_DEBUG_FLUSH_CKPT 0x020u
