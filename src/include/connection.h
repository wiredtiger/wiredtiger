...
#define WT_VERB_HISTORY_STORE 0x0000004000u
#define WT_VERB_HISTORY_STORE_ACTIVITY 0x0000008000u
...
#define WT_TIMING_STRESS_HISTORY_STORE_SWEEP 0x004u
...
#define WT_CONN_EVICTION_NO_HISTORY_STORE 0x00000400u
#define WT_CONN_EVICTION_RUN 0x00000800u
#define WT_CONN_HISTORY_STORE_OPEN 0x00001000u
