...
#define	WT_CONN_EVICTION_NO_LOOKASIDE	0x000020u
#define	WT_CONN_EVICTION_RUN		0x000040u
#define	WT_CONN_IN_MEMORY		0x000080u
#define	WT_CONN_LEAK_MEMORY		0x000100u
#define	WT_CONN_LOOKASIDE_OPEN		0x000200u
#define	WT_CONN_LSM_MERGE		0x000400u
#define	WT_CONN_OPTRACK			0x000800u
#define	WT_CONN_PANIC			0x001000u
#define	WT_CONN_READONLY		0x002000u
#define	WT_CONN_RECOVERING		0x004000u
#define	WT_CONN_SERVER_ASYNC		0x008000u
#define	WT_CONN_SERVER_CHECKPOINT	0x010000u
#define	WT_CONN_SERVER_CURSOR_CACHE	0x020000u
