...
#define WT_CONN_DEBUG_CLEAN_SCRUB 0x00002u
#define WT_CONN_DEBUG_CONFIGURATION 0x00004u
#define WT_CONN_DEBUG_CORRUPTION_ABORT 0x00008u
#define WT_CONN_DEBUG_CRASH_POINT_AFTER_DROP_COLGROUP 0x00010u
#define WT_CONN_DEBUG_CRASH_POINT_AFTER_DROP_FILE 0x00020u
#define WT_CONN_DEBUG_CRASH_POINT_BEFORE_INSERT_COLGROUP 0x00040u
#define WT_CONN_DEBUG_CRASH_POINT_BEFORE_INSERT_FILE 0x00080u
#define WT_CONN_DEBUG_CURSOR_COPY 0x00100u
#define WT_CONN_DEBUG_CURSOR_REPOSITION 0x00200u
...
#define WT_CONN_DEBUG_STRESS_SKIPLIST 0x08000u
#define WT_CONN_DEBUG_TABLE_LOGGING 0x10000u
#define WT_CONN_DEBUG_TIERED_FLUSH_ERROR_CONTINUE 0x20000u
