...
#define WT_TIMING_STRESS_HS_CHECKPOINT_DELAY 0x00020u
#define WT_TIMING_STRESS_HS_SEARCH 0x00040u
#define WT_TIMING_STRESS_HS_SWEEP 0x00080u
#define WT_TIMING_STRESS_PREPARE_CHECKPOINT_DELAY 0x00100u
#define WT_TIMING_STRESS_SPLIT_1 0x00200u
#define WT_TIMING_STRESS_SPLIT_2 0x00400u
#define WT_TIMING_STRESS_SPLIT_3 0x00800u
#define WT_TIMING_STRESS_SPLIT_4 0x01000u
#define WT_TIMING_STRESS_SPLIT_5 0x02000u
#define WT_TIMING_STRESS_SPLIT_6 0x04000u
#define WT_TIMING_STRESS_SPLIT_7 0x08000u
#define WT_TIMING_STRESS_SPLIT_8 0x10000u
    /* AUTOMATIC FLAG VALUE GENERATION STOP 64 */
