...
#define WT_TIMING_STRESS_CHECKPOINT_INVISIBLE_TXNID_DELAY 0x0004u
#define WT_TIMING_STRESS_CHECKPOINT_SLOW 0x0008u
#define WT_TIMING_STRESS_HS_CHECKPOINT_DELAY 0x0010u
#define WT_TIMING_STRESS_HS_SEARCH 0x0020u
#define WT_TIMING_STRESS_HS_SWEEP 0x0040u
#define WT_TIMING_STRESS_PREPARE_CHECKPOINT_DELAY 0x0080u
#define WT_TIMING_STRESS_SPLIT_1 0x0100u
#define WT_TIMING_STRESS_SPLIT_2 0x0200u
#define WT_TIMING_STRESS_SPLIT_3 0x0400u
#define WT_TIMING_STRESS_SPLIT_4 0x0800u
#define WT_TIMING_STRESS_SPLIT_5 0x1000u
#define WT_TIMING_STRESS_SPLIT_6 0x2000u
#define WT_TIMING_STRESS_SPLIT_7 0x4000u
#define WT_TIMING_STRESS_SPLIT_8 0x8000u
    /* AUTOMATIC FLAG VALUE GENERATION STOP 64 */
