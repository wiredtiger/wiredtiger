...
#define WT_CONN_COMPAT_NONE UINT16_MAX
    ...
    bool debug_realloc_exact; /* Reallocate exact size */
...
#define WT_CONN_DEBUG_SLOW_CKPT 0x00000100u
#define WT_CONN_EVICTION_NO_LOOKASIDE 0x00000200u
#define WT_CONN_EVICTION_RUN 0x00000400u
#define WT_CONN_INCR_BACKUP 0x00000800u
#define WT_CONN_IN_MEMORY 0x00001000u
#define WT_CONN_LEAK_MEMORY 0x00002000u
#define WT_CONN_LOOKASIDE_OPEN 0x00004000u
#define WT_CONN_LSM_MERGE 0x00008000u
#define WT_CONN_OPTRACK 0x00010000u
#define WT_CONN_PANIC 0x00020000u
#define WT_CONN_READONLY 0x00040000u
#define WT_CONN_RECONFIGURING 0x00080000u
#define WT_CONN_RECOVERING 0x00100000u
#define WT_CONN_SALVAGE 0x00200000u
#define WT_CONN_SERVER_ASYNC 0x00400000u
#define WT_CONN_SERVER_CAPACITY 0x00800000u
#define WT_CONN_SERVER_CHECKPOINT 0x01000000u
#define WT_CONN_SERVER_LOG 0x02000000u
#define WT_CONN_SERVER_LSM 0x04000000u
#define WT_CONN_SERVER_STATISTICS 0x08000000u
#define WT_CONN_SERVER_SWEEP 0x10000000u
