...
#define WT_CONN_DEBUG_EVICTION_CKPT_TS_ORDERING 0x010u
#define WT_CONN_DEBUG_EVICT_AGGRESSIVE_MODE 0x020u
#define WT_CONN_DEBUG_REALLOC_EXACT 0x040u
#define WT_CONN_DEBUG_REALLOC_MALLOC 0x080u
#define WT_CONN_DEBUG_SLOW_CKPT 0x100u
#define WT_CONN_DEBUG_STRESS_SKIPLIST 0x200u
#define WT_CONN_DEBUG_TABLE_LOGGING 0x400u
...
#define WT_TIMING_STRESS_CLOSE_STRESS_LOG 0x0000040u
...
#define WT_TIMING_STRESS_FAILPOINT_REC_SPLIT_WRITE 0x0000800u
#define WT_TIMING_STRESS_HS_CHECKPOINT_DELAY 0x0001000u
#define WT_TIMING_STRESS_HS_SEARCH 0x0002000u
#define WT_TIMING_STRESS_HS_SWEEP 0x0004000u
#define WT_TIMING_STRESS_PREPARE_CHECKPOINT_DELAY 0x0008000u
#define WT_TIMING_STRESS_PREPARE_RESOLUTION 0x0010000u
