...
#define WT_TIMING_STRESS_COMMIT_TRANSACTION_SLOW 0x00000080ull
#define WT_TIMING_STRESS_COMPACT_SLOW 0x00000100ull
#define WT_TIMING_STRESS_EVICT_REPOSITION 0x00000200ull
#define WT_TIMING_STRESS_FAILPOINT_EVICTION_SPLIT 0x00000400ull
#define WT_TIMING_STRESS_FAILPOINT_HISTORY_STORE_DELETE_KEY_FROM_TS 0x00000800ull
...
#define WT_CONN_CKPT_GATHER 0x00000010u
#define WT_CONN_CKPT_SYNC 0x00000020u
#define WT_CONN_CLOSING 0x00000040u
#define WT_CONN_CLOSING_CHECKPOINT 0x00000080u
#define WT_CONN_CLOSING_NO_MORE_OPENS 0x00000100u
#define WT_CONN_COMPATIBILITY 0x00000200u
#define WT_CONN_DATA_CORRUPTION 0x00000400u
...
#define WT_CONN_OBSOLETE_CLEANUP_RECLAIM_SPACE 0x00040000u
