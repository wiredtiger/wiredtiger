...
#define WT_TIMING_STRESS_CHECKPOINT_RESERVED_TXNID_DELAY 0x000004u
...
#define WT_TIMING_STRESS_FAILPOINT_EVICTION_FAIL_AFTER_RECONCILIATION 0x000040u
#define WT_TIMING_STRESS_FAILPOINT_HISTORY_STORE_DELETE_KEY_FROM_TS 0x000080u
#define WT_TIMING_STRESS_HS_CHECKPOINT_DELAY 0x000100u
#define WT_TIMING_STRESS_HS_SEARCH 0x000200u
