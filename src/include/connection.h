...
/* AUTOMATIC FLAG VALUE GENERATION START 0 */
#define WT_CONN_BACKUP_PARTIAL_RESTORE 0x00001u
#define WT_CONN_CACHE_CURSORS 0x00002u
#define WT_CONN_CALL_LOG_ENABLED 0x00004u
#define WT_CONN_CKPT_CLEANUP_RECLAIM_SPACE 0x00008u
#define WT_CONN_CKPT_SYNC 0x00010u
#define WT_CONN_IN_MEMORY 0x00020u
#define WT_CONN_KEY_PROVIDER_PUSH 0x00040u
#define WT_CONN_LIVE_RESTORE_FS 0x00080u
#define WT_CONN_PRECISE_CHECKPOINT 0x00100u
#define WT_CONN_PRESERVE_PREPARED 0x00200u
#define WT_CONN_READONLY 0x00400u
#define WT_CONN_READ_SKIP_CORRUPT 0x00800u
#define WT_CONN_RECOVERING 0x01000u
#define WT_CONN_RECOVERING_METADATA 0x02000u
#define WT_CONN_RECOVERY_COMPLETE 0x04000u
#define WT_CONN_SALVAGE 0x08000u
#define WT_CONN_WAS_BACKUP 0x10000u
    /* AUTOMATIC FLAG VALUE GENERATION STOP 32 */
