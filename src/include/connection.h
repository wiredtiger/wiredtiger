...
/* AUTOMATIC FLAG VALUE GENERATION START */
#define WT_CONN_CACHE_CURSORS 0x000000001u
#define WT_CONN_CACHE_POOL 0x000000002u
#define WT_CONN_CKPT_GATHER 0x000000004u
#define WT_CONN_CKPT_SYNC 0x000000008u
#define WT_CONN_CLOSING 0x000000010u
#define WT_CONN_CLOSING_NO_MORE_OPENS 0x000000020u
#define WT_CONN_CLOSING_TIMESTAMP 0x000000040u
#define WT_CONN_COMPATIBILITY 0x000000080u
#define WT_CONN_DATA_CORRUPTION 0x000000100u
#define WT_CONN_DEBUG_CURSOR_COPY 0x000000200u
#define WT_CONN_DEBUG_REALLOC_EXACT 0x000000400u
#define WT_CONN_DEBUG_SLOW_CKPT 0x000000800u
#define WT_CONN_EVICTION_NO_LOOKASIDE 0x000001000u
#define WT_CONN_EVICTION_RUN 0x000002000u
#define WT_CONN_INCR_BACKUP 0x000004000u
#define WT_CONN_IN_MEMORY 0x000008000u
#define WT_CONN_LEAK_MEMORY 0x000010000u
#define WT_CONN_LOOKASIDE_OPEN 0x000020000u
#define WT_CONN_LSM_MERGE 0x000040000u
#define WT_CONN_OPTRACK 0x000080000u
#define WT_CONN_PANIC 0x000100000u
#define WT_CONN_READONLY 0x000200000u
#define WT_CONN_RECONFIGURING 0x000400000u
#define WT_CONN_RECOVERING 0x000800000u
#define WT_CONN_SALVAGE 0x001000000u
#define WT_CONN_SERVER_ASYNC 0x002000000u
#define WT_CONN_SERVER_CAPACITY 0x004000000u
#define WT_CONN_SERVER_CHECKPOINT 0x008000000u
#define WT_CONN_SERVER_LOG 0x010000000u
#define WT_CONN_SERVER_LSM 0x020000000u
#define WT_CONN_SERVER_STATISTICS 0x040000000u
#define WT_CONN_SERVER_SWEEP 0x080000000u
#define WT_CONN_WAS_BACKUP 0x100000000u
    /* AUTOMATIC FLAG VALUE GENERATION STOP */
    uint32_t flags;
};
