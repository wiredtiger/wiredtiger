 ...
 */
/* AUTOMATIC FLAG VALUE GENERATION START 0 */
#define WT_TIMING_STRESS_AGGRESSIVE_STASH_FREE 0x000000000001ull
#define WT_TIMING_STRESS_AGGRESSIVE_SWEEP 0x000000000002ull
#define WT_TIMING_STRESS_BACKUP_BLKMOD_DELAY 0x000000000004ull
#define WT_TIMING_STRESS_BACKUP_RENAME 0x000000000008ull
#define WT_TIMING_STRESS_CHECKPOINT_EVICT_PAGE 0x000000000010ull
#define WT_TIMING_STRESS_CHECKPOINT_HANDLE 0x000000000020ull
#define WT_TIMING_STRESS_CHECKPOINT_SLOW 0x000000000040ull
#define WT_TIMING_STRESS_CHECKPOINT_STOP 0x000000000080ull
#define WT_TIMING_STRESS_CLOSE_STRESS_LOG 0x000000000100ull
#define WT_TIMING_STRESS_COMMIT_TRANSACTION_SLOW 0x000000000200ull
#define WT_TIMING_STRESS_COMPACT_SLOW 0x000000000400ull
#define WT_TIMING_STRESS_DISAGG_ROLE_TRANSITION 0x000000000800ull
#define WT_TIMING_STRESS_DISAGG_STABLE_DHANDLE_DELAY 0x000000001000ull
#define WT_TIMING_STRESS_DROP_DEFERRED_HOLD 0x000000002000ull
#define WT_TIMING_STRESS_EVICT_REPOSITION 0x000000004000ull
#define WT_TIMING_STRESS_FAILPOINT_DISAGG_CHECKPOINT_APPLY 0x000000008000ull
#define WT_TIMING_STRESS_FAILPOINT_DISAGG_CHECKPOINT_QUEUE_DRAIN 0x000000010000ull
#define WT_TIMING_STRESS_FAILPOINT_EVICTION_SPLIT 0x000000020000ull
#define WT_TIMING_STRESS_FAILPOINT_HISTORY_STORE_DELETE_KEY_FROM_TS 0x000000040000ull
#define WT_TIMING_STRESS_FAILPOINT_PAGE_LOG_HANDLE_PUT 0x000000080000ull
#define WT_TIMING_STRESS_FAILPOINT_REC_BEFORE_WRAPUP 0x000000100000ull
#define WT_TIMING_STRESS_FAILPOINT_REC_SPLIT_WRITE 0x000000200000ull
#define WT_TIMING_STRESS_HS_CHECKPOINT_DELAY 0x000000400000ull
#define WT_TIMING_STRESS_HS_SEARCH 0x000000800000ull
#define WT_TIMING_STRESS_HS_SWEEP 0x000001000000ull
#define WT_TIMING_STRESS_LIVE_RESTORE_CLEAN_UP 0x000002000000ull
#define WT_TIMING_STRESS_OPEN_INDEX_SLOW 0x000004000000ull
#define WT_TIMING_STRESS_PREFETCH_1 0x000008000000ull
#define WT_TIMING_STRESS_PREFETCH_2 0x000010000000ull
#define WT_TIMING_STRESS_PREFETCH_3 0x000020000000ull
#define WT_TIMING_STRESS_PREFIX_COMPARE 0x000040000000ull
#define WT_TIMING_STRESS_PREPARE_CHECKPOINT_DELAY 0x000080000000ull
#define WT_TIMING_STRESS_PREPARE_RESOLUTION_1 0x000100000000ull
#define WT_TIMING_STRESS_PREPARE_RESOLUTION_2 0x000200000000ull
#define WT_TIMING_STRESS_SESSION_ALTER_SLOW 0x000400000000ull
#define WT_TIMING_STRESS_SLEEP_BEFORE_READ_OVERFLOW_ONPAGE 0x000800000000ull
#define WT_TIMING_STRESS_SPLIT_1 0x001000000000ull
#define WT_TIMING_STRESS_SPLIT_2 0x002000000000ull
#define WT_TIMING_STRESS_SPLIT_3 0x004000000000ull
#define WT_TIMING_STRESS_SPLIT_4 0x008000000000ull
#define WT_TIMING_STRESS_SPLIT_5 0x010000000000ull
#define WT_TIMING_STRESS_SPLIT_6 0x020000000000ull
#define WT_TIMING_STRESS_SPLIT_7 0x040000000000ull
#define WT_TIMING_STRESS_SPLIT_8 0x080000000000ull
#define WT_TIMING_STRESS_TIERED_FLUSH_FINISH 0x100000000000ull
    /* AUTOMATIC FLAG VALUE GENERATION STOP 64 */
