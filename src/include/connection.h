...
struct __wt_layered_table_manager {
    ...
    uint32_t ingest_clear_pin_done;
    uint32_t ingest_clear_lone_done;
    void *ingest_clear_pin_session;
};
...
#define WT_TIMING_STRESS_FAILPOINT_DISAGG_INGEST_CLEAR 0x0000001000ull
