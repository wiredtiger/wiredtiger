...
struct __wt_verbose_message_info {
    uint32_t id;                  /* A unique ID for the specific log message. */
    WT_VERBOSE_CATEGORY category; /* The verbose category (e.g., WT_VERB_API). */
    WT_VERBOSE_LEVEL level;       /* The verbosity level (e.g., WT_VERBOSE_INFO). */
};
...
#define WT_BASE_LOG_ID 5
#define WT_DEFAULT_LOG_ID 0 /* Default log ID 000 for verbose messages */
 ...
 * 2. The next two digits identify the WiredTiger module defined in WT_VERBOSE_CATEGORY.
 * 3. The final three digits denote the specific message ID within that module.
 * This allows for a total of 1000 unique messages per module.
 */
