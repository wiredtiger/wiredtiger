...
#define WT_SESSION_INGEST_REPLAY 0x0008000u
#define WT_SESSION_INTERNAL 0x0010000u
#define WT_SESSION_LOGGING_INMEM 0x0020000u
#define WT_SESSION_NO_DATA_HANDLES 0x0040000u
#define WT_SESSION_NO_RECONCILE 0x0080000u
#define WT_SESSION_PREFETCH_ENABLED 0x0100000u
#define WT_SESSION_PREFETCH_THREAD 0x0200000u
#define WT_SESSION_QUIET_CORRUPT_FILE 0x0400000u
#define WT_SESSION_QUIET_OPEN_FILE 0x0800000u
#define WT_SESSION_READ_WONT_NEED 0x1000000u
#define WT_SESSION_RESOLVING_TXN 0x2000000u
#define WT_SESSION_ROLLBACK_TO_STABLE 0x4000000u
#define WT_SESSION_SAVE_ERRORS 0x8000000u
