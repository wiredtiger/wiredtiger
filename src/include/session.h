...
#define WT_SESSION_DEBUG_DO_NOT_CLEAR_TXN_ID 0x000010u
#define WT_SESSION_DEBUG_RELEASE_EVICT 0x000020u
#define WT_SESSION_EVICTION 0x000040u
#define WT_SESSION_IGNORE_CACHE_SIZE 0x000080u
#define WT_SESSION_IMPORT 0x000100u
#define WT_SESSION_IMPORT_REPAIR 0x000200u
#define WT_SESSION_INTERNAL 0x000400u
#define WT_SESSION_LOGGING_INMEM 0x000800u
#define WT_SESSION_NO_DATA_HANDLES 0x001000u
#define WT_SESSION_NO_LOGGING 0x002000u
#define WT_SESSION_NO_RECONCILE 0x004000u
#define WT_SESSION_QUIET_CORRUPT_FILE 0x008000u
#define WT_SESSION_QUIET_TIERED 0x010000u
