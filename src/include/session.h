...
#define	WT_SESSION_CACHE_CURSORS		0x0000001u
#define	WT_SESSION_CAN_WAIT			0x0000002u
#define	WT_SESSION_IGNORE_CACHE_SIZE		0x0000004u
#define	WT_SESSION_INTERNAL			0x0000008u
#define	WT_SESSION_LOCKED_CHECKPOINT		0x0000010u
#define	WT_SESSION_LOCKED_HANDLE_LIST_READ	0x0000020u
#define	WT_SESSION_LOCKED_HANDLE_LIST_WRITE	0x0000040u
#define	WT_SESSION_LOCKED_METADATA		0x0000080u
#define	WT_SESSION_LOCKED_PASS			0x0000100u
#define	WT_SESSION_LOCKED_SCHEMA		0x0000200u
#define	WT_SESSION_LOCKED_SLOT			0x0000400u
#define	WT_SESSION_LOCKED_TABLE_READ		0x0000800u
#define	WT_SESSION_LOCKED_TABLE_WRITE		0x0001000u
#define	WT_SESSION_LOCKED_TURTLE		0x0002000u
#define	WT_SESSION_LOCKED_TXN_GLOBAL_WRITE	0x0004000u
#define	WT_SESSION_LOGGING_INMEM		0x0008000u
#define	WT_SESSION_LOOKASIDE_CURSOR		0x0010000u
#define	WT_SESSION_NO_DATA_HANDLES		0x0020000u
#define	WT_SESSION_NO_LOGGING			0x0040000u
#define	WT_SESSION_NO_RECONCILE			0x0080000u
#define	WT_SESSION_NO_SCHEMA_LOCK		0x0100000u
#define	WT_SESSION_QUIET_CORRUPT_FILE		0x0200000u
#define	WT_SESSION_READ_WONT_NEED		0x0400000u
#define	WT_SESSION_SCHEMA_TXN			0x0800000u
#define	WT_SESSION_SERVER_ASYNC			0x1000000u
