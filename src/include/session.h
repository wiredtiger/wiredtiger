...
#define WT_SESSION_DEBUG_ALLOW_EVICT_NO_PROGRESS_RECONCILIATION 0x0000010u
#define WT_SESSION_DEBUG_CHECKPOINT_FAIL_BEFORE_TURTLE_UPDATE 0x0000020u
#define WT_SESSION_DEBUG_DO_NOT_CLEAR_TXN_ID 0x0000040u
#define WT_SESSION_DEBUG_RELEASE_EVICT 0x0000080u
#define WT_SESSION_DUMPING_EXTLIST 0x0000100u
#define WT_SESSION_EVICTION 0x0000200u
#define WT_SESSION_HS_WRAPUP 0x0000400u
#define WT_SESSION_IGNORE_CACHE_SIZE 0x0000800u
#define WT_SESSION_IMPORT 0x0001000u
#define WT_SESSION_IMPORT_REPAIR 0x0002000u
#define WT_SESSION_INTERNAL 0x0004000u
#define WT_SESSION_LOGGING_INMEM 0x0008000u
#define WT_SESSION_NO_DATA_HANDLES 0x0010000u
#define WT_SESSION_NO_RECONCILE 0x0020000u
#define WT_SESSION_PREFETCH_ENABLED 0x0040000u
#define WT_SESSION_PREFETCH_THREAD 0x0080000u
#define WT_SESSION_QUIET_CORRUPT_FILE 0x0100000u
#define WT_SESSION_QUIET_OPEN_FILE 0x0200000u
#define WT_SESSION_READ_WONT_NEED 0x0400000u
#define WT_SESSION_RESOLVING_TXN 0x0800000u
#define WT_SESSION_ROLLBACK_TO_STABLE 0x1000000u
#define WT_SESSION_SAVE_ERRORS 0x2000000u
