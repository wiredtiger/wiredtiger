...
#define WT_SESSION_BACKUP_CURSOR 0x000000001u
#define WT_SESSION_BACKUP_DUP 0x000000002u
#define WT_SESSION_CACHE_CURSORS 0x000000004u
#define WT_SESSION_CAN_WAIT 0x000000008u
#define WT_SESSION_HS_CURSOR 0x000000010u
#define WT_SESSION_IGNORE_CACHE_SIZE 0x000000020u
#define WT_SESSION_IGNORE_HS_TOMBSTONE 0x000000040u
#define WT_SESSION_INSTANTIATE_PREPARED 0x000000080u
#define WT_SESSION_INTERNAL 0x000000100u
#define WT_SESSION_LOCKED_CHECKPOINT 0x000000200u
#define WT_SESSION_LOCKED_HANDLE_LIST_READ 0x000000400u
#define WT_SESSION_LOCKED_HANDLE_LIST_WRITE 0x000000800u
#define WT_SESSION_LOCKED_HOTBACKUP_READ 0x000001000u
#define WT_SESSION_LOCKED_HOTBACKUP_WRITE 0x000002000u
#define WT_SESSION_LOCKED_METADATA 0x000004000u
#define WT_SESSION_LOCKED_PASS 0x000008000u
#define WT_SESSION_LOCKED_SCHEMA 0x000010000u
#define WT_SESSION_LOCKED_SLOT 0x000020000u
#define WT_SESSION_LOCKED_TABLE_READ 0x000040000u
#define WT_SESSION_LOCKED_TABLE_WRITE 0x000080000u
#define WT_SESSION_LOCKED_TURTLE 0x000100000u
#define WT_SESSION_LOGGING_INMEM 0x000200000u
#define WT_SESSION_NO_DATA_HANDLES 0x000400000u
#define WT_SESSION_NO_LOGGING 0x000800000u
#define WT_SESSION_NO_RECONCILE 0x001000000u
#define WT_SESSION_NO_SCHEMA_LOCK 0x002000000u
#define WT_SESSION_QUIET_CORRUPT_FILE 0x004000000u
#define WT_SESSION_READ_WONT_NEED 0x008000000u
#define WT_SESSION_RESOLVING_MODIFY 0x010000000u
#define WT_SESSION_RESOLVING_TXN 0x020000000u
#define WT_SESSION_ROLLBACK_TO_STABLE 0x040000000u
#define WT_SESSION_SCHEMA_TXN 0x080000000u
#define WT_SESSION_SERVER_ASYNC 0x100000000u
