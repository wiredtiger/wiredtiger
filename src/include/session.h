...
#define WT_SESSION_LOCKED_SCHEMA_READ 0x0100u
#define WT_SESSION_LOCKED_SCHEMA_WRITE 0x0200u
#define WT_SESSION_LOCKED_SLOT 0x0400u
#define WT_SESSION_LOCKED_TABLE_READ 0x0800u
#define WT_SESSION_LOCKED_TABLE_WRITE 0x1000u
#define WT_SESSION_LOCKED_TURTLE 0x2000u
#define WT_SESSION_NO_SCHEMA_LOCK 0x4000u
    /*AUTOMATIC FLAG VALUE GENERATION STOP 32 */
    uint32_t lock_flags;
#define WT_SESSION_LOCKED_SCHEMA2 (WT_SESSION_LOCKED_SCHEMA_READ | WT_SESSION_LOCKED_SCHEMA_WRITE)
