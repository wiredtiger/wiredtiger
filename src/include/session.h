...
/* AUTOMATIC FLAG VALUE GENERATION START 0 */
#define WT_SESSION_BACKUP_CURSOR 0x000000001ull
#define WT_SESSION_BACKUP_DUP 0x000000002ull
#define WT_SESSION_CACHE_CURSORS 0x000000004ull
#define WT_SESSION_CAN_WAIT 0x000000008ull
#define WT_SESSION_CHECKPOINT 0x000000010ull
#define WT_SESSION_CHECKPOINT_WORKER 0x000000020ull
#define WT_SESSION_CREATE_BTREE 0x000000040ull
#define WT_SESSION_DEBUG_CHECKPOINT_FAIL_BEFORE_TURTLE_UPDATE 0x000000080ull
#define WT_SESSION_DEBUG_DO_NOT_CLEAR_TXN_ID 0x000000100ull
#define WT_SESSION_DEBUG_RELEASE_EVICT 0x000000200ull
#define WT_SESSION_DROP_LOCAL_ONLY 0x000000400ull
#define WT_SESSION_DUMPING_EXTLIST 0x000000800ull
#define WT_SESSION_EVICTION 0x000001000ull
#define WT_SESSION_HS_WRAPUP 0x000002000ull
#define WT_SESSION_IGNORE_CACHE_SIZE 0x000004000ull
#define WT_SESSION_IMPORT 0x000008000ull
#define WT_SESSION_IMPORT_REPAIR 0x000010000ull
#define WT_SESSION_INGEST_REPLAY 0x000020000ull
#define WT_SESSION_INTERNAL 0x000040000ull
#define WT_SESSION_LOGGING_INMEM 0x000080000ull
#define WT_SESSION_NON_TRANSACTIONAL_TRUNCATE 0x000100000ull
#define WT_SESSION_NO_DATA_HANDLES 0x000200000ull
#define WT_SESSION_NO_RECONCILE 0x000400000ull
#define WT_SESSION_PREFETCH_ENABLED 0x000800000ull
#define WT_SESSION_PREFETCH_THREAD 0x001000000ull
#define WT_SESSION_QUIET_CORRUPT_FILE 0x002000000ull
#define WT_SESSION_QUIET_OPEN_FILE 0x004000000ull
#define WT_SESSION_READ_SKIP_CORRUPT 0x008000000ull
#define WT_SESSION_READ_WONT_NEED 0x010000000ull
#define WT_SESSION_RESOLVING_TXN 0x020000000ull
#define WT_SESSION_ROLLBACK_TO_STABLE 0x040000000ull
#define WT_SESSION_SAVE_ERRORS 0x080000000ull
#define WT_SESSION_SCHEMA_TXN 0x100000000ull
