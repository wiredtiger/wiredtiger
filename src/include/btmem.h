...
#define WT_REC_SCRUB 0x08u
#define WT_REC_VISIBILITY_ERR 0x10u
#define WT_REC_VISIBLE_ALL 0x20u
// #define WT_REC_LOOKASIDE 0x40u
// #define WT_REC_UPDATE_RESTORE 0x80u
/* AUTOMATIC FLAG VALUE GENERATION STOP */
