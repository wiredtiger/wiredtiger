...
#define WT_UPDATE_RESTORED_FAST_TRUNCATE 0x08u /* Update restored for fast truncate. */
...
#define WT_UPDATE_RESTORED_PREPARED 0x40u      /* Active update restored from data store. */
                                               /* AUTOMATIC FLAG VALUE GENERATION STOP 32 */
    uint8_t flags;
