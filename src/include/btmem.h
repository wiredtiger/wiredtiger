...
#define WT_REF_FLAG_LEFTMOST 0x04u     /* Leftmost page at this level */
#define WT_REF_FLAG_REC_MULTIPLE 0x08u /* Page has been split in reconciliation */
#define WT_REF_FLAG_RIGHTMOST 0x10u    /* Rightmost page at this level */
                                       /* AUTOMATIC FLAG VALUE GENERATION STOP 8 */
    uint8_t flags;
