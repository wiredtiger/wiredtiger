...
#define WT_UPDATE_RESTORED_FAST_TRUNCATE 0x0040u   /* Fast truncate instantiation. */
#define WT_UPDATE_RESTORED_FROM_DELTA 0x0080u      /* Update restored from delta. */
#define WT_UPDATE_RESTORED_FROM_DS 0x0100u         /* Update restored from data store. */
#define WT_UPDATE_RESTORED_FROM_HS 0x0200u         /* Update restored from history store. */
#define WT_UPDATE_RTS_DRYRUN_ABORT 0x0400u         /* Used by dry run to mark a would-be abort. */
#define WT_UPDATE_TOMBSTONE_FOR_PREPARE_ROLLBACK \
    0x0800u                                 /* Tombstone that rollbacked a prepared update.*/
