...
WT_PACKED_STRUCT_BEGIN(__wt_update)
	...
	/*
	 * Use the maximum size and the maximum size-1 as is-deleted and
	 * is-reserved flags, which means we can't store 4GB objects; I'd
	 * rather not increase the size of this structure for a flag bit.
	 */
