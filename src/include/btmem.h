...
/* AUTOMATIC FLAG VALUE GENERATION START */
#define WT_REC_CALL_URGENT 0x01u
#define WT_REC_CHECKPOINT 0x02u
#define WT_REC_CLEAN_AFTER_REC 0x04u
#define WT_REC_EVICT 0x08u
#define WT_REC_HS 0x10u
#define WT_REC_IN_MEMORY 0x20u
#define WT_REC_SCRUB 0x40u
#define WT_REC_VISIBILITY_ERR 0x80u
