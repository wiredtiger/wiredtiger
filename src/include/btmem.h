...
#define mod_page_las u1.r.page_las
        ...
        struct { /* Multiple replacement blocks */
            ...
            /* Aggregated start/stop time pair of multiple replacement blocks */
            wt_timestamp_t newest_durable_ts;
            wt_timestamp_t oldest_start_ts;
            uint64_t oldest_start_txn;
            wt_timestamp_t newest_stop_ts;
...
#undef mod_multi_newest_durable_ts
#define mod_multi_newest_durable_ts u1.m.newest_durable_ts
#undef mod_multi_oldest_start_ts
#define mod_multi_oldest_start_ts u1.m.oldest_start_ts
#undef mod_multi_oldest_start_txn
#define mod_multi_oldest_start_txn u1.m.oldest_start_txn
