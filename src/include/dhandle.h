...
#define WT_DHANDLE_TS_ASSERT_READ_ALWAYS 0x001u  /* Assert read always checking. */
#define WT_DHANDLE_TS_ASSERT_READ_NEVER 0x002u   /* Assert read never checking. */
#define WT_DHANDLE_TS_ASSERT_WRITE 0x004u        /* Assert write checking. */
