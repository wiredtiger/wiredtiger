...
#define WT_DHANDLE_VERBOSE_TS_READ_ALWAYS 0x080u /* Verbose read always checking. */
#define WT_DHANDLE_VERBOSE_TS_READ_NEVER 0x100u  /* Verbose read never checking. */
#define WT_DHANDLE_VERBOSE_TS_WRITE 0x200u       /* Verbose write checking. */
