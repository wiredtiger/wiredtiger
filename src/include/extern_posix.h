...
extern int __wt_cond_init(WT_SESSION_IMPL *session, const char *name, WT_CONDVAR *cond) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
...
extern void __wt_cond_destroy(WT_SESSION_IMPL *session, WT_CONDVAR *cond);
