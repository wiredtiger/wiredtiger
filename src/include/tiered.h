 ...
 */
/* AUTOMATIC FLAG VALUE GENERATION START 0 */
#define WT_TIERED_WORK_CACHE 0x1u       /* Cache flushed object to tier. */
#define WT_TIERED_WORK_DROP_LOCAL 0x2u  /* Drop object from local storage. */
#define WT_TIERED_WORK_DROP_SHARED 0x4u /* Drop object from tier. */
#define WT_TIERED_WORK_FLUSH 0x8u       /* Flush object to tier. */
/* AUTOMATIC FLAG VALUE GENERATION STOP 32 */
