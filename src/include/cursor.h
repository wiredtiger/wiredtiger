...
struct __wt_cursor_btree {
     ...
     * Touch-cursor state.
     *
     * When ``touch_enabled`` is set, the cursor's search APIs fire a non-returning warmup hint down
     * the page log layer (PALI) for the would-be leaf page and return WT_NOTFOUND, instead of
