...
#define WT_CURSOR_STATIC_INIT(n, get_key, get_value, get_raw_key_value, set_key, set_value,        \
  set_raw_key_value, compare, equals, next, prev, reset, search, search_near, insert, modify,      \
  update, remove, reserve, reconfigure, largest_key, bound, cache, reopen, checkpoint_id, close)   \
    static const WT_CURSOR n = {                                                                   \
      ...
      NULL, /* key_format */                                                                       \
      NULL, /* value_format */                                                                     \
      get_key, get_value, get_raw_key_value, set_key, set_value, set_raw_key_value, compare,       \
      equals, next, prev, reset, search, search_near, insert, modify, update, remove, reserve,     \
