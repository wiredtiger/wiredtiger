...
#define WT_CURSOR_IS_DUMP(cursor) \
    F_ISSET(cursor,               \
      (WT_CURSTD_DUMP_HEX | WT_CURSTD_DUMP_PRINT | WT_CURSTD_DUMP_JSON | WT_CURSTD_DUMP_PRETTY))

#define WT_CURSOR_RAW_OK \
    (WT_CURSTD_DUMP_HEX | WT_CURSTD_DUMP_PRINT | WT_CURSTD_DUMP_PRETTY | WT_CURSTD_RAW)
