 ...
 */
static inline void
__wt_atomic_store_bool_relaxed(bool *vp, bool v)
{
    *(vp) = (v);
}
 ...
 */
static inline bool
__wt_atomic_load_bool_v_relaxed(volatile bool *vp)
{
    return (*(vp));
}
