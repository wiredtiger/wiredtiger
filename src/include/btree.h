...
#define WT_ASSERT_COMMIT_TS_ALWAYS 0x001u
#define WT_ASSERT_COMMIT_TS_KEY_CONSISTENT 0x002u
#define WT_ASSERT_COMMIT_TS_MIXED_MODE 0x004u
#define WT_ASSERT_COMMIT_TS_NEVER 0x008u
#define WT_ASSERT_COMMIT_TS_ORDERED 0x010u
#define WT_ASSERT_DURABLE_TS_ALWAYS 0x020u
#define WT_ASSERT_DURABLE_TS_KEY_CONSISTENT 0x040u
#define WT_ASSERT_DURABLE_TS_MIXED_MODE 0x080u
#define WT_ASSERT_DURABLE_TS_NEVER 0x100u
#define WT_ASSERT_DURABLE_TS_ORDERED 0x200u
#define WT_ASSERT_READ_TS_ALWAYS 0x400u
#define WT_ASSERT_READ_TS_NEVER 0x800u
