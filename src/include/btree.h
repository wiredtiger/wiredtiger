...
#define WT_ASSERT_COMMIT_TS_KEYS 0x002u
#define WT_ASSERT_COMMIT_TS_NEVER 0x004u
#define WT_ASSERT_DURABLE_TS_ALWAYS 0x008u
#define WT_ASSERT_DURABLE_TS_KEYS 0x010u
#define WT_ASSERT_DURABLE_TS_MIXED 0x020u
#define WT_ASSERT_DURABLE_TS_NEVER 0x040u
#define WT_ASSERT_READ_TS_ALWAYS 0x080u
#define WT_ASSERT_READ_TS_NEVER 0x100u
