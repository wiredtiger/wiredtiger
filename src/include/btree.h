...
#define BTCUR_SEARCH_NEAR_EVENT_NONE 0
#define BTCUR_SEARCH_NEAR_EVENT_CALL 1
#define BTCUR_SEARCH_NEAR_EVENT_EXIT 2
#define BTCUR_SEARCH_NEAR_EVENT_RET_NON_ZERO 3
#define BTCUR_SEARCH_NEAR_EVENT_DIAG_ORDER_INIT 4
#define BTCUR_SEARCH_NEAR_EVENT_RET_ZERO_EXACTP_NON_NULL 5
#define BTCUR_SEARCH_NEAR_EVENT_RET_ZERO_DONE 6
#define BTCUR_SEARCH_NEAR_EVENT_NOT_FIX_IMPLICIT 7
#define BTCUR_SEARCH_NEAR_EVENT_FIX_IMPLICIT 8
#define BTCUR_SEARCH_NEAR_EVENT_NOT_PREFIX_AND_MATCH 9
#define BTCUR_SEARCH_NEAR_EVENT_PREFIX_AND_MATCH 10
#define BTCUR_SEARCH_NEAR_EVENT_VALID2 11
#define BTCUR_SEARCH_NEAR_EVENT_INVALID_COL 12
#define BTCUR_SEARCH_NEAR_EVENT_INVALID_ROW 13
#define BTCUR_SEARCH_NEAR_EVENT_INVALID 14
#define BTCUR_SEARCH_NEAR_EVENT_LEAF_FOUND_ERR 15
#define BTCUR_SEARCH_NEAR_EVENT_ROW_AND_PINNED 16
#define BTCUR_SEARCH_NEAR_EVENT_SEARCH_NEIGHBOURING_RET_FINAL 17
#define BTCUR_SEARCH_NEAR_EVENT_SEARCH_NEIGHBOURING_RET_PREV 18
#define BTCUR_SEARCH_NEAR_EVENT_SEARCH_NEIGHBOURING_RET_PREFIX 19
#define BTCUR_SEARCH_NEAR_EVENT_SEARCH_NEIGHBOURING_RET_NEXT 20
#define BTCUR_SEARCH_NEAR_EVENT_SEARCH_NEIGHBOURING_CALL 21
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_CALL 22
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_RECNO_OOB 23
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_LEAF_NON_NULL 24
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_LEAF_NON_NULL_UNSAFE 25
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_LEAF_NON_NULL_UNSAFE_RET_ZERO 26
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_RESTART 27
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_OUTER_LOOP 28
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_OUTER_LOOP_BRK_PG_TYPE_WRONG 29
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_OUTER_LOOP_LAST_RET 30
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_LEAF_ONLY 31
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_RECNO_OOB_APPEND 32
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_COL_FIX_RECNO_LT 33
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_COL_FIX_RECNO_GT 34
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_COL_FIX_OK 35
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_NON_COL_FIX_RECNO_LT 36
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_NON_COL_FIX_RECNO_GT 37
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_NON_COL_FIX_OK 38
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_UPDATE_PRESENT 39
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_UPDATE_PRESENT_INSERT 40
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_HAPPY 41
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_PAST_END_FAIL 42
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_PAST_END_EQ 43
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_PAST_END_GT 44
#define BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_PAST_END_LT 45
#define BTCUR_SEARCH_NEAR_EVENT_COL_VAR_LAST_RECNO_REPEAT 46
#define BTCUR_SEARCH_NEAR_EVENT_TXN_READ_STOP_VISIBLE 47
#define BTCUR_SEARCH_NEAR_EVENT_TXN_READ_DHANDLE_IS_HS 48
#define BTCUR_SEARCH_NEAR_EVENT_TXN_READ_DHANDLE_IS_HS_SKIP_BUF 49
#define BTCUR_SEARCH_NEAR_EVENT_TXN_READ_CHECK_HS 50
#define BTCUR_SEARCH_NEAR_EVENT_TXN_READ_CHECK_HS_NOTFOUND 51
#define BTCUR_SEARCH_NEAR_EVENT_PG_SPLIT 52
#define BTCUR_SEARCH_NEAR_EVENT_CURSOR_VALID_DODGY_RETURN 53
#define BTCUR_SEARCH_NEAR_EVENT_CURSOR_VALID_DODGY_PAST_HERE 54
#define BTCUR_SEARCH_NEAR_EVENT_TXN_READ_SKIP_NO_ONDISK 55
#define BTCUR_SEARCH_NEAR_EVENT_CUR_VALID_CALL 56
#define BTCUR_SEARCH_NEAR_EVENT_CUR_VALID_CBT_INS_EXISTS 57
#define BTCUR_SEARCH_NEAR_EVENT_CUR_VALID_CBT_INS_NOT_INVALID 58
#define BTCUR_SEARCH_NEAR_EVENT_CUR_VALID_CBT_INS_NOT_INVALID_TOMBSTONE 59
#define BTCUR_SEARCH_NEAR_EVENT_CUR_VALID_COL_VAR_NO_ENTRIES 60
#define BTCUR_SEARCH_NEAR_EVENT_CUR_VALID_DODGY_RETURN 61
#define BTCUR_SEARCH_NEAR_EVENT_CUR_VALID_DODGY_PAST_HERE 62
#define BTCUR_SEARCH_NEAR_EVENT_CUR_VALID_CELL_DELETED 63
#define BTCUR_SEARCH_NEAR_EVENT_CUR_VALID_COL_VAR_BREAK 64
