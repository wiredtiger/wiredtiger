...
#define WT_BTREE_CLEAR_SIZE (offsetof(WT_BTREE, evict_ref))
    ...
    enum {
        BTCUR_SEARCH_NEAR_EVENT_NONE, /* 0 */
        BTCUR_SEARCH_NEAR_EVENT_CALL, /* 1 */
        BTCUR_SEARCH_NEAR_EVENT_EXIT, /* 2 */
        BTCUR_SEARCH_NEAR_EVENT_RET_NON_ZERO, /* 3 */
        BTCUR_SEARCH_NEAR_EVENT_DIAG_ORDER_INIT, /* 4 */
        BTCUR_SEARCH_NEAR_EVENT_RET_ZERO_EXACTP_NON_NULL, /* 5 */
        BTCUR_SEARCH_NEAR_EVENT_RET_ZERO_DONE, /* 6 */
        BTCUR_SEARCH_NEAR_EVENT_NOT_FIX_IMPLICIT, /* 7 */
        BTCUR_SEARCH_NEAR_EVENT_FIX_IMPLICIT, /* 8 */
        BTCUR_SEARCH_NEAR_EVENT_NOT_PREFIX_AND_MATCH, /* 9 */
        BTCUR_SEARCH_NEAR_EVENT_PREFIX_AND_MATCH, /* 10 */
        BTCUR_SEARCH_NEAR_EVENT_VALID2, /* 11 */
        BTCUR_SEARCH_NEAR_EVENT_INVALID_COL, /* 12 */
        BTCUR_SEARCH_NEAR_EVENT_INVALID_ROW, /* 13 */
        BTCUR_SEARCH_NEAR_EVENT_INVALID, /* 14 */
        BTCUR_SEARCH_NEAR_EVENT_LEAF_FOUND_ERR, /* 15 */
        BTCUR_SEARCH_NEAR_EVENT_ROW_AND_PINNED, /* 16 */
        BTCUR_SEARCH_NEAR_EVENT_SEARCH_NEIGHBOURING_RET_FINAL, /* 17 */
        BTCUR_SEARCH_NEAR_EVENT_SEARCH_NEIGHBOURING_RET_PREV, /* 18 */
        BTCUR_SEARCH_NEAR_EVENT_SEARCH_NEIGHBOURING_RET_PREFIX, /* 19 */
        BTCUR_SEARCH_NEAR_EVENT_SEARCH_NEIGHBOURING_RET_NEXT, /* 20 */
        BTCUR_SEARCH_NEAR_EVENT_SEARCH_NEIGHBOURING_CALL, /* 21 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_CALL, /* 22 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_RECNO_OOB, /* 23 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_LEAF_NON_NULL, /* 24 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_LEAF_NON_NULL_UNSAFE, /* 25 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_LEAF_NON_NULL_UNSAFE_RET_ZERO, /* 26 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_RESTART, /* 27 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_OUTER_LOOP, /* 28 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_OUTER_LOOP_BRK_PG_TYPE_WRONG, /* 29 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_OUTER_LOOP_LAST_RET, /* 30 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_LEAF_ONLY, /* 31 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_RECNO_OOB_APPEND, /* 32 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_COL_FIX_RECNO_LT, /* 33 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_COL_FIX_RECNO_GT, /* 34 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_COL_FIX_OK, /* 35 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_NON_COL_FIX_RECNO_LT, /* 36 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_NON_COL_FIX_RECNO_GT, /* 37 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_NON_COL_FIX_OK, /* 38 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_UPDATE_PRESENT, /* 39 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_UPDATE_PRESENT_INSERT, /* 40 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_HAPPY, /* 41 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_PAST_END_FAIL, /* 42 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_PAST_END_EQ, /* 43 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_PAST_END_GT, /* 44 */
        BTCUR_SEARCH_NEAR_EVENT_COL_SRCH_PAST_END_LT, /* 45 */
    } search_near_event;
