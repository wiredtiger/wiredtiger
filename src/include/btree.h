...
#define WT_BTREE_ID_NAMESPACE_SPECIAL 2
...
#define WT_BTREE_ID_SPECIAL(x) (WT_BTREE_ID_NAMESPACE_ID(x) == WT_BTREE_ID_NAMESPACE_SPECIAL)
#define WT_BTREE_ID_SHARED(x) \
    ((WT_BTREE_ID_NAMESPACE_ID(x) == WT_BTREE_ID_NAMESPACE_SHARED) || WT_BTREE_ID_SPECIAL(x))
