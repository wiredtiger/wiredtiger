...
#define WT_CONF_ID_evict_dhandle_hash_size 247ULL
#define WT_CONF_ID_evict_num_buckets 246ULL
#define WT_CONF_ID_evict_sample_inmem 250ULL
...
#define WT_CONF_ID_threads_max 248ULL
#define WT_CONF_ID_threads_min 249ULL
...
static const struct {
    ...
    struct {
        uint64_t evict_dhandle_hash_size;
  ...
  {
    WT_CONF_ID_Eviction | (WT_CONF_ID_evict_dhandle_hash_size << 16),
