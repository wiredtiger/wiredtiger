...
#define WT_CONF_ID_disagg_block_header_upgrade 245ULL
...
static const struct {
    ...
    struct {
        ...
        uint64_t disagg_block_header_upgrade;
  ...
  },
  {
    ...
    WT_CONF_ID_Debug_mode | (WT_CONF_ID_disagg_block_header_upgrade << 16),
