...
#define WT_CONF_ID_Block_cache 209ULL
#define WT_CONF_ID_Checkpoint 224ULL
#define WT_CONF_ID_Checkpoint_cleanup 227ULL
#define WT_CONF_ID_Chunk_cache 345ULL
#define WT_CONF_ID_Compatibility 230ULL
#define WT_CONF_ID_Crash_point 234ULL
#define WT_CONF_ID_Debug 134ULL
#define WT_CONF_ID_Debug_mode 232ULL
#define WT_CONF_ID_Disaggregated 20ULL
#define WT_CONF_ID_Dump_version 136ULL
#define WT_CONF_ID_Encryption 23ULL
#define WT_CONF_ID_Eviction 262ULL
#define WT_CONF_ID_File_manager 283ULL
#define WT_CONF_ID_Flush_tier 195ULL
#define WT_CONF_ID_Hash 361ULL
#define WT_CONF_ID_Heuristic_controls 288ULL
#define WT_CONF_ID_History_store 292ULL
#define WT_CONF_ID_Import 104ULL
#define WT_CONF_ID_Incremental 146ULL
#define WT_CONF_ID_Io_capacity 294ULL
#define WT_CONF_ID_Live_restore 65ULL
#define WT_CONF_ID_Load_control 298ULL
#define WT_CONF_ID_Log 41ULL
#define WT_CONF_ID_Lsm 110ULL
#define WT_CONF_ID_Merge_custom 120ULL
#define WT_CONF_ID_Operation_tracking 307ULL
#define WT_CONF_ID_Page_delta 309ULL
#define WT_CONF_ID_Prefetch 334ULL
#define WT_CONF_ID_Prefetch1 339ULL
#define WT_CONF_ID_Rollback_to_stable 315ULL
#define WT_CONF_ID_Roundup_timestamps 184ULL
#define WT_CONF_ID_Shared_cache 317ULL
#define WT_CONF_ID_Statistics_log 321ULL
#define WT_CONF_ID_Tiered_storage 52ULL
#define WT_CONF_ID_Transaction_sync 381ULL
#define WT_CONF_ID_access_pattern_hint 12ULL
#define WT_CONF_ID_action 93ULL
#define WT_CONF_ID_after_drop_colgroup 237ULL
#define WT_CONF_ID_after_drop_file 238ULL
#define WT_CONF_ID_allocation_size 13ULL
#define WT_CONF_ID_app_eviction_min_cache_fill_ratio 270ULL
#define WT_CONF_ID_app_metadata 0ULL
#define WT_CONF_ID_append 90ULL
#define WT_CONF_ID_archive 301ULL
#define WT_CONF_ID_auth_token 53ULL
#define WT_CONF_ID_auto_throttle 111ULL
#define WT_CONF_ID_available 373ULL
#define WT_CONF_ID_background 97ULL
#define WT_CONF_ID_background_compact 233ULL
#define WT_CONF_ID_backup 200ULL
#define WT_CONF_ID_backup_restore_target 340ULL
#define WT_CONF_ID_before_insert_colgroup 235ULL
#define WT_CONF_ID_before_insert_file 236ULL
#define WT_CONF_ID_bitmap 66ULL
#define WT_CONF_ID_blkcache_eviction_aggression 212ULL
#define WT_CONF_ID_block_allocation 14ULL
#define WT_CONF_ID_block_compressor 15ULL
#define WT_CONF_ID_block_manager 16ULL
#define WT_CONF_ID_bloom 112ULL
#define WT_CONF_ID_bloom_bit_count 113ULL
#define WT_CONF_ID_bloom_config 114ULL
#define WT_CONF_ID_bloom_hash_count 115ULL
#define WT_CONF_ID_bloom_oldest 116ULL
#define WT_CONF_ID_bound 94ULL
#define WT_CONF_ID_bucket 54ULL
#define WT_CONF_ID_bucket_prefix 55ULL
#define WT_CONF_ID_buckets 362ULL
#define WT_CONF_ID_buffer_alignment 341ULL
#define WT_CONF_ID_builtin_extension_config 342ULL
#define WT_CONF_ID_bulk 132ULL
#define WT_CONF_ID_cache 201ULL
#define WT_CONF_ID_cache_cursors 331ULL
#define WT_CONF_ID_cache_directory 56ULL
#define WT_CONF_ID_cache_max_wait_ms 220ULL
#define WT_CONF_ID_cache_on_checkpoint 210ULL
#define WT_CONF_ID_cache_on_writes 211ULL
#define WT_CONF_ID_cache_overhead 221ULL
#define WT_CONF_ID_cache_resident 17ULL
#define WT_CONF_ID_cache_size 222ULL
#define WT_CONF_ID_cache_stuck_timeout_ms 223ULL
#define WT_CONF_ID_cache_tolerance_for_app_eviction 271ULL
#define WT_CONF_ID_cache_top 202ULL
#define WT_CONF_ID_capacity 347ULL
...
#define WT_CONF_ID_checkpoint_cleanup_obsolete_tw_pages_dirty_max 289ULL
#define WT_CONF_ID_checkpoint_crash_point 191ULL
#define WT_CONF_ID_checkpoint_crash_trigger_point 192ULL
#define WT_CONF_ID_checkpoint_fail_before_turtle_update 332ULL
#define WT_CONF_ID_checkpoint_lsn 63ULL
#define WT_CONF_ID_checkpoint_meta 75ULL
#define WT_CONF_ID_checkpoint_read_timestamp 135ULL
#define WT_CONF_ID_checkpoint_retention 240ULL
#define WT_CONF_ID_checkpoint_scrub_eviction 265ULL
#define WT_CONF_ID_checkpoint_scrub_image_max 266ULL
#define WT_CONF_ID_checkpoint_sync 343ULL
#define WT_CONF_ID_checkpoint_threads 344ULL
#define WT_CONF_ID_checkpoint_use_history 133ULL
#define WT_CONF_ID_checkpoint_wait 126ULL
#define WT_CONF_ID_checksum 18ULL
#define WT_CONF_ID_chunk 318ULL
#define WT_CONF_ID_chunk_cache 296ULL
#define WT_CONF_ID_chunk_cache_evict_trigger 348ULL
#define WT_CONF_ID_chunk_count_limit 117ULL
#define WT_CONF_ID_chunk_max 118ULL
#define WT_CONF_ID_chunk_size 119ULL
#define WT_CONF_ID_claim_prepared_id 177ULL
#define WT_CONF_ID_close_handle_minimum 284ULL
#define WT_CONF_ID_close_idle_time 285ULL
#define WT_CONF_ID_close_scan_interval 286ULL
...
#define WT_CONF_ID_compile_configuration_count 353ULL
#define WT_CONF_ID_compressor 366ULL
#define WT_CONF_ID_config 327ULL
#define WT_CONF_ID_config_base 354ULL
#define WT_CONF_ID_configuration 241ULL
#define WT_CONF_ID_consolidate 147ULL
#define WT_CONF_ID_control_threshold 300ULL
#define WT_CONF_ID_corruption_abort 239ULL
#define WT_CONF_ID_create 355ULL
#define WT_CONF_ID_cross_key 141ULL
#define WT_CONF_ID_cursor_copy 242ULL
#define WT_CONF_ID_cursor_reposition 243ULL
#define WT_CONF_ID_cursors 203ULL
#define WT_CONF_ID_database_size_fix 193ULL
#define WT_CONF_ID_default 374ULL
#define WT_CONF_ID_delete_pct 313ULL
#define WT_CONF_ID_delta_pct 310ULL
#define WT_CONF_ID_dhandle_buckets 363ULL
#define WT_CONF_ID_dictionary 19ULL
#define WT_CONF_ID_direct_io 356ULL
#define WT_CONF_ID_disagg_address_cookie_optional_field 245ULL
#define WT_CONF_ID_disagg_address_cookie_upgrade 244ULL
#define WT_CONF_ID_disagg_commit_ts_optional 246ULL
#define WT_CONF_ID_disagg_slow_truncate_follower 247ULL
#define WT_CONF_ID_do_not_clear_txn_id 163ULL
#define WT_CONF_ID_drain_threads 76ULL
#define WT_CONF_ID_drop 194ULL
#define WT_CONF_ID_dryrun 98ULL
#define WT_CONF_ID_dump 145ULL
#define WT_CONF_ID_dump_address 164ULL
#define WT_CONF_ID_dump_all_data 165ULL
#define WT_CONF_ID_dump_blocks 166ULL
#define WT_CONF_ID_dump_key_data 167ULL
#define WT_CONF_ID_dump_layout 168ULL
#define WT_CONF_ID_dump_offsets 169ULL
#define WT_CONF_ID_dump_pages 170ULL
#define WT_CONF_ID_dump_tree_shape 171ULL
#define WT_CONF_ID_durable_timestamp 3ULL
#define WT_CONF_ID_early_load 328ULL
#define WT_CONF_ID_enable 299ULL
#define WT_CONF_ID_enabled 42ULL
#define WT_CONF_ID_entry 329ULL
#define WT_CONF_ID_error_prefix 261ULL
#define WT_CONF_ID_evict_sample_inmem 267ULL
#define WT_CONF_ID_evict_use_softptr 268ULL
#define WT_CONF_ID_eviction 248ULL
#define WT_CONF_ID_eviction_checkpoint_target 275ULL
#define WT_CONF_ID_eviction_checkpoint_ts_ordering 260ULL
#define WT_CONF_ID_eviction_dirty_target 276ULL
#define WT_CONF_ID_eviction_dirty_trigger 277ULL
#define WT_CONF_ID_eviction_obsolete_tw_pages_dirty_max 290ULL
#define WT_CONF_ID_eviction_target 278ULL
#define WT_CONF_ID_eviction_trigger 279ULL
#define WT_CONF_ID_eviction_updates_target 280ULL
#define WT_CONF_ID_eviction_updates_trigger 281ULL
#define WT_CONF_ID_exclude 99ULL
#define WT_CONF_ID_exclusive 103ULL
#define WT_CONF_ID_exclusive_refreshed 96ULL
#define WT_CONF_ID_extensions 358ULL
#define WT_CONF_ID_extensions_strict 359ULL
#define WT_CONF_ID_extra_diagnostics 282ULL
#define WT_CONF_ID_extractor 71ULL
#define WT_CONF_ID_file 148ULL
#define WT_CONF_ID_file_extend 360ULL
#define WT_CONF_ID_file_max 293ULL
#define WT_CONF_ID_file_metadata 106ULL
#define WT_CONF_ID_file_wait_ms 229ULL
#define WT_CONF_ID_final_flush 198ULL
#define WT_CONF_ID_fix_btree_size 172ULL
#define WT_CONF_ID_flush_time 73ULL
#define WT_CONF_ID_flush_timestamp 74ULL
#define WT_CONF_ID_flushed_data_cache_insertion 350ULL
#define WT_CONF_ID_force 127ULL
#define WT_CONF_ID_force_stop 149ULL
#define WT_CONF_ID_force_write_wait 367ULL
#define WT_CONF_ID_format 26ULL
#define WT_CONF_ID_free_space_target 100ULL
#define WT_CONF_ID_full_target 213ULL
#define WT_CONF_ID_generation_drain_timeout_ms 287ULL
#define WT_CONF_ID_get 162ULL
#define WT_CONF_ID_granularity 150ULL
#define WT_CONF_ID_handles 204ULL
#define WT_CONF_ID_hashsize 215ULL
#define WT_CONF_ID_hazard_max 364ULL
#define WT_CONF_ID_huffman_key 27ULL
#define WT_CONF_ID_huffman_value 28ULL
#define WT_CONF_ID_id 64ULL
#define WT_CONF_ID_ignore_cache_size 178ULL
#define WT_CONF_ID_ignore_in_memory_cache_size 29ULL
#define WT_CONF_ID_ignore_prepare 179ULL
#define WT_CONF_ID_immutable 72ULL
#define WT_CONF_ID_in_memory 30ULL
#define WT_CONF_ID_inclusive 95ULL
#define WT_CONF_ID_incremental_app_eviction 272ULL
...
#define WT_CONF_ID_internal_page_delta 311ULL
#define WT_CONF_ID_internal_page_max 34ULL
#define WT_CONF_ID_interval 380ULL
#define WT_CONF_ID_isolation 180ULL
#define WT_CONF_ID_json 322ULL
#define WT_CONF_ID_json_output 297ULL
...
#define WT_CONF_ID_leaf_page_delta 312ULL
#define WT_CONF_ID_leaf_page_max 39ULL
#define WT_CONF_ID_leaf_value_max 40ULL
#define WT_CONF_ID_leak_memory 199ULL
#define WT_CONF_ID_legacy_page_visit_strategy 269ULL
#define WT_CONF_ID_legacy_tombstone_encoding_break_glass 83ULL
#define WT_CONF_ID_local_files_action 78ULL
#define WT_CONF_ID_local_retention 57ULL
#define WT_CONF_ID_lock_wait 128ULL
#define WT_CONF_ID_log 205ULL
#define WT_CONF_ID_log_retention 249ULL
#define WT_CONF_ID_log_size 225ULL
#define WT_CONF_ID_lose_all_my_data 79ULL
#define WT_CONF_ID_max_consecutive_delta 314ULL
#define WT_CONF_ID_max_percent_overhead 216ULL
#define WT_CONF_ID_memory_page_image_max 43ULL
#define WT_CONF_ID_memory_page_max 44ULL
#define WT_CONF_ID_merge_max 124ULL
#define WT_CONF_ID_merge_min 125ULL
#define WT_CONF_ID_metadata 206ULL
#define WT_CONF_ID_metadata_file 107ULL
#define WT_CONF_ID_method 228ULL
#define WT_CONF_ID_mmap 369ULL
#define WT_CONF_ID_mmap_all 370ULL
#define WT_CONF_ID_multiprocess 371ULL
#define WT_CONF_ID_name 24ULL
#define WT_CONF_ID_nbits 67ULL
#define WT_CONF_ID_next_random 153ULL
#define WT_CONF_ID_next_random_sample_size 154ULL
#define WT_CONF_ID_next_random_seed 155ULL
#define WT_CONF_ID_no_timestamp 181ULL
#define WT_CONF_ID_nvram_path 217ULL
#define WT_CONF_ID_object_target_size 58ULL
#define WT_CONF_ID_obsolete_tw_btree_max 291ULL
#define WT_CONF_ID_oldest 88ULL
#define WT_CONF_ID_oldest_timestamp 335ULL
#define WT_CONF_ID_on_close 323ULL
#define WT_CONF_ID_operation_timeout_ms 182ULL
#define WT_CONF_ID_os_cache_dirty_max 45ULL
#define WT_CONF_ID_os_cache_dirty_pct 302ULL
#define WT_CONF_ID_os_cache_max 46ULL
#define WT_CONF_ID_overwrite 91ULL
#define WT_CONF_ID_page_history 250ULL
#define WT_CONF_ID_page_log 21ULL
#define WT_CONF_ID_panic_corrupt 108ULL
#define WT_CONF_ID_path 308ULL
#define WT_CONF_ID_percent_file_in_dram 218ULL
#define WT_CONF_ID_pinned 346ULL
#define WT_CONF_ID_prealloc 303ULL
#define WT_CONF_ID_prealloc_init_count 304ULL
#define WT_CONF_ID_precise_checkpoint 372ULL
#define WT_CONF_ID_prefer_scrub_eviction 273ULL
#define WT_CONF_ID_prefix 121ULL
...
#define WT_CONF_ID_prepare_timestamp 187ULL
#define WT_CONF_ID_prepared 185ULL
#define WT_CONF_ID_prepared_id 188ULL
#define WT_CONF_ID_preserve_prepared 375ULL
#define WT_CONF_ID_priority 183ULL
#define WT_CONF_ID_quota 319ULL
#define WT_CONF_ID_raw 156ULL
#define WT_CONF_ID_raw_key_value 140ULL
#define WT_CONF_ID_read 186ULL
#define WT_CONF_ID_read_corrupt 173ULL
#define WT_CONF_ID_read_once 157ULL
#define WT_CONF_ID_read_size 365ULL
#define WT_CONF_ID_read_timestamp 4ULL
#define WT_CONF_ID_readonly 68ULL
#define WT_CONF_ID_realloc_exact 251ULL
#define WT_CONF_ID_realloc_malloc 252ULL
#define WT_CONF_ID_recover 368ULL
#define WT_CONF_ID_release 231ULL
#define WT_CONF_ID_release_evict 143ULL
#define WT_CONF_ID_release_evict_page 333ULL
#define WT_CONF_ID_remove 305ULL
#define WT_CONF_ID_remove_files 129ULL
#define WT_CONF_ID_remove_shared 130ULL
#define WT_CONF_ID_repair 109ULL
#define WT_CONF_ID_require_max 351ULL
#define WT_CONF_ID_require_min 352ULL
#define WT_CONF_ID_reserve 320ULL
#define WT_CONF_ID_role 80ULL
#define WT_CONF_ID_rollback_error 253ULL
#define WT_CONF_ID_rollback_timestamp 189ULL
#define WT_CONF_ID_run_once 101ULL
#define WT_CONF_ID_salvage 376ULL
#define WT_CONF_ID_schema_epoch 161ULL
#define WT_CONF_ID_secretkey 357ULL
#define WT_CONF_ID_session_max 377ULL
#define WT_CONF_ID_session_scratch_max 378ULL
#define WT_CONF_ID_session_table_cache 379ULL
#define WT_CONF_ID_sessions 207ULL
#define WT_CONF_ID_shared 59ULL
#define WT_CONF_ID_show_prepared_rollback 142ULL
#define WT_CONF_ID_size 214ULL
#define WT_CONF_ID_size_stats 144ULL
#define WT_CONF_ID_skip_checkpoint 197ULL
#define WT_CONF_ID_skip_per_key_hs 174ULL
#define WT_CONF_ID_skip_sort_check 158ULL
#define WT_CONF_ID_skip_update_obsolete_check 274ULL
#define WT_CONF_ID_slow_checkpoint 254ULL
#define WT_CONF_ID_slow_truncate 255ULL
#define WT_CONF_ID_source 8ULL
#define WT_CONF_ID_sources 324ULL
...
#define WT_CONF_ID_src_id 151ULL
#define WT_CONF_ID_stable 85ULL
#define WT_CONF_ID_stable_disaggregated_schema_epoch 336ULL
#define WT_CONF_ID_stable_timestamp 175ULL
#define WT_CONF_ID_start_generation 122ULL
#define WT_CONF_ID_start_timestamp 138ULL
#define WT_CONF_ID_statistics 159ULL
#define WT_CONF_ID_step_down_disaggregated_schema_epoch 337ULL
#define WT_CONF_ID_step_down_timestamp 338ULL
#define WT_CONF_ID_stepdown_write_mirroring 82ULL
#define WT_CONF_ID_storage_path 349ULL
#define WT_CONF_ID_storage_tier 22ULL
#define WT_CONF_ID_stress_skiplist 256ULL
#define WT_CONF_ID_strict 176ULL
#define WT_CONF_ID_strict_checkpoint_metadata 81ULL
#define WT_CONF_ID_suffix 123ULL
#define WT_CONF_ID_sync 131ULL
#define WT_CONF_ID_system_ram 219ULL
#define WT_CONF_ID_table_logging 257ULL
#define WT_CONF_ID_target 160ULL
#define WT_CONF_ID_terminate 330ULL
#define WT_CONF_ID_this_id 152ULL
#define WT_CONF_ID_threads 316ULL
#define WT_CONF_ID_threads_max 263ULL
#define WT_CONF_ID_threads_min 264ULL
#define WT_CONF_ID_tiered_flush_error_continue 258ULL
#define WT_CONF_ID_tiered_object 69ULL
#define WT_CONF_ID_tiers 89ULL
#define WT_CONF_ID_timeout 102ULL
#define WT_CONF_ID_timestamp 325ULL
#define WT_CONF_ID_timestamp_order 139ULL
#define WT_CONF_ID_timing_stress_for_test 326ULL
#define WT_CONF_ID_total 295ULL
#define WT_CONF_ID_txn 208ULL
#define WT_CONF_ID_type 9ULL
#define WT_CONF_ID_update_restore_evict 259ULL
#define WT_CONF_ID_use_environment 382ULL
#define WT_CONF_ID_use_environment_priv 383ULL
#define WT_CONF_ID_use_timestamp 196ULL
#define WT_CONF_ID_value_format 60ULL
#define WT_CONF_ID_verbose 10ULL
#define WT_CONF_ID_verify_metadata 384ULL
#define WT_CONF_ID_version 70ULL
#define WT_CONF_ID_visible_only 137ULL
#define WT_CONF_ID_wait 226ULL
#define WT_CONF_ID_write_through 385ULL
#define WT_CONF_ID_write_timestamp 5ULL
#define WT_CONF_ID_write_timestamp_usage 11ULL
#define WT_CONF_ID_zero_fill 306ULL

#define WT_CONF_ID_COUNT 386
/*
...
static const struct {
    ...
    struct {
        ...
        uint64_t page_log;
        uint64_t role;
        uint64_t stepdown_write_mirroring;
  ...
  },
  {
    ...
    WT_CONF_ID_Disaggregated | (WT_CONF_ID_stepdown_write_mirroring << 16),
