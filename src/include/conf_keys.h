...
#define WT_CONF_ID_Block_cache 181ULL
#define WT_CONF_ID_Checkpoint 196ULL
#define WT_CONF_ID_Checkpoint_cleanup 199ULL
#define WT_CONF_ID_Chunk_cache 201ULL
#define WT_CONF_ID_Compatibility 203ULL
#define WT_CONF_ID_Debug 127ULL
#define WT_CONF_ID_Debug_mode 205ULL
...
#define WT_CONF_ID_Import 109ULL
#define WT_CONF_ID_Incremental 132ULL
#define WT_CONF_ID_Io_capacity 241ULL
#define WT_CONF_ID_Log 36ULL
#define WT_CONF_ID_Lsm 70ULL
#define WT_CONF_ID_Lsm_manager 251ULL
#define WT_CONF_ID_Merge_custom 80ULL
#define WT_CONF_ID_Operation_tracking 254ULL
#define WT_CONF_ID_Prefetch 274ULL
#define WT_CONF_ID_Roundup_timestamps 164ULL
#define WT_CONF_ID_Shared_cache 256ULL
#define WT_CONF_ID_Statistics_log 260ULL
#define WT_CONF_ID_Tiered_storage 49ULL
#define WT_CONF_ID_Transaction_sync 312ULL
#define WT_CONF_ID_access_pattern_hint 12ULL
#define WT_CONF_ID_action 98ULL
#define WT_CONF_ID_allocation_size 13ULL
#define WT_CONF_ID_app_metadata 0ULL
#define WT_CONF_ID_append 95ULL
#define WT_CONF_ID_archive 245ULL
#define WT_CONF_ID_auth_token 50ULL
#define WT_CONF_ID_auto_throttle 71ULL
#define WT_CONF_ID_available 305ULL
#define WT_CONF_ID_background 102ULL
#define WT_CONF_ID_background_compact 206ULL
#define WT_CONF_ID_backup 174ULL
#define WT_CONF_ID_backup_restore_target 277ULL
#define WT_CONF_ID_blkcache_eviction_aggression 184ULL
#define WT_CONF_ID_block_allocation 14ULL
#define WT_CONF_ID_block_compressor 15ULL
#define WT_CONF_ID_bloom 72ULL
#define WT_CONF_ID_bloom_bit_count 73ULL
#define WT_CONF_ID_bloom_config 74ULL
#define WT_CONF_ID_bloom_false_positives 119ULL
#define WT_CONF_ID_bloom_hash_count 75ULL
#define WT_CONF_ID_bloom_oldest 76ULL
#define WT_CONF_ID_bound 99ULL
#define WT_CONF_ID_bucket 51ULL
#define WT_CONF_ID_bucket_prefix 52ULL
...
#define WT_CONF_ID_bulk 125ULL
#define WT_CONF_ID_cache 175ULL
#define WT_CONF_ID_cache_cursors 270ULL
#define WT_CONF_ID_cache_directory 53ULL
#define WT_CONF_ID_cache_max_wait_ms 192ULL
#define WT_CONF_ID_cache_on_checkpoint 182ULL
#define WT_CONF_ID_cache_on_writes 183ULL
#define WT_CONF_ID_cache_overhead 193ULL
#define WT_CONF_ID_cache_resident 16ULL
#define WT_CONF_ID_cache_size 194ULL
#define WT_CONF_ID_cache_stuck_timeout_ms 195ULL
#define WT_CONF_ID_capacity 281ULL
#define WT_CONF_ID_checkpoint 58ULL
#define WT_CONF_ID_checkpoint_backup_info 59ULL
#define WT_CONF_ID_checkpoint_cleanup 168ULL
#define WT_CONF_ID_checkpoint_fail_before_turtle_update 271ULL
#define WT_CONF_ID_checkpoint_lsn 60ULL
#define WT_CONF_ID_checkpoint_read_timestamp 128ULL
#define WT_CONF_ID_checkpoint_retention 208ULL
#define WT_CONF_ID_checkpoint_sync 280ULL
#define WT_CONF_ID_checkpoint_use_history 126ULL
#define WT_CONF_ID_checkpoint_wait 114ULL
...
#define WT_CONF_ID_chunk_count_limit 77ULL
#define WT_CONF_ID_chunk_max 78ULL
#define WT_CONF_ID_chunk_size 79ULL
#define WT_CONF_ID_chunks 68ULL
...
#define WT_CONF_ID_colgroups 92ULL
#define WT_CONF_ID_collator 6ULL
#define WT_CONF_ID_columns 7ULL
#define WT_CONF_ID_commit_timestamp 2ULL
#define WT_CONF_ID_compare 120ULL
#define WT_CONF_ID_compare_timestamp 110ULL
...
#define WT_CONF_ID_consolidate 133ULL
#define WT_CONF_ID_corruption_abort 207ULL
#define WT_CONF_ID_count 121ULL
#define WT_CONF_ID_create 289ULL
#define WT_CONF_ID_cursor_copy 209ULL
#define WT_CONF_ID_cursor_reposition 210ULL
...
#define WT_CONF_ID_do_not_clear_txn_id 148ULL
#define WT_CONF_ID_drop 169ULL
#define WT_CONF_ID_dryrun 103ULL
#define WT_CONF_ID_dump 131ULL
#define WT_CONF_ID_dump_address 149ULL
#define WT_CONF_ID_dump_all_data 150ULL
#define WT_CONF_ID_dump_blocks 151ULL
#define WT_CONF_ID_dump_key_data 152ULL
#define WT_CONF_ID_dump_layout 153ULL
#define WT_CONF_ID_dump_offsets 154ULL
#define WT_CONF_ID_dump_pages 155ULL
#define WT_CONF_ID_dump_version 129ULL
...
#define WT_CONF_ID_eviction 211ULL
...
#define WT_CONF_ID_exclude 104ULL
#define WT_CONF_ID_exclusive 108ULL
#define WT_CONF_ID_exclusive_refreshed 101ULL
#define WT_CONF_ID_extensions 292ULL
#define WT_CONF_ID_extra_diagnostics 233ULL
#define WT_CONF_ID_extractor 65ULL
#define WT_CONF_ID_file 134ULL
#define WT_CONF_ID_file_extend 293ULL
#define WT_CONF_ID_file_max 240ULL
#define WT_CONF_ID_file_metadata 112ULL
#define WT_CONF_ID_final_flush 172ULL
#define WT_CONF_ID_flush_time 87ULL
#define WT_CONF_ID_flush_timestamp 88ULL
#define WT_CONF_ID_flushed_data_cache_insertion 284ULL
#define WT_CONF_ID_force 115ULL
#define WT_CONF_ID_force_stop 135ULL
#define WT_CONF_ID_force_write_wait 300ULL
#define WT_CONF_ID_format 22ULL
#define WT_CONF_ID_free_space_target 105ULL
#define WT_CONF_ID_full_target 185ULL
#define WT_CONF_ID_generation_drain_timeout_ms 238ULL
#define WT_CONF_ID_get 147ULL
#define WT_CONF_ID_granularity 136ULL
#define WT_CONF_ID_handles 177ULL
#define WT_CONF_ID_hashsize 187ULL
#define WT_CONF_ID_hazard_max 297ULL
#define WT_CONF_ID_huffman_key 23ULL
#define WT_CONF_ID_huffman_value 24ULL
#define WT_CONF_ID_id 61ULL
#define WT_CONF_ID_ignore_cache_size 273ULL
#define WT_CONF_ID_ignore_in_memory_cache_size 25ULL
#define WT_CONF_ID_ignore_prepare 159ULL
#define WT_CONF_ID_immutable 66ULL
#define WT_CONF_ID_in_memory 298ULL
#define WT_CONF_ID_inclusive 100ULL
#define WT_CONF_ID_index_key_columns 67ULL
#define WT_CONF_ID_ingest 89ULL
...
#define WT_CONF_ID_isolation 160ULL
...
#define WT_CONF_ID_local_retention 54ULL
#define WT_CONF_ID_lock_wait 116ULL
#define WT_CONF_ID_log 178ULL
#define WT_CONF_ID_log_retention 212ULL
#define WT_CONF_ID_log_size 197ULL
#define WT_CONF_ID_max_percent_overhead 188ULL
#define WT_CONF_ID_memory_page_image_max 39ULL
#define WT_CONF_ID_memory_page_max 40ULL
#define WT_CONF_ID_merge 253ULL
#define WT_CONF_ID_merge_max 84ULL
#define WT_CONF_ID_merge_min 85ULL
#define WT_CONF_ID_metadata_file 113ULL
...
#define WT_CONF_ID_next_random 139ULL
#define WT_CONF_ID_next_random_sample_size 140ULL
#define WT_CONF_ID_next_random_seed 141ULL
#define WT_CONF_ID_no_timestamp 161ULL
#define WT_CONF_ID_nvram_path 189ULL
#define WT_CONF_ID_object_target_size 55ULL
#define WT_CONF_ID_old_chunks 86ULL
#define WT_CONF_ID_oldest 93ULL
#define WT_CONF_ID_oldest_timestamp 275ULL
#define WT_CONF_ID_oligarch_constituent 38ULL
#define WT_CONF_ID_oligarch_test_config 90ULL
#define WT_CONF_ID_on_close 262ULL
#define WT_CONF_ID_operation 122ULL
#define WT_CONF_ID_operation_timeout_ms 162ULL
#define WT_CONF_ID_os_cache_dirty_max 41ULL
#define WT_CONF_ID_os_cache_dirty_pct 246ULL
#define WT_CONF_ID_os_cache_max 42ULL
#define WT_CONF_ID_overwrite 96ULL
#define WT_CONF_ID_path 255ULL
#define WT_CONF_ID_percent_file_in_dram 190ULL
#define WT_CONF_ID_pinned 202ULL
...
#define WT_CONF_ID_prefix_search 97ULL
#define WT_CONF_ID_prepare_timestamp 167ULL
#define WT_CONF_ID_prepared 165ULL
#define WT_CONF_ID_priority 163ULL
#define WT_CONF_ID_quota 258ULL
#define WT_CONF_ID_raw 142ULL
#define WT_CONF_ID_read 166ULL
#define WT_CONF_ID_read_corrupt 156ULL
#define WT_CONF_ID_read_once 143ULL
#define WT_CONF_ID_read_timestamp 4ULL
#define WT_CONF_ID_readonly 62ULL
#define WT_CONF_ID_realloc_exact 213ULL
#define WT_CONF_ID_realloc_malloc 214ULL
#define WT_CONF_ID_recover 301ULL
#define WT_CONF_ID_release 204ULL
#define WT_CONF_ID_release_evict 130ULL
#define WT_CONF_ID_release_evict_page 272ULL
#define WT_CONF_ID_remove 249ULL
#define WT_CONF_ID_remove_files 117ULL
#define WT_CONF_ID_remove_shared 118ULL
#define WT_CONF_ID_repair 111ULL
...
#define WT_CONF_ID_run_once 106ULL
...
#define WT_CONF_ID_sessions 179ULL
#define WT_CONF_ID_shared 56ULL
#define WT_CONF_ID_size 186ULL
#define WT_CONF_ID_skip_sort_check 144ULL
...
#define WT_CONF_ID_src_id 137ULL
#define WT_CONF_ID_stable 91ULL
#define WT_CONF_ID_stable_timestamp 157ULL
#define WT_CONF_ID_start_generation 82ULL
#define WT_CONF_ID_statistics 145ULL
#define WT_CONF_ID_storage_path 283ULL
#define WT_CONF_ID_storage_source 48ULL
#define WT_CONF_ID_strategy 123ULL
#define WT_CONF_ID_stress_skiplist 217ULL
#define WT_CONF_ID_strict 158ULL
#define WT_CONF_ID_suffix 83ULL
#define WT_CONF_ID_sync 124ULL
#define WT_CONF_ID_system_ram 191ULL
#define WT_CONF_ID_table_logging 218ULL
#define WT_CONF_ID_target 146ULL
#define WT_CONF_ID_terminate 269ULL
#define WT_CONF_ID_this_id 138ULL
...
#define WT_CONF_ID_tiered_object 63ULL
#define WT_CONF_ID_tiers 94ULL
#define WT_CONF_ID_timeout 107ULL
#define WT_CONF_ID_timestamp 264ULL
#define WT_CONF_ID_timing_stress_for_test 265ULL
#define WT_CONF_ID_total 242ULL
#define WT_CONF_ID_txn 180ULL
...
static const struct {
  ...
  WT_CONF_ID_oligarch_test_config,
