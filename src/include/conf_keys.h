...
#define WT_CONF_ID_flags 188ULL
...
#define WT_CONF_ID_precise_checkpoint 317ULL
...
#define WT_CONF_ID_preserve_prepared 320ULL
...
static const struct {
  ...
  {
    WT_CONF_ID_Cache_eviction_controls | (WT_CONF_ID_flags << 16),
  },
  {
