...
#define WT_CONF_ID_conn_close_stress_log_printf 199ULL
...
static const struct {
    ...
    struct {
        ...
        uint64_t conn_close_stress_log_printf;
  ...
  },
  {
    ...
    WT_CONF_ID_Debug_mode | (WT_CONF_ID_conn_close_stress_log_printf << 16),
