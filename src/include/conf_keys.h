...
#define WT_CONF_ID_checkpoint_pickup_defer_budget_pct 76ULL
#define WT_CONF_ID_checkpoint_pickup_defer_min_kb 77ULL
#define WT_CONF_ID_checkpoint_pickup_defer_period 78ULL
...
#define WT_CONF_ID_drain_threads 79ULL
...
#define WT_CONF_ID_last_materialized_lsn 80ULL
...
#define WT_CONF_ID_local_files_action 81ULL
...
#define WT_CONF_ID_lose_all_my_data 82ULL
...
static const struct {
    ...
    struct {
        ...
        uint64_t checkpoint_pickup_defer_budget_pct;
        uint64_t checkpoint_pickup_defer_min_kb;
        uint64_t checkpoint_pickup_defer_period;
  ...
  },
  {
    ...
    WT_CONF_ID_Disaggregated | (WT_CONF_ID_checkpoint_pickup_defer_budget_pct << 16),
    WT_CONF_ID_Disaggregated | (WT_CONF_ID_checkpoint_pickup_defer_min_kb << 16),
    WT_CONF_ID_Disaggregated | (WT_CONF_ID_checkpoint_pickup_defer_period << 16),
