...
#define WT_CONF_ID_Block_cache 192ULL
...
#define WT_CONF_ID_Debug 135ULL
#define WT_CONF_ID_Debug_mode 217ULL
#define WT_CONF_ID_Disaggregated 20ULL
#define WT_CONF_ID_Dump_version 137ULL
#define WT_CONF_ID_Encryption 25ULL
#define WT_CONF_ID_Eviction 234ULL
#define WT_CONF_ID_File_manager 248ULL
#define WT_CONF_ID_Flush_tier 181ULL
#define WT_CONF_ID_Hash 308ULL
#define WT_CONF_ID_History_store 253ULL
#define WT_CONF_ID_Import 118ULL
#define WT_CONF_ID_Incremental 143ULL
#define WT_CONF_ID_Io_capacity 255ULL
#define WT_CONF_ID_Log 43ULL
#define WT_CONF_ID_Lsm 75ULL
#define WT_CONF_ID_Lsm_manager 265ULL
#define WT_CONF_ID_Merge_custom 85ULL
#define WT_CONF_ID_Operation_tracking 268ULL
#define WT_CONF_ID_Prefetch 288ULL
#define WT_CONF_ID_Roundup_timestamps 175ULL
#define WT_CONF_ID_Shared_cache 270ULL
#define WT_CONF_ID_Statistics_log 274ULL
#define WT_CONF_ID_Tiered_storage 54ULL
#define WT_CONF_ID_Transaction_sync 325ULL
...
#define WT_CONF_ID_append 103ULL
#define WT_CONF_ID_archive 259ULL
#define WT_CONF_ID_auth_token 55ULL
#define WT_CONF_ID_auto_throttle 76ULL
#define WT_CONF_ID_available 318ULL
#define WT_CONF_ID_background 111ULL
#define WT_CONF_ID_background_compact 218ULL
#define WT_CONF_ID_backup 185ULL
#define WT_CONF_ID_backup_restore_target 291ULL
#define WT_CONF_ID_blkcache_eviction_aggression 195ULL
#define WT_CONF_ID_block_allocation 14ULL
#define WT_CONF_ID_block_compressor 15ULL
#define WT_CONF_ID_block_manager 16ULL
#define WT_CONF_ID_bloom 77ULL
#define WT_CONF_ID_bloom_bit_count 78ULL
#define WT_CONF_ID_bloom_config 79ULL
#define WT_CONF_ID_bloom_false_positives 127ULL
#define WT_CONF_ID_bloom_hash_count 80ULL
#define WT_CONF_ID_bloom_oldest 81ULL
#define WT_CONF_ID_bound 108ULL
#define WT_CONF_ID_bucket 56ULL
#define WT_CONF_ID_bucket_prefix 57ULL
#define WT_CONF_ID_buckets 309ULL
#define WT_CONF_ID_buffer_alignment 292ULL
#define WT_CONF_ID_builtin_extension_config 293ULL
#define WT_CONF_ID_bulk 133ULL
#define WT_CONF_ID_cache 186ULL
#define WT_CONF_ID_cache_cursors 284ULL
#define WT_CONF_ID_cache_directory 58ULL
#define WT_CONF_ID_cache_max_wait_ms 203ULL
#define WT_CONF_ID_cache_on_checkpoint 193ULL
#define WT_CONF_ID_cache_on_writes 194ULL
...
#define WT_CONF_ID_capacity 295ULL
#define WT_CONF_ID_checkpoint 63ULL
#define WT_CONF_ID_checkpoint_backup_info 64ULL
#define WT_CONF_ID_checkpoint_cleanup 179ULL
#define WT_CONF_ID_checkpoint_fail_before_turtle_update 285ULL
#define WT_CONF_ID_checkpoint_id 94ULL
#define WT_CONF_ID_checkpoint_lsn 65ULL
#define WT_CONF_ID_checkpoint_meta 95ULL
#define WT_CONF_ID_checkpoint_read_timestamp 136ULL
#define WT_CONF_ID_checkpoint_retention 220ULL
#define WT_CONF_ID_checkpoint_sync 294ULL
#define WT_CONF_ID_checkpoint_use_history 134ULL
#define WT_CONF_ID_checkpoint_wait 123ULL
#define WT_CONF_ID_checksum 18ULL
#define WT_CONF_ID_chunk 271ULL
#define WT_CONF_ID_chunk_cache 257ULL
#define WT_CONF_ID_chunk_cache_evict_trigger 296ULL
#define WT_CONF_ID_chunk_count_limit 82ULL
#define WT_CONF_ID_chunk_max 83ULL
#define WT_CONF_ID_chunk_size 84ULL
#define WT_CONF_ID_chunks 73ULL
#define WT_CONF_ID_close_handle_minimum 249ULL
#define WT_CONF_ID_close_idle_time 250ULL
#define WT_CONF_ID_close_scan_interval 251ULL
#define WT_CONF_ID_colgroups 100ULL
#define WT_CONF_ID_collator 6ULL
#define WT_CONF_ID_columns 7ULL
#define WT_CONF_ID_commit_timestamp 2ULL
#define WT_CONF_ID_compare 128ULL
#define WT_CONF_ID_compare_timestamp 119ULL
#define WT_CONF_ID_compile_configuration_count 301ULL
#define WT_CONF_ID_compressor 312ULL
#define WT_CONF_ID_config 280ULL
#define WT_CONF_ID_config_base 302ULL
#define WT_CONF_ID_consolidate 144ULL
#define WT_CONF_ID_corruption_abort 219ULL
#define WT_CONF_ID_count 129ULL
#define WT_CONF_ID_create 303ULL
#define WT_CONF_ID_cursor_copy 221ULL
#define WT_CONF_ID_cursor_reposition 222ULL
#define WT_CONF_ID_cursors 187ULL
#define WT_CONF_ID_default 319ULL
#define WT_CONF_ID_delta_pct 23ULL
#define WT_CONF_ID_dhandle_buckets 310ULL
#define WT_CONF_ID_dictionary 19ULL
#define WT_CONF_ID_direct_io 304ULL
#define WT_CONF_ID_do_not_clear_txn_id 159ULL
#define WT_CONF_ID_drop 180ULL
#define WT_CONF_ID_dryrun 112ULL
...
#define WT_CONF_ID_early_load 281ULL
#define WT_CONF_ID_enabled 44ULL
#define WT_CONF_ID_entry 282ULL
#define WT_CONF_ID_error_prefix 233ULL
#define WT_CONF_ID_evict_abort_on_cache_full 238ULL
#define WT_CONF_ID_evict_sample_inmem 237ULL
#define WT_CONF_ID_eviction 223ULL
#define WT_CONF_ID_eviction_checkpoint_target 240ULL
#define WT_CONF_ID_eviction_dirty_target 241ULL
#define WT_CONF_ID_eviction_dirty_trigger 242ULL
#define WT_CONF_ID_eviction_target 243ULL
#define WT_CONF_ID_eviction_trigger 244ULL
#define WT_CONF_ID_eviction_updates_target 245ULL
#define WT_CONF_ID_eviction_updates_trigger 246ULL
#define WT_CONF_ID_exclude 113ULL
#define WT_CONF_ID_exclusive 117ULL
#define WT_CONF_ID_exclusive_refreshed 110ULL
#define WT_CONF_ID_extensions 306ULL
#define WT_CONF_ID_extra_diagnostics 247ULL
#define WT_CONF_ID_extractor 70ULL
#define WT_CONF_ID_file 145ULL
#define WT_CONF_ID_file_extend 307ULL
#define WT_CONF_ID_file_max 254ULL
#define WT_CONF_ID_file_metadata 121ULL
#define WT_CONF_ID_final_flush 183ULL
#define WT_CONF_ID_flush_time 92ULL
#define WT_CONF_ID_flush_timestamp 93ULL
#define WT_CONF_ID_flushed_data_cache_insertion 298ULL
#define WT_CONF_ID_force 104ULL
#define WT_CONF_ID_force_stop 146ULL
#define WT_CONF_ID_force_write_wait 313ULL
#define WT_CONF_ID_format 28ULL
#define WT_CONF_ID_free_space_target 114ULL
#define WT_CONF_ID_full_target 196ULL
#define WT_CONF_ID_generation_drain_timeout_ms 252ULL
#define WT_CONF_ID_get 158ULL
#define WT_CONF_ID_granularity 147ULL
#define WT_CONF_ID_handles 188ULL
#define WT_CONF_ID_hashsize 198ULL
#define WT_CONF_ID_hazard_max 311ULL
#define WT_CONF_ID_huffman_key 29ULL
#define WT_CONF_ID_huffman_value 30ULL
#define WT_CONF_ID_id 66ULL
#define WT_CONF_ID_ignore_cache_size 287ULL
...
#define WT_CONF_ID_inclusive 109ULL
#define WT_CONF_ID_index_key_columns 72ULL
#define WT_CONF_ID_ingest 98ULL
...
#define WT_CONF_ID_interval 324ULL
#define WT_CONF_ID_isolation 171ULL
#define WT_CONF_ID_json 275ULL
#define WT_CONF_ID_json_output 258ULL
#define WT_CONF_ID_key_format 37ULL
#define WT_CONF_ID_key_gap 38ULL
#define WT_CONF_ID_keyid 27ULL
#define WT_CONF_ID_last 74ULL
#define WT_CONF_ID_leaf_item_max 39ULL
#define WT_CONF_ID_leaf_key_max 40ULL
#define WT_CONF_ID_leaf_page_max 41ULL
#define WT_CONF_ID_leaf_value_max 42ULL
#define WT_CONF_ID_leak_memory 184ULL
#define WT_CONF_ID_local_retention 59ULL
#define WT_CONF_ID_lock_wait 124ULL
#define WT_CONF_ID_log 189ULL
#define WT_CONF_ID_log_retention 224ULL
...
#define WT_CONF_ID_memory_page_image_max 45ULL
#define WT_CONF_ID_memory_page_max 46ULL
#define WT_CONF_ID_merge 267ULL
#define WT_CONF_ID_merge_max 89ULL
#define WT_CONF_ID_merge_min 90ULL
#define WT_CONF_ID_metadata_file 122ULL
#define WT_CONF_ID_method 212ULL
#define WT_CONF_ID_mmap 315ULL
#define WT_CONF_ID_mmap_all 316ULL
#define WT_CONF_ID_multiprocess 317ULL
...
#define WT_CONF_ID_nvram_path 200ULL
#define WT_CONF_ID_object_target_size 60ULL
#define WT_CONF_ID_old_chunks 91ULL
#define WT_CONF_ID_oldest 101ULL
#define WT_CONF_ID_oldest_timestamp 289ULL
#define WT_CONF_ID_on_close 276ULL
#define WT_CONF_ID_operation 130ULL
#define WT_CONF_ID_operation_timeout_ms 173ULL
#define WT_CONF_ID_os_cache_dirty_max 47ULL
#define WT_CONF_ID_os_cache_dirty_pct 260ULL
#define WT_CONF_ID_os_cache_max 48ULL
#define WT_CONF_ID_overwrite 105ULL
#define WT_CONF_ID_page_log 21ULL
#define WT_CONF_ID_path 269ULL
#define WT_CONF_ID_percent_file_in_dram 201ULL
#define WT_CONF_ID_pinned 214ULL
#define WT_CONF_ID_prealloc 261ULL
#define WT_CONF_ID_prealloc_init_count 262ULL
#define WT_CONF_ID_precise 210ULL
#define WT_CONF_ID_prefix 86ULL
#define WT_CONF_ID_prefix_compression 49ULL
#define WT_CONF_ID_prefix_compression_min 50ULL
#define WT_CONF_ID_prefix_search 106ULL
#define WT_CONF_ID_prepare_timestamp 178ULL
#define WT_CONF_ID_prepared 176ULL
#define WT_CONF_ID_priority 174ULL
#define WT_CONF_ID_quota 272ULL
...
#define WT_CONF_ID_reconcile_avail_lag 239ULL
#define WT_CONF_ID_recover 314ULL
#define WT_CONF_ID_release 216ULL
#define WT_CONF_ID_release_evict 141ULL
#define WT_CONF_ID_release_evict_page 286ULL
#define WT_CONF_ID_remove 263ULL
#define WT_CONF_ID_remove_files 125ULL
#define WT_CONF_ID_remove_shared 126ULL
#define WT_CONF_ID_repair 120ULL
#define WT_CONF_ID_require_max 299ULL
#define WT_CONF_ID_require_min 300ULL
#define WT_CONF_ID_reserve 273ULL
#define WT_CONF_ID_role 97ULL
#define WT_CONF_ID_rollback_error 227ULL
#define WT_CONF_ID_run_once 115ULL
#define WT_CONF_ID_salvage 320ULL
#define WT_CONF_ID_secretkey 305ULL
#define WT_CONF_ID_session_max 321ULL
#define WT_CONF_ID_session_scratch_max 322ULL
#define WT_CONF_ID_session_table_cache 323ULL
#define WT_CONF_ID_sessions 190ULL
#define WT_CONF_ID_shared 61ULL
#define WT_CONF_ID_size 197ULL
#define WT_CONF_ID_skip_sort_check 155ULL
#define WT_CONF_ID_slow_checkpoint 228ULL
#define WT_CONF_ID_source 8ULL
#define WT_CONF_ID_sources 277ULL
#define WT_CONF_ID_split_deepen_min_child 51ULL
#define WT_CONF_ID_split_deepen_per_child 52ULL
#define WT_CONF_ID_split_pct 53ULL
#define WT_CONF_ID_src_id 148ULL
#define WT_CONF_ID_stable 99ULL
#define WT_CONF_ID_stable_prefix 22ULL
#define WT_CONF_ID_stable_timestamp 168ULL
#define WT_CONF_ID_start_generation 87ULL
#define WT_CONF_ID_start_timestamp 139ULL
#define WT_CONF_ID_statistics 156ULL
#define WT_CONF_ID_storage_path 297ULL
#define WT_CONF_ID_strategy 131ULL
#define WT_CONF_ID_stress_skiplist 229ULL
#define WT_CONF_ID_strict 169ULL
#define WT_CONF_ID_suffix 88ULL
#define WT_CONF_ID_sync 132ULL
#define WT_CONF_ID_system_ram 202ULL
#define WT_CONF_ID_table_logging 230ULL
#define WT_CONF_ID_target 157ULL
#define WT_CONF_ID_terminate 283ULL
...
#define WT_CONF_ID_tiers 102ULL
#define WT_CONF_ID_timeout 116ULL
#define WT_CONF_ID_timestamp 278ULL
#define WT_CONF_ID_timestamp_order 140ULL
#define WT_CONF_ID_timing_stress_for_test 279ULL
#define WT_CONF_ID_total 256ULL
#define WT_CONF_ID_txn 191ULL
#define WT_CONF_ID_type 9ULL
#define WT_CONF_ID_update_restore_evict 232ULL
#define WT_CONF_ID_use_environment 326ULL
#define WT_CONF_ID_use_environment_priv 327ULL
#define WT_CONF_ID_use_timestamp 182ULL
#define WT_CONF_ID_value_format 62ULL
#define WT_CONF_ID_verbose 10ULL
#define WT_CONF_ID_verify_metadata 328ULL
#define WT_CONF_ID_version 69ULL
#define WT_CONF_ID_visible_only 138ULL
#define WT_CONF_ID_wait 209ULL
#define WT_CONF_ID_worker_thread_max 266ULL
#define WT_CONF_ID_write_through 329ULL
#define WT_CONF_ID_write_timestamp 5ULL
#define WT_CONF_ID_write_timestamp_usage 11ULL
#define WT_CONF_ID_zero_fill 264ULL

#define WT_CONF_ID_COUNT 330
/*
...
static const struct {
    ...
    struct {
        uint64_t evict_abort_on_cache_full;
        uint64_t evict_sample_inmem;
        uint64_t reconcile_avail_lag;
  ...
  {
    WT_CONF_ID_Eviction | (WT_CONF_ID_evict_abort_on_cache_full << 16),
    WT_CONF_ID_Eviction | (WT_CONF_ID_evict_sample_inmem << 16),
    WT_CONF_ID_Eviction | (WT_CONF_ID_reconcile_avail_lag << 16),
