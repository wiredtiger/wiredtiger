...
#define WT_CONF_ID_Block_cache 187ULL
#define WT_CONF_ID_Checkpoint 202ULL
#define WT_CONF_ID_Checkpoint_cleanup 205ULL
#define WT_CONF_ID_Chunk_cache 207ULL
#define WT_CONF_ID_Compatibility 209ULL
#define WT_CONF_ID_Debug 133ULL
#define WT_CONF_ID_Debug_mode 211ULL
#define WT_CONF_ID_Disaggregated 19ULL
#define WT_CONF_ID_Encryption 23ULL
#define WT_CONF_ID_Eviction 229ULL
#define WT_CONF_ID_File_manager 241ULL
#define WT_CONF_ID_Flush_tier 176ULL
#define WT_CONF_ID_Hash 302ULL
#define WT_CONF_ID_History_store 246ULL
#define WT_CONF_ID_Import 115ULL
#define WT_CONF_ID_Incremental 138ULL
#define WT_CONF_ID_Io_capacity 248ULL
#define WT_CONF_ID_Log 41ULL
#define WT_CONF_ID_Lsm 75ULL
#define WT_CONF_ID_Lsm_manager 258ULL
#define WT_CONF_ID_Merge_custom 85ULL
#define WT_CONF_ID_Oligarch 261ULL
#define WT_CONF_ID_Oligarch_log 45ULL
#define WT_CONF_ID_Operation_tracking 262ULL
#define WT_CONF_ID_Prefetch 282ULL
#define WT_CONF_ID_Roundup_timestamps 170ULL
#define WT_CONF_ID_Shared_cache 264ULL
#define WT_CONF_ID_Statistics_log 268ULL
#define WT_CONF_ID_Tiered_storage 54ULL
#define WT_CONF_ID_Transaction_oligarch_sync 319ULL
#define WT_CONF_ID_Transaction_sync 320ULL
#define WT_CONF_ID_access_pattern_hint 12ULL
#define WT_CONF_ID_action 103ULL
#define WT_CONF_ID_allocation_size 13ULL
#define WT_CONF_ID_app_metadata 0ULL
#define WT_CONF_ID_append 99ULL
#define WT_CONF_ID_archive 252ULL
#define WT_CONF_ID_auth_token 55ULL
#define WT_CONF_ID_auto_throttle 76ULL
#define WT_CONF_ID_available 312ULL
#define WT_CONF_ID_background 108ULL
#define WT_CONF_ID_background_compact 212ULL
#define WT_CONF_ID_backup 180ULL
#define WT_CONF_ID_backup_restore_target 285ULL
#define WT_CONF_ID_blkcache_eviction_aggression 190ULL
...
#define WT_CONF_ID_bloom_false_positives 124ULL
#define WT_CONF_ID_bloom_hash_count 80ULL
#define WT_CONF_ID_bloom_oldest 81ULL
#define WT_CONF_ID_bound 104ULL
#define WT_CONF_ID_bucket 56ULL
#define WT_CONF_ID_bucket_prefix 57ULL
#define WT_CONF_ID_buckets 303ULL
#define WT_CONF_ID_buffer_alignment 286ULL
#define WT_CONF_ID_builtin_extension_config 287ULL
#define WT_CONF_ID_bulk 131ULL
#define WT_CONF_ID_cache 181ULL
#define WT_CONF_ID_cache_cursors 278ULL
#define WT_CONF_ID_cache_directory 58ULL
#define WT_CONF_ID_cache_max_wait_ms 198ULL
#define WT_CONF_ID_cache_on_checkpoint 188ULL
#define WT_CONF_ID_cache_on_writes 189ULL
#define WT_CONF_ID_cache_overhead 199ULL
#define WT_CONF_ID_cache_resident 16ULL
#define WT_CONF_ID_cache_size 200ULL
#define WT_CONF_ID_cache_stuck_timeout_ms 201ULL
...
#define WT_CONF_ID_colgroups 96ULL
#define WT_CONF_ID_collator 6ULL
#define WT_CONF_ID_columns 7ULL
#define WT_CONF_ID_commit_timestamp 2ULL
#define WT_CONF_ID_compare 125ULL
#define WT_CONF_ID_compare_timestamp 116ULL
#define WT_CONF_ID_compile_configuration_count 295ULL
#define WT_CONF_ID_compressor 306ULL
#define WT_CONF_ID_config 274ULL
#define WT_CONF_ID_config_base 296ULL
#define WT_CONF_ID_consolidate 139ULL
#define WT_CONF_ID_corruption_abort 213ULL
#define WT_CONF_ID_count 126ULL
#define WT_CONF_ID_create 297ULL
#define WT_CONF_ID_cursor_copy 215ULL
#define WT_CONF_ID_cursor_reposition 216ULL
#define WT_CONF_ID_cursors 182ULL
...
#define WT_CONF_ID_drop 175ULL
#define WT_CONF_ID_dryrun 109ULL
...
#define WT_CONF_ID_exclude 110ULL
#define WT_CONF_ID_exclusive 114ULL
#define WT_CONF_ID_exclusive_refreshed 106ULL
#define WT_CONF_ID_extensions 300ULL
#define WT_CONF_ID_extra_diagnostics 240ULL
#define WT_CONF_ID_extractor 70ULL
#define WT_CONF_ID_file 140ULL
#define WT_CONF_ID_file_extend 301ULL
#define WT_CONF_ID_file_max 247ULL
#define WT_CONF_ID_file_metadata 118ULL
#define WT_CONF_ID_final_flush 178ULL
#define WT_CONF_ID_flush_time 92ULL
#define WT_CONF_ID_flush_timestamp 93ULL
#define WT_CONF_ID_flushed_data_cache_insertion 292ULL
#define WT_CONF_ID_force 100ULL
#define WT_CONF_ID_force_stop 141ULL
#define WT_CONF_ID_force_write_wait 307ULL
#define WT_CONF_ID_format 26ULL
#define WT_CONF_ID_free_space_target 111ULL
#define WT_CONF_ID_full_target 191ULL
#define WT_CONF_ID_generation_drain_timeout_ms 245ULL
#define WT_CONF_ID_get 153ULL
#define WT_CONF_ID_granularity 142ULL
#define WT_CONF_ID_handles 183ULL
#define WT_CONF_ID_hashsize 193ULL
#define WT_CONF_ID_hazard_max 305ULL
...
#define WT_CONF_ID_isolation 166ULL
#define WT_CONF_ID_json 269ULL
#define WT_CONF_ID_json_output 251ULL
...
#define WT_CONF_ID_no_timestamp 167ULL
#define WT_CONF_ID_nvram_path 195ULL
#define WT_CONF_ID_object_target_size 60ULL
#define WT_CONF_ID_old_chunks 91ULL
#define WT_CONF_ID_oldest 97ULL
#define WT_CONF_ID_oldest_timestamp 283ULL
#define WT_CONF_ID_oligarch_constituent 46ULL
#define WT_CONF_ID_oligarch_sync 129ULL
#define WT_CONF_ID_on_close 270ULL
#define WT_CONF_ID_operation 127ULL
#define WT_CONF_ID_operation_timeout_ms 168ULL
#define WT_CONF_ID_os_cache_dirty_max 47ULL
#define WT_CONF_ID_os_cache_dirty_pct 253ULL
#define WT_CONF_ID_os_cache_max 48ULL
#define WT_CONF_ID_overwrite 101ULL
#define WT_CONF_ID_page_log 20ULL
#define WT_CONF_ID_path 263ULL
#define WT_CONF_ID_percent_file_in_dram 196ULL
#define WT_CONF_ID_pinned 208ULL
#define WT_CONF_ID_prealloc 254ULL
#define WT_CONF_ID_prealloc_init_count 255ULL
#define WT_CONF_ID_prefix 86ULL
#define WT_CONF_ID_prefix_compression 49ULL
#define WT_CONF_ID_prefix_compression_min 50ULL
#define WT_CONF_ID_prefix_search 102ULL
#define WT_CONF_ID_prepare_timestamp 173ULL
#define WT_CONF_ID_prepared 171ULL
#define WT_CONF_ID_priority 169ULL
#define WT_CONF_ID_quota 266ULL
#define WT_CONF_ID_raw 148ULL
#define WT_CONF_ID_read 172ULL
#define WT_CONF_ID_read_corrupt 162ULL
...
#define WT_CONF_ID_release 210ULL
#define WT_CONF_ID_release_evict 136ULL
#define WT_CONF_ID_release_evict_page 280ULL
#define WT_CONF_ID_remove 256ULL
#define WT_CONF_ID_remove_files 122ULL
#define WT_CONF_ID_remove_shared 123ULL
#define WT_CONF_ID_repair 117ULL
#define WT_CONF_ID_require_max 293ULL
#define WT_CONF_ID_require_min 294ULL
#define WT_CONF_ID_reserve 267ULL
#define WT_CONF_ID_role 107ULL
#define WT_CONF_ID_rollback_error 221ULL
#define WT_CONF_ID_run_once 112ULL
...
#define WT_CONF_ID_sessions 185ULL
#define WT_CONF_ID_shared 61ULL
#define WT_CONF_ID_size 192ULL
...
#define WT_CONF_ID_stable 95ULL
#define WT_CONF_ID_stable_prefix 21ULL
#define WT_CONF_ID_stable_timestamp 163ULL
#define WT_CONF_ID_start_generation 87ULL
#define WT_CONF_ID_statistics 151ULL
#define WT_CONF_ID_storage_path 291ULL
#define WT_CONF_ID_storage_source 22ULL
#define WT_CONF_ID_strategy 128ULL
#define WT_CONF_ID_stress_skiplist 223ULL
#define WT_CONF_ID_strict 164ULL
#define WT_CONF_ID_suffix 88ULL
#define WT_CONF_ID_sync 130ULL
#define WT_CONF_ID_system_ram 197ULL
...
#define WT_CONF_ID_tiers 98ULL
#define WT_CONF_ID_timeout 113ULL
#define WT_CONF_ID_timestamp 272ULL
#define WT_CONF_ID_timing_stress_for_test 273ULL
#define WT_CONF_ID_total 249ULL
#define WT_CONF_ID_txn 186ULL
#define WT_CONF_ID_type 9ULL
#define WT_CONF_ID_update_restore_evict 226ULL
#define WT_CONF_ID_use_environment 321ULL
#define WT_CONF_ID_use_environment_priv 322ULL
#define WT_CONF_ID_use_timestamp 177ULL
#define WT_CONF_ID_value_format 62ULL
#define WT_CONF_ID_verbose 10ULL
#define WT_CONF_ID_verify_metadata 323ULL
#define WT_CONF_ID_version 69ULL
#define WT_CONF_ID_wait 204ULL
#define WT_CONF_ID_worker_thread_max 259ULL
#define WT_CONF_ID_write_through 324ULL
#define WT_CONF_ID_write_timestamp 5ULL
#define WT_CONF_ID_write_timestamp_usage 11ULL
#define WT_CONF_ID_zero_fill 257ULL

#define WT_CONF_ID_COUNT 325
/*
...
static const struct {
  ...
  },
  {
    ...
    WT_CONF_ID_Disaggregated | (WT_CONF_ID_storage_source << 16),
  },
  {
  ...
  {
    WT_CONF_ID_Oligarch | (WT_CONF_ID_role << 16),
  },
  {
