...
#define WT_CONF_ID_lazy_stable_open 78ULL
...
#define WT_CONF_ID_strict_checkpoint_metadata 82ULL
...
static const struct {
  ...
  },
  {
    ...
    WT_CONF_ID_Disaggregated | (WT_CONF_ID_lazy_stable_open << 16),
