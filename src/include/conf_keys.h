...
#define WT_CONF_ID_Heuristic_controls 254ULL
...
#define WT_CONF_ID_checkpoint_cleanup_obsolete_tw_pages_dirty_max 255ULL
...
#define WT_CONF_ID_eviction_obsolete_tw_pages_dirty_max 256ULL
...
#define WT_CONF_ID_obsolete_tw_btree_max 257ULL
