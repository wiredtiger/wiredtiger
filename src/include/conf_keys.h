...
#define WT_CONF_ID_allow_evict_no_progress_reconciliation 313ULL
...
static const struct {
    ...
    struct {
        uint64_t allow_evict_no_progress_reconciliation;
  ...
  {
    WT_CONF_ID_Debug | (WT_CONF_ID_allow_evict_no_progress_reconciliation << 16),
