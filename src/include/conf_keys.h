...
#define WT_CONF_ID_eviction_dirty_index_auto_grow 268ULL
#define WT_CONF_ID_eviction_dirty_index_disagg 269ULL
...
#define WT_CONF_ID_ignore_cache_size 328ULL
...
static const struct {
    ...
    uint64_t eviction_dirty_index_auto_grow;
  ...
  WT_CONF_ID_eviction_dirty_index_auto_grow,
