...
#define WT_CONF_ID_chunk_size 280ULL
...
#define WT_CONF_ID_legacy_page_visit_strategy 220ULL
...
#define WT_CONF_ID_metadata 169ULL
...
#define WT_CONF_ID_next_checkpoint_id 79ULL
