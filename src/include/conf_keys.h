...
#define WT_CONF_ID_File_manager 267ULL
#define WT_CONF_ID_Flush_tier 185ULL
#define WT_CONF_ID_Hash 335ULL
#define WT_CONF_ID_Heuristic_controls 272ULL
#define WT_CONF_ID_History_store 276ULL
#define WT_CONF_ID_Import 101ULL
#define WT_CONF_ID_Incremental 141ULL
#define WT_CONF_ID_Io_capacity 278ULL
...
#define WT_CONF_ID_Operation_tracking 288ULL
#define WT_CONF_ID_Page_delta 290ULL
#define WT_CONF_ID_Prefetch 315ULL
#define WT_CONF_ID_Prefetch1 317ULL
#define WT_CONF_ID_Rollback_to_stable 295ULL
#define WT_CONF_ID_Roundup_timestamps 175ULL
#define WT_CONF_ID_Shared_cache 297ULL
#define WT_CONF_ID_Statistics_log 301ULL
#define WT_CONF_ID_Tiered_storage 52ULL
#define WT_CONF_ID_Transaction_sync 355ULL
#define WT_CONF_ID_access_pattern_hint 12ULL
#define WT_CONF_ID_action 90ULL
#define WT_CONF_ID_allocation_size 13ULL
#define WT_CONF_ID_app_eviction_min_cache_fill_ratio 254ULL
#define WT_CONF_ID_app_metadata 0ULL
#define WT_CONF_ID_append 87ULL
#define WT_CONF_ID_archive 282ULL
#define WT_CONF_ID_auth_token 53ULL
#define WT_CONF_ID_auto_throttle 108ULL
#define WT_CONF_ID_available 347ULL
#define WT_CONF_ID_background 94ULL
#define WT_CONF_ID_background_compact 223ULL
#define WT_CONF_ID_backup 189ULL
#define WT_CONF_ID_backup_restore_target 318ULL
...
#define WT_CONF_ID_buckets 336ULL
#define WT_CONF_ID_buffer_alignment 319ULL
#define WT_CONF_ID_builtin_extension_config 320ULL
#define WT_CONF_ID_bulk 129ULL
#define WT_CONF_ID_cache 190ULL
#define WT_CONF_ID_cache_cursors 311ULL
...
#define WT_CONF_ID_cache_tolerance_for_app_eviction 255ULL
#define WT_CONF_ID_capacity 322ULL
...
#define WT_CONF_ID_checkpoint_cleanup_obsolete_tw_pages_dirty_max 273ULL
#define WT_CONF_ID_checkpoint_crash_point 182ULL
#define WT_CONF_ID_checkpoint_crash_trigger_point 183ULL
#define WT_CONF_ID_checkpoint_fail_before_turtle_update 312ULL
...
#define WT_CONF_ID_checkpoint_retention 229ULL
#define WT_CONF_ID_checkpoint_sync 321ULL
#define WT_CONF_ID_checkpoint_use_history 130ULL
#define WT_CONF_ID_checkpoint_wait 123ULL
#define WT_CONF_ID_checksum 18ULL
#define WT_CONF_ID_chunk 298ULL
#define WT_CONF_ID_chunk_cache 280ULL
#define WT_CONF_ID_chunk_cache_evict_trigger 323ULL
...
#define WT_CONF_ID_close_handle_minimum 268ULL
#define WT_CONF_ID_close_idle_time 269ULL
#define WT_CONF_ID_close_scan_interval 270ULL
...
#define WT_CONF_ID_compile_configuration_count 328ULL
#define WT_CONF_ID_compressor 340ULL
#define WT_CONF_ID_config 307ULL
#define WT_CONF_ID_config_base 329ULL
#define WT_CONF_ID_configuration 230ULL
#define WT_CONF_ID_consolidate 142ULL
#define WT_CONF_ID_corruption_abort 228ULL
#define WT_CONF_ID_crash_point_after_drop_colgroup 226ULL
#define WT_CONF_ID_crash_point_after_drop_file 227ULL
#define WT_CONF_ID_crash_point_before_insert_colgroup 224ULL
#define WT_CONF_ID_crash_point_before_insert_file 225ULL
#define WT_CONF_ID_create 330ULL
#define WT_CONF_ID_cross_key 138ULL
#define WT_CONF_ID_cursor_copy 231ULL
#define WT_CONF_ID_cursor_reposition 232ULL
#define WT_CONF_ID_cursors 191ULL
#define WT_CONF_ID_default 348ULL
#define WT_CONF_ID_delta_pct 291ULL
#define WT_CONF_ID_dhandle_buckets 337ULL
#define WT_CONF_ID_dictionary 19ULL
#define WT_CONF_ID_direct_io 331ULL
#define WT_CONF_ID_disagg_address_cookie_optional_field 234ULL
#define WT_CONF_ID_disagg_address_cookie_upgrade 233ULL
...
#define WT_CONF_ID_early_load 308ULL
#define WT_CONF_ID_enabled 42ULL
#define WT_CONF_ID_entry 309ULL
#define WT_CONF_ID_error_prefix 247ULL
#define WT_CONF_ID_evict_sample_inmem 251ULL
#define WT_CONF_ID_evict_use_softptr 252ULL
#define WT_CONF_ID_eviction 235ULL
#define WT_CONF_ID_eviction_checkpoint_target 259ULL
#define WT_CONF_ID_eviction_checkpoint_ts_ordering 246ULL
#define WT_CONF_ID_eviction_dirty_target 260ULL
#define WT_CONF_ID_eviction_dirty_trigger 261ULL
#define WT_CONF_ID_eviction_obsolete_tw_pages_dirty_max 274ULL
#define WT_CONF_ID_eviction_target 262ULL
#define WT_CONF_ID_eviction_trigger 263ULL
#define WT_CONF_ID_eviction_updates_target 264ULL
#define WT_CONF_ID_eviction_updates_trigger 265ULL
#define WT_CONF_ID_exclude 96ULL
#define WT_CONF_ID_exclusive 100ULL
#define WT_CONF_ID_exclusive_refreshed 93ULL
#define WT_CONF_ID_extensions 333ULL
#define WT_CONF_ID_extra_diagnostics 266ULL
#define WT_CONF_ID_extractor 71ULL
#define WT_CONF_ID_file 143ULL
#define WT_CONF_ID_file_extend 334ULL
#define WT_CONF_ID_file_max 277ULL
...
#define WT_CONF_ID_incremental_app_eviction 256ULL
...
#define WT_CONF_ID_internal_page_delta 292ULL
#define WT_CONF_ID_internal_page_max 34ULL
#define WT_CONF_ID_interval 354ULL
#define WT_CONF_ID_isolation 171ULL
#define WT_CONF_ID_json 302ULL
#define WT_CONF_ID_json_output 281ULL
...
#define WT_CONF_ID_log_retention 236ULL
#define WT_CONF_ID_log_size 213ULL
#define WT_CONF_ID_lose_all_my_data 79ULL
#define WT_CONF_ID_max_consecutive_delta 294ULL
...
#define WT_CONF_ID_mmap 343ULL
#define WT_CONF_ID_mmap_all 344ULL
#define WT_CONF_ID_multiprocess 345ULL
...
#define WT_CONF_ID_obsolete_tw_btree_max 275ULL
#define WT_CONF_ID_oldest 85ULL
#define WT_CONF_ID_oldest_timestamp 316ULL
#define WT_CONF_ID_on_close 303ULL
#define WT_CONF_ID_operation_timeout_ms 173ULL
#define WT_CONF_ID_os_cache_dirty_max 45ULL
#define WT_CONF_ID_os_cache_dirty_pct 283ULL
#define WT_CONF_ID_os_cache_max 46ULL
#define WT_CONF_ID_overwrite 88ULL
#define WT_CONF_ID_page_history 237ULL
#define WT_CONF_ID_page_log 21ULL
#define WT_CONF_ID_panic_corrupt 105ULL
#define WT_CONF_ID_path 289ULL
#define WT_CONF_ID_percent_file_in_dram 206ULL
#define WT_CONF_ID_pinned 219ULL
#define WT_CONF_ID_prealloc 284ULL
#define WT_CONF_ID_prealloc_init_count 285ULL
#define WT_CONF_ID_precise_checkpoint 346ULL
#define WT_CONF_ID_prefer_scrub_eviction 257ULL
...
#define WT_CONF_ID_preserve_prepared 349ULL
#define WT_CONF_ID_priority 174ULL
#define WT_CONF_ID_quota 299ULL
...
#define WT_CONF_ID_read_size 339ULL
#define WT_CONF_ID_read_timestamp 4ULL
#define WT_CONF_ID_readonly 68ULL
#define WT_CONF_ID_realloc_exact 238ULL
#define WT_CONF_ID_realloc_malloc 239ULL
#define WT_CONF_ID_recover 342ULL
#define WT_CONF_ID_release 221ULL
#define WT_CONF_ID_release_evict 139ULL
#define WT_CONF_ID_release_evict_page 313ULL
#define WT_CONF_ID_remove 286ULL
#define WT_CONF_ID_remove_files 126ULL
#define WT_CONF_ID_remove_shared 127ULL
#define WT_CONF_ID_repair 106ULL
#define WT_CONF_ID_require_max 326ULL
#define WT_CONF_ID_require_min 327ULL
#define WT_CONF_ID_reserve 300ULL
#define WT_CONF_ID_role 80ULL
#define WT_CONF_ID_rollback_error 240ULL
#define WT_CONF_ID_rollback_timestamp 180ULL
#define WT_CONF_ID_run_once 98ULL
#define WT_CONF_ID_salvage 350ULL
#define WT_CONF_ID_secretkey 332ULL
#define WT_CONF_ID_session_max 351ULL
#define WT_CONF_ID_session_scratch_max 352ULL
#define WT_CONF_ID_session_table_cache 353ULL
...
#define WT_CONF_ID_skip_update_obsolete_check 258ULL
#define WT_CONF_ID_slow_checkpoint 241ULL
#define WT_CONF_ID_source 8ULL
#define WT_CONF_ID_sources 304ULL
...
#define WT_CONF_ID_storage_path 324ULL
#define WT_CONF_ID_storage_tier 22ULL
#define WT_CONF_ID_stress_skiplist 242ULL
...
#define WT_CONF_ID_table_logging 243ULL
#define WT_CONF_ID_target 155ULL
#define WT_CONF_ID_terminate 310ULL
#define WT_CONF_ID_this_id 147ULL
#define WT_CONF_ID_threads 296ULL
#define WT_CONF_ID_threads_max 249ULL
#define WT_CONF_ID_threads_min 250ULL
#define WT_CONF_ID_tiered_flush_error_continue 244ULL
#define WT_CONF_ID_tiered_object 69ULL
#define WT_CONF_ID_tiers 86ULL
#define WT_CONF_ID_timeout 99ULL
#define WT_CONF_ID_timestamp 305ULL
#define WT_CONF_ID_timestamp_order 136ULL
#define WT_CONF_ID_timing_stress_for_test 306ULL
#define WT_CONF_ID_total 279ULL
#define WT_CONF_ID_txn 196ULL
#define WT_CONF_ID_type 9ULL
#define WT_CONF_ID_update_restore_evict 245ULL
#define WT_CONF_ID_use_environment 356ULL
#define WT_CONF_ID_use_environment_priv 357ULL
#define WT_CONF_ID_use_timestamp 186ULL
#define WT_CONF_ID_value_format 60ULL
#define WT_CONF_ID_verbose 10ULL
#define WT_CONF_ID_verify_metadata 358ULL
#define WT_CONF_ID_version 70ULL
#define WT_CONF_ID_visible_only 134ULL
#define WT_CONF_ID_wait 214ULL
#define WT_CONF_ID_write_through 359ULL
#define WT_CONF_ID_write_timestamp 5ULL
#define WT_CONF_ID_write_timestamp_usage 11ULL
#define WT_CONF_ID_zero_fill 287ULL

#define WT_CONF_ID_COUNT 360
/*
...
static const struct {
    ...
    struct {
        ...
        uint64_t crash_point_after_drop_colgroup;
        uint64_t crash_point_after_drop_file;
        uint64_t crash_point_before_insert_colgroup;
        uint64_t crash_point_before_insert_file;
  ...
  },
  {
    ...
    WT_CONF_ID_Debug_mode | (WT_CONF_ID_crash_point_after_drop_colgroup << 16),
    WT_CONF_ID_Debug_mode | (WT_CONF_ID_crash_point_after_drop_file << 16),
    WT_CONF_ID_Debug_mode | (WT_CONF_ID_crash_point_before_insert_colgroup << 16),
    WT_CONF_ID_Debug_mode | (WT_CONF_ID_crash_point_before_insert_file << 16),
