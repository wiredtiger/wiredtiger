...
#define WT_CONF_ID_Strategy 256ULL
...
#define WT_CONF_ID_method 306ULL
...
#define WT_CONF_ID_obsolete_check_optimization 257ULL
...
static const struct {
  ...
  {
    WT_CONF_ID_Strategy | (WT_CONF_ID_obsolete_check_optimization << 16),
  },
  {
