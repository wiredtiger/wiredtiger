...
#define WT_CONF_ID_checkpoint_cleanup_obsolete_tw_pages_dirty_max 253ULL
...
#define WT_CONF_ID_eviction_obsolete_tw_pages_dirty_max 254ULL
...
#define WT_CONF_ID_obsolete_tw_btree_max 255ULL
