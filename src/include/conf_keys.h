...
#define WT_CONF_ID_Debug 138ULL
#define WT_CONF_ID_Debug_mode 221ULL
#define WT_CONF_ID_Disaggregated 20ULL
#define WT_CONF_ID_Dump_version 140ULL
#define WT_CONF_ID_Encryption 25ULL
#define WT_CONF_ID_Eviction 238ULL
#define WT_CONF_ID_File_manager 250ULL
#define WT_CONF_ID_Flush_tier 185ULL
#define WT_CONF_ID_Hash 310ULL
#define WT_CONF_ID_History_store 255ULL
#define WT_CONF_ID_Import 120ULL
#define WT_CONF_ID_Incremental 146ULL
#define WT_CONF_ID_Io_capacity 257ULL
#define WT_CONF_ID_Layered_table_log 39ULL
#define WT_CONF_ID_Log 46ULL
#define WT_CONF_ID_Lsm 77ULL
#define WT_CONF_ID_Lsm_manager 267ULL
#define WT_CONF_ID_Merge_custom 87ULL
#define WT_CONF_ID_Operation_tracking 270ULL
#define WT_CONF_ID_Prefetch 290ULL
#define WT_CONF_ID_Roundup_timestamps 179ULL
#define WT_CONF_ID_Shared_cache 272ULL
#define WT_CONF_ID_Statistics_log 276ULL
#define WT_CONF_ID_Tiered_storage 56ULL
#define WT_CONF_ID_Transaction_layered_table_sync 327ULL
#define WT_CONF_ID_Transaction_sync 328ULL
#define WT_CONF_ID_access_pattern_hint 12ULL
#define WT_CONF_ID_action 109ULL
#define WT_CONF_ID_allocation_size 13ULL
#define WT_CONF_ID_app_metadata 0ULL
#define WT_CONF_ID_append 105ULL
#define WT_CONF_ID_archive 261ULL
#define WT_CONF_ID_auth_token 57ULL
#define WT_CONF_ID_auto_throttle 78ULL
#define WT_CONF_ID_available 320ULL
#define WT_CONF_ID_background 113ULL
#define WT_CONF_ID_background_compact 222ULL
#define WT_CONF_ID_backup 189ULL
#define WT_CONF_ID_backup_restore_target 293ULL
...
#define WT_CONF_ID_bloom 79ULL
#define WT_CONF_ID_bloom_bit_count 80ULL
#define WT_CONF_ID_bloom_config 81ULL
#define WT_CONF_ID_bloom_false_positives 129ULL
#define WT_CONF_ID_bloom_hash_count 82ULL
#define WT_CONF_ID_bloom_oldest 83ULL
#define WT_CONF_ID_bound 110ULL
#define WT_CONF_ID_bucket 58ULL
#define WT_CONF_ID_bucket_prefix 59ULL
#define WT_CONF_ID_buckets 311ULL
#define WT_CONF_ID_buffer_alignment 294ULL
#define WT_CONF_ID_builtin_extension_config 295ULL
#define WT_CONF_ID_bulk 136ULL
#define WT_CONF_ID_cache 190ULL
#define WT_CONF_ID_cache_cursors 286ULL
#define WT_CONF_ID_cache_directory 60ULL
...
#define WT_CONF_ID_capacity 297ULL
#define WT_CONF_ID_checkpoint 65ULL
#define WT_CONF_ID_checkpoint_backup_info 66ULL
#define WT_CONF_ID_checkpoint_cleanup 183ULL
#define WT_CONF_ID_checkpoint_fail_before_turtle_update 287ULL
#define WT_CONF_ID_checkpoint_id 96ULL
#define WT_CONF_ID_checkpoint_lsn 67ULL
#define WT_CONF_ID_checkpoint_meta 97ULL
#define WT_CONF_ID_checkpoint_read_timestamp 139ULL
#define WT_CONF_ID_checkpoint_retention 224ULL
#define WT_CONF_ID_checkpoint_sync 296ULL
#define WT_CONF_ID_checkpoint_use_history 137ULL
#define WT_CONF_ID_checkpoint_wait 125ULL
#define WT_CONF_ID_checksum 18ULL
#define WT_CONF_ID_chunk 273ULL
#define WT_CONF_ID_chunk_cache 259ULL
#define WT_CONF_ID_chunk_cache_evict_trigger 298ULL
#define WT_CONF_ID_chunk_count_limit 84ULL
#define WT_CONF_ID_chunk_max 85ULL
#define WT_CONF_ID_chunk_size 86ULL
#define WT_CONF_ID_chunks 75ULL
#define WT_CONF_ID_close_handle_minimum 251ULL
#define WT_CONF_ID_close_idle_time 252ULL
#define WT_CONF_ID_close_scan_interval 253ULL
#define WT_CONF_ID_colgroups 102ULL
#define WT_CONF_ID_collator 6ULL
#define WT_CONF_ID_columns 7ULL
#define WT_CONF_ID_commit_timestamp 2ULL
#define WT_CONF_ID_compare 130ULL
#define WT_CONF_ID_compare_timestamp 121ULL
#define WT_CONF_ID_compile_configuration_count 303ULL
#define WT_CONF_ID_compressor 314ULL
#define WT_CONF_ID_config 282ULL
#define WT_CONF_ID_config_base 304ULL
#define WT_CONF_ID_consolidate 147ULL
#define WT_CONF_ID_corruption_abort 223ULL
#define WT_CONF_ID_count 131ULL
#define WT_CONF_ID_create 305ULL
#define WT_CONF_ID_cursor_copy 225ULL
#define WT_CONF_ID_cursor_reposition 226ULL
#define WT_CONF_ID_cursors 191ULL
#define WT_CONF_ID_default 321ULL
#define WT_CONF_ID_delta_pct 23ULL
#define WT_CONF_ID_dhandle_buckets 312ULL
#define WT_CONF_ID_dictionary 19ULL
#define WT_CONF_ID_direct_io 306ULL
#define WT_CONF_ID_do_not_clear_txn_id 163ULL
#define WT_CONF_ID_drop 184ULL
#define WT_CONF_ID_dryrun 114ULL
...
#define WT_CONF_ID_early_load 283ULL
#define WT_CONF_ID_enabled 40ULL
#define WT_CONF_ID_entry 284ULL
#define WT_CONF_ID_error_prefix 237ULL
#define WT_CONF_ID_evict_sample_inmem 241ULL
#define WT_CONF_ID_eviction 227ULL
#define WT_CONF_ID_eviction_checkpoint_target 242ULL
#define WT_CONF_ID_eviction_dirty_target 243ULL
#define WT_CONF_ID_eviction_dirty_trigger 244ULL
#define WT_CONF_ID_eviction_target 245ULL
#define WT_CONF_ID_eviction_trigger 246ULL
#define WT_CONF_ID_eviction_updates_target 247ULL
#define WT_CONF_ID_eviction_updates_trigger 248ULL
#define WT_CONF_ID_exclude 115ULL
#define WT_CONF_ID_exclusive 119ULL
#define WT_CONF_ID_exclusive_refreshed 112ULL
#define WT_CONF_ID_extensions 308ULL
#define WT_CONF_ID_extra_diagnostics 249ULL
#define WT_CONF_ID_extractor 72ULL
#define WT_CONF_ID_file 148ULL
#define WT_CONF_ID_file_extend 309ULL
#define WT_CONF_ID_file_max 256ULL
#define WT_CONF_ID_file_metadata 123ULL
#define WT_CONF_ID_final_flush 187ULL
#define WT_CONF_ID_flush_time 94ULL
#define WT_CONF_ID_flush_timestamp 95ULL
#define WT_CONF_ID_flushed_data_cache_insertion 300ULL
#define WT_CONF_ID_force 106ULL
#define WT_CONF_ID_force_stop 149ULL
#define WT_CONF_ID_force_write_wait 315ULL
#define WT_CONF_ID_format 28ULL
#define WT_CONF_ID_free_space_target 116ULL
#define WT_CONF_ID_full_target 200ULL
#define WT_CONF_ID_generation_drain_timeout_ms 254ULL
...
#define WT_CONF_ID_hazard_max 313ULL
#define WT_CONF_ID_huffman_key 29ULL
#define WT_CONF_ID_huffman_value 30ULL
#define WT_CONF_ID_id 68ULL
#define WT_CONF_ID_ignore_cache_size 289ULL
#define WT_CONF_ID_ignore_in_memory_cache_size 31ULL
#define WT_CONF_ID_ignore_prepare 174ULL
#define WT_CONF_ID_immutable 73ULL
#define WT_CONF_ID_in_memory 32ULL
#define WT_CONF_ID_inclusive 111ULL
#define WT_CONF_ID_index_key_columns 74ULL
#define WT_CONF_ID_ingest 100ULL
#define WT_CONF_ID_internal_item_max 33ULL
#define WT_CONF_ID_internal_key_max 34ULL
#define WT_CONF_ID_internal_key_truncate 35ULL
#define WT_CONF_ID_internal_page_max 36ULL
#define WT_CONF_ID_interval 326ULL
#define WT_CONF_ID_isolation 175ULL
#define WT_CONF_ID_json 277ULL
#define WT_CONF_ID_json_output 260ULL
#define WT_CONF_ID_key_format 37ULL
#define WT_CONF_ID_key_gap 38ULL
#define WT_CONF_ID_keyid 27ULL
#define WT_CONF_ID_last 76ULL
#define WT_CONF_ID_layered_constituent 41ULL
#define WT_CONF_ID_layered_table_sync 134ULL
#define WT_CONF_ID_leaf_item_max 42ULL
#define WT_CONF_ID_leaf_key_max 43ULL
#define WT_CONF_ID_leaf_page_max 44ULL
#define WT_CONF_ID_leaf_value_max 45ULL
#define WT_CONF_ID_leak_memory 188ULL
#define WT_CONF_ID_local_retention 61ULL
...
#define WT_CONF_ID_max_consecutive_delta 24ULL
#define WT_CONF_ID_max_percent_overhead 203ULL
#define WT_CONF_ID_memory_page_image_max 47ULL
#define WT_CONF_ID_memory_page_max 48ULL
#define WT_CONF_ID_merge 269ULL
#define WT_CONF_ID_merge_max 91ULL
#define WT_CONF_ID_merge_min 92ULL
#define WT_CONF_ID_metadata_file 124ULL
#define WT_CONF_ID_method 216ULL
#define WT_CONF_ID_mmap 317ULL
#define WT_CONF_ID_mmap_all 318ULL
#define WT_CONF_ID_multiprocess 319ULL
#define WT_CONF_ID_name 26ULL
#define WT_CONF_ID_next_checkpoint_id 98ULL
...
#define WT_CONF_ID_next_random_unrestricted 156ULL
#define WT_CONF_ID_no_timestamp 176ULL
#define WT_CONF_ID_nvram_path 204ULL
#define WT_CONF_ID_object_target_size 62ULL
#define WT_CONF_ID_old_chunks 93ULL
#define WT_CONF_ID_oldest 103ULL
#define WT_CONF_ID_oldest_timestamp 291ULL
#define WT_CONF_ID_on_close 278ULL
#define WT_CONF_ID_operation 132ULL
#define WT_CONF_ID_operation_timeout_ms 177ULL
#define WT_CONF_ID_os_cache_dirty_max 49ULL
#define WT_CONF_ID_os_cache_dirty_pct 262ULL
#define WT_CONF_ID_os_cache_max 50ULL
#define WT_CONF_ID_overwrite 107ULL
#define WT_CONF_ID_page_log 21ULL
#define WT_CONF_ID_path 271ULL
#define WT_CONF_ID_percent_file_in_dram 205ULL
#define WT_CONF_ID_pinned 218ULL
#define WT_CONF_ID_prealloc 263ULL
#define WT_CONF_ID_prealloc_init_count 264ULL
#define WT_CONF_ID_precise 214ULL
#define WT_CONF_ID_prefix 88ULL
#define WT_CONF_ID_prefix_compression 51ULL
#define WT_CONF_ID_prefix_compression_min 52ULL
#define WT_CONF_ID_prefix_search 108ULL
#define WT_CONF_ID_prepare_timestamp 182ULL
#define WT_CONF_ID_prepared 180ULL
#define WT_CONF_ID_priority 178ULL
#define WT_CONF_ID_quota 274ULL
#define WT_CONF_ID_raw 157ULL
#define WT_CONF_ID_read 181ULL
#define WT_CONF_ID_read_corrupt 171ULL
#define WT_CONF_ID_read_once 158ULL
...
#define WT_CONF_ID_recover 316ULL
#define WT_CONF_ID_release 220ULL
#define WT_CONF_ID_release_evict 144ULL
#define WT_CONF_ID_release_evict_page 288ULL
#define WT_CONF_ID_remove 265ULL
#define WT_CONF_ID_remove_files 127ULL
#define WT_CONF_ID_remove_shared 128ULL
#define WT_CONF_ID_repair 122ULL
#define WT_CONF_ID_require_max 301ULL
#define WT_CONF_ID_require_min 302ULL
#define WT_CONF_ID_reserve 275ULL
#define WT_CONF_ID_role 99ULL
#define WT_CONF_ID_rollback_error 231ULL
#define WT_CONF_ID_run_once 117ULL
#define WT_CONF_ID_salvage 322ULL
#define WT_CONF_ID_secretkey 307ULL
#define WT_CONF_ID_session_max 323ULL
#define WT_CONF_ID_session_scratch_max 324ULL
#define WT_CONF_ID_session_table_cache 325ULL
#define WT_CONF_ID_sessions 194ULL
#define WT_CONF_ID_shared 63ULL
#define WT_CONF_ID_size 201ULL
#define WT_CONF_ID_skip_sort_check 159ULL
#define WT_CONF_ID_slow_checkpoint 232ULL
#define WT_CONF_ID_source 8ULL
#define WT_CONF_ID_sources 279ULL
#define WT_CONF_ID_split_deepen_min_child 53ULL
#define WT_CONF_ID_split_deepen_per_child 54ULL
#define WT_CONF_ID_split_pct 55ULL
#define WT_CONF_ID_src_id 151ULL
#define WT_CONF_ID_stable 101ULL
#define WT_CONF_ID_stable_prefix 22ULL
#define WT_CONF_ID_stable_timestamp 172ULL
#define WT_CONF_ID_start_generation 89ULL
#define WT_CONF_ID_start_timestamp 142ULL
#define WT_CONF_ID_statistics 160ULL
#define WT_CONF_ID_storage_path 299ULL
#define WT_CONF_ID_strategy 133ULL
#define WT_CONF_ID_stress_skiplist 233ULL
#define WT_CONF_ID_strict 173ULL
#define WT_CONF_ID_suffix 90ULL
#define WT_CONF_ID_sync 135ULL
#define WT_CONF_ID_system_ram 206ULL
#define WT_CONF_ID_table_logging 234ULL
#define WT_CONF_ID_target 161ULL
#define WT_CONF_ID_terminate 285ULL
...
#define WT_CONF_ID_tiers 104ULL
#define WT_CONF_ID_timeout 118ULL
#define WT_CONF_ID_timestamp 280ULL
#define WT_CONF_ID_timestamp_order 143ULL
#define WT_CONF_ID_timing_stress_for_test 281ULL
#define WT_CONF_ID_total 258ULL
...
#define WT_CONF_ID_zero_fill 266ULL
...
static const struct {
    ...
    uint64_t next_random_unrestricted;
  ...
  },
  {
    ...
    WT_CONF_ID_Disaggregated | (WT_CONF_ID_stable_prefix << 16),
  },
  {
  ...
  WT_CONF_ID_next_random_unrestricted,
