...
#define WT_CONF_ID_checkpoint_scrub_eviction 256ULL
#define WT_CONF_ID_checkpoint_scrub_image_max 257ULL
...
#define WT_CONF_ID_eviction_dirty_index 267ULL
#define WT_CONF_ID_eviction_dirty_index_disagg 268ULL
...
#define WT_CONF_ID_timing_stress_force 249ULL
...
static const struct {
    ...
    uint64_t eviction_dirty_index;
    uint64_t eviction_dirty_index_disagg;
  ...
  WT_CONF_ID_eviction_dirty_index,
  WT_CONF_ID_eviction_dirty_index_disagg,
