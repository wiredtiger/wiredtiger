...
#define WT_CONF_ID_checkpoint_scrub_eviction 254ULL
#define WT_CONF_ID_checkpoint_scrub_image_max 255ULL
...
#define WT_CONF_ID_drop_defer_unlink 276ULL
...
static const struct {
  ...
  },
  {
    ...
    WT_CONF_ID_File_manager | (WT_CONF_ID_drop_defer_unlink << 16),
  },
  {
