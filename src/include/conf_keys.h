...
#define WT_CONF_ID_check_active_cursor_when_reset 268ULL
...
static const struct {
    ...
    struct {
        uint64_t check_active_cursor_when_reset;
  ...
  {
    WT_CONF_ID_Debug | (WT_CONF_ID_check_active_cursor_when_reset << 16),
