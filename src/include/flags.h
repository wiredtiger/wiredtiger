 ...
 * flags section: BEGIN
 */
#define	WT_CONN_CACHE_CURSORS				0x00000001
#define	WT_CONN_CACHE_POOL				0x00000002
#define	WT_CONN_CKPT_SYNC				0x00000004
#define	WT_CONN_CLOSING					0x00000008
#define	WT_CONN_CLOSING_NO_MORE_OPENS			0x00000010
#define	WT_CONN_EVICTION_NO_LOOKASIDE			0x00000020
#define	WT_CONN_EVICTION_RUN				0x00000040
#define	WT_CONN_IN_MEMORY				0x00000080
#define	WT_CONN_LEAK_MEMORY				0x00000100
#define	WT_CONN_LOOKASIDE_OPEN				0x00000200
#define	WT_CONN_LSM_MERGE				0x00000400
#define	WT_CONN_PANIC					0x00000800
#define	WT_CONN_READONLY				0x00001000
#define	WT_CONN_RECOVERING				0x00002000
#define	WT_CONN_SERVER_ASYNC				0x00004000
#define	WT_CONN_SERVER_CHECKPOINT			0x00008000
#define	WT_CONN_SERVER_CURSOR_CACHE			0x00010000
#define	WT_CONN_SERVER_LOG				0x00020000
#define	WT_CONN_SERVER_LSM				0x00040000
#define	WT_CONN_SERVER_STATISTICS			0x00080000
#define	WT_CONN_SERVER_SWEEP				0x00100000
#define	WT_CONN_WAS_BACKUP				0x00200000
...
#define	WT_SESSION_CACHE_CURSORS			0x00000001
#define	WT_SESSION_CAN_WAIT				0x00000002
#define	WT_SESSION_IDLE					0x00000004
#define	WT_SESSION_IGNORE_CACHE_SIZE			0x00000008
#define	WT_SESSION_INTERNAL				0x00000010
#define	WT_SESSION_LOCKED_CHECKPOINT			0x00000020
#define	WT_SESSION_LOCKED_HANDLE_LIST_READ		0x00000040
#define	WT_SESSION_LOCKED_HANDLE_LIST_WRITE		0x00000080
#define	WT_SESSION_LOCKED_METADATA			0x00000100
#define	WT_SESSION_LOCKED_PASS				0x00000200
#define	WT_SESSION_LOCKED_SCHEMA			0x00000400
#define	WT_SESSION_LOCKED_SLOT				0x00000800
#define	WT_SESSION_LOCKED_TABLE_READ			0x00001000
#define	WT_SESSION_LOCKED_TABLE_WRITE			0x00002000
#define	WT_SESSION_LOCKED_TURTLE			0x00004000
#define	WT_SESSION_LOGGING_INMEM			0x00008000
#define	WT_SESSION_LOOKASIDE_CURSOR			0x00010000
#define	WT_SESSION_NO_DATA_HANDLES			0x00020000
#define	WT_SESSION_NO_LOGGING				0x00040000
#define	WT_SESSION_NO_RECONCILE				0x00080000
#define	WT_SESSION_NO_SCHEMA_LOCK			0x00100000
#define	WT_SESSION_QUIET_CORRUPT_FILE			0x00200000
#define	WT_SESSION_READ_WONT_NEED			0x00400000
#define	WT_SESSION_SERVER_ASYNC				0x00800000
