...
__ref_set_state(WT_REF *ref, wt_ref_state_t state)
{
...
static WT_INLINE void
__ref_track_state(
  WT_SESSION_IMPL *session, WT_REF *ref, wt_ref_state_t new_state, const char *func, int line)
{
 ...
 */
static WT_INLINE wt_ref_state_t
 ...
 */
static WT_INLINE bool
__ref_cas_state(WT_SESSION_IMPL *session, WT_REF *ref, wt_ref_state_t old_state,
  wt_ref_state_t new_state, const char *func, int line)
{
    bool cas_result;
 ...
 */
static WT_INLINE void
__ref_lock(WT_SESSION_IMPL *session, WT_REF *ref, wt_ref_state_t *previous_statep)
{
