...
__ref_set_state(WT_REF *ref, WT_REF_STATE_TYPE state)
{
...
static WT_INLINE void
__ref_track_state(
  WT_SESSION_IMPL *session, WT_REF *ref, WT_REF_STATE_TYPE new_state, const char *func, int line)
{
 ...
 */
static WT_INLINE WT_REF_STATE_TYPE
 ...
 */
static WT_INLINE bool
__ref_cas_state(WT_SESSION_IMPL *session, WT_REF *ref, WT_REF_STATE_TYPE old_state,
  WT_REF_STATE_TYPE new_state, const char *func, int line)
{
    bool cas_result;
 ...
 */
static WT_INLINE void
__ref_lock(WT_SESSION_IMPL *session, WT_REF *ref, WT_REF_STATE_TYPE *previous_statep)
{
