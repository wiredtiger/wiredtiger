...
static const WT_CONFIG_ENTRY config_entries[] = {
	...
	{ "WT_CONNECTION.reconfigure",
	  ...
	  "lsm_merge=true,operation_tracking=(enabled=true,"
	  "path=\"./operation_tracking\"),shared_cache=(chunk=10MB,name=,"
	...
	{ "wiredtiger_open",
	  ...
	  "mmap=true,multiprocess=false,operation_tracking=(enabled=true,"
	  "path=\"./operation_tracking\"),readonly=false,session_max=100,"
