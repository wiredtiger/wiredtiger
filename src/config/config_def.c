...
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  {"WT_SESSION.create",
    ...
    "tiered_storage=(auth_token=,bucket=,local_retention=,name=,"
  ...
  {"file.config",
    ...
    "tiered_storage=(auth_token=,bucket=,local_retention=,name=,"
    "object_target_size=),value_format=u,verbose=[],"
    "write_timestamp_usage=none",
  ...
  {"file.meta",
    ...
    ",split_deepen_per_child=0,split_pct=90,"
    "tiered_storage=(auth_token=,bucket=,local_retention=,name=,"
    "object_target_size=),value_format=u,verbose=[],version=(major=0,"
