...
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  {"WT_SESSION.alter",
    ...
    "assert=(read_timestamp=none,write_timestamp=false),"
  ...
  {"colgroup.meta",
    "app_metadata=,assert=(read_timestamp=none,write_timestamp=false)"
  ...
  {"index.meta",
    "app_metadata=,assert=(read_timestamp=none,write_timestamp=false)"
    ",collator=,columns=,extractor=,immutable=false,"
