...
static const WT_CONFIG_CHECK
    confchk_wiredtiger_open_diagnostic_subconfigs[] = {
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure[] = {
	...
	{ "diagnostic", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_diagnostic_subconfigs, 2 },
...
static const WT_CONFIG_ENTRY config_entries[] = {
	...
	{ "WT_CONNECTION.reconfigure",
	  ...
	  "wait=0),compatibility=(release=),diagnostic=(rollback_error=0,"
	...
	{ "wiredtiger_open",
	  ...
	  "config_base=true,create=false,diagnostic=(rollback_error=0,"
	...
	{ "wiredtiger_open_basecfg",
	  ...
	  "checkpoint=(log_size=0,wait=0),checkpoint_sync=true,"
	  "compatibility=(release=,require_max=,require_min=),"
	  "diagnostic=(rollback_error=0,table_logging=false),direct_io=,"
