...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_block_cache_subconfigs[] = {
  {"enabled", "boolean", NULL, NULL, NULL, 0}, {"eviction_on", "boolean", NULL, NULL, NULL, 0},
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure[] = {
  ...
  {"block_cache", "category", NULL, NULL, confchk_wiredtiger_open_block_cache_subconfigs, 10},
...
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  {"WT_CONNECTION.reconfigure",
    ...
    "block_cache=(enabled=false,eviction_on=true,hashsize=0,"
    "max_percent_overhead=0,path=,percent_file_in_dram=0,size=0,"
    "system_ram=0,type=,write_allocate=true),cache_max_wait_ms=0,"
  ...
  {"wiredtiger_open",
    ...
    "block_cache=(enabled=false,eviction_on=true,hashsize=0,"
    "max_percent_overhead=0,path=,percent_file_in_dram=0,size=0,"
    "system_ram=0,type=,write_allocate=true),buffer_alignment=-1,"
