...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_close[] = {
  {"final_flush", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 159, INT64_MIN,
    INT64_MAX, NULL},
  {"leak_memory", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 160, INT64_MIN,
    INT64_MAX, NULL},
  {"use_timestamp", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 158, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_CONNECTION_debug_info[] = {
  {"cache", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 161, INT64_MIN,
    INT64_MAX, NULL},
  {"cursors", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 162, INT64_MIN,
    INT64_MAX, NULL},
  {"handles", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 163, INT64_MIN,
    INT64_MAX, NULL},
  {"log", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 164, INT64_MIN,
    INT64_MAX, NULL},
  {"sessions", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 165, INT64_MIN,
    INT64_MAX, NULL},
  {"txn", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 166, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_CONNECTION_load_extension[] = {
  {"config", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 249, INT64_MIN,
    INT64_MAX, NULL},
  {"early_load", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 250, INT64_MIN,
    INT64_MAX, NULL},
  {"entry", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 251, INT64_MIN,
    INT64_MAX, NULL},
  {"terminate", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 252, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_CONNECTION_open_session_debug_subconfigs[] = {
  {"release_evict_page", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 254,
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_open_session[] = {
  {"cache_cursors", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 253, INT64_MIN,
    INT64_MAX, NULL},
  {"cache_max_wait_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 178, 0,
    INT64_MAX, NULL},
  {"debug", "category", NULL, NULL, confchk_WT_CONNECTION_open_session_debug_subconfigs, 1,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 117, INT64_MIN, INT64_MAX, NULL},
  {"ignore_cache_size", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 255,
    INT64_MIN, INT64_MAX, NULL},
  {"isolation", "string", NULL,
    "choices=[\"read-uncommitted\",\"read-committed\","
    "\"snapshot\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 148, INT64_MIN, INT64_MAX, confchk_isolation_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_query_timestamp[] = {
  {"get", "string", NULL,
    ...
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 136, INT64_MIN, INT64_MAX, confchk_get_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_block_cache_subconfigs[] = {
  {"blkcache_eviction_aggression", "int", NULL, "min=1,max=7200", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_INT, 170, 1, 7200, NULL},
  {"cache_on_checkpoint", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 168,
    INT64_MIN, INT64_MAX, NULL},
  {"cache_on_writes", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 169,
    INT64_MIN, INT64_MAX, NULL},
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 37, INT64_MIN,
    INT64_MAX, NULL},
  {"full_target", "int", NULL, "min=30,max=100", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 171, 30, 100,
    NULL},
  {"hashsize", "int", NULL, "min=512,max=256K", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 173, 512,
    256LL * WT_KILOBYTE, NULL},
  {"max_percent_overhead", "int", NULL, "min=1,max=500", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 174,
    1, 500, NULL},
  {"nvram_path", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 175, INT64_MIN,
    INT64_MAX, NULL},
  {"percent_file_in_dram", "int", NULL, "min=0,max=100", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 176,
    0, 100, NULL},
  {"size", "int", NULL, "min=0,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 172, 0,
    10LL * WT_TERABYTE, NULL},
  {"system_ram", "int", NULL, "min=0,max=1024GB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 177, 0,
    1024LL * WT_GIGABYTE, NULL},
  {"type", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 9, INT64_MIN, INT64_MAX,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_wiredtiger_open_checkpoint_subconfigs[] = {
  {"log_size", "int", NULL, "min=0,max=2GB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 183, 0,
    2LL * WT_GIGABYTE, NULL},
  {"wait", "int", NULL, "min=0,max=100000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 184, 0, 100000,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_chunk_cache_subconfigs[] = {
  {"capacity", "int", NULL, "min=0,max=100TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 187, 0,
  ...
  {"device_path", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 189, INT64_MIN,
    INT64_MAX, NULL},
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 37, INT64_MIN,
    INT64_MAX, NULL},
  {"hashsize", "int", NULL, "min=64,max=1048576", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 173, 64,
    1048576LL, NULL},
  {"type", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 9, INT64_MIN, INT64_MAX,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure_compatibility_subconfigs[] = {
  {"release", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 191, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_wiredtiger_open_debug_mode_subconfigs[] = {
  {"checkpoint_retention", "int", NULL, "min=0,max=1024", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 194,
    0, 1024, NULL},
  {"corruption_abort", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 193,
    INT64_MIN, INT64_MAX, NULL},
  {"cursor_copy", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 195, INT64_MIN,
    INT64_MAX, NULL},
  {"cursor_reposition", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 196,
    INT64_MIN, INT64_MAX, NULL},
  {"eviction", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 197, INT64_MIN,
    INT64_MAX, NULL},
  {"log_retention", "int", NULL, "min=0,max=1024", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 198, 0,
    1024, NULL},
  {"realloc_exact", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 199, INT64_MIN,
    INT64_MAX, NULL},
  {"realloc_malloc", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 200,
    INT64_MIN, INT64_MAX, NULL},
  {"rollback_error", "int", NULL, "min=0,max=10M", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 201, 0,
    10LL * WT_MEGABYTE, NULL},
  {"slow_checkpoint", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 202,
    INT64_MIN, INT64_MAX, NULL},
  {"stress_skiplist", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 203,
    INT64_MIN, INT64_MAX, NULL},
  {"table_logging", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 204, INT64_MIN,
    INT64_MAX, NULL},
  {"tiered_flush_error_continue", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN,
    205, INT64_MIN, INT64_MAX, NULL},
  {"update_restore_evict", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 206,
    INT64_MIN, INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_wiredtiger_open_eviction_subconfigs[] = {
  {"threads_max", "int", NULL, "min=1,max=20", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 209, 1, 20,
    NULL},
  {"threads_min", "int", NULL, "min=1,max=20", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 210, 1, 20,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_file_manager_subconfigs[] = {
  {"close_handle_minimum", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 220, 0,
    INT64_MAX, NULL},
  {"close_idle_time", "int", NULL, "min=0,max=100000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 221, 0,
    100000, NULL},
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_history_store_subconfigs[] = {
  {"file_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 225, 0, INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_wiredtiger_open_io_capacity_subconfigs[] = {
  {"total", "int", NULL, "min=0,max=1TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 227, 0,
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure_log_subconfigs[] = {
  {"archive", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 229, INT64_MIN,
    INT64_MAX, NULL},
  {"os_cache_dirty_pct", "int", NULL, "min=0,max=100", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 230, 0,
    100, NULL},
  {"prealloc", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 231, INT64_MIN,
    INT64_MAX, NULL},
  {"remove", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 232, INT64_MIN,
    INT64_MAX, NULL},
  {"zero_fill", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 233, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_wiredtiger_open_lsm_manager_subconfigs[] = {
  {"merge", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 236, INT64_MIN,
    INT64_MAX, NULL},
  {"worker_thread_max", "int", NULL, "min=3,max=20", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 235, 3,
    20, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_operation_tracking_subconfigs[] = {
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 37, INT64_MIN,
    INT64_MAX, NULL},
  {"path", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 238, INT64_MIN, INT64_MAX,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_wiredtiger_open_shared_cache_subconfigs[] = {
  {"chunk", "int", NULL, "min=1MB,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 240,
    1LL * WT_MEGABYTE, 10LL * WT_TERABYTE, NULL},
  {"name", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 20, INT64_MIN, INT64_MAX,
    NULL},
  {"quota", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 241, INT64_MIN, INT64_MAX,
    NULL},
  {"reserve", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 242, INT64_MIN, INT64_MAX,
    NULL},
  {"size", "int", NULL, "min=1MB,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 172,
    1LL * WT_MEGABYTE, 10LL * WT_TERABYTE, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure_statistics_log_subconfigs[] = {
  {"json", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 244, INT64_MIN,
    INT64_MAX, NULL},
  {"on_close", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 245, INT64_MIN,
    INT64_MAX, NULL},
  {"sources", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 246, INT64_MIN, INT64_MAX,
    NULL},
  {"timestamp", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 247, INT64_MIN,
    INT64_MAX, NULL},
  {"wait", "int", NULL, "min=0,max=100000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 184, 0, 100000,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const char *confchk_timing_stress_for_test_choices[] = {"aggressive_stash_free",
  ...
  "failpoint_eviction_fail_after_reconciliation", "failpoint_history_store_delete_key_from_ts",
  "history_store_checkpoint_delay", "history_store_search", "history_store_sweep_race",
  "prepare_checkpoint_delay", "prepare_resolution", "sleep_before_read_overflow_onpage", "split_1",
  "split_2", "split_3", "split_4", "split_5", "split_6", "split_7", "split_8",
  "tiered_flush_finish", NULL};
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure[] = {
  {"block_cache", "category", NULL, NULL, confchk_wiredtiger_open_block_cache_subconfigs, 12,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 167, INT64_MIN, INT64_MAX, NULL},
  {"cache_max_wait_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 178, 0,
    INT64_MAX, NULL},
  {"cache_overhead", "int", NULL, "min=0,max=30", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 179, 0, 30,
    NULL},
  {"cache_size", "int", NULL, "min=1MB,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 180,
    1LL * WT_MEGABYTE, 10LL * WT_TERABYTE, NULL},
  {"cache_stuck_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 181, 0,
    INT64_MAX, NULL},
  ...
  {"checkpoint_cleanup", "string", NULL, "choices=[\"none\",\"reclaim_space\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 185, INT64_MIN, INT64_MAX, confchk_checkpoint_cleanup_choices},
  {"chunk_cache", "category", NULL, NULL, confchk_wiredtiger_open_chunk_cache_subconfigs, 7,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 186, INT64_MIN, INT64_MAX, NULL},
  ...
  {"error_prefix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 207, INT64_MIN,
    INT64_MAX, NULL},
  {"eviction", "category", NULL, NULL, confchk_wiredtiger_open_eviction_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 208, INT64_MIN, INT64_MAX, NULL},
  ...
  {"eviction_dirty_target", "int", NULL, "min=1,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT,
    212, 1, 10LL * WT_TERABYTE, NULL},
  {"eviction_dirty_trigger", "int", NULL, "min=1,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT,
    213, 1, 10LL * WT_TERABYTE, NULL},
  {"eviction_target", "int", NULL, "min=10,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 214, 10,
    10LL * WT_TERABYTE, NULL},
  {"eviction_trigger", "int", NULL, "min=10,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 215,
    10, 10LL * WT_TERABYTE, NULL},
  {"eviction_updates_target", "int", NULL, "min=0,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT,
    216, 0, 10LL * WT_TERABYTE, NULL},
  {"eviction_updates_trigger", "int", NULL, "min=0,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT,
    217, 0, 10LL * WT_TERABYTE, NULL},
  {"extra_diagnostics", "list", NULL,
    ...
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 218, INT64_MIN, INT64_MAX,
  ...
  {"generation_drain_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 223,
    0, INT64_MAX, NULL},
  ...
  {"log", "category", NULL, NULL, confchk_WT_CONNECTION_reconfigure_log_subconfigs, 5,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 36, INT64_MIN, INT64_MAX, NULL},
  {"lsm_manager", "category", NULL, NULL, confchk_wiredtiger_open_lsm_manager_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 234, INT64_MIN, INT64_MAX, NULL},
  {"operation_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 150, 0,
    INT64_MAX, NULL},
  {"operation_tracking", "category", NULL, NULL,
    confchk_wiredtiger_open_operation_tracking_subconfigs, 2, WT_CONFIG_COMPILED_TYPE_CATEGORY, 237,
    INT64_MIN, INT64_MAX, NULL},
  ...
  {"statistics", "list", NULL,
    ...
    "\"clear\",\"tree_walk\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 134, INT64_MIN, INT64_MAX, confchk_statistics_choices},
  ...
  {"timing_stress_for_test", "list", NULL,
    ...
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 248, INT64_MIN, INT64_MAX,
  ...
  {"verbose", "list", NULL,
    ...
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 10, INT64_MIN, INT64_MAX, confchk_verbose_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_CONNECTION_rollback_to_stable[] = {
  {"dryrun", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 257, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_CONNECTION_set_timestamp[] = {
  {"durable_timestamp", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 3, INT64_MIN,
    INT64_MAX, NULL},
  {"force", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 105, INT64_MIN,
    INT64_MAX, NULL},
  {"oldest_timestamp", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 256,
    INT64_MIN, INT64_MAX, NULL},
...
static const WT_CONFIG_CHECK confchk_WT_CURSOR_bound[] = {
  {"action", "string", NULL, "choices=[\"clear\",\"set\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING,
    93, INT64_MIN, INT64_MAX, confchk_action_choices},
  {"bound", "string", NULL, "choices=[\"lower\",\"upper\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 94, INT64_MIN, INT64_MAX, confchk_bound_choices},
  {"inclusive", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 95, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_CURSOR_reconfigure[] = {
  {"append", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 90, INT64_MIN,
    INT64_MAX, NULL},
  {"overwrite", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 91, INT64_MIN,
    INT64_MAX, NULL},
  {"prefix_search", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 92, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_create_assert_subconfigs[] = {
  {"commit_timestamp", "string", NULL,
    ...
    "\"none\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 2, INT64_MIN, INT64_MAX,
    confchk_commit_timestamp_choices},
  {"durable_timestamp", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"never\","
    "\"none\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 3, INT64_MIN, INT64_MAX,
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_alter[] = {
  {"access_pattern_hint", "string", NULL, "choices=[\"none\",\"random\",\"sequential\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 12, INT64_MIN, INT64_MAX, confchk_access_pattern_hint_choices},
  {"app_metadata", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 0, INT64_MIN,
    INT64_MAX, NULL},
  {"assert", "category", NULL, NULL, confchk_WT_SESSION_create_assert_subconfigs, 4,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 1, INT64_MIN, INT64_MAX, NULL},
  {"cache_resident", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 16, INT64_MIN,
    INT64_MAX, NULL},
  {"checkpoint", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 56, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"log", "category", NULL, NULL, confchk_WT_SESSION_create_log_subconfigs, 1,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 36, INT64_MIN, INT64_MAX, NULL},
  {"os_cache_dirty_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 40, 0,
    INT64_MAX, NULL},
  {"os_cache_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 41, 0, INT64_MAX,
    NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose2_choices},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
    "\"never\",\"none\",\"ordered\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 11, INT64_MIN, INT64_MAX,
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_begin_transaction_roundup_timestamps_subconfigs[] =
  {{"prepared", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 153, INT64_MIN,
     INT64_MAX, NULL},
    {"read", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 154, INT64_MIN,
      INT64_MAX, NULL},
    {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_begin_transaction[] = {
  {"ignore_prepare", "string", NULL, "choices=[\"false\",\"force\",\"true\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 147, INT64_MIN, INT64_MAX, confchk_ignore_prepare_choices},
  {"isolation", "string", NULL,
    "choices=[\"read-uncommitted\",\"read-committed\","
    "\"snapshot\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 148, INT64_MIN, INT64_MAX, confchk_isolation2_choices},
  {"name", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 20, INT64_MIN, INT64_MAX,
    NULL},
  {"no_timestamp", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 149, INT64_MIN,
    INT64_MAX, NULL},
  {"operation_timeout_ms", "int", NULL, "min=1", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 150, 1,
    INT64_MAX, NULL},
  {"priority", "int", NULL, "min=-100,max=100", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 151, 100, 100,
    NULL},
  {"read_timestamp", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 4, INT64_MIN,
    INT64_MAX, NULL},
  {"roundup_timestamps", "category", NULL, NULL,
    confchk_WT_SESSION_begin_transaction_roundup_timestamps_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 152, INT64_MIN, INT64_MAX, NULL},
  {"sync", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 114, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_checkpoint_flush_tier_subconfigs[] = {
  ...
  {"sync", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 114, INT64_MIN,
    INT64_MAX, NULL},
  {"timeout", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 97, INT64_MIN, INT64_MAX,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_SESSION_checkpoint[] = {
  {"drop", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 156, INT64_MIN, INT64_MAX,
    NULL},
  ...
  {"name", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 20, INT64_MIN, INT64_MAX,
    NULL},
  {"target", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 135, INT64_MIN, INT64_MAX,
    NULL},
  {"use_timestamp", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 158, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_commit_transaction[] = {
  {"commit_timestamp", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 2, INT64_MIN,
    INT64_MAX, NULL},
  {"durable_timestamp", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 3, INT64_MIN,
    INT64_MAX, NULL},
  {"operation_timeout_ms", "int", NULL, "min=1", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 150, 1,
  ...
  {"sync", "string", NULL, "choices=[\"off\",\"on\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 114,
    INT64_MIN, INT64_MAX, confchk_sync_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_create_encryption_subconfigs[] = {
  {"keyid", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 21, INT64_MIN, INT64_MAX,
    NULL},
  {"name", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 20, INT64_MIN, INT64_MAX,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_create_import_subconfigs[] = {
  {"compare_timestamp", "string", NULL,
    ...
    "\"stable_timestamp\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 100, INT64_MIN, INT64_MAX,
    confchk_compare_timestamp_choices},
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 37, INT64_MIN,
    INT64_MAX, NULL},
  {"file_metadata", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 102, INT64_MIN,
    INT64_MAX, NULL},
  {"metadata_file", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 103, INT64_MIN,
    INT64_MAX, NULL},
  {"repair", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 101, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_SESSION_create_merge_custom_subconfigs[] = {
  {"prefix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 79, INT64_MIN,
    INT64_MAX, NULL},
  {"start_generation", "int", NULL, "min=0,max=10", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 80, 0, 10,
    NULL},
  {"suffix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 81, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_SESSION_create_lsm_subconfigs[] = {
  {"auto_throttle", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 69, INT64_MIN,
    INT64_MAX, NULL},
  {"bloom", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 70, INT64_MIN,
    INT64_MAX, NULL},
  {"bloom_bit_count", "int", NULL, "min=2,max=1000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 71, 2,
    1000, NULL},
  {"bloom_config", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 72, INT64_MIN,
    INT64_MAX, NULL},
  {"bloom_hash_count", "int", NULL, "min=2,max=100", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 73, 2,
    100, NULL},
  {"bloom_oldest", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 74, INT64_MIN,
    INT64_MAX, NULL},
  {"chunk_count_limit", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 75, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"merge_custom", "category", NULL, NULL, confchk_WT_SESSION_create_merge_custom_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 78, INT64_MIN, INT64_MAX, NULL},
  {"merge_max", "int", NULL, "min=2,max=100", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 82, 2, 100,
    NULL},
  {"merge_min", "int", NULL, "max=100", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 83, INT64_MIN, 100,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_SESSION_create_tiered_storage_subconfigs[] = {
  {"auth_token", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 48, INT64_MIN,
    INT64_MAX, NULL},
  {"bucket", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 49, INT64_MIN,
    INT64_MAX, NULL},
  {"bucket_prefix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 50, INT64_MIN,
    INT64_MAX, NULL},
  {"cache_directory", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 51, INT64_MIN,
    INT64_MAX, NULL},
  {"local_retention", "int", NULL, "min=0,max=10000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 52, 0,
    10000, NULL},
  {"name", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 20, INT64_MIN, INT64_MAX,
    NULL},
  {"object_target_size", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 53, 0,
    INT64_MAX, NULL},
  {"shared", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 54, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_create[] = {
  {"access_pattern_hint", "string", NULL, "choices=[\"none\",\"random\",\"sequential\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 12, INT64_MIN, INT64_MAX, confchk_access_pattern_hint2_choices},
  ...
  {"block_compressor", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 15, INT64_MIN,
    INT64_MAX, NULL},
  {"cache_resident", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 16, INT64_MIN,
    INT64_MAX, NULL},
  {"checksum", "string", NULL,
    ...
    "\"unencrypted\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 17, INT64_MIN, INT64_MAX, confchk_checksum_choices},
  {"colgroups", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 87, INT64_MIN, INT64_MAX,
    NULL},
  {"collator", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 6, INT64_MIN,
    INT64_MAX, NULL},
  {"columns", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 7, INT64_MIN, INT64_MAX,
    NULL},
  {"dictionary", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 18, 0, INT64_MAX,
    NULL},
  {"encryption", "category", NULL, NULL, confchk_WT_SESSION_create_encryption_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 19, INT64_MIN, INT64_MAX, NULL},
  {"exclusive", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 98, INT64_MIN,
    INT64_MAX, NULL},
  {"extractor", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 63, INT64_MIN,
    INT64_MAX, NULL},
  {"format", "string", NULL, "choices=[\"btree\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 22,
    INT64_MIN, INT64_MAX, confchk_format_choices},
  {"huffman_key", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 23, INT64_MIN,
    INT64_MAX, NULL},
  {"huffman_value", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 24, INT64_MIN,
    INT64_MAX, NULL},
  {"ignore_in_memory_cache_size", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN,
    25, INT64_MIN, INT64_MAX, NULL},
  {"immutable", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 64, INT64_MIN,
    INT64_MAX, NULL},
  {"import", "category", NULL, NULL, confchk_WT_SESSION_create_import_subconfigs, 5,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 99, INT64_MIN, INT64_MAX, NULL},
  {"internal_item_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 26, 0,
    INT64_MAX, NULL},
  {"internal_key_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 27, 0, INT64_MAX,
    NULL},
  ...
  {"key_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 30,
    INT64_MIN, INT64_MAX, NULL},
  {"key_gap", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 31, 0, INT64_MAX, NULL},
  {"leaf_item_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 32, 0, INT64_MAX,
    NULL},
  {"leaf_key_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 33, 0, INT64_MAX,
    NULL},
  {"leaf_page_max", "int", NULL, "min=512B,max=512MB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 34,
    512, 512LL * WT_MEGABYTE, NULL},
  {"leaf_value_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 35, 0, INT64_MAX,
    NULL},
  {"log", "category", NULL, NULL, confchk_WT_SESSION_create_log_subconfigs, 1,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 36, INT64_MIN, INT64_MAX, NULL},
  {"lsm", "category", NULL, NULL, confchk_WT_SESSION_create_lsm_subconfigs, 12,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 68, INT64_MIN, INT64_MAX, NULL},
  {"memory_page_image_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 38, 0,
    INT64_MAX, NULL},
  ...
  {"prefix_compression", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 42,
    INT64_MIN, INT64_MAX, NULL},
  {"prefix_compression_min", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 43, 0,
    INT64_MAX, NULL},
  {"source", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 8, INT64_MIN, INT64_MAX,
    NULL},
  {"split_deepen_min_child", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 44, INT64_MIN,
    INT64_MAX, NULL},
  {"split_deepen_per_child", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 45, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"value_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 55,
    INT64_MIN, INT64_MAX, NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose3_choices},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
    "\"never\",\"none\",\"ordered\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 11, INT64_MIN, INT64_MAX,
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_drop[] = {
  ...
  {"force", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 105, INT64_MIN,
    INT64_MAX, NULL},
  {"lock_wait", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 106, INT64_MIN,
    INT64_MAX, NULL},
  {"remove_files", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 107, INT64_MIN,
    INT64_MAX, NULL},
  {"remove_shared", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 108, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_flush_tier[] = {
  ...
  {"lock_wait", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 106, INT64_MIN,
    INT64_MAX, NULL},
  {"sync", "string", NULL, "choices=[\"off\",\"on\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 114,
    INT64_MIN, INT64_MAX, confchk_sync2_choices},
  {"timeout", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 97, INT64_MIN, INT64_MAX,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_join[] = {
  ...
  {"compare", "string", NULL, "choices=[\"eq\",\"ge\",\"gt\",\"le\",\"lt\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 110, INT64_MIN, INT64_MAX, confchk_compare_choices},
  {"count", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 111, INT64_MIN, INT64_MAX,
    NULL},
  {"operation", "string", NULL, "choices=[\"and\",\"or\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING,
    112, INT64_MIN, INT64_MAX, confchk_operation_choices},
  {"strategy", "string", NULL, "choices=[\"bloom\",\"default\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 113, INT64_MIN, INT64_MAX, confchk_strategy_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const char *confchk_sync3_choices[] = {"off", "on", NULL};

static const WT_CONFIG_CHECK confchk_WT_SESSION_log_flush[] = {
  {"sync", "string", NULL, "choices=[\"off\",\"on\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 114,
    INT64_MIN, INT64_MAX, confchk_sync3_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_open_cursor_debug_subconfigs[] = {
  {"checkpoint_read_timestamp", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 118,
    INT64_MIN, INT64_MAX, NULL},
  {"dump_version", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 119, INT64_MIN,
    INT64_MAX, NULL},
  {"release_evict", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 120, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_open_cursor_incremental_subconfigs[] = {
  {"consolidate", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 123, INT64_MIN,
    INT64_MAX, NULL},
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 37, INT64_MIN,
    INT64_MAX, NULL},
  {"file", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 124, INT64_MIN, INT64_MAX,
    NULL},
  {"force_stop", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 125, INT64_MIN,
    INT64_MAX, NULL},
  {"granularity", "int", NULL, "min=4KB,max=2GB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 126,
    4LL * WT_KILOBYTE, 2LL * WT_GIGABYTE, NULL},
  {"src_id", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 127, INT64_MIN,
    INT64_MAX, NULL},
  {"this_id", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 128, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_open_cursor[] = {
  {"append", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 90, INT64_MIN,
    INT64_MAX, NULL},
  {"bulk", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 115, INT64_MIN, INT64_MAX,
    NULL},
  {"checkpoint", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 56, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"dump", "string", NULL,
    ...
    "\"print\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 121, INT64_MIN, INT64_MAX, confchk_dump_choices},
  {"incremental", "category", NULL, NULL, confchk_WT_SESSION_open_cursor_incremental_subconfigs, 7,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 122, INT64_MIN, INT64_MAX, NULL},
  {"next_random", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 129, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"prefix_search", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 92, INT64_MIN,
    INT64_MAX, NULL},
  {"raw", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 131, INT64_MIN,
    INT64_MAX, NULL},
  {"read_once", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 132, INT64_MIN,
    INT64_MAX, NULL},
  {"readonly", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 60, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"statistics", "list", NULL,
    ...
    "\"size\",\"tree_walk\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 134, INT64_MIN, INT64_MAX, confchk_statistics2_choices},
  {"target", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 135, INT64_MIN, INT64_MAX,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_query_timestamp[] = {
  {"get", "string", NULL,
    ...
    "\"read\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 136, INT64_MIN, INT64_MAX, confchk_get2_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_reconfigure[] = {
  ...
  {"isolation", "string", NULL,
    "choices=[\"read-uncommitted\",\"read-committed\","
    "\"snapshot\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 148, INT64_MIN, INT64_MAX, confchk_isolation3_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_verify[] = {
  {"do_not_clear_txn_id", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 137,
    INT64_MIN, INT64_MAX, NULL},
  {"dump_address", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 138, INT64_MIN,
    INT64_MAX, NULL},
  {"dump_app_data", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 139, INT64_MIN,
    INT64_MAX, NULL},
  {"dump_blocks", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 140, INT64_MIN,
    INT64_MAX, NULL},
  {"dump_layout", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 141, INT64_MIN,
    INT64_MAX, NULL},
  {"dump_offsets", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 142, INT64_MIN,
    INT64_MAX, NULL},
  {"dump_pages", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 143, INT64_MIN,
    INT64_MAX, NULL},
  {"read_corrupt", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 144, INT64_MIN,
    INT64_MAX, NULL},
  {"stable_timestamp", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 145,
    INT64_MIN, INT64_MAX, NULL},
  {"strict", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 146, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_colgroup_meta[] = {
  ...
  {"type", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 9, INT64_MIN, INT64_MAX,
    NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose4_choices},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
    "\"never\",\"none\",\"ordered\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 11, INT64_MIN, INT64_MAX,
...
static const WT_CONFIG_CHECK confchk_file_config[] = {
  {"access_pattern_hint", "string", NULL, "choices=[\"none\",\"random\",\"sequential\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 12, INT64_MIN, INT64_MAX, confchk_access_pattern_hint3_choices},
  {"allocation_size", "int", NULL, "min=512B,max=128MB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 13,
    512, 128LL * WT_MEGABYTE, NULL},
  {"app_metadata", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 0, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"checksum", "string", NULL,
    "choices=[\"on\",\"off\",\"uncompressed\","
    "\"unencrypted\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 17, INT64_MIN, INT64_MAX, confchk_checksum2_choices},
  {"collator", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 6, INT64_MIN,
    INT64_MAX, NULL},
  {"columns", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 7, INT64_MIN, INT64_MAX,
    NULL},
  ...
  {"value_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 55,
    INT64_MIN, INT64_MAX, NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose5_choices},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
    "\"never\",\"none\",\"ordered\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 11, INT64_MIN, INT64_MAX,
...
static const WT_CONFIG_CHECK confchk_file_meta[] = {
  {"access_pattern_hint", "string", NULL, "choices=[\"none\",\"random\",\"sequential\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 12, INT64_MIN, INT64_MAX, confchk_access_pattern_hint4_choices},
  {"allocation_size", "int", NULL, "min=512B,max=128MB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 13,
    512, 128LL * WT_MEGABYTE, NULL},
  {"app_metadata", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 0, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"checkpoint_backup_info", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 57,
    INT64_MIN, INT64_MAX, NULL},
  {"checkpoint_lsn", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 58, INT64_MIN,
    INT64_MAX, NULL},
  {"checksum", "string", NULL,
    "choices=[\"on\",\"off\",\"uncompressed\","
    "\"unencrypted\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 17, INT64_MIN, INT64_MAX, confchk_checksum3_choices},
  {"collator", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 6, INT64_MIN,
    INT64_MAX, NULL},
  {"columns", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 7, INT64_MIN, INT64_MAX,
    NULL},
  ...
  {"huffman_value", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 24, INT64_MIN,
    INT64_MAX, NULL},
  {"id", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 59, INT64_MIN, INT64_MAX,
    NULL},
  {"ignore_in_memory_cache_size", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN,
    25, INT64_MIN, INT64_MAX, NULL},
  {"internal_item_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 26, 0,
  ...
  {"split_pct", "int", NULL, "min=50,max=100", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 46, 50, 100,
    NULL},
  {"tiered_object", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 61, INT64_MIN,
    INT64_MAX, NULL},
  {"tiered_storage", "category", NULL, NULL, confchk_WT_SESSION_create_tiered_storage_subconfigs, 8,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 47, INT64_MIN, INT64_MAX, NULL},
  {"value_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 55,
    INT64_MIN, INT64_MAX, NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose6_choices},
  {"version", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 62, INT64_MIN,
    INT64_MAX, NULL},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
    "\"never\",\"none\",\"ordered\"]",
...
static const WT_CONFIG_CHECK confchk_index_meta[] = {
  ...
  {"immutable", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 64, INT64_MIN,
    INT64_MAX, NULL},
  {"index_key_columns", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 65, INT64_MIN,
    INT64_MAX, NULL},
  {"key_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 30,
    INT64_MIN, INT64_MAX, NULL},
  {"source", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 8, INT64_MIN, INT64_MAX,
  ...
  {"value_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 55,
    INT64_MIN, INT64_MAX, NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose7_choices},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
    "\"never\",\"none\",\"ordered\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 11, INT64_MIN, INT64_MAX,
...
static const WT_CONFIG_CHECK confchk_lsm_meta[] = {
  {"access_pattern_hint", "string", NULL, "choices=[\"none\",\"random\",\"sequential\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 12, INT64_MIN, INT64_MAX, confchk_access_pattern_hint5_choices},
  {"allocation_size", "int", NULL, "min=512B,max=128MB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 13,
    512, 128LL * WT_MEGABYTE, NULL},
  {"app_metadata", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 0, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"checksum", "string", NULL,
    "choices=[\"on\",\"off\",\"uncompressed\","
    "\"unencrypted\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 17, INT64_MIN, INT64_MAX, confchk_checksum4_choices},
  {"chunks", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 66, INT64_MIN,
    INT64_MAX, NULL},
  {"collator", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 6, INT64_MIN,
    INT64_MAX, NULL},
  {"columns", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 7, INT64_MIN, INT64_MAX,
  ...
  {"key_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 30,
    INT64_MIN, INT64_MAX, NULL},
  {"key_gap", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 31, 0, INT64_MAX, NULL},
  {"last", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 67, INT64_MIN, INT64_MAX,
    NULL},
  {"leaf_item_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 32, 0, INT64_MAX,
    NULL},
  {"leaf_key_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 33, 0, INT64_MAX,
  ...
  {"memory_page_max", "int", NULL, "min=512B,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 39,
    512, 10LL * WT_TERABYTE, NULL},
  {"old_chunks", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 84, INT64_MIN,
    INT64_MAX, NULL},
  {"os_cache_dirty_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 40, 0,
    INT64_MAX, NULL},
  {"os_cache_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 41, 0, INT64_MAX,
  ...
  {"value_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 55,
    INT64_MIN, INT64_MAX, NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose8_choices},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
    "\"never\",\"none\",\"ordered\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 11, INT64_MIN, INT64_MAX,
...
static const WT_CONFIG_CHECK confchk_object_meta[] = {
  {"access_pattern_hint", "string", NULL, "choices=[\"none\",\"random\",\"sequential\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 12, INT64_MIN, INT64_MAX, confchk_access_pattern_hint6_choices},
  {"allocation_size", "int", NULL, "min=512B,max=128MB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 13,
    512, 128LL * WT_MEGABYTE, NULL},
  {"app_metadata", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 0, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"checksum", "string", NULL,
    "choices=[\"on\",\"off\",\"uncompressed\","
    "\"unencrypted\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 17, INT64_MIN, INT64_MAX, confchk_checksum5_choices},
  {"collator", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 6, INT64_MIN,
    INT64_MAX, NULL},
  {"columns", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 7, INT64_MIN, INT64_MAX,
    NULL},
  ...
  {"encryption", "category", NULL, NULL, confchk_WT_SESSION_create_encryption_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 19, INT64_MIN, INT64_MAX, NULL},
  {"flush_time", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 85, INT64_MIN,
    INT64_MAX, NULL},
  {"flush_timestamp", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 86, INT64_MIN,
    INT64_MAX, NULL},
  {"format", "string", NULL, "choices=[\"btree\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 22,
  ...
  {"value_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 55,
    INT64_MIN, INT64_MAX, NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose9_choices},
  {"version", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 62, INT64_MIN,
    INT64_MAX, NULL},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
...
static const WT_CONFIG_CHECK confchk_table_meta[] = {
  ...
  {"value_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 55,
    INT64_MIN, INT64_MAX, NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose10_choices},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
    "\"never\",\"none\",\"ordered\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 11, INT64_MIN, INT64_MAX,
...
static const WT_CONFIG_CHECK confchk_tier_meta[] = {
  {"access_pattern_hint", "string", NULL, "choices=[\"none\",\"random\",\"sequential\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 12, INT64_MIN, INT64_MAX, confchk_access_pattern_hint7_choices},
  {"allocation_size", "int", NULL, "min=512B,max=128MB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 13,
    512, 128LL * WT_MEGABYTE, NULL},
  {"app_metadata", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 0, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"checksum", "string", NULL,
    "choices=[\"on\",\"off\",\"uncompressed\","
    "\"unencrypted\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 17, INT64_MIN, INT64_MAX, confchk_checksum6_choices},
  {"collator", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 6, INT64_MIN,
    INT64_MAX, NULL},
  {"columns", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 7, INT64_MIN, INT64_MAX,
    NULL},
  ...
  {"value_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 55,
    INT64_MIN, INT64_MAX, NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose11_choices},
  {"version", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 62, INT64_MIN,
    INT64_MAX, NULL},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
...
static const WT_CONFIG_CHECK confchk_tiered_meta[] = {
  {"access_pattern_hint", "string", NULL, "choices=[\"none\",\"random\",\"sequential\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 12, INT64_MIN, INT64_MAX, confchk_access_pattern_hint8_choices},
  {"allocation_size", "int", NULL, "min=512B,max=128MB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 13,
    512, 128LL * WT_MEGABYTE, NULL},
  {"app_metadata", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 0, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"checksum", "string", NULL,
    "choices=[\"on\",\"off\",\"uncompressed\","
    "\"unencrypted\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 17, INT64_MIN, INT64_MAX, confchk_checksum7_choices},
  {"collator", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 6, INT64_MIN,
    INT64_MAX, NULL},
  {"columns", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 7, INT64_MIN, INT64_MAX,
    NULL},
  ...
  {"memory_page_max", "int", NULL, "min=512B,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 39,
    512, 10LL * WT_TERABYTE, NULL},
  {"oldest", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 88, INT64_MIN,
    INT64_MAX, NULL},
  {"os_cache_dirty_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 40, 0,
    INT64_MAX, NULL},
  {"os_cache_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 41, 0, INT64_MAX,
  ...
  {"tiered_storage", "category", NULL, NULL, confchk_WT_SESSION_create_tiered_storage_subconfigs, 8,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 47, INT64_MIN, INT64_MAX, NULL},
  {"tiers", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 89, INT64_MIN, INT64_MAX,
    NULL},
  {"value_format", "format", __wt_struct_confchk, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_FORMAT, 55,
    INT64_MIN, INT64_MAX, NULL},
  {"verbose", "list", NULL, "choices=[\"write_timestamp\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    10, INT64_MIN, INT64_MAX, confchk_verbose12_choices},
  {"version", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 62, INT64_MIN,
    INT64_MAX, NULL},
  {"write_timestamp_usage", "string", NULL,
    "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_compatibility_subconfigs[] = {
  {"release", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 191, INT64_MIN,
    INT64_MAX, NULL},
  {"require_max", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 262, INT64_MIN,
    INT64_MAX, NULL},
  {"require_min", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 263, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_encryption_subconfigs[] = {
  ...
  {"name", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 20, INT64_MIN, INT64_MAX,
    NULL},
  {"secretkey", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 268, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_hash_subconfigs[] = {
  {"buckets", "int", NULL, "min=64,max=65536", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 272, 64, 65536,
    NULL},
  {"dhandle_buckets", "int", NULL, "min=64,max=65536", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 273,
    64, 65536, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_log_subconfigs[] = {
  {"archive", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 229, INT64_MIN,
    INT64_MAX, NULL},
  {"compressor", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 276, INT64_MIN,
    INT64_MAX, NULL},
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 37, INT64_MIN,
    INT64_MAX, NULL},
  {"file_max", "int", NULL, "min=100KB,max=2GB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 225,
    100LL * WT_KILOBYTE, 2LL * WT_GIGABYTE, NULL},
  {"force_write_wait", "int", NULL, "min=1,max=60", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 277, 1,
    60, NULL},
  {"os_cache_dirty_pct", "int", NULL, "min=0,max=100", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 230, 0,
    100, NULL},
  {"path", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 238, INT64_MIN, INT64_MAX,
  ...
  {"recover", "string", NULL, "choices=[\"error\",\"on\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING,
    278, INT64_MIN, INT64_MAX, confchk_recover_choices},
  {"remove", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 232, INT64_MIN,
    INT64_MAX, NULL},
  {"zero_fill", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 233, INT64_MIN,
    INT64_MAX, NULL},
...
static const WT_CONFIG_CHECK confchk_tiered_storage_subconfigs[] = {
  ...
  {"cache_directory", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 51, INT64_MIN,
    INT64_MAX, NULL},
  {"interval", "int", NULL, "min=1,max=1000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 286, 1, 1000,
    NULL},
  {"local_retention", "int", NULL, "min=0,max=10000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 52, 0,
    10000, NULL},
  {"name", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 20, INT64_MIN, INT64_MAX,
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_transaction_sync_subconfigs[] = {
  ...
  {"method", "string", NULL, "choices=[\"dsync\",\"fsync\",\"none\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 288, INT64_MIN, INT64_MAX, confchk_method_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open[] = {
  {"backup_restore_target", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 258,
    INT64_MIN, INT64_MAX, NULL},
  {"block_cache", "category", NULL, NULL, confchk_wiredtiger_open_block_cache_subconfigs, 12,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 167, INT64_MIN, INT64_MAX, NULL},
  {"buffer_alignment", "int", NULL, "min=-1,max=1MB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 259, 1,
    1LL * WT_MEGABYTE, NULL},
  {"builtin_extension_config", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 260,
    INT64_MIN, INT64_MAX, NULL},
  {"cache_cursors", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 253, INT64_MIN,
    INT64_MAX, NULL},
  {"cache_max_wait_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 178, 0,
  ...
  {"checkpoint", "category", NULL, NULL, confchk_wiredtiger_open_checkpoint_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 182, INT64_MIN, INT64_MAX, NULL},
  {"checkpoint_cleanup", "string", NULL, "choices=[\"none\",\"reclaim_space\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 185, INT64_MIN, INT64_MAX, confchk_checkpoint_cleanup2_choices},
  {"checkpoint_sync", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 261,
    INT64_MIN, INT64_MAX, NULL},
  {"chunk_cache", "category", NULL, NULL, confchk_wiredtiger_open_chunk_cache_subconfigs, 7,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 186, INT64_MIN, INT64_MAX, NULL},
  {"compatibility", "category", NULL, NULL, confchk_wiredtiger_open_compatibility_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 190, INT64_MIN, INT64_MAX, NULL},
  {"compile_configuration_count", "int", NULL, "min=500", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 264,
    500, INT64_MAX, NULL},
  {"config_base", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 265, INT64_MIN,
    INT64_MAX, NULL},
  {"create", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 266, INT64_MIN,
    INT64_MAX, NULL},
  {"debug_mode", "category", NULL, NULL, confchk_wiredtiger_open_debug_mode_subconfigs, 14,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 192, INT64_MIN, INT64_MAX, NULL},
  {"direct_io", "list", NULL, "choices=[\"checkpoint\",\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 267, INT64_MIN, INT64_MAX, confchk_direct_io_choices},
  ...
  {"exclusive", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 98, INT64_MIN,
    INT64_MAX, NULL},
  {"extensions", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 269, INT64_MIN,
    INT64_MAX, NULL},
  {"extra_diagnostics", "list", NULL,
    "choices=[\"all\",\"checkpoint_validate\",\"cursor_check\""
    ",\"disk_validate\",\"eviction_check\",\"generation_check\","
  ...
  {"file_extend", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    270, INT64_MIN, INT64_MAX, confchk_file_extend_choices},
  {"file_manager", "category", NULL, NULL, confchk_wiredtiger_open_file_manager_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 219, INT64_MIN, INT64_MAX, NULL},
  {"generation_drain_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 223,
    0, INT64_MAX, NULL},
  ...
  {"hazard_max", "int", NULL, "min=15", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 274, 15, INT64_MAX,
    NULL},
  {"history_store", "category", NULL, NULL, confchk_wiredtiger_open_history_store_subconfigs, 1,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 224, INT64_MIN, INT64_MAX, NULL},
  {"in_memory", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 275, INT64_MIN,
    INT64_MAX, NULL},
  {"io_capacity", "category", NULL, NULL, confchk_wiredtiger_open_io_capacity_subconfigs, 1,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 226, INT64_MIN, INT64_MAX, NULL},
  {"json_output", "list", NULL, "choices=[\"error\",\"message\"]", NULL, 0,
  ...
  {"lsm_manager", "category", NULL, NULL, confchk_wiredtiger_open_lsm_manager_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 234, INT64_MIN, INT64_MAX, NULL},
  {"mmap", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 279, INT64_MIN,
    INT64_MAX, NULL},
  {"mmap_all", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 280, INT64_MIN,
    INT64_MAX, NULL},
  {"multiprocess", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 281, INT64_MIN,
    INT64_MAX, NULL},
  {"operation_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 150, 0,
    INT64_MAX, NULL},
  {"operation_tracking", "category", NULL, NULL,
  ...
  {"readonly", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 60, INT64_MIN,
    INT64_MAX, NULL},
  {"salvage", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 282, INT64_MIN,
    INT64_MAX, NULL},
  {"session_max", "int", NULL, "min=1", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 283, 1, INT64_MAX,
    NULL},
  {"session_scratch_max", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 284, INT64_MIN,
    INT64_MAX, NULL},
  {"session_table_cache", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 285,
    INT64_MIN, INT64_MAX, NULL},
  {"shared_cache", "category", NULL, NULL, confchk_wiredtiger_open_shared_cache_subconfigs, 5,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 239, INT64_MIN, INT64_MAX, NULL},
  {"statistics", "list", NULL,
    "choices=[\"all\",\"cache_walk\",\"fast\",\"none\","
    "\"clear\",\"tree_walk\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 134, INT64_MIN, INT64_MAX, confchk_statistics3_choices},
  ...
  {"transaction_sync", "category", NULL, NULL, confchk_wiredtiger_open_transaction_sync_subconfigs,
    2, WT_CONFIG_COMPILED_TYPE_CATEGORY, 287, INT64_MIN, INT64_MAX, NULL},
  {"use_environment", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 289,
    INT64_MIN, INT64_MAX, NULL},
  {"use_environment_priv", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 290,
    INT64_MIN, INT64_MAX, NULL},
  {"verbose", "list", NULL,
    "choices=[\"api\",\"backup\",\"block\",\"block_cache\","
    "\"checkpoint\",\"checkpoint_cleanup\",\"checkpoint_progress\","
    ...
    "\"thread_group\",\"tiered\",\"timestamp\",\"transaction\","
    "\"verify\",\"version\",\"write\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 10, INT64_MIN, INT64_MAX, confchk_verbose13_choices},
  {"verify_metadata", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 291,
    INT64_MIN, INT64_MAX, NULL},
  {"write_through", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 292, INT64_MIN, INT64_MAX, confchk_write_through_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_all[] = {
  ...
  {"checkpoint", "category", NULL, NULL, confchk_wiredtiger_open_checkpoint_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 182, INT64_MIN, INT64_MAX, NULL},
  {"checkpoint_cleanup", "string", NULL, "choices=[\"none\",\"reclaim_space\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 185, INT64_MIN, INT64_MAX, confchk_checkpoint_cleanup3_choices},
  {"checkpoint_sync", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 261,
    INT64_MIN, INT64_MAX, NULL},
  {"chunk_cache", "category", NULL, NULL, confchk_wiredtiger_open_chunk_cache_subconfigs, 7,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 186, INT64_MIN, INT64_MAX, NULL},
  ...
  {"debug_mode", "category", NULL, NULL, confchk_wiredtiger_open_debug_mode_subconfigs, 14,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 192, INT64_MIN, INT64_MAX, NULL},
  {"direct_io", "list", NULL, "choices=[\"checkpoint\",\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 267, INT64_MIN, INT64_MAX, confchk_direct_io2_choices},
  {"encryption", "category", NULL, NULL, confchk_wiredtiger_open_encryption_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 19, INT64_MIN, INT64_MAX, NULL},
  {"error_prefix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 207, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"file_extend", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    270, INT64_MIN, INT64_MAX, confchk_file_extend2_choices},
  {"file_manager", "category", NULL, NULL, confchk_wiredtiger_open_file_manager_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 219, INT64_MIN, INT64_MAX, NULL},
  {"generation_drain_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 223,
    0, INT64_MAX, NULL},
  ...
  {"statistics", "list", NULL,
    "choices=[\"all\",\"cache_walk\",\"fast\",\"none\","
    "\"clear\",\"tree_walk\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 134, INT64_MIN, INT64_MAX, confchk_statistics4_choices},
  {"statistics_log", "category", NULL, NULL, confchk_wiredtiger_open_statistics_log_subconfigs, 6,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 243, INT64_MIN, INT64_MAX, NULL},
  {"tiered_storage", "category", NULL, NULL, confchk_tiered_storage_subconfigs, 8,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 47, INT64_MIN, INT64_MAX, NULL},
  ...
  {"verbose", "list", NULL,
    ...
    "\"thread_group\",\"tiered\",\"timestamp\",\"transaction\","
    "\"verify\",\"version\",\"write\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 10, INT64_MIN, INT64_MAX, confchk_verbose14_choices},
  {"verify_metadata", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 291,
    INT64_MIN, INT64_MAX, NULL},
  {"version", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 62, INT64_MIN,
    INT64_MAX, NULL},
  {"write_through", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 292, INT64_MIN, INT64_MAX, confchk_write_through2_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_basecfg[] = {
  ...
  {"checkpoint", "category", NULL, NULL, confchk_wiredtiger_open_checkpoint_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 182, INT64_MIN, INT64_MAX, NULL},
  {"checkpoint_cleanup", "string", NULL, "choices=[\"none\",\"reclaim_space\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 185, INT64_MIN, INT64_MAX, confchk_checkpoint_cleanup4_choices},
  {"checkpoint_sync", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 261,
    INT64_MIN, INT64_MAX, NULL},
  {"chunk_cache", "category", NULL, NULL, confchk_wiredtiger_open_chunk_cache_subconfigs, 7,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 186, INT64_MIN, INT64_MAX, NULL},
  ...
  {"debug_mode", "category", NULL, NULL, confchk_wiredtiger_open_debug_mode_subconfigs, 14,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 192, INT64_MIN, INT64_MAX, NULL},
  {"direct_io", "list", NULL, "choices=[\"checkpoint\",\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 267, INT64_MIN, INT64_MAX, confchk_direct_io3_choices},
  {"encryption", "category", NULL, NULL, confchk_wiredtiger_open_encryption_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 19, INT64_MIN, INT64_MAX, NULL},
  {"error_prefix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 207, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"file_extend", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    270, INT64_MIN, INT64_MAX, confchk_file_extend3_choices},
  {"file_manager", "category", NULL, NULL, confchk_wiredtiger_open_file_manager_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 219, INT64_MIN, INT64_MAX, NULL},
  {"generation_drain_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 223,
    0, INT64_MAX, NULL},
  ...
  {"statistics", "list", NULL,
    "choices=[\"all\",\"cache_walk\",\"fast\",\"none\","
    "\"clear\",\"tree_walk\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 134, INT64_MIN, INT64_MAX, confchk_statistics5_choices},
  {"statistics_log", "category", NULL, NULL, confchk_wiredtiger_open_statistics_log_subconfigs, 6,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 243, INT64_MIN, INT64_MAX, NULL},
  {"tiered_storage", "category", NULL, NULL, confchk_tiered_storage_subconfigs, 8,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 47, INT64_MIN, INT64_MAX, NULL},
  ...
  {"verbose", "list", NULL,
    ...
    "\"thread_group\",\"tiered\",\"timestamp\",\"transaction\","
    "\"verify\",\"version\",\"write\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 10, INT64_MIN, INT64_MAX, confchk_verbose15_choices},
  {"verify_metadata", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 291,
    INT64_MIN, INT64_MAX, NULL},
  {"version", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 62, INT64_MIN,
    INT64_MAX, NULL},
  {"write_through", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 292, INT64_MIN, INT64_MAX, confchk_write_through3_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_usercfg[] = {
  ...
  {"checkpoint", "category", NULL, NULL, confchk_wiredtiger_open_checkpoint_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 182, INT64_MIN, INT64_MAX, NULL},
  {"checkpoint_cleanup", "string", NULL, "choices=[\"none\",\"reclaim_space\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 185, INT64_MIN, INT64_MAX, confchk_checkpoint_cleanup5_choices},
  {"checkpoint_sync", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 261,
    INT64_MIN, INT64_MAX, NULL},
  {"chunk_cache", "category", NULL, NULL, confchk_wiredtiger_open_chunk_cache_subconfigs, 7,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 186, INT64_MIN, INT64_MAX, NULL},
  ...
  {"debug_mode", "category", NULL, NULL, confchk_wiredtiger_open_debug_mode_subconfigs, 14,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 192, INT64_MIN, INT64_MAX, NULL},
  {"direct_io", "list", NULL, "choices=[\"checkpoint\",\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 267, INT64_MIN, INT64_MAX, confchk_direct_io4_choices},
  {"encryption", "category", NULL, NULL, confchk_wiredtiger_open_encryption_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 19, INT64_MIN, INT64_MAX, NULL},
  {"error_prefix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 207, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"file_extend", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    270, INT64_MIN, INT64_MAX, confchk_file_extend4_choices},
  {"file_manager", "category", NULL, NULL, confchk_wiredtiger_open_file_manager_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 219, INT64_MIN, INT64_MAX, NULL},
  {"generation_drain_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 223,
    0, INT64_MAX, NULL},
  ...
  {"statistics", "list", NULL,
    "choices=[\"all\",\"cache_walk\",\"fast\",\"none\","
    "\"clear\",\"tree_walk\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 134, INT64_MIN, INT64_MAX, confchk_statistics6_choices},
  {"statistics_log", "category", NULL, NULL, confchk_wiredtiger_open_statistics_log_subconfigs, 6,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 243, INT64_MIN, INT64_MAX, NULL},
  {"tiered_storage", "category", NULL, NULL, confchk_tiered_storage_subconfigs, 8,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 47, INT64_MIN, INT64_MAX, NULL},
  ...
  {"verbose", "list", NULL,
    ...
    "\"thread_group\",\"tiered\",\"timestamp\",\"transaction\","
    "\"verify\",\"version\",\"write\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 10, INT64_MIN, INT64_MAX, confchk_verbose16_choices},
  {"verify_metadata", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 291,
    INT64_MIN, INT64_MAX, NULL},
  {"write_through", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 292, INT64_MIN, INT64_MAX, confchk_write_through4_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_ENTRY config_entries[] = {
  {"WT_CONNECTION.add_collator", "", NULL, 0, 1, false},
  {"WT_CONNECTION.add_compressor", "", NULL, 0, 2, false},
  {"WT_CONNECTION.add_data_source", "", NULL, 0, 3, false},
  {"WT_CONNECTION.add_encryptor", "", NULL, 0, 4, false},
  {"WT_CONNECTION.add_extractor", "", NULL, 0, 5, false},
  {"WT_CONNECTION.add_storage_source", "", NULL, 0, 6, false},
  {"WT_CONNECTION.close", "final_flush=false,leak_memory=false,use_timestamp=true",
    confchk_WT_CONNECTION_close, 3, 7, false},
  {"WT_CONNECTION.debug_info",
    "cache=false,cursors=false,handles=false,log=false,sessions=false"
    ",txn=false",
    confchk_WT_CONNECTION_debug_info, 6, 8, false},
  ...
  {"WT_CONNECTION.reconfigure",
    ...
    "verbose=[]",
    confchk_WT_CONNECTION_reconfigure, 35, 12, false},
  {"WT_CONNECTION.rollback_to_stable", "dryrun=false", confchk_WT_CONNECTION_rollback_to_stable, 1,
    13, false},
  {"WT_CONNECTION.set_file_system", "", NULL, 0, 14, false},
  {"WT_CONNECTION.set_timestamp",
    "durable_timestamp=,force=false,oldest_timestamp=,"
    "stable_timestamp=",
    confchk_WT_CONNECTION_set_timestamp, 4, 15, false},
  {"WT_CURSOR.bound", "action=set,bound=,inclusive=true", confchk_WT_CURSOR_bound, 3, 16, false},
  {"WT_CURSOR.close", "", NULL, 0, 17, false},
  {"WT_CURSOR.reconfigure", "append=false,overwrite=true,prefix_search=false",
    confchk_WT_CURSOR_reconfigure, 3, 18, false},
  {"WT_SESSION.alter",
    ...
    confchk_WT_SESSION_alter, 11, 19, false},
  ...
  {"WT_SESSION.checkpoint",
    ...
    confchk_WT_SESSION_checkpoint, 6, 21, false},
  {"WT_SESSION.close", "", NULL, 0, 22, false},
  {"WT_SESSION.commit_transaction",
    "commit_timestamp=,durable_timestamp=,operation_timeout_ms=0,"
    "sync=",
    confchk_WT_SESSION_commit_transaction, 4, 23, false},
  {"WT_SESSION.compact", "timeout=1200", confchk_WT_SESSION_compact, 1, 24, false},
  {"WT_SESSION.create",
    ...
    "write_timestamp_usage=none",
    confchk_WT_SESSION_create, 48, 25, false},
  {"WT_SESSION.drop",
    "checkpoint_wait=true,force=false,lock_wait=true,"
    "remove_files=true,remove_shared=false",
    confchk_WT_SESSION_drop, 5, 26, false},
  {"WT_SESSION.flush_tier", "force=false,lock_wait=true,sync=on,timeout=0",
    confchk_WT_SESSION_flush_tier, 4, 27, false},
  {"WT_SESSION.join",
    "bloom_bit_count=16,bloom_false_positives=false,"
    "bloom_hash_count=8,compare=\"eq\",count=0,operation=\"and\","
    "strategy=",
    confchk_WT_SESSION_join, 7, 28, false},
  {"WT_SESSION.log_flush", "sync=on", confchk_WT_SESSION_log_flush, 1, 29, false},
  {"WT_SESSION.log_printf", "", NULL, 0, 30, false},
  {"WT_SESSION.open_cursor",
    ...
    confchk_WT_SESSION_open_cursor, 18, 31, false},
  {"WT_SESSION.prepare_transaction", "prepare_timestamp=", confchk_WT_SESSION_prepare_transaction,
    1, 32, false},
  {"WT_SESSION.query_timestamp", "get=read", confchk_WT_SESSION_query_timestamp, 1, 33, false},
  {"WT_SESSION.reconfigure",
    "cache_cursors=true,cache_max_wait_ms=0,"
    "debug=(release_evict_page=false),ignore_cache_size=false,"
    "isolation=snapshot",
    confchk_WT_SESSION_reconfigure, 5, 34, false},
  {"WT_SESSION.rename", "", NULL, 0, 35, false}, {"WT_SESSION.reset", "", NULL, 0, 36, false},
  {"WT_SESSION.reset_snapshot", "", NULL, 0, 37, false},
  {"WT_SESSION.rollback_transaction", "operation_timeout_ms=0",
    confchk_WT_SESSION_rollback_transaction, 1, 38, false},
  {"WT_SESSION.salvage", "force=false", confchk_WT_SESSION_salvage, 1, 39, false},
  {"WT_SESSION.strerror", "", NULL, 0, 40, false},
  {"WT_SESSION.timestamp_transaction",
    "commit_timestamp=,durable_timestamp=,prepare_timestamp=,"
    "read_timestamp=",
    confchk_WT_SESSION_timestamp_transaction, 4, 41, false},
  {"WT_SESSION.timestamp_transaction_uint", "", NULL, 0, 42, false},
  {"WT_SESSION.truncate", "", NULL, 0, 43, false}, {"WT_SESSION.upgrade", "", NULL, 0, 44, false},
  {"WT_SESSION.verify",
    ...
    "strict=false",
    confchk_WT_SESSION_verify, 10, 45, false},
  {"colgroup.meta",
    ...
    "write_timestamp_usage=none",
    confchk_colgroup_meta, 8, 46, false},
  {"file.config",
    "access_pattern_hint=none,allocation_size=4KB,app_metadata=,"
    "assert=(commit_timestamp=none,durable_timestamp=none,"
    "read_timestamp=none,write_timestamp=off),block_allocation=best,"
    ...
    "write_timestamp_usage=none",
    confchk_file_config, 40, 47, false},
  {"file.meta",
    "access_pattern_hint=none,allocation_size=4KB,app_metadata=,"
    "assert=(commit_timestamp=none,durable_timestamp=none,"
    "read_timestamp=none,write_timestamp=off),block_allocation=best,"
  ...
  {"index.meta",
    ...
    "write_timestamp_usage=none",
    confchk_index_meta, 13, 49, false},
  {"lsm.meta",
    "access_pattern_hint=none,allocation_size=4KB,app_metadata=,"
    "assert=(commit_timestamp=none,durable_timestamp=none,"
    "read_timestamp=none,write_timestamp=off),block_allocation=best,"
  ...
  {"tiered.meta",
    ...
    confchk_tiered_meta, 52, 54, false},
  {"wiredtiger_open",
    ...
    confchk_wiredtiger_open, 64, 55, false},
  {"wiredtiger_open_all",
    "backup_restore_target=,"
    "block_cache=(blkcache_eviction_aggression=1800,"
    "cache_on_checkpoint=true,cache_on_writes=true,enabled=false,"
    ...
    confchk_wiredtiger_open_all, 65, 56, false},
  {"wiredtiger_open_basecfg",
    ...
    "verify_metadata=false,version=(major=0,minor=0),write_through=",
    confchk_wiredtiger_open_basecfg, 59, 57, false},
  {"wiredtiger_open_usercfg",
    ...
    "transaction_sync=(enabled=false,method=fsync),verbose=[],"
    "verify_metadata=false,write_through=",
    confchk_wiredtiger_open_usercfg, 58, 58, false},
