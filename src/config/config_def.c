...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure[] = {
  ...
  {"encourage_row_split", "boolean", NULL, NULL, NULL, 0},
...
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  {"WT_CONNECTION.reconfigure",
    ...
    "update_restore_evict=false),encourage_row_split=false,"
  ...
  {"wiredtiger_open",
    ...
    "encourage_row_split=false,encryption=(keyid=,name=,secretkey=),"
    "error_prefix=,eviction=(threads_max=8,threads_min=1),"
    "eviction_checkpoint_target=1,eviction_dirty_target=5,"
    "eviction_dirty_trigger=20,eviction_target=80,eviction_trigger=95"
    ",eviction_updates_target=0,eviction_updates_trigger=0,"
  ...
  {"wiredtiger_open_basecfg",
    ...
    "flush_checkpoint=false,log_retention=0,realloc_exact=false,"
    "rollback_error=0,slow_checkpoint=false,table_logging=false,"
    "update_restore_evict=false),direct_io=,encourage_row_split=false"
