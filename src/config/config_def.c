...
static const WT_CONFIG_CHECK
    confchk_wiredtiger_open_access_pattern_subconfigs[] = {
	{ "data", "string",
	    NULL, "choices=[\"default\",\"random\",\"sequential\"]",
	    NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure[] = {
	{ "access_pattern", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_access_pattern_subconfigs, 1 },
	{ "async", "category",
	    NULL, NULL,
...
static const WT_CONFIG_ENTRY config_entries[] = {
	...
	{ "WT_CONNECTION.reconfigure",
	  "access_pattern=(data=default),async=(enabled=false,ops_max=1024,"
	  "threads=2),cache_overhead=8,cache_size=100MB,"
	  "checkpoint=(log_size=0,wait=0),error_prefix=,"
	...
	{ "wiredtiger_open",
	  "access_pattern=(data=default),async=(enabled=false,ops_max=1024,"
	  "threads=2),buffer_alignment=-1,builtin_extension_config=,"
	  "cache_overhead=8,cache_size=100MB,checkpoint=(log_size=0,wait=0)"
	  ",checkpoint_sync=true,config_base=true,create=false,direct_io=,"
	...
	{ "wiredtiger_open_basecfg",
	  ...
	  "threads=2),buffer_alignment=-1,builtin_extension_config=,"
	  "cache_overhead=8,cache_size=100MB,checkpoint=(log_size=0,wait=0)"
	  ",checkpoint_sync=true,direct_io=,encryption=(keyid=,name=,"
