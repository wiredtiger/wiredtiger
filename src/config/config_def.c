...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_debug_info[] = {
  ...
  {"handles", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 163, INT64_MIN,
    INT64_MAX, NULL},
  {"log", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 36, INT64_MIN, INT64_MAX,
    NULL},
  {"sessions", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 164, INT64_MIN,
    INT64_MAX, NULL},
  {"txn", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 165, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_WT_CONNECTION_load_extension[] = {
  {"config", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 246, INT64_MIN,
    INT64_MAX, NULL},
  {"early_load", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 247, INT64_MIN,
    INT64_MAX, NULL},
  {"entry", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 248, INT64_MIN,
    INT64_MAX, NULL},
  {"terminate", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 249, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_open_session[] = {
  {"cache_cursors", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 250, INT64_MIN,
    INT64_MAX, NULL},
  {"cache_max_wait_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 177, 0,
    INT64_MAX, NULL},
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_block_cache_subconfigs[] = {
  {"blkcache_eviction_aggression", "int", NULL, "min=1,max=7200", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_INT, 169, 1, 7200, NULL},
  ...
  {"max_percent_overhead", "int", NULL, "min=1,max=500", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 173,
    1, 500, NULL},
  {"nvram_path", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 174, INT64_MIN,
    INT64_MAX, NULL},
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_chunk_cache_subconfigs[] = {
  ...
  {"device_path", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 187, INT64_MIN,
    INT64_MAX, NULL},
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 37, INT64_MIN,
    INT64_MAX, NULL},
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure_compatibility_subconfigs[] = {
  {"release", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 189, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_debug_mode_subconfigs[] = {
  ...
  {"corruption_abort", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 191,
    INT64_MIN, INT64_MAX, NULL},
  {"cursor_copy", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 193, INT64_MIN,
    INT64_MAX, NULL},
  {"cursor_reposition", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 194,
    INT64_MIN, INT64_MAX, NULL},
  {"eviction", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 195, INT64_MIN,
    INT64_MAX, NULL},
  {"log_retention", "int", NULL, "min=0,max=1024", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 196, 0,
    1024, NULL},
  {"realloc_exact", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 197, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"stress_skiplist", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 201,
    INT64_MIN, INT64_MAX, NULL},
  {"table_logging", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 202, INT64_MIN,
    INT64_MAX, NULL},
  {"tiered_flush_error_continue", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN,
    203, INT64_MIN, INT64_MAX, NULL},
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_file_manager_subconfigs[] = {
  {"close_handle_minimum", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 217, 0,
    INT64_MAX, NULL},
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_history_store_subconfigs[] = {
  {"file_max", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 222, 0, INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure_log_subconfigs[] = {
  {"archive", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 226, INT64_MIN,
    INT64_MAX, NULL},
  {"os_cache_dirty_pct", "int", NULL, "min=0,max=100", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 227, 0,
    100, NULL},
  {"prealloc", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 228, INT64_MIN,
    INT64_MAX, NULL},
  {"remove", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 229, INT64_MIN,
    INT64_MAX, NULL},
  {"zero_fill", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 230, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};

static const WT_CONFIG_CHECK confchk_wiredtiger_open_lsm_manager_subconfigs[] = {
  {"merge", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 233, INT64_MIN,
    INT64_MAX, NULL},
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_operation_tracking_subconfigs[] = {
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 37, INT64_MIN,
    INT64_MAX, NULL},
  {"path", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 235, INT64_MIN, INT64_MAX,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_shared_cache_subconfigs[] = {
  ...
  {"name", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 20, INT64_MIN, INT64_MAX,
    NULL},
  {"quota", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 238, INT64_MIN, INT64_MAX,
    NULL},
  {"reserve", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 239, INT64_MIN, INT64_MAX,
    NULL},
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure_statistics_log_subconfigs[] = {
  {"json", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 241, INT64_MIN,
    INT64_MAX, NULL},
  {"on_close", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 242, INT64_MIN,
    INT64_MAX, NULL},
  {"sources", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 243, INT64_MIN, INT64_MAX,
    NULL},
  {"timestamp", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 244, INT64_MIN,
    INT64_MAX, NULL},
  {"wait", "int", NULL, "min=0,max=100000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 182, 0, 100000,
    NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure[] = {
  {"block_cache", "category", NULL, NULL, confchk_wiredtiger_open_block_cache_subconfigs, 12,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 166, INT64_MIN, INT64_MAX, NULL},
  {"cache_max_wait_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 177, 0,
    INT64_MAX, NULL},
  ...
  {"cache_size", "int", NULL, "min=1MB,max=10TB", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 179,
    1LL * WT_MEGABYTE, 10LL * WT_TERABYTE, NULL},
  {"cache_stuck_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 180, 0,
    INT64_MAX, NULL},
  {"checkpoint", "category", NULL, NULL, confchk_wiredtiger_open_checkpoint_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 56, INT64_MIN, INT64_MAX, NULL},
  {"checkpoint_cleanup", "string", NULL, "choices=[\"none\",\"reclaim_space\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 183, INT64_MIN, INT64_MAX, confchk_checkpoint_cleanup_choices},
  {"chunk_cache", "category", NULL, NULL, confchk_wiredtiger_open_chunk_cache_subconfigs, 7,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 184, INT64_MIN, INT64_MAX, NULL},
  ...
  {"error_prefix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 205, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"extra_diagnostics", "list", NULL,
    ...
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 215, INT64_MIN, INT64_MAX,
  ...
  {"io_capacity", "category", NULL, NULL, confchk_wiredtiger_open_io_capacity_subconfigs, 1,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 223, INT64_MIN, INT64_MAX, NULL},
  ...
  {"lsm_manager", "category", NULL, NULL, confchk_wiredtiger_open_lsm_manager_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 231, INT64_MIN, INT64_MAX, NULL},
  ...
  {"shared_cache", "category", NULL, NULL, confchk_wiredtiger_open_shared_cache_subconfigs, 5,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 236, INT64_MIN, INT64_MAX, NULL},
  ...
  {"timing_stress_for_test", "list", NULL,
    ...
    "\"txn_read\"]",
    NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 245, INT64_MIN, INT64_MAX,
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_rollback_to_stable[] = {
  {"dryrun", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 254, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_compatibility_subconfigs[] = {
  {"release", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 189, INT64_MIN,
    INT64_MAX, NULL},
  {"require_max", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 259, INT64_MIN,
    INT64_MAX, NULL},
  {"require_min", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 260, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_encryption_subconfigs[] = {
  ...
  {"name", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 20, INT64_MIN, INT64_MAX,
    NULL},
  {"secretkey", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 265, INT64_MIN,
    INT64_MAX, NULL},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_log_subconfigs[] = {
  {"archive", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 226, INT64_MIN,
    INT64_MAX, NULL},
  {"compressor", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 273, INT64_MIN,
    INT64_MAX, NULL},
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 37, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"recover", "string", NULL, "choices=[\"error\",\"on\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING,
    275, INT64_MIN, INT64_MAX, confchk_recover_choices},
  {"remove", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 229, INT64_MIN,
    INT64_MAX, NULL},
  {"zero_fill", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 230, INT64_MIN,
    INT64_MAX, NULL},
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_transaction_sync_subconfigs[] = {
  ...
  {"method", "string", NULL, "choices=[\"dsync\",\"fsync\",\"none\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 285, INT64_MIN, INT64_MAX, confchk_method_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open[] = {
  ...
  {"checkpoint", "category", NULL, NULL, confchk_wiredtiger_open_checkpoint_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 56, INT64_MIN, INT64_MAX, NULL},
  {"checkpoint_cleanup", "string", NULL, "choices=[\"none\",\"reclaim_space\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 183, INT64_MIN, INT64_MAX, confchk_checkpoint_cleanup2_choices},
  ...
  {"compatibility", "category", NULL, NULL, confchk_wiredtiger_open_compatibility_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 188, INT64_MIN, INT64_MAX, NULL},
  {"compile_configuration_count", "int", NULL, "min=500", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 261,
    500, INT64_MAX, NULL},
  {"config_base", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 262, INT64_MIN,
    INT64_MAX, NULL},
  {"create", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 263, INT64_MIN,
    INT64_MAX, NULL},
  {"debug_mode", "category", NULL, NULL, confchk_wiredtiger_open_debug_mode_subconfigs, 14,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 190, INT64_MIN, INT64_MAX, NULL},
  {"direct_io", "list", NULL, "choices=[\"checkpoint\",\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 264, INT64_MIN, INT64_MAX, confchk_direct_io_choices},
  ...
  {"exclusive", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 98, INT64_MIN,
    INT64_MAX, NULL},
  {"extensions", "list", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST, 266, INT64_MIN,
    INT64_MAX, NULL},
  {"extra_diagnostics", "list", NULL,
    "choices=[\"all\",\"checkpoint_validate\",\"cursor_check\""
    ",\"disk_validate\",\"eviction_check\",\"generation_check\","
  ...
  {"file_extend", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    267, INT64_MIN, INT64_MAX, confchk_file_extend_choices},
  {"file_manager", "category", NULL, NULL, confchk_wiredtiger_open_file_manager_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 216, INT64_MIN, INT64_MAX, NULL},
  {"generation_drain_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 220,
    0, INT64_MAX, NULL},
  ...
  {"hazard_max", "int", NULL, "min=15", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 271, 15, INT64_MAX,
    NULL},
  {"history_store", "category", NULL, NULL, confchk_wiredtiger_open_history_store_subconfigs, 1,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 221, INT64_MIN, INT64_MAX, NULL},
  {"in_memory", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 272, INT64_MIN,
    INT64_MAX, NULL},
  {"io_capacity", "category", NULL, NULL, confchk_wiredtiger_open_io_capacity_subconfigs, 1,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 223, INT64_MIN, INT64_MAX, NULL},
  {"json_output", "list", NULL, "choices=[\"error\",\"message\"]", NULL, 0,
  ...
  {"lsm_manager", "category", NULL, NULL, confchk_wiredtiger_open_lsm_manager_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 231, INT64_MIN, INT64_MAX, NULL},
  {"mmap", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 276, INT64_MIN,
    INT64_MAX, NULL},
  {"mmap_all", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 277, INT64_MIN,
    INT64_MAX, NULL},
  {"multiprocess", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 278, INT64_MIN,
    INT64_MAX, NULL},
  {"operation_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 150, 0,
    INT64_MAX, NULL},
  {"operation_tracking", "category", NULL, NULL,
  ...
  {"readonly", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 60, INT64_MIN,
    INT64_MAX, NULL},
  {"salvage", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 279, INT64_MIN,
    INT64_MAX, NULL},
  {"session_max", "int", NULL, "min=1", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 280, 1, INT64_MAX,
    NULL},
  {"session_scratch_max", "int", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 281, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"transaction_sync", "category", NULL, NULL, confchk_wiredtiger_open_transaction_sync_subconfigs,
    2, WT_CONFIG_COMPILED_TYPE_CATEGORY, 284, INT64_MIN, INT64_MAX, NULL},
  ...
  {"write_through", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 289, INT64_MIN, INT64_MAX, confchk_write_through_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_all[] = {
  ...
  {"checkpoint", "category", NULL, NULL, confchk_wiredtiger_open_checkpoint_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 56, INT64_MIN, INT64_MAX, NULL},
  {"checkpoint_cleanup", "string", NULL, "choices=[\"none\",\"reclaim_space\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 183, INT64_MIN, INT64_MAX, confchk_checkpoint_cleanup3_choices},
  {"checkpoint_sync", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 258,
    INT64_MIN, INT64_MAX, NULL},
  {"chunk_cache", "category", NULL, NULL, confchk_wiredtiger_open_chunk_cache_subconfigs, 7,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 184, INT64_MIN, INT64_MAX, NULL},
  ...
  {"debug_mode", "category", NULL, NULL, confchk_wiredtiger_open_debug_mode_subconfigs, 14,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 190, INT64_MIN, INT64_MAX, NULL},
  {"direct_io", "list", NULL, "choices=[\"checkpoint\",\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 264, INT64_MIN, INT64_MAX, confchk_direct_io2_choices},
  {"encryption", "category", NULL, NULL, confchk_wiredtiger_open_encryption_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 19, INT64_MIN, INT64_MAX, NULL},
  {"error_prefix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 205, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"file_extend", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    267, INT64_MIN, INT64_MAX, confchk_file_extend2_choices},
  {"file_manager", "category", NULL, NULL, confchk_wiredtiger_open_file_manager_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 216, INT64_MIN, INT64_MAX, NULL},
  {"generation_drain_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 220,
    0, INT64_MAX, NULL},
  ...
  {"version", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 62, INT64_MIN,
    INT64_MAX, NULL},
  {"write_through", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 289, INT64_MIN, INT64_MAX, confchk_write_through2_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_basecfg[] = {
  ...
  {"checkpoint", "category", NULL, NULL, confchk_wiredtiger_open_checkpoint_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 56, INT64_MIN, INT64_MAX, NULL},
  {"checkpoint_cleanup", "string", NULL, "choices=[\"none\",\"reclaim_space\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 183, INT64_MIN, INT64_MAX, confchk_checkpoint_cleanup4_choices},
  {"checkpoint_sync", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 258,
    INT64_MIN, INT64_MAX, NULL},
  {"chunk_cache", "category", NULL, NULL, confchk_wiredtiger_open_chunk_cache_subconfigs, 7,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 184, INT64_MIN, INT64_MAX, NULL},
  ...
  {"debug_mode", "category", NULL, NULL, confchk_wiredtiger_open_debug_mode_subconfigs, 14,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 190, INT64_MIN, INT64_MAX, NULL},
  {"direct_io", "list", NULL, "choices=[\"checkpoint\",\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 264, INT64_MIN, INT64_MAX, confchk_direct_io3_choices},
  {"encryption", "category", NULL, NULL, confchk_wiredtiger_open_encryption_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 19, INT64_MIN, INT64_MAX, NULL},
  {"error_prefix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 205, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"file_extend", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    267, INT64_MIN, INT64_MAX, confchk_file_extend3_choices},
  {"file_manager", "category", NULL, NULL, confchk_wiredtiger_open_file_manager_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 216, INT64_MIN, INT64_MAX, NULL},
  {"generation_drain_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 220,
    0, INT64_MAX, NULL},
  ...
  {"version", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 62, INT64_MIN,
    INT64_MAX, NULL},
  {"write_through", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 289, INT64_MIN, INT64_MAX, confchk_write_through3_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_usercfg[] = {
  ...
  {"checkpoint", "category", NULL, NULL, confchk_wiredtiger_open_checkpoint_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 56, INT64_MIN, INT64_MAX, NULL},
  {"checkpoint_cleanup", "string", NULL, "choices=[\"none\",\"reclaim_space\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_STRING, 183, INT64_MIN, INT64_MAX, confchk_checkpoint_cleanup5_choices},
  {"checkpoint_sync", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 258,
    INT64_MIN, INT64_MAX, NULL},
  {"chunk_cache", "category", NULL, NULL, confchk_wiredtiger_open_chunk_cache_subconfigs, 7,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 184, INT64_MIN, INT64_MAX, NULL},
  ...
  {"debug_mode", "category", NULL, NULL, confchk_wiredtiger_open_debug_mode_subconfigs, 14,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 190, INT64_MIN, INT64_MAX, NULL},
  {"direct_io", "list", NULL, "choices=[\"checkpoint\",\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 264, INT64_MIN, INT64_MAX, confchk_direct_io4_choices},
  {"encryption", "category", NULL, NULL, confchk_wiredtiger_open_encryption_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 19, INT64_MIN, INT64_MAX, NULL},
  {"error_prefix", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 205, INT64_MIN,
    INT64_MAX, NULL},
  ...
  {"file_extend", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0, WT_CONFIG_COMPILED_TYPE_LIST,
    267, INT64_MIN, INT64_MAX, confchk_file_extend4_choices},
  {"file_manager", "category", NULL, NULL, confchk_wiredtiger_open_file_manager_subconfigs, 3,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 216, INT64_MIN, INT64_MAX, NULL},
  {"generation_drain_timeout_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 220,
    0, INT64_MAX, NULL},
  ...
  {"verify_metadata", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 288,
    INT64_MIN, INT64_MAX, NULL},
  {"write_through", "list", NULL, "choices=[\"data\",\"log\"]", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_LIST, 289, INT64_MIN, INT64_MAX, confchk_write_through4_choices},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL}};
