...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure_tiered_storage_subconfigs[] = {
  ...
  {"object_target_size", "int", NULL, "min=0", NULL, 0}, {NULL, NULL, NULL, NULL, NULL, 0}};
...
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  {"WT_CONNECTION.reconfigure",
    ...
    "tiered_storage=(local_retention=300,object_target_size=0),"
  ...
  {"wiredtiger_open",
    ...
    "object_target_size=0),timing_stress_for_test=,"
