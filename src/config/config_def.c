...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure[] = {
  ...
  {"timing_stress_for_test", "list", NULL,
    ...
    "\"hs_sweep_race\",\"split_1\",\"split_2\",\"split_3\","
  ...
  {"verbose", "list", NULL,
    ...
    ",\"evictserver\",\"fileops\",\"handleops\",\"log\",\"hs\","
    "\"hs_activity\",\"lsm\",\"lsm_manager\",\"metadata\",\"mutex\","
    "\"overflow\",\"read\",\"rebalance\",\"reconcile\",\"recovery\","
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_verify[] = {
  ...
  {"dump_time_pairs", "boolean", NULL, NULL, NULL, 0}, {"strict", "boolean", NULL, NULL, NULL, 0},
  {NULL, NULL, NULL, NULL, NULL, 0}};
...
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  {"WT_SESSION.verify",
    ...
    "dump_offsets=,dump_pages=false,dump_time_pairs=false,"
    "strict=false",
