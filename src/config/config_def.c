...
static const WT_CONFIG_CHECK confchk_WT_SESSION_create_tiered_storage_subconfigs[] = {
  ...
  {"bucket_region", "string", NULL, NULL, NULL, 0},
...
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  {"WT_SESSION.create",
    ...
    "bucket=,bucket_prefix=,bucket_region=,cache_directory=,"
  ...
  {"file.config",
    ...
    "bucket_prefix=,bucket_region=,cache_directory=,"
  ...
  {"file.meta",
    ...
    "bucket_region=,cache_directory=,local_retention=300,name=,"
