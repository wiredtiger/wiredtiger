...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_block_cache_subconfigs[] = {
  ...
  {"size", "int", NULL, "min=0,max=6GB", NULL, 0}, {"type", "string", NULL, NULL, NULL, 0},
  {NULL, NULL, NULL, NULL, NULL, 0}};
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure[] = {
  ...
  {"block_cache", "category", NULL, NULL, confchk_wiredtiger_open_block_cache_subconfigs, 4},
  ...
  {"verbose", "list", NULL,
    ...
    "\"checkpoint\",\"checkpoint_gc\",\"checkpoint_progress\","
...
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  {"WT_CONNECTION.reconfigure",
    ...
    "block_cache=(enabled=false,path=,size=0,type=),"
