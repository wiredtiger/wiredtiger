...
static const WT_CONFIG_CHECK confchk_wiredtiger_open_debug_mode_subconfigs[] = {
  {"abort_on_corruption_in_diagnostic", "boolean", NULL, NULL, NULL, 0},
...
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  {"WT_CONNECTION.reconfigure",
    ...
    "debug_mode=(abort_on_corruption_in_diagnostic=true,"
    "checkpoint_retention=0,cursor_copy=false,eviction=false,"
