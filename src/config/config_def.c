...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_close[] = {
	{ "final_flush", "boolean", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_CHECK
    confchk_WT_CONNECTION_open_session_debug_subconfigs[] = {
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_open_session[] = {
	...
	{ "debug", "category",
	    NULL, NULL,
	    confchk_WT_CONNECTION_open_session_debug_subconfigs, 1 },
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_query_timestamp[] = {
	{ "get", "string",
	    NULL, "choices=[\"all_durable\",\"last_checkpoint\",\"oldest\","
...
static const WT_CONFIG_CHECK
    confchk_wiredtiger_open_chunk_cache_subconfigs[] = {
	{ "capacity", "int", NULL, "min=0,max=100TB", NULL, 0 },
	{ "chunk_cache_evict_trigger", "int",
	    NULL, "min=0,max=100",
	    NULL, 0 },
	{ "chunk_size", "int", NULL, "min=512KB,max=100GB", NULL, 0 },
	{ "device_path", "string", NULL, NULL, NULL, 0 },
	{ "enabled", "boolean", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_CHECK
	...
	{ "tiered_flush_error_continue", "boolean",
	    NULL, NULL,
	    NULL, 0 },
	{ "update_restore_evict", "boolean", NULL, NULL, NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK
    confchk_wiredtiger_open_history_store_subconfigs[] = {
...
static const WT_CONFIG_CHECK
	...
	{ "remove", "boolean", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_CHECK
    confchk_WT_CONNECTION_reconfigure_tiered_storage_subconfigs[] = {
	{ "local_retention", "int", NULL, "min=0,max=10000", NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};

static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure[] = {
	{ "block_cache", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_block_cache_subconfigs, 12 },
	{ "cache_max_wait_ms", "int", NULL, "min=0", NULL, 0 },
	...
	{ "checkpoint_cleanup", "string",
	    NULL, "choices=[\"none\",\"reclaim_space\"]",
	    NULL, 0 },
	{ "chunk_cache", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_chunk_cache_subconfigs, 7 },
	{ "compatibility", "category",
	    NULL, NULL,
	    confchk_WT_CONNECTION_reconfigure_compatibility_subconfigs, 1 },
	{ "debug_mode", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_debug_mode_subconfigs, 14 },
	...
	{ "eviction_trigger", "int",
	    ...
	    NULL, 0 },
	{ "eviction_updates_target", "int",
	    NULL, "min=0,max=10TB",
	    NULL, 0 },
	{ "eviction_updates_trigger", "int",
	    NULL, "min=0,max=10TB",
	    NULL, 0 },
	{ "extra_diagnostics", "list",
	    NULL, "choices=[\"all\",\"checkpoint_validate\",\"cursor_check\""
	...
	{ "generation_drain_timeout_ms", "int",
	    NULL, "min=0",
	    NULL, 0 },
	{ "history_store", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_history_store_subconfigs, 1 },
	{ "io_capacity", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_io_capacity_subconfigs, 1 },
	{ "json_output", "list",
	    NULL, "choices=[\"error\",\"message\"]",
	    NULL, 0 },
	{ "log", "category",
	    NULL, NULL,
	    confchk_WT_CONNECTION_reconfigure_log_subconfigs, 5 },
	...
	{ "timing_stress_for_test", "list",
	    ...
	    NULL, 0 },
	{ "verbose", "list",
	    NULL, "choices=[\"api\",\"backup\",\"block\",\"block_cache\","
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_rollback_to_stable[] = {
	{ "dryrun", "boolean", NULL, NULL, NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK confchk_WT_CURSOR_bound[] = {
	{ "action", "string",
	    NULL, "choices=[\"clear\",\"set\"]",
	    NULL, 0 },
	{ "bound", "string",
	    NULL, "choices=[\"lower\",\"upper\"]",
	    NULL, 0 },
	{ "inclusive", "boolean", NULL, NULL, NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK confchk_WT_CURSOR_reconfigure[] = {
	...
	{ "prefix_search", "boolean", NULL, NULL, NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};

static const WT_CONFIG_CHECK
    confchk_WT_SESSION_create_assert_subconfigs[] = {
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_alter[] = {
	...
	{ "assert", "category",
	    NULL, NULL,
	    confchk_WT_SESSION_create_assert_subconfigs, 4 },
	...
	{ "verbose", "list",
	    NULL, "choices=[\"write_timestamp\"]",
	    NULL, 0 },
	{ "write_timestamp_usage", "string",
	    NULL, "choices=[\"always\",\"key_consistent\",\"mixed_mode\","
	    "\"never\",\"none\",\"ordered\"]",
	    NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_begin_transaction[] = {
	...
	{ "isolation", "string",
	    ...
	    NULL, 0 },
	{ "name", "string", NULL, NULL, NULL, 0 },
	{ "no_timestamp", "boolean", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_CHECK
    confchk_WT_SESSION_checkpoint_flush_tier_subconfigs[] = {
	{ "enabled", "boolean", NULL, NULL, NULL, 0 },
	{ "force", "boolean", NULL, NULL, NULL, 0 },
	{ "sync", "boolean", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_checkpoint[] = {
	...
	{ "flush_tier", "category",
	    NULL, NULL,
	    confchk_WT_SESSION_checkpoint_flush_tier_subconfigs, 4 },
	{ "force", "boolean", NULL, NULL, NULL, 0 },
	{ "name", "string", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_CHECK
    confchk_WT_SESSION_create_import_subconfigs[] = {
	{ "compare_timestamp", "string",
	    NULL, "choices=[\"oldest\",\"oldest_timestamp\",\"stable\","
	    "\"stable_timestamp\"]",
	    NULL, 0 },
	{ "enabled", "boolean", NULL, NULL, NULL, 0 },
	{ "file_metadata", "string", NULL, NULL, NULL, 0 },
	{ "metadata_file", "string", NULL, NULL, NULL, 0 },
	{ "repair", "boolean", NULL, NULL, NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK
    confchk_WT_SESSION_create_tiered_storage_subconfigs[] = {
	{ "auth_token", "string", NULL, NULL, NULL, 0 },
	{ "bucket", "string", NULL, NULL, NULL, 0 },
	{ "bucket_prefix", "string", NULL, NULL, NULL, 0 },
	{ "cache_directory", "string", NULL, NULL, NULL, 0 },
	{ "local_retention", "int", NULL, "min=0,max=10000", NULL, 0 },
	{ "name", "string", NULL, NULL, NULL, 0 },
	{ "object_target_size", "int", NULL, "min=0", NULL, 0 },
	{ "shared", "boolean", NULL, NULL, NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_create[] = {
	...
	{ "import", "category",
	    NULL, NULL,
	    confchk_WT_SESSION_create_import_subconfigs, 5 },
	...
	{ "tiered_storage", "category",
	    NULL, NULL,
	    confchk_WT_SESSION_create_tiered_storage_subconfigs, 8 },
	{ "type", "string", NULL, NULL, NULL, 0 },
	{ "value_format", "format",
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_drop[] = {
	...
	{ "remove_shared", "boolean", NULL, NULL, NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK
    confchk_WT_SESSION_open_cursor_debug_subconfigs[] = {
	{ "checkpoint_read_timestamp", "string", NULL, NULL, NULL, 0 },
	{ "dump_version", "boolean", NULL, NULL, NULL, 0 },
	{ "release_evict", "boolean", NULL, NULL, NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};

static const WT_CONFIG_CHECK
    confchk_WT_SESSION_open_cursor_incremental_subconfigs[] = {
	{ "consolidate", "boolean", NULL, NULL, NULL, 0 },
	{ "enabled", "boolean", NULL, NULL, NULL, 0 },
	{ "file", "string", NULL, NULL, NULL, 0 },
	{ "force_stop", "boolean", NULL, NULL, NULL, 0 },
	{ "granularity", "int", NULL, "min=4KB,max=2GB", NULL, 0 },
	{ "src_id", "string", NULL, NULL, NULL, 0 },
	{ "this_id", "string", NULL, NULL, NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_open_cursor[] = {
	...
	{ "debug", "category",
	    NULL, NULL,
	    confchk_WT_SESSION_open_cursor_debug_subconfigs, 3 },
	{ "dump", "string",
	    NULL, "choices=[\"hex\",\"json\",\"pretty\",\"pretty_hex\","
	    "\"print\"]",
	    NULL, 0 },
	{ "incremental", "category",
	    NULL, NULL,
	    confchk_WT_SESSION_open_cursor_incremental_subconfigs, 7 },
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_verify[] = {
	...
	{ "stable_timestamp", "boolean", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_CHECK confchk_object_meta[] = {
	...
	{ "flush_timestamp", "string", NULL, NULL, NULL, 0 },
	{ "format", "string", NULL, "choices=[\"btree\"]", NULL, 0 },
	{ "huffman_key", "string", NULL, NULL, NULL, 0 },
	{ "huffman_value", "string", NULL, NULL, NULL, 0 },
	{ "id", "string", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_CHECK confchk_tiered_meta[] = {
	...
	{ "memory_page_max", "int",
	    NULL, "min=512B,max=10TB",
	    NULL, 0 },
	{ "oldest", "string", NULL, NULL, NULL, 0 },
	{ "os_cache_dirty_max", "int", NULL, "min=0", NULL, 0 },
	{ "os_cache_max", "int", NULL, "min=0", NULL, 0 },
	{ "prefix_compression", "boolean", NULL, NULL, NULL, 0 },
	{ "prefix_compression_min", "int", NULL, "min=0", NULL, 0 },
...
static const WT_CONFIG_CHECK
    confchk_wiredtiger_open_hash_subconfigs[] = {
	{ "buckets", "int", NULL, "min=64,max=65536", NULL, 0 },
	{ "dhandle_buckets", "int",
	    NULL, "min=64,max=65536",
	    NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK confchk_wiredtiger_open[] = {
	...
	{ "hash", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_hash_subconfigs, 2 },
	...
	{ "log", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_log_subconfigs, 11 },
	{ "lsm_manager", "category",
	    NULL, NULL,
	    confchk_wiredtiger_open_lsm_manager_subconfigs, 2 },
	{ "mmap", "boolean", NULL, NULL, NULL, 0 },
	{ "mmap_all", "boolean", NULL, NULL, NULL, 0 },
	...
	{ "tiered_storage", "category",
	    NULL, NULL,
	    confchk_tiered_storage_subconfigs, 8 },
	{ "timing_stress_for_test", "list",
	    NULL, "choices=[\"aggressive_stash_free\",\"aggressive_sweep\","
	    "\"backup_rename\",\"checkpoint_evict_page\","
	    "\"checkpoint_handle\",\"checkpoint_slow\",\"checkpoint_stop\","
...
static const WT_CONFIG_ENTRY config_entries[] = {
	...
	{ "WT_CONNECTION.close",
	  "final_flush=false,leak_memory=false,use_timestamp=true",
	...
	{ "WT_CURSOR.bound",
	  "action=set,bound=,inclusive=true",
	  confchk_WT_CURSOR_bound, 3
	},
	{ "WT_CURSOR.close",
	  "",
	  NULL, 0
	...
	{ "WT_SESSION.flush_tier",
	  "force=false,lock_wait=true,sync=on,timeout=0",
