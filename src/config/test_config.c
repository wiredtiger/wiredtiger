...
static const WT_CONFIG_CHECK confchk_example_test[] = {
  ...
  {"workload_generator", "category", NULL, NULL, confchk_workload_generator_subconfigs, 11},
...
static const WT_CONFIG_ENTRY config_entries[] = {
  {"example_test",
    ...
    "runtime_monitor=(ops_per_second=1,stat_cache_size=(enabled=false"
    ",limit=)),timestamp_manager=(enabled=false,oldest_lag=0,"
    "stable_lag=0),workload_generator=(collection_count=1,"
    "insert_config=(key_size=0,ops_per_second=1,value_size=0),"
    "insert_threads=0,key_count=0,key_size=0,ops_per_second=1,"
    "ops_per_transaction=(max=1,min=),read_threads=0,"
    "update_config=(key_size=0,ops_per_second=1,value_size=0),"
    "update_threads=0,value_size=0),workload_tracking=(enabled=false)",
