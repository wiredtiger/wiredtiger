...
static const WT_CONFIG_CHECK confchk_statistics_monitor_subconfigs[] = {
...
static const WT_CONFIG_ENTRY config_entries[] = {
  {"bounded_cursor_perf",
    ...
    "type=all),statistics_monitor=(cache_hs_insert=(max=1,min=0,"
  ...
  {"burst_inserts",
    ...
    "enable_logging=false,operation_tracker=(enabled=true,op_rate=1s,"
    "tracking_key_format=QSQ,tracking_value_format=iS),"
    "reverse_collator=false,statistics_config=(enable_logging=true,"
    "type=all),statistics_monitor=(cache_hs_insert=(max=1,min=0,"
    "postrun=false,runtime=false,save=false),cc_pages_removed=(max=1,"
  ...
  {"search_near_01",
    ...
    "statistics_monitor=(cache_hs_insert=(max=1,min=0,postrun=false,"
