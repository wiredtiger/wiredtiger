...
static const WT_CONFIG_CHECK confchk_cache_hs_insert_subconfigs[] = {
	{ "max", "string", NULL, NULL, NULL, 0 },
	{ "min", "int", NULL, "min=0", NULL, 0 },
	{ "postrun", "boolean", NULL, NULL, NULL, 0 },
	{ "runtime", "boolean", NULL, NULL, NULL, 0 },
	{ "save", "boolean", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_CHECK confchk_metrics_monitor_subconfigs[] = {
	{ "cache_hs_insert", "category",
	    NULL, NULL,
	    confchk_cache_hs_insert_subconfigs, 5 },
	{ "cc_pages_removed", "category",
	    NULL, NULL,
	    confchk_cc_pages_removed_subconfigs, 5 },
	{ "enabled", "boolean", NULL, NULL, NULL, 0 },
	{ "op_rate", "string", NULL, NULL, NULL, 0 },
	{ "stat_cache_size", "category",
	    NULL, NULL,
	    confchk_stat_cache_size_subconfigs, 5 },
	{ "stat_db_size", "category",
	    NULL, NULL,
	    confchk_stat_db_size_subconfigs, 5 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};

static const WT_CONFIG_CHECK
    confchk_operation_tracker_subconfigs[] = {
	{ "enabled", "boolean", NULL, NULL, NULL, 0 },
	{ "op_rate", "string", NULL, NULL, NULL, 0 },
	{ "tracking_key_format", "string", NULL, NULL, NULL, 0 },
	{ "tracking_value_format", "string", NULL, NULL, NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};

static const WT_CONFIG_CHECK
    confchk_statistics_config_subconfigs[] = {
...
static const WT_CONFIG_CHECK
    confchk_timestamp_manager_subconfigs[] = {
	{ "enabled", "boolean", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_CHECK
    confchk_checkpoint_config_subconfigs[] = {
	{ "op_rate", "string", NULL, NULL, NULL, 0 },
	{ "thread_count", "int", NULL, "min=0,max=1", NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};

static const WT_CONFIG_CHECK
    confchk_ops_per_transaction_subconfigs[] = {
	{ "max", "string", NULL, NULL, NULL, 0 },
	{ "min", "int", NULL, "min=0", NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK confchk_custom_config_subconfigs[] = {
	{ "key_size", "int", NULL, "min=1", NULL, 0 },
	{ "op_rate", "string", NULL, NULL, NULL, 0 },
	{ "ops_per_transaction", "category",
	    NULL, NULL,
	    confchk_ops_per_transaction_subconfigs, 2 },
	{ "thread_count", "int", NULL, "min=0", NULL, 0 },
	{ "value_size", "int", NULL, "min=1", NULL, 0 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK confchk_populate_config_subconfigs[] = {
	{ "collection_count", "int",
	    NULL, "min=0,max=200000",
	    NULL, 0 },
	{ "key_count_per_collection", "int",
	    NULL, "min=0,max=1000000",
	    NULL, 0 },
	{ "key_size", "int", NULL, "min=1", NULL, 0 },
...
static const WT_CONFIG_CHECK confchk_workload_manager_subconfigs[] = {
	{ "checkpoint_config", "category",
	    NULL, NULL,
	    confchk_checkpoint_config_subconfigs, 2 },
	{ "custom_config", "category",
	    NULL, NULL,
	    confchk_custom_config_subconfigs, 5 },
	{ "enabled", "boolean", NULL, NULL, NULL, 0 },
	{ "insert_config", "category",
	    NULL, NULL,
	    confchk_insert_config_subconfigs, 5 },
	{ "op_rate", "string", NULL, NULL, NULL, 0 },
	{ "populate_config", "category",
	    NULL, NULL,
	    confchk_populate_config_subconfigs, 5 },
	{ "read_config", "category",
	    NULL, NULL,
	    confchk_read_config_subconfigs, 5 },
	{ "remove_config", "category",
	    NULL, NULL,
	    confchk_remove_config_subconfigs, 3 },
	{ "update_config", "category",
	    NULL, NULL,
	    confchk_update_config_subconfigs, 5 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
...
static const WT_CONFIG_CHECK confchk_bounded_cursor_perf[] = {
	...
	{ "duration_seconds", "int",
	    ...
	    NULL, 0 },
	{ "enable_logging", "boolean", NULL, NULL, NULL, 0 },
	{ "metrics_monitor", "category",
	    NULL, NULL,
	    confchk_metrics_monitor_subconfigs, 6 },
	{ "operation_tracker", "category",
	    NULL, NULL,
	    confchk_operation_tracker_subconfigs, 4 },
	{ "reverse_collator", "boolean", NULL, NULL, NULL, 0 },
	{ "statistics_config", "category",
	    NULL, NULL,
	    confchk_statistics_config_subconfigs, 2 },
	{ "timestamp_manager", "category",
	    NULL, NULL,
	    confchk_timestamp_manager_subconfigs, 4 },
	{ "workload_manager", "category",
	    NULL, NULL,
	    confchk_workload_manager_subconfigs, 9 },
	{ NULL, NULL, NULL, NULL, NULL, 0 }
};
