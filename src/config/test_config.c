...
static const WT_CONFIG_CHECK confchk_cache_hs_insert_subconfigs[] = {
  {"max", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 10},
  {"min", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 9},
  {"postrun", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 11},
  {"runtime", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 12},
  {"save", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 13},
...
static const WT_CONFIG_CHECK confchk_metrics_monitor_subconfigs[] = {
  {"cache_hs_insert", "category", NULL, NULL, confchk_cache_hs_insert_subconfigs, 5,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 8},
  {"cc_pages_removed", "category", NULL, NULL, confchk_cc_pages_removed_subconfigs, 5,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 14},
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 6},
  {"op_rate", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 7},
  {"stat_cache_size", "category", NULL, NULL, confchk_stat_cache_size_subconfigs, 5,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 15},
  {"stat_db_size", "category", NULL, NULL, confchk_stat_db_size_subconfigs, 5,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 16},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0}};
...
static const WT_CONFIG_CHECK confchk_statistics_config_subconfigs[] = {
  {"enable_logging", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 4},
  {"type", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 22},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0}};

static const WT_CONFIG_CHECK confchk_timestamp_manager_subconfigs[] = {
  {"enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 6},
  {"oldest_lag", "int", NULL, "min=0,max=1000000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 24},
  {"op_rate", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 7},
  {"stable_lag", "int", NULL, "min=0,max=1000000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 25},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0}};

static const WT_CONFIG_CHECK confchk_checkpoint_config_subconfigs[] = {
  {"op_rate", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 7},
  {"thread_count", "int", NULL, "min=0,max=1", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 28},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0}};
...
static const WT_CONFIG_CHECK confchk_custom_config_subconfigs[] = {
  {"key_size", "int", NULL, "min=1", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 31},
  {"op_rate", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 7},
  {"ops_per_transaction", "category", NULL, NULL, confchk_ops_per_transaction_subconfigs, 2,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 30},
  {"thread_count", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 28},
  {"value_size", "int", NULL, "min=1", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 32},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0}};
...
static const WT_CONFIG_CHECK confchk_populate_config_subconfigs[] = {
  {"collection_count", "int", NULL, "min=0,max=200000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 35},
  {"key_count_per_collection", "int", NULL, "min=0,max=1000000", NULL, 0,
    WT_CONFIG_COMPILED_TYPE_INT, 36},
  {"key_size", "int", NULL, "min=1", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 31},
  {"thread_count", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 28},
  {"value_size", "int", NULL, "min=1", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 32},
  {NULL, NULL, NULL, NULL, NULL, 0, 0, 0}};
...
static const WT_CONFIG_CHECK confchk_bounded_cursor_perf[] = {
  ...
  {"duration_seconds", "int", NULL, "min=0,max=1000000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 3},
  {"enable_logging", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 4},
  {"metrics_monitor", "category", NULL, NULL, confchk_metrics_monitor_subconfigs, 6,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 5},
  {"operation_tracker", "category", NULL, NULL, confchk_operation_tracker_subconfigs, 4,
    WT_CONFIG_COMPILED_TYPE_CATEGORY, 17},
...
static const WT_CONFIG_CHECK confchk_burst_inserts[] = {
  {"burst_duration", "string", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_STRING, 41},
  {"cache_max_wait_ms", "int", NULL, "min=0", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 0},
  {"cache_size_mb", "int", NULL, "min=0,max=100000000000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 1},
  {"compression_enabled", "boolean", NULL, NULL, NULL, 0, WT_CONFIG_COMPILED_TYPE_BOOLEAN, 2},
  {"duration_seconds", "int", NULL, "min=0,max=1000000", NULL, 0, WT_CONFIG_COMPILED_TYPE_INT, 3},
