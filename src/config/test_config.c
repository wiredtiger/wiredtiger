...
static const WT_CONFIG_CHECK confchk_runtime_monitor_subconfigs[] = {
  ...
  {"ops_per_second", "int", NULL, "min=1,max=1000", NULL, 0},
...
static const WT_CONFIG_CHECK confchk_workload_generator_subconfigs[] = {
  ...
  {"enabled", "boolean", NULL, NULL, NULL, 0},
  {"insert_config", "category", NULL, NULL, confchk_insert_config_subconfigs, 3},
  ...
  {"update_config", "category", NULL, NULL, confchk_update_config_subconfigs, 3},
...
static const WT_CONFIG_CHECK confchk_example_test[] = {
  ...
  {"runtime_monitor", "category", NULL, NULL, confchk_runtime_monitor_subconfigs, 3},
  {"timestamp_manager", "category", NULL, NULL, confchk_timestamp_manager_subconfigs, 4},
  {"workload_generator", "category", NULL, NULL, confchk_workload_generator_subconfigs, 13},
...
static const WT_CONFIG_ENTRY config_entries[] = {
  {"example_test",
    ...
    "runtime_monitor=(enabled=false,ops_per_second=1,"
    "stat_cache_size=(enabled=false,limit=)),"
    "timestamp_manager=(enabled=false,oldest_lag=0,ops_per_second=1,"
    "stable_lag=0),workload_generator=(collection_count=1,"
    "enabled=false,insert_config=(key_size=0,ops_per_second=1,"
    "value_size=0),insert_threads=0,key_count=0,key_size=0,"
    "ops_per_second=1,ops_per_second=1,ops_per_transaction=(max=1,"
    "min=),read_threads=0,update_config=(key_size=0,ops_per_second=1,"
    "value_size=0),update_threads=0,value_size=0),"
