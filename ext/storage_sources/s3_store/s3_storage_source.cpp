...
static void S3ShowStatistics(const S3Storage &);
...
S3FileLock(WT_FILE_HANDLE *fileHandle, WT_SESSION *session, bool lock)
{
    ...
    ((S3FileHandle *)fileHandle)->storage->statistics.fhOps++;
    return (0);
}
 ...
 */
static void
S3ShowStatistics(const S3Storage &s3)
{
