...
// incorporate the logging with WiredTiger's logging system. AWS SDK also registers the same
// logger, and the best attempt is made to match the SDK's logging levels to WiredTiger's.
