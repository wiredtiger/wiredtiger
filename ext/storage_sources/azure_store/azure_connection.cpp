  ...
  const std::string &search_prefix, std::vector<std::string> &objects, bool list_single) const
{
    ...
    int azure_connection::put_object(const std::string &object_key, const std::string &file_path)
      const
    {
    ...
    int azure_connection::delete_object(const std::string &object_key) const
    {
    ...
    int azure_connection::read_object(
    ...
    int azure_connection::object_exists(
    ...
    int azure_connection::bucket_exists(bool &exists) const
    {
        exists = false;
    ...
    const int azure_connection::http_to_errno(const Azure::Core::RequestFailedException &e) const
    {
