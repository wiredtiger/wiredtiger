 ...
 * the Azure client. The azure_connection allows for the following functionality:
 * Listing the container contents filtered by a given prefix and output all or output single, Puts a
 * blob to the cloud, gets the blob from the cloud, and deletes a blob from the cloud. It also can check
 * for the existance for a unique container or blob. Each azure_connection is associated with a unique
